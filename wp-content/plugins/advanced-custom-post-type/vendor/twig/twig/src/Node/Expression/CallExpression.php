...
abstract class CallExpression extends AbstractExpression
{
    ...
    protected function compileArguments(Compiler $compiler, $isArray = false): void
    {
        ...
        $twigCallable = $this->getAttribute('acpt_twig_callable');
    ...
    protected function getArguments($callable, $arguments)
    {
        ...
        $isVariadic = $this->getAttribute('acpt_twig_callable')->isVariadic();
        if (!$named && !$isVariadic) {
            return $parameters;
        }
     ...
     *
     * To be removed in 4.0 and replace by $this->getAttribute('acpt_twig_callable').
     */
    private function getTwigCallable(): TwigCallableInterface
    {
        $current = $this->getAttribute('acpt_twig_callable');

        $this->setAttribute('acpt_twig_callable', match ($this->getAttribute('type')) {
            'test' => (new TwigTest(
        ...
        return $this->getAttribute('acpt_twig_callable');
    }
}
