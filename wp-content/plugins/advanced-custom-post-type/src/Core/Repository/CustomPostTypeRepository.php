		...
		if(self::isAValidCustomPostType($postType)){
			...
			if(
				...
				$settings = [
					...
					'with_front' => isset($postTypeObject->with_front) ? $postTypeObject->with_front : null,
					'rewrite_hierarchical' => isset($postTypeObject->rewrite_hierarchical) ? $postTypeObject->rewrite_hierarchical : null,
