...
class TableField extends AbstractField
{
	...
	public function render()
	{
		...
		$field .= '<a class="acpt-modal-link acpt-open-import-template button button-secondary" href="#acpt-import-template-'.$id.'" rel="modal:open" >'.Translator::translate("Import template").'</a>';
	...
	private function enqueueAssets()
	{
		...
		wp_enqueue_script( 'acpt-tabulator-js', plugins_url( ACPT_DEV_MODE ? 'advanced-custom-post-type/assets/static/js/ACPTTabulator.js' : 'advanced-custom-post-type/assets/static/js/ACPTTabulator.min.js'), [], '1.0.0', true);
		wp_enqueue_script( 'custom-tabulator-js', plugins_url( ACPT_DEV_MODE ? 'advanced-custom-post-type/assets/static/js/tabulator.js' : 'advanced-custom-post-type/assets/static/js/tabulator.min.js'), [], '1.0.0', true);
	}
}