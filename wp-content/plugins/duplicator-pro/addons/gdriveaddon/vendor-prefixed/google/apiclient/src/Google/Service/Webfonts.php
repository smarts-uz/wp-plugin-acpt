 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Webfonts', 'VendorDuplicator\\Google_Service_Webfonts', \false);
/**
...
class Google_Service_Webfonts_Webfonts_Resource extends Google_Service_Resource
{
    ...
    public function listWebfonts($optParams = array())
    {
        ...
        return $this->call('list', array($params), "VendorDuplicator\\Google_Service_Webfonts_WebfontList");
    }
}
/**
 * The "webfonts" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Webfonts_Webfonts_Resource', 'VendorDuplicator\\Google_Service_Webfonts_Webfonts_Resource', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Webfonts_Webfont', 'VendorDuplicator\\Google_Service_Webfonts_Webfont', \false);
/** @internal */
class Google_Service_Webfonts_WebfontList extends Google_Collection
{
    protected $collection_key = 'items';
    protected $internal_gapi_mappings = array();
    protected $itemsType = 'VendorDuplicator\\Google_Service_Webfonts_Webfont';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Webfonts_WebfontList', 'VendorDuplicator\\Google_Service_Webfonts_WebfontList', \false);
