...
class Google_Http_MediaFileUpload
{
    ...
    {
        if ($this->client->getClassConfig("VendorDuplicator\\Google_Http_Request", "enable_gzip_for_uploads")) {
    ...
    public function resume($resumeUri)
    {
        ...
        $httpRequest = new Google_Http_Request($this->resumeUri, 'PUT', $headers);
        return $this->makePutRequest($httpRequest);
    }
    /**
     * @return array|bool
