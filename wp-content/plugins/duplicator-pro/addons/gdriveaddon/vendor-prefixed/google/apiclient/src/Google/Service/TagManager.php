...
class Google_Service_TagManager extends Google_Service
{
    ...
    public function __construct(Google_Client $client)
    {
        ...
        $this->accounts = new Google_Service_TagManager_Accounts_Resource($this, $this->serviceName, 'accounts', array('methods' => array('get' => array('path' => 'accounts/{accountId}', 'httpMethod' => 'GET', 'parameters' => array('accountId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'list' => array('path' => 'accounts', 'httpMethod' => 'GET', 'parameters' => array()), 'update' => array('path' => 'accounts/{accountId}', 'httpMethod' => 'PUT', 'parameters' => array('accountId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'fingerprint' => array('location' => 'query', 'type' => 'string'))))));
        $this->accounts_containers = new Google_Service_TagManager_AccountsContainers_Resource($this, $this->serviceName, 'containers', array('methods' => array('create' => array('path' => 'accounts/{accountId}/containers', 'httpMethod' => 'POST', 'parameters' => array('accountId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'delete' => array('path' => 'accounts/{accountId}/containers/{containerId}', 'httpMethod' => 'DELETE', 'parameters' => array('accountId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'containerId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'get' => array('path' => 'accounts/{accountId}/containers/{containerId}', 'httpMethod' => 'GET', 'parameters' => array('accountId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'containerId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'list' => array('path' => 'accounts/{accountId}/containers', 'httpMethod' => 'GET', 'parameters' => array('accountId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'update' => array('path' => 'accounts/{accountId}/containers/{containerId}', 'httpMethod' => 'PUT', 'parameters' => array('accountId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'containerId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'fingerprint' => array('location' => 'query', 'type' => 'string'))))));
        $this->accounts_containers_folders = new Google_Service_TagManager_AccountsContainersFolders_Resource($this, $this->serviceName, 'folders', array('methods' => array('create' => array('path' => 'accounts/{accountId}/containers/{containerId}/folders', 'httpMethod' => 'POST', 'parameters' => array('accountId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'containerId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'delete' => array('path' => 'accounts/{accountId}/containers/{containerId}/folders/{folderId}', 'httpMethod' => 'DELETE', 'parameters' => array('accountId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'containerId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'folderId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'get' => array('path' => 'accounts/{accountId}/containers/{containerId}/folders/{folderId}', 'httpMethod' => 'GET', 'parameters' => array('accountId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'containerId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'folderId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'list' => array('path' => 'accounts/{accountId}/containers/{containerId}/folders', 'httpMethod' => 'GET', 'parameters' => array('accountId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'containerId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'update' => array('path' => 'accounts/{accountId}/containers/{containerId}/folders/{folderId}', 'httpMethod' => 'PUT', 'parameters' => array('accountId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'containerId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'folderId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'fingerprint' => array('location' => 'query', 'type' => 'string'))))));
        ...
        $this->accounts_containers_move_folders = new Google_Service_TagManager_AccountsContainersMoveFolders_Resource($this, $this->serviceName, 'move_folders', array('methods' => array('update' => array('path' => 'accounts/{accountId}/containers/{containerId}/move_folders/{folderId}', 'httpMethod' => 'PUT', 'parameters' => array('accountId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'containerId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'folderId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'tagId' => array('location' => 'query', 'type' => 'string', 'repeated' => \true), 'triggerId' => array('location' => 'query', 'type' => 'string', 'repeated' => \true), 'variableId' => array('location' => 'query', 'type' => 'string', 'repeated' => \true))))));
        $this->accounts_containers_tags = new Google_Service_TagManager_AccountsContainersTags_Resource($this, $this->serviceName, 'tags', array('methods' => array('create' => array('path' => 'accounts/{accountId}/containers/{containerId}/tags', 'httpMethod' => 'POST', 'parameters' => array('accountId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'containerId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'delete' => array('path' => 'accounts/{accountId}/containers/{containerId}/tags/{tagId}', 'httpMethod' => 'DELETE', 'parameters' => array('accountId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'containerId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'tagId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'get' => array('path' => 'accounts/{accountId}/containers/{containerId}/tags/{tagId}', 'httpMethod' => 'GET', 'parameters' => array('accountId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'containerId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'tagId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'list' => array('path' => 'accounts/{accountId}/containers/{containerId}/tags', 'httpMethod' => 'GET', 'parameters' => array('accountId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'containerId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'update' => array('path' => 'accounts/{accountId}/containers/{containerId}/tags/{tagId}', 'httpMethod' => 'PUT', 'parameters' => array('accountId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'containerId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'tagId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'fingerprint' => array('location' => 'query', 'type' => 'string'))))));
        $this->accounts_containers_triggers = new Google_Service_TagManager_AccountsContainersTriggers_Resource($this, $this->serviceName, 'triggers', array('methods' => array('create' => array('path' => 'accounts/{accountId}/containers/{containerId}/triggers', 'httpMethod' => 'POST', 'parameters' => array('accountId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'containerId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'delete' => array('path' => 'accounts/{accountId}/containers/{containerId}/triggers/{triggerId}', 'httpMethod' => 'DELETE', 'parameters' => array('accountId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'containerId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'triggerId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'get' => array('path' => 'accounts/{accountId}/containers/{containerId}/triggers/{triggerId}', 'httpMethod' => 'GET', 'parameters' => array('accountId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'containerId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'triggerId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'list' => array('path' => 'accounts/{accountId}/containers/{containerId}/triggers', 'httpMethod' => 'GET', 'parameters' => array('accountId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'containerId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'update' => array('path' => 'accounts/{accountId}/containers/{containerId}/triggers/{triggerId}', 'httpMethod' => 'PUT', 'parameters' => array('accountId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'containerId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'triggerId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'fingerprint' => array('location' => 'query', 'type' => 'string'))))));
        $this->accounts_containers_variables = new Google_Service_TagManager_AccountsContainersVariables_Resource($this, $this->serviceName, 'variables', array('methods' => array('create' => array('path' => 'accounts/{accountId}/containers/{containerId}/variables', 'httpMethod' => 'POST', 'parameters' => array('accountId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'containerId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'delete' => array('path' => 'accounts/{accountId}/containers/{containerId}/variables/{variableId}', 'httpMethod' => 'DELETE', 'parameters' => array('accountId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'containerId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'variableId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'get' => array('path' => 'accounts/{accountId}/containers/{containerId}/variables/{variableId}', 'httpMethod' => 'GET', 'parameters' => array('accountId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'containerId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'variableId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'list' => array('path' => 'accounts/{accountId}/containers/{containerId}/variables', 'httpMethod' => 'GET', 'parameters' => array('accountId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'containerId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'update' => array('path' => 'accounts/{accountId}/containers/{containerId}/variables/{variableId}', 'httpMethod' => 'PUT', 'parameters' => array('accountId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'containerId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'variableId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'fingerprint' => array('location' => 'query', 'type' => 'string'))))));
        $this->accounts_containers_versions = new Google_Service_TagManager_AccountsContainersVersions_Resource($this, $this->serviceName, 'versions', array('methods' => array('create' => array('path' => 'accounts/{accountId}/containers/{containerId}/versions', 'httpMethod' => 'POST', 'parameters' => array('accountId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'containerId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'delete' => array('path' => 'accounts/{accountId}/containers/{containerId}/versions/{containerVersionId}', 'httpMethod' => 'DELETE', 'parameters' => array('accountId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'containerId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'containerVersionId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'get' => array('path' => 'accounts/{accountId}/containers/{containerId}/versions/{containerVersionId}', 'httpMethod' => 'GET', 'parameters' => array('accountId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'containerId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'containerVersionId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'list' => array('path' => 'accounts/{accountId}/containers/{containerId}/versions', 'httpMethod' => 'GET', 'parameters' => array('accountId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'containerId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'headers' => array('location' => 'query', 'type' => 'boolean'), 'includeDeleted' => array('location' => 'query', 'type' => 'boolean'))), 'publish' => array('path' => 'accounts/{accountId}/containers/{containerId}/versions/{containerVersionId}/publish', 'httpMethod' => 'POST', 'parameters' => array('accountId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'containerId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'containerVersionId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'fingerprint' => array('location' => 'query', 'type' => 'string'))), 'restore' => array('path' => 'accounts/{accountId}/containers/{containerId}/versions/{containerVersionId}/restore', 'httpMethod' => 'POST', 'parameters' => array('accountId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'containerId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'containerVersionId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'undelete' => array('path' => 'accounts/{accountId}/containers/{containerId}/versions/{containerVersionId}/undelete', 'httpMethod' => 'POST', 'parameters' => array('accountId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'containerId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'containerVersionId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'update' => array('path' => 'accounts/{accountId}/containers/{containerId}/versions/{containerVersionId}', 'httpMethod' => 'PUT', 'parameters' => array('accountId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'containerId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'containerVersionId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'fingerprint' => array('location' => 'query', 'type' => 'string'))))));
        $this->accounts_permissions = new Google_Service_TagManager_AccountsPermissions_Resource($this, $this->serviceName, 'permissions', array('methods' => array('create' => array('path' => 'accounts/{accountId}/permissions', 'httpMethod' => 'POST', 'parameters' => array('accountId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'delete' => array('path' => 'accounts/{accountId}/permissions/{permissionId}', 'httpMethod' => 'DELETE', 'parameters' => array('accountId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'permissionId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'get' => array('path' => 'accounts/{accountId}/permissions/{permissionId}', 'httpMethod' => 'GET', 'parameters' => array('accountId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'permissionId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'list' => array('path' => 'accounts/{accountId}/permissions', 'httpMethod' => 'GET', 'parameters' => array('accountId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'update' => array('path' => 'accounts/{accountId}/permissions/{permissionId}', 'httpMethod' => 'PUT', 'parameters' => array('accountId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'permissionId' => array('location' => 'path', 'type' => 'string', 'required' => \true))))));
    }
}
/*
 * Licensed under the Apache License, Version 2.0 (the "License"); you may not
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_TagManager', 'VendorDuplicator\\Google_Service_TagManager', \false);
/**
...
class Google_Service_TagManager_Accounts_Resource extends Google_Service_Resource
{
    ...
    public function get($accountId, $optParams = array())
    {
        ...
        return $this->call('get', array($params), "VendorDuplicator\\Google_Service_TagManager_Account");
    }
    /**
    ...
    public function listAccounts($optParams = array())
    {
        $params = array();
        $params = \array_merge($params, $optParams);
        return $this->call('list', array($params), "VendorDuplicator\\Google_Service_TagManager_ListAccountsResponse");
    }
    /**
    ...
    public function update($accountId, Google_Service_TagManager_Account $postBody, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('update', array($params), "VendorDuplicator\\Google_Service_TagManager_Account");
    }
}
/**
 * The "accounts" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_TagManager_Accounts_Resource', 'VendorDuplicator\\Google_Service_TagManager_Accounts_Resource', \false);
/**
...
class Google_Service_TagManager_AccountsContainers_Resource extends Google_Service_Resource
{
    ...
    public function create($accountId, Google_Service_TagManager_Container $postBody, $optParams = array())
    {
        $params = array('accountId' => $accountId, 'postBody' => $postBody);
        $params = \array_merge($params, $optParams);
        return $this->call('create', array($params), "VendorDuplicator\\Google_Service_TagManager_Container");
    }
    /**
    ...
    public function get($accountId, $containerId, $optParams = array())
    {
        $params = array('accountId' => $accountId, 'containerId' => $containerId);
        $params = \array_merge($params, $optParams);
        return $this->call('get', array($params), "VendorDuplicator\\Google_Service_TagManager_Container");
    }
    /**
    ...
    public function listAccountsContainers($accountId, $optParams = array())
    {
        $params = array('accountId' => $accountId);
        $params = \array_merge($params, $optParams);
        return $this->call('list', array($params), "VendorDuplicator\\Google_Service_TagManager_ListContainersResponse");
    }
    /**
    ...
    public function update($accountId, $containerId, Google_Service_TagManager_Container $postBody, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('update', array($params), "VendorDuplicator\\Google_Service_TagManager_Container");
    }
}
/**
 * The "containers" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_TagManager_AccountsContainers_Resource', 'VendorDuplicator\\Google_Service_TagManager_AccountsContainers_Resource', \false);
/**
...
class Google_Service_TagManager_AccountsContainersFolders_Resource extends Google_Service_Resource
{
    ...
    public function create($accountId, $containerId, Google_Service_TagManager_Folder $postBody, $optParams = array())
    {
        $params = array('accountId' => $accountId, 'containerId' => $containerId, 'postBody' => $postBody);
        $params = \array_merge($params, $optParams);
        return $this->call('create', array($params), "VendorDuplicator\\Google_Service_TagManager_Folder");
    }
    /**
    ...
    public function get($accountId, $containerId, $folderId, $optParams = array())
    {
        $params = array('accountId' => $accountId, 'containerId' => $containerId, 'folderId' => $folderId);
        $params = \array_merge($params, $optParams);
        return $this->call('get', array($params), "VendorDuplicator\\Google_Service_TagManager_Folder");
    }
    /**
    ...
    public function listAccountsContainersFolders($accountId, $containerId, $optParams = array())
    {
        $params = array('accountId' => $accountId, 'containerId' => $containerId);
        $params = \array_merge($params, $optParams);
        return $this->call('list', array($params), "VendorDuplicator\\Google_Service_TagManager_ListFoldersResponse");
    }
    /**
    ...
    public function update($accountId, $containerId, $folderId, Google_Service_TagManager_Folder $postBody, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('update', array($params), "VendorDuplicator\\Google_Service_TagManager_Folder");
    }
}
/**
 * The "folders" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_TagManager_AccountsContainersFolders_Resource', 'VendorDuplicator\\Google_Service_TagManager_AccountsContainersFolders_Resource', \false);
/**
...
class Google_Service_TagManager_AccountsContainersFoldersEntities_Resource extends Google_Service_Resource
{
    ...
    public function listAccountsContainersFoldersEntities($accountId, $containerId, $folderId, $optParams = array())
    {
        $params = array('accountId' => $accountId, 'containerId' => $containerId, 'folderId' => $folderId);
        $params = \array_merge($params, $optParams);
        return $this->call('list', array($params), "VendorDuplicator\\Google_Service_TagManager_FolderEntities");
    }
}
/**
 * The "entities" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_TagManager_AccountsContainersFoldersEntities_Resource', 'VendorDuplicator\\Google_Service_TagManager_AccountsContainersFoldersEntities_Resource', \false);
/**
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_TagManager_AccountsContainersMoveFolders_Resource', 'VendorDuplicator\\Google_Service_TagManager_AccountsContainersMoveFolders_Resource', \false);
/**
...
class Google_Service_TagManager_AccountsContainersTags_Resource extends Google_Service_Resource
{
    ...
    public function create($accountId, $containerId, Google_Service_TagManager_Tag $postBody, $optParams = array())
    {
        $params = array('accountId' => $accountId, 'containerId' => $containerId, 'postBody' => $postBody);
        $params = \array_merge($params, $optParams);
        return $this->call('create', array($params), "VendorDuplicator\\Google_Service_TagManager_Tag");
    }
    /**
    ...
    public function get($accountId, $containerId, $tagId, $optParams = array())
    {
        $params = array('accountId' => $accountId, 'containerId' => $containerId, 'tagId' => $tagId);
        $params = \array_merge($params, $optParams);
        return $this->call('get', array($params), "VendorDuplicator\\Google_Service_TagManager_Tag");
    }
    /**
    ...
    public function listAccountsContainersTags($accountId, $containerId, $optParams = array())
    {
        $params = array('accountId' => $accountId, 'containerId' => $containerId);
        $params = \array_merge($params, $optParams);
        return $this->call('list', array($params), "VendorDuplicator\\Google_Service_TagManager_ListTagsResponse");
    }
    /**
    ...
    public function update($accountId, $containerId, $tagId, Google_Service_TagManager_Tag $postBody, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('update', array($params), "VendorDuplicator\\Google_Service_TagManager_Tag");
    }
}
/**
 * The "tags" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_TagManager_AccountsContainersTags_Resource', 'VendorDuplicator\\Google_Service_TagManager_AccountsContainersTags_Resource', \false);
/**
...
class Google_Service_TagManager_AccountsContainersTriggers_Resource extends Google_Service_Resource
{
    ...
    public function create($accountId, $containerId, Google_Service_TagManager_Trigger $postBody, $optParams = array())
    {
        $params = array('accountId' => $accountId, 'containerId' => $containerId, 'postBody' => $postBody);
        $params = \array_merge($params, $optParams);
        return $this->call('create', array($params), "VendorDuplicator\\Google_Service_TagManager_Trigger");
    }
    /**
    ...
    public function get($accountId, $containerId, $triggerId, $optParams = array())
    {
        $params = array('accountId' => $accountId, 'containerId' => $containerId, 'triggerId' => $triggerId);
        $params = \array_merge($params, $optParams);
        return $this->call('get', array($params), "VendorDuplicator\\Google_Service_TagManager_Trigger");
    }
    /**
    ...
    public function listAccountsContainersTriggers($accountId, $containerId, $optParams = array())
    {
        $params = array('accountId' => $accountId, 'containerId' => $containerId);
        $params = \array_merge($params, $optParams);
        return $this->call('list', array($params), "VendorDuplicator\\Google_Service_TagManager_ListTriggersResponse");
    }
    /**
    ...
    public function update($accountId, $containerId, $triggerId, Google_Service_TagManager_Trigger $postBody, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('update', array($params), "VendorDuplicator\\Google_Service_TagManager_Trigger");
    }
}
/**
 * The "triggers" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_TagManager_AccountsContainersTriggers_Resource', 'VendorDuplicator\\Google_Service_TagManager_AccountsContainersTriggers_Resource', \false);
/**
...
class Google_Service_TagManager_AccountsContainersVariables_Resource extends Google_Service_Resource
{
    ...
    public function create($accountId, $containerId, Google_Service_TagManager_Variable $postBody, $optParams = array())
    {
        $params = array('accountId' => $accountId, 'containerId' => $containerId, 'postBody' => $postBody);
        $params = \array_merge($params, $optParams);
        return $this->call('create', array($params), "VendorDuplicator\\Google_Service_TagManager_Variable");
    }
    /**
    ...
    public function get($accountId, $containerId, $variableId, $optParams = array())
    {
        $params = array('accountId' => $accountId, 'containerId' => $containerId, 'variableId' => $variableId);
        $params = \array_merge($params, $optParams);
        return $this->call('get', array($params), "VendorDuplicator\\Google_Service_TagManager_Variable");
    }
    /**
    ...
    public function listAccountsContainersVariables($accountId, $containerId, $optParams = array())
    {
        $params = array('accountId' => $accountId, 'containerId' => $containerId);
        $params = \array_merge($params, $optParams);
        return $this->call('list', array($params), "VendorDuplicator\\Google_Service_TagManager_ListVariablesResponse");
    }
    /**
    ...
    public function update($accountId, $containerId, $variableId, Google_Service_TagManager_Variable $postBody, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('update', array($params), "VendorDuplicator\\Google_Service_TagManager_Variable");
    }
}
/**
 * The "variables" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_TagManager_AccountsContainersVariables_Resource', 'VendorDuplicator\\Google_Service_TagManager_AccountsContainersVariables_Resource', \false);
/**
...
class Google_Service_TagManager_AccountsContainersVersions_Resource extends Google_Service_Resource
{
    ...
    public function create($accountId, $containerId, Google_Service_TagManager_CreateContainerVersionRequestVersionOptions $postBody, $optParams = array())
    {
        $params = array('accountId' => $accountId, 'containerId' => $containerId, 'postBody' => $postBody);
        $params = \array_merge($params, $optParams);
        return $this->call('create', array($params), "VendorDuplicator\\Google_Service_TagManager_CreateContainerVersionResponse");
    }
    /**
    ...
    public function get($accountId, $containerId, $containerVersionId, $optParams = array())
    {
        $params = array('accountId' => $accountId, 'containerId' => $containerId, 'containerVersionId' => $containerVersionId);
        $params = \array_merge($params, $optParams);
        return $this->call('get', array($params), "VendorDuplicator\\Google_Service_TagManager_ContainerVersion");
    }
    /**
    ...
    public function listAccountsContainersVersions($accountId, $containerId, $optParams = array())
    {
        $params = array('accountId' => $accountId, 'containerId' => $containerId);
        $params = \array_merge($params, $optParams);
        return $this->call('list', array($params), "VendorDuplicator\\Google_Service_TagManager_ListContainerVersionsResponse");
    }
    /**
    ...
    public function publish($accountId, $containerId, $containerVersionId, $optParams = array())
    {
        $params = array('accountId' => $accountId, 'containerId' => $containerId, 'containerVersionId' => $containerVersionId);
        $params = \array_merge($params, $optParams);
        return $this->call('publish', array($params), "VendorDuplicator\\Google_Service_TagManager_PublishContainerVersionResponse");
    }
    /**
    ...
    public function restore($accountId, $containerId, $containerVersionId, $optParams = array())
    {
        $params = array('accountId' => $accountId, 'containerId' => $containerId, 'containerVersionId' => $containerVersionId);
        $params = \array_merge($params, $optParams);
        return $this->call('restore', array($params), "VendorDuplicator\\Google_Service_TagManager_ContainerVersion");
    }
    /**
    ...
    public function undelete($accountId, $containerId, $containerVersionId, $optParams = array())
    {
        $params = array('accountId' => $accountId, 'containerId' => $containerId, 'containerVersionId' => $containerVersionId);
        $params = \array_merge($params, $optParams);
        return $this->call('undelete', array($params), "VendorDuplicator\\Google_Service_TagManager_ContainerVersion");
    }
    /**
    ...
    public function update($accountId, $containerId, $containerVersionId, Google_Service_TagManager_ContainerVersion $postBody, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('update', array($params), "VendorDuplicator\\Google_Service_TagManager_ContainerVersion");
    }
}
/**
 * The "versions" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_TagManager_AccountsContainersVersions_Resource', 'VendorDuplicator\\Google_Service_TagManager_AccountsContainersVersions_Resource', \false);
/**
...
class Google_Service_TagManager_AccountsPermissions_Resource extends Google_Service_Resource
{
    ...
    public function create($accountId, Google_Service_TagManager_UserAccess $postBody, $optParams = array())
    {
        $params = array('accountId' => $accountId, 'postBody' => $postBody);
        $params = \array_merge($params, $optParams);
        return $this->call('create', array($params), "VendorDuplicator\\Google_Service_TagManager_UserAccess");
    }
    /**
    ...
    public function get($accountId, $permissionId, $optParams = array())
    {
        $params = array('accountId' => $accountId, 'permissionId' => $permissionId);
        $params = \array_merge($params, $optParams);
        return $this->call('get', array($params), "VendorDuplicator\\Google_Service_TagManager_UserAccess");
    }
    /**
    ...
    public function listAccountsPermissions($accountId, $optParams = array())
    {
        $params = array('accountId' => $accountId);
        $params = \array_merge($params, $optParams);
        return $this->call('list', array($params), "VendorDuplicator\\Google_Service_TagManager_ListAccountUsersResponse");
    }
    /**
    ...
    public function update($accountId, $permissionId, Google_Service_TagManager_UserAccess $postBody, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('update', array($params), "VendorDuplicator\\Google_Service_TagManager_UserAccess");
    }
}
/**
 * The "permissions" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_TagManager_AccountsPermissions_Resource', 'VendorDuplicator\\Google_Service_TagManager_AccountsPermissions_Resource', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_TagManager_Account', 'VendorDuplicator\\Google_Service_TagManager_Account', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_TagManager_AccountAccess', 'VendorDuplicator\\Google_Service_TagManager_AccountAccess', \false);
/** @internal */
class Google_Service_TagManager_Condition extends Google_Collection
{
    protected $collection_key = 'parameter';
    protected $internal_gapi_mappings = array();
    protected $parameterType = 'VendorDuplicator\\Google_Service_TagManager_Parameter';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_TagManager_Condition', 'VendorDuplicator\\Google_Service_TagManager_Condition', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_TagManager_Container', 'VendorDuplicator\\Google_Service_TagManager_Container', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_TagManager_ContainerAccess', 'VendorDuplicator\\Google_Service_TagManager_ContainerAccess', \false);
/** @internal */
class Google_Service_TagManager_ContainerVersion extends Google_Collection
{
    ...
    protected $internal_gapi_mappings = array();
    public $accountId;
    protected $containerType = 'VendorDuplicator\\Google_Service_TagManager_Container';
    protected $containerDataType = '';
    public $containerId;
    public $containerVersionId;
    public $deleted;
    public $fingerprint;
    protected $folderType = 'VendorDuplicator\\Google_Service_TagManager_Folder';
    protected $folderDataType = 'array';
    protected $macroType = 'VendorDuplicator\\Google_Service_TagManager_Macro';
    protected $macroDataType = 'array';
    public $name;
    public $notes;
    protected $ruleType = 'VendorDuplicator\\Google_Service_TagManager_Rule';
    protected $ruleDataType = 'array';
    protected $tagType = 'VendorDuplicator\\Google_Service_TagManager_Tag';
    protected $tagDataType = 'array';
    protected $triggerType = 'VendorDuplicator\\Google_Service_TagManager_Trigger';
    protected $triggerDataType = 'array';
    protected $variableType = 'VendorDuplicator\\Google_Service_TagManager_Variable';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_TagManager_ContainerVersion', 'VendorDuplicator\\Google_Service_TagManager_ContainerVersion', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_TagManager_ContainerVersionHeader', 'VendorDuplicator\\Google_Service_TagManager_ContainerVersionHeader', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_TagManager_CreateContainerVersionRequestVersionOptions', 'VendorDuplicator\\Google_Service_TagManager_CreateContainerVersionRequestVersionOptions', \false);
/** @internal */
class Google_Service_TagManager_CreateContainerVersionResponse extends Google_Model
{
    protected $internal_gapi_mappings = array();
    public $compilerError;
    protected $containerVersionType = 'VendorDuplicator\\Google_Service_TagManager_ContainerVersion';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_TagManager_CreateContainerVersionResponse', 'VendorDuplicator\\Google_Service_TagManager_CreateContainerVersionResponse', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_TagManager_Folder', 'VendorDuplicator\\Google_Service_TagManager_Folder', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_TagManager_FolderEntities', 'VendorDuplicator\\Google_Service_TagManager_FolderEntities', \false);
/** @internal */
class Google_Service_TagManager_ListAccountUsersResponse extends Google_Collection
{
    protected $collection_key = 'userAccess';
    protected $internal_gapi_mappings = array();
    protected $userAccessType = 'VendorDuplicator\\Google_Service_TagManager_UserAccess';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_TagManager_ListAccountUsersResponse', 'VendorDuplicator\\Google_Service_TagManager_ListAccountUsersResponse', \false);
/** @internal */
class Google_Service_TagManager_ListAccountsResponse extends Google_Collection
{
    protected $collection_key = 'accounts';
    protected $internal_gapi_mappings = array();
    protected $accountsType = 'VendorDuplicator\\Google_Service_TagManager_Account';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_TagManager_ListAccountsResponse', 'VendorDuplicator\\Google_Service_TagManager_ListAccountsResponse', \false);
/** @internal */
class Google_Service_TagManager_ListContainerVersionsResponse extends Google_Collection
{
    ...
    protected $containerVersionHeaderType = 'VendorDuplicator\\Google_Service_TagManager_ContainerVersionHeader';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_TagManager_ListContainerVersionsResponse', 'VendorDuplicator\\Google_Service_TagManager_ListContainerVersionsResponse', \false);
/** @internal */
class Google_Service_TagManager_ListContainersResponse extends Google_Collection
{
    protected $collection_key = 'containers';
    protected $internal_gapi_mappings = array();
    protected $containersType = 'VendorDuplicator\\Google_Service_TagManager_Container';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_TagManager_ListContainersResponse', 'VendorDuplicator\\Google_Service_TagManager_ListContainersResponse', \false);
/** @internal */
class Google_Service_TagManager_ListFoldersResponse extends Google_Collection
{
    protected $collection_key = 'folders';
    protected $internal_gapi_mappings = array();
    protected $foldersType = 'VendorDuplicator\\Google_Service_TagManager_Folder';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_TagManager_ListFoldersResponse', 'VendorDuplicator\\Google_Service_TagManager_ListFoldersResponse', \false);
/** @internal */
class Google_Service_TagManager_ListTagsResponse extends Google_Collection
{
    protected $collection_key = 'tags';
    protected $internal_gapi_mappings = array();
    protected $tagsType = 'VendorDuplicator\\Google_Service_TagManager_Tag';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_TagManager_ListTagsResponse', 'VendorDuplicator\\Google_Service_TagManager_ListTagsResponse', \false);
/** @internal */
class Google_Service_TagManager_ListTriggersResponse extends Google_Collection
{
    protected $collection_key = 'triggers';
    protected $internal_gapi_mappings = array();
    protected $triggersType = 'VendorDuplicator\\Google_Service_TagManager_Trigger';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_TagManager_ListTriggersResponse', 'VendorDuplicator\\Google_Service_TagManager_ListTriggersResponse', \false);
/** @internal */
class Google_Service_TagManager_ListVariablesResponse extends Google_Collection
{
    protected $collection_key = 'variables';
    protected $internal_gapi_mappings = array();
    protected $variablesType = 'VendorDuplicator\\Google_Service_TagManager_Variable';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_TagManager_ListVariablesResponse', 'VendorDuplicator\\Google_Service_TagManager_ListVariablesResponse', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_TagManager_Macro', 'VendorDuplicator\\Google_Service_TagManager_Macro', \false);
/** @internal */
class Google_Service_TagManager_Parameter extends Google_Collection
{
    ...
    protected $internal_gapi_mappings = array();
    public $key;
    protected $listType = 'VendorDuplicator\\Google_Service_TagManager_Parameter';
    protected $listDataType = 'array';
    protected $mapType = 'VendorDuplicator\\Google_Service_TagManager_Parameter';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_TagManager_Parameter', 'VendorDuplicator\\Google_Service_TagManager_Parameter', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_TagManager_PublishContainerVersionResponse', 'VendorDuplicator\\Google_Service_TagManager_PublishContainerVersionResponse', \false);
/** @internal */
class Google_Service_TagManager_Rule extends Google_Collection
{
    ...
    protected $internal_gapi_mappings = array();
    public $accountId;
    protected $conditionType = 'VendorDuplicator\\Google_Service_TagManager_Condition';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_TagManager_Rule', 'VendorDuplicator\\Google_Service_TagManager_Rule', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_TagManager_SetupTag', 'VendorDuplicator\\Google_Service_TagManager_SetupTag', \false);
/** @internal */
class Google_Service_TagManager_Tag extends Google_Collection
{
    ...
    protected $parameterDataType = 'array';
    public $parentFolderId;
    protected $priorityType = 'VendorDuplicator\\Google_Service_TagManager_Parameter';
    protected $priorityDataType = '';
    public $scheduleEndMs;
    public $scheduleStartMs;
    protected $setupTagType = 'VendorDuplicator\\Google_Service_TagManager_SetupTag';
    protected $setupTagDataType = 'array';
    public $tagFiringOption;
    public $tagId;
    protected $teardownTagType = 'VendorDuplicator\\Google_Service_TagManager_TeardownTag';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_TagManager_Tag', 'VendorDuplicator\\Google_Service_TagManager_Tag', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_TagManager_TeardownTag', 'VendorDuplicator\\Google_Service_TagManager_TeardownTag', \false);
/** @internal */
class Google_Service_TagManager_Trigger extends Google_Collection
{
    ...
    protected $internal_gapi_mappings = array();
    public $accountId;
    protected $autoEventFilterType = 'VendorDuplicator\\Google_Service_TagManager_Condition';
    protected $autoEventFilterDataType = 'array';
    protected $checkValidationType = 'VendorDuplicator\\Google_Service_TagManager_Parameter';
    protected $checkValidationDataType = '';
    public $containerId;
    protected $customEventFilterType = 'VendorDuplicator\\Google_Service_TagManager_Condition';
    protected $customEventFilterDataType = 'array';
    protected $enableAllVideosType = 'VendorDuplicator\\Google_Service_TagManager_Parameter';
    protected $enableAllVideosDataType = '';
    protected $eventNameType = 'VendorDuplicator\\Google_Service_TagManager_Parameter';
    protected $eventNameDataType = '';
    protected $filterType = 'VendorDuplicator\\Google_Service_TagManager_Condition';
    protected $filterDataType = 'array';
    public $fingerprint;
    protected $intervalType = 'VendorDuplicator\\Google_Service_TagManager_Parameter';
    protected $intervalDataType = '';
    protected $limitType = 'VendorDuplicator\\Google_Service_TagManager_Parameter';
    protected $limitDataType = '';
    public $name;
    public $parentFolderId;
    public $triggerId;
    public $type;
    protected $uniqueTriggerIdType = 'VendorDuplicator\\Google_Service_TagManager_Parameter';
    protected $uniqueTriggerIdDataType = '';
    protected $videoPercentageListType = 'VendorDuplicator\\Google_Service_TagManager_Parameter';
    protected $videoPercentageListDataType = '';
    protected $waitForTagsType = 'VendorDuplicator\\Google_Service_TagManager_Parameter';
    protected $waitForTagsDataType = '';
    protected $waitForTagsTimeoutType = 'VendorDuplicator\\Google_Service_TagManager_Parameter';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_TagManager_Trigger', 'VendorDuplicator\\Google_Service_TagManager_Trigger', \false);
/** @internal */
class Google_Service_TagManager_UserAccess extends Google_Collection
{
    protected $collection_key = 'containerAccess';
    protected $internal_gapi_mappings = array();
    protected $accountAccessType = 'VendorDuplicator\\Google_Service_TagManager_AccountAccess';
    protected $accountAccessDataType = '';
    public $accountId;
    protected $containerAccessType = 'VendorDuplicator\\Google_Service_TagManager_ContainerAccess';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_TagManager_UserAccess', 'VendorDuplicator\\Google_Service_TagManager_UserAccess', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_TagManager_Variable', 'VendorDuplicator\\Google_Service_TagManager_Variable', \false);
