...
class Google_Service_Logging extends Google_Service
{
    ...
    public function __construct(Google_Client $client)
    {
        ...
        $this->entries = new Google_Service_Logging_Entries_Resource($this, $this->serviceName, 'entries', array('methods' => array('list' => array('path' => 'v2beta1/entries:list', 'httpMethod' => 'POST', 'parameters' => array()), 'write' => array('path' => 'v2beta1/entries:write', 'httpMethod' => 'POST', 'parameters' => array()))));
        $this->monitoredResourceDescriptors = new Google_Service_Logging_MonitoredResourceDescriptors_Resource($this, $this->serviceName, 'monitoredResourceDescriptors', array('methods' => array('list' => array('path' => 'v2beta1/monitoredResourceDescriptors', 'httpMethod' => 'GET', 'parameters' => array('pageSize' => array('location' => 'query', 'type' => 'integer'), 'pageToken' => array('location' => 'query', 'type' => 'string'))))));
        $this->projects_logs = new Google_Service_Logging_ProjectsLogs_Resource($this, $this->serviceName, 'logs', array('methods' => array('delete' => array('path' => 'v2beta1/{+logName}', 'httpMethod' => 'DELETE', 'parameters' => array('logName' => array('location' => 'path', 'type' => 'string', 'required' => \true))))));
        $this->projects_metrics = new Google_Service_Logging_ProjectsMetrics_Resource($this, $this->serviceName, 'metrics', array('methods' => array('create' => array('path' => 'v2beta1/{+projectName}/metrics', 'httpMethod' => 'POST', 'parameters' => array('projectName' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'delete' => array('path' => 'v2beta1/{+metricName}', 'httpMethod' => 'DELETE', 'parameters' => array('metricName' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'get' => array('path' => 'v2beta1/{+metricName}', 'httpMethod' => 'GET', 'parameters' => array('metricName' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'list' => array('path' => 'v2beta1/{+projectName}/metrics', 'httpMethod' => 'GET', 'parameters' => array('projectName' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'pageToken' => array('location' => 'query', 'type' => 'string'), 'pageSize' => array('location' => 'query', 'type' => 'integer'))), 'update' => array('path' => 'v2beta1/{+metricName}', 'httpMethod' => 'PUT', 'parameters' => array('metricName' => array('location' => 'path', 'type' => 'string', 'required' => \true))))));
        $this->projects_sinks = new Google_Service_Logging_ProjectsSinks_Resource($this, $this->serviceName, 'sinks', array('methods' => array('create' => array('path' => 'v2beta1/{+projectName}/sinks', 'httpMethod' => 'POST', 'parameters' => array('projectName' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'delete' => array('path' => 'v2beta1/{+sinkName}', 'httpMethod' => 'DELETE', 'parameters' => array('sinkName' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'get' => array('path' => 'v2beta1/{+sinkName}', 'httpMethod' => 'GET', 'parameters' => array('sinkName' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'list' => array('path' => 'v2beta1/{+projectName}/sinks', 'httpMethod' => 'GET', 'parameters' => array('projectName' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'pageToken' => array('location' => 'query', 'type' => 'string'), 'pageSize' => array('location' => 'query', 'type' => 'integer'))), 'update' => array('path' => 'v2beta1/{+sinkName}', 'httpMethod' => 'PUT', 'parameters' => array('sinkName' => array('location' => 'path', 'type' => 'string', 'required' => \true))))));
    }
}
/*
 * Licensed under the Apache License, Version 2.0 (the "License"); you may not
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Logging', 'VendorDuplicator\\Google_Service_Logging', \false);
/**
...
class Google_Service_Logging_Entries_Resource extends Google_Service_Resource
{
    ...
    public function listEntries(Google_Service_Logging_ListLogEntriesRequest $postBody, $optParams = array())
    {
        ...
        return $this->call('list', array($params), "VendorDuplicator\\Google_Service_Logging_ListLogEntriesResponse");
    }
    /**
    ...
    public function write(Google_Service_Logging_WriteLogEntriesRequest $postBody, $optParams = array())
    {
        $params = array('postBody' => $postBody);
        $params = \array_merge($params, $optParams);
        return $this->call('write', array($params), "VendorDuplicator\\Google_Service_Logging_WriteLogEntriesResponse");
    }
}
/**
 * The "entries" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Logging_Entries_Resource', 'VendorDuplicator\\Google_Service_Logging_Entries_Resource', \false);
/**
...
class Google_Service_Logging_MonitoredResourceDescriptors_Resource extends Google_Service_Resource
{
    ...
    public function listMonitoredResourceDescriptors($optParams = array())
    {
        $params = array();
        $params = \array_merge($params, $optParams);
        return $this->call('list', array($params), "VendorDuplicator\\Google_Service_Logging_ListMonitoredResourceDescriptorsResponse");
    }
}
/**
 * The "monitoredResourceDescriptors" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Logging_MonitoredResourceDescriptors_Resource', 'VendorDuplicator\\Google_Service_Logging_MonitoredResourceDescriptors_Resource', \false);
/**
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Logging_Projects_Resource', 'VendorDuplicator\\Google_Service_Logging_Projects_Resource', \false);
/**
...
class Google_Service_Logging_ProjectsLogs_Resource extends Google_Service_Resource
{
    ...
    public function delete($logName, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('delete', array($params), "VendorDuplicator\\Google_Service_Logging_Empty");
    }
}
/**
 * The "logs" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Logging_ProjectsLogs_Resource', 'VendorDuplicator\\Google_Service_Logging_ProjectsLogs_Resource', \false);
/**
...
class Google_Service_Logging_ProjectsMetrics_Resource extends Google_Service_Resource
{
    ...
    public function create($projectName, Google_Service_Logging_LogMetric $postBody, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('create', array($params), "VendorDuplicator\\Google_Service_Logging_LogMetric");
    }
    /**
    ...
    public function get($metricName, $optParams = array())
    {
        $params = array('metricName' => $metricName);
        $params = \array_merge($params, $optParams);
        return $this->call('get', array($params), "VendorDuplicator\\Google_Service_Logging_LogMetric");
    }
    /**
    ...
    public function listProjectsMetrics($projectName, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('list', array($params), "VendorDuplicator\\Google_Service_Logging_ListLogMetricsResponse");
    }
    /**
    ...
    public function update($metricName, Google_Service_Logging_LogMetric $postBody, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('update', array($params), "VendorDuplicator\\Google_Service_Logging_LogMetric");
    }
}
/**
 * The "metrics" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Logging_ProjectsMetrics_Resource', 'VendorDuplicator\\Google_Service_Logging_ProjectsMetrics_Resource', \false);
/**
...
class Google_Service_Logging_ProjectsSinks_Resource extends Google_Service_Resource
{
    ...
    public function create($projectName, Google_Service_Logging_LogSink $postBody, $optParams = array())
    {
        $params = array('projectName' => $projectName, 'postBody' => $postBody);
        $params = \array_merge($params, $optParams);
        return $this->call('create', array($params), "VendorDuplicator\\Google_Service_Logging_LogSink");
    }
    /**
    ...
    public function get($sinkName, $optParams = array())
    {
        $params = array('sinkName' => $sinkName);
        $params = \array_merge($params, $optParams);
        return $this->call('get', array($params), "VendorDuplicator\\Google_Service_Logging_LogSink");
    }
    /**
    ...
    public function listProjectsSinks($projectName, $optParams = array())
    {
        $params = array('projectName' => $projectName);
        $params = \array_merge($params, $optParams);
        return $this->call('list', array($params), "VendorDuplicator\\Google_Service_Logging_ListSinksResponse");
    }
    /**
    ...
    public function update($sinkName, Google_Service_Logging_LogSink $postBody, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('update', array($params), "VendorDuplicator\\Google_Service_Logging_LogSink");
    }
}
/**
 * The "sinks" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Logging_ProjectsSinks_Resource', 'VendorDuplicator\\Google_Service_Logging_ProjectsSinks_Resource', \false);
/** @internal */
class Google_Service_Logging_Empty extends Google_Model
{
}
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Logging_Empty', 'VendorDuplicator\\Google_Service_Logging_Empty', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Logging_HttpRequest', 'VendorDuplicator\\Google_Service_Logging_HttpRequest', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Logging_LabelDescriptor', 'VendorDuplicator\\Google_Service_Logging_LabelDescriptor', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Logging_ListLogEntriesRequest', 'VendorDuplicator\\Google_Service_Logging_ListLogEntriesRequest', \false);
/** @internal */
class Google_Service_Logging_ListLogEntriesResponse extends Google_Collection
{
    protected $collection_key = 'entries';
    protected $internal_gapi_mappings = array();
    protected $entriesType = 'VendorDuplicator\\Google_Service_Logging_LogEntry';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Logging_ListLogEntriesResponse', 'VendorDuplicator\\Google_Service_Logging_ListLogEntriesResponse', \false);
/** @internal */
class Google_Service_Logging_ListLogMetricsResponse extends Google_Collection
{
    protected $collection_key = 'metrics';
    protected $internal_gapi_mappings = array();
    protected $metricsType = 'VendorDuplicator\\Google_Service_Logging_LogMetric';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Logging_ListLogMetricsResponse', 'VendorDuplicator\\Google_Service_Logging_ListLogMetricsResponse', \false);
/** @internal */
class Google_Service_Logging_ListMonitoredResourceDescriptorsResponse extends Google_Collection
{
    ...
    protected $internal_gapi_mappings = array();
    public $nextPageToken;
    protected $resourceDescriptorsType = 'VendorDuplicator\\Google_Service_Logging_MonitoredResourceDescriptor';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Logging_ListMonitoredResourceDescriptorsResponse', 'VendorDuplicator\\Google_Service_Logging_ListMonitoredResourceDescriptorsResponse', \false);
/** @internal */
class Google_Service_Logging_ListSinksResponse extends Google_Collection
{
    ...
    protected $internal_gapi_mappings = array();
    public $nextPageToken;
    protected $sinksType = 'VendorDuplicator\\Google_Service_Logging_LogSink';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Logging_ListSinksResponse', 'VendorDuplicator\\Google_Service_Logging_ListSinksResponse', \false);
/** @internal */
class Google_Service_Logging_LogEntry extends Google_Model
{
    protected $internal_gapi_mappings = array();
    protected $httpRequestType = 'VendorDuplicator\\Google_Service_Logging_HttpRequest';
    protected $httpRequestDataType = '';
    public $insertId;
    public $jsonPayload;
    public $labels;
    public $logName;
    protected $operationType = 'VendorDuplicator\\Google_Service_Logging_LogEntryOperation';
    protected $operationDataType = '';
    public $protoPayload;
    protected $resourceType = 'VendorDuplicator\\Google_Service_Logging_MonitoredResource';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Logging_LogEntry', 'VendorDuplicator\\Google_Service_Logging_LogEntry', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Logging_LogEntryOperation', 'VendorDuplicator\\Google_Service_Logging_LogEntryOperation', \false);
/** @internal */
class Google_Service_Logging_LogLine extends Google_Model
{
    ...
    public $logMessage;
    public $severity;
    protected $sourceLocationType = 'VendorDuplicator\\Google_Service_Logging_SourceLocation';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Logging_LogLine', 'VendorDuplicator\\Google_Service_Logging_LogLine', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Logging_LogMetric', 'VendorDuplicator\\Google_Service_Logging_LogMetric', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Logging_LogSink', 'VendorDuplicator\\Google_Service_Logging_LogSink', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Logging_MonitoredResource', 'VendorDuplicator\\Google_Service_Logging_MonitoredResource', \false);
/** @internal */
class Google_Service_Logging_MonitoredResourceDescriptor extends Google_Collection
{
    ...
    public $description;
    public $displayName;
    protected $labelsType = 'VendorDuplicator\\Google_Service_Logging_LabelDescriptor';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Logging_MonitoredResourceDescriptor', 'VendorDuplicator\\Google_Service_Logging_MonitoredResourceDescriptor', \false);
/** @internal */
class Google_Service_Logging_RequestLog extends Google_Collection
{
    ...
    public $ip;
    public $latency;
    protected $lineType = 'VendorDuplicator\\Google_Service_Logging_LogLine';
    ...
    public $resource;
    public $responseSize;
    protected $sourceReferenceType = 'VendorDuplicator\\Google_Service_Logging_SourceReference';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Logging_RequestLog', 'VendorDuplicator\\Google_Service_Logging_RequestLog', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Logging_SourceLocation', 'VendorDuplicator\\Google_Service_Logging_SourceLocation', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Logging_SourceReference', 'VendorDuplicator\\Google_Service_Logging_SourceReference', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Logging_WriteLogEntriesRequest', 'VendorDuplicator\\Google_Service_Logging_WriteLogEntriesRequest', \false);
/** @internal */
class Google_Service_Logging_WriteLogEntriesResponse extends Google_Model
{
}
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Logging_WriteLogEntriesResponse', 'VendorDuplicator\\Google_Service_Logging_WriteLogEntriesResponse', \false);
