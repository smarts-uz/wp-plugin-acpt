...
class Google_Service_Cloudlatencytest extends Google_Service
{
    ...
    public function __construct(Google_Client $client)
    {
        ...
        $this->statscollection = new Google_Service_Cloudlatencytest_Statscollection_Resource($this, $this->serviceName, 'statscollection', array('methods' => array('updateaggregatedstats' => array('path' => 'updateaggregatedstats', 'httpMethod' => 'POST', 'parameters' => array()), 'updatestats' => array('path' => 'updatestats', 'httpMethod' => 'POST', 'parameters' => array()))));
    }
}
/*
 * Licensed under the Apache License, Version 2.0 (the "License"); you may not
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Cloudlatencytest', 'VendorDuplicator\\Google_Service_Cloudlatencytest', \false);
/**
...
class Google_Service_Cloudlatencytest_Statscollection_Resource extends Google_Service_Resource
{
    ...
    public function updateaggregatedstats(Google_Service_Cloudlatencytest_AggregatedStats $postBody, $optParams = array())
    {
        ...
        return $this->call('updateaggregatedstats', array($params), "VendorDuplicator\\Google_Service_Cloudlatencytest_AggregatedStatsReply");
    }
    /**
    ...
    public function updatestats(Google_Service_Cloudlatencytest_Stats $postBody, $optParams = array())
    {
        $params = array('postBody' => $postBody);
        $params = \array_merge($params, $optParams);
        return $this->call('updatestats', array($params), "VendorDuplicator\\Google_Service_Cloudlatencytest_StatsReply");
    }
}
/**
 * The "statscollection" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Cloudlatencytest_Statscollection_Resource', 'VendorDuplicator\\Google_Service_Cloudlatencytest_Statscollection_Resource', \false);
/** @internal */
class Google_Service_Cloudlatencytest_AggregatedStats extends Google_Collection
{
    protected $collection_key = 'stats';
    protected $internal_gapi_mappings = array();
    protected $statsType = 'VendorDuplicator\\Google_Service_Cloudlatencytest_Stats';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Cloudlatencytest_AggregatedStats', 'VendorDuplicator\\Google_Service_Cloudlatencytest_AggregatedStats', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Cloudlatencytest_AggregatedStatsReply', 'VendorDuplicator\\Google_Service_Cloudlatencytest_AggregatedStatsReply', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Cloudlatencytest_DoubleValue', 'VendorDuplicator\\Google_Service_Cloudlatencytest_DoubleValue', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Cloudlatencytest_IntValue', 'VendorDuplicator\\Google_Service_Cloudlatencytest_IntValue', \false);
/** @internal */
class Google_Service_Cloudlatencytest_Stats extends Google_Collection
{
    protected $collection_key = 'stringValues';
    protected $internal_gapi_mappings = array();
    protected $doubleValuesType = 'VendorDuplicator\\Google_Service_Cloudlatencytest_DoubleValue';
    protected $doubleValuesDataType = 'array';
    protected $intValuesType = 'VendorDuplicator\\Google_Service_Cloudlatencytest_IntValue';
    protected $intValuesDataType = 'array';
    protected $stringValuesType = 'VendorDuplicator\\Google_Service_Cloudlatencytest_StringValue';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Cloudlatencytest_Stats', 'VendorDuplicator\\Google_Service_Cloudlatencytest_Stats', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Cloudlatencytest_StatsReply', 'VendorDuplicator\\Google_Service_Cloudlatencytest_StatsReply', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Cloudlatencytest_StringValue', 'VendorDuplicator\\Google_Service_Cloudlatencytest_StringValue', \false);
