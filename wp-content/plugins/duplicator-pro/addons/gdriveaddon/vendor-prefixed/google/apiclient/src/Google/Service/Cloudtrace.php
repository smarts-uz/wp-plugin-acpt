...
class Google_Service_Cloudtrace extends Google_Service
{
    ...
    public function __construct(Google_Client $client)
    {
        ...
        $this->projects = new Google_Service_Cloudtrace_Projects_Resource($this, $this->serviceName, 'projects', array('methods' => array('patchTraces' => array('path' => 'v1/projects/{projectId}/traces', 'httpMethod' => 'PATCH', 'parameters' => array('projectId' => array('location' => 'path', 'type' => 'string', 'required' => \true))))));
        $this->projects_traces = new Google_Service_Cloudtrace_ProjectsTraces_Resource($this, $this->serviceName, 'traces', array('methods' => array('get' => array('path' => 'v1/projects/{projectId}/traces/{traceId}', 'httpMethod' => 'GET', 'parameters' => array('projectId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'traceId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'list' => array('path' => 'v1/projects/{projectId}/traces', 'httpMethod' => 'GET', 'parameters' => array('projectId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'view' => array('location' => 'query', 'type' => 'string'), 'pageSize' => array('location' => 'query', 'type' => 'integer'), 'pageToken' => array('location' => 'query', 'type' => 'string'), 'startTime' => array('location' => 'query', 'type' => 'string'), 'endTime' => array('location' => 'query', 'type' => 'string'), 'filter' => array('location' => 'query', 'type' => 'string'), 'orderBy' => array('location' => 'query', 'type' => 'string'))))));
    }
}
/*
 * Licensed under the Apache License, Version 2.0 (the "License"); you may not
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Cloudtrace', 'VendorDuplicator\\Google_Service_Cloudtrace', \false);
/**
...
class Google_Service_Cloudtrace_Projects_Resource extends Google_Service_Resource
{
    ...
    public function patchTraces($projectId, Google_Service_Cloudtrace_Traces $postBody, $optParams = array())
    {
        ...
        return $this->call('patchTraces', array($params), "VendorDuplicator\\Google_Service_Cloudtrace_Empty");
    }
}
/**
 * The "projects" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Cloudtrace_Projects_Resource', 'VendorDuplicator\\Google_Service_Cloudtrace_Projects_Resource', \false);
/**
...
class Google_Service_Cloudtrace_ProjectsTraces_Resource extends Google_Service_Resource
{
    ...
    public function get($projectId, $traceId, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('get', array($params), "VendorDuplicator\\Google_Service_Cloudtrace_Trace");
    }
    /**
    ...
    public function listProjectsTraces($projectId, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('list', array($params), "VendorDuplicator\\Google_Service_Cloudtrace_ListTracesResponse");
    }
}
/**
 * The "traces" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Cloudtrace_ProjectsTraces_Resource', 'VendorDuplicator\\Google_Service_Cloudtrace_ProjectsTraces_Resource', \false);
/** @internal */
class Google_Service_Cloudtrace_Empty extends Google_Model
{
}
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Cloudtrace_Empty', 'VendorDuplicator\\Google_Service_Cloudtrace_Empty', \false);
/** @internal */
class Google_Service_Cloudtrace_ListTracesResponse extends Google_Collection
{
    ...
    protected $tracesType = 'VendorDuplicator\\Google_Service_Cloudtrace_Trace';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Cloudtrace_ListTracesResponse', 'VendorDuplicator\\Google_Service_Cloudtrace_ListTracesResponse', \false);
/** @internal */
class Google_Service_Cloudtrace_Trace extends Google_Collection
{
    ...
    protected $internal_gapi_mappings = array();
    public $projectId;
    protected $spansType = 'VendorDuplicator\\Google_Service_Cloudtrace_TraceSpan';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Cloudtrace_Trace', 'VendorDuplicator\\Google_Service_Cloudtrace_Trace', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Cloudtrace_TraceSpan', 'VendorDuplicator\\Google_Service_Cloudtrace_TraceSpan', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Cloudtrace_Traces', 'VendorDuplicator\\Google_Service_Cloudtrace_Traces', \false);
