...
class Google_Service_Appsactivity extends Google_Service
{
    ...
    public function __construct(Google_Client $client)
    {
        ...
        $this->activities = new Google_Service_Appsactivity_Activities_Resource($this, $this->serviceName, 'activities', array('methods' => array('list' => array('path' => 'activities', 'httpMethod' => 'GET', 'parameters' => array('drive.ancestorId' => array('location' => 'query', 'type' => 'string'), 'drive.fileId' => array('location' => 'query', 'type' => 'string'), 'groupingStrategy' => array('location' => 'query', 'type' => 'string'), 'pageSize' => array('location' => 'query', 'type' => 'integer'), 'pageToken' => array('location' => 'query', 'type' => 'string'), 'source' => array('location' => 'query', 'type' => 'string'), 'userId' => array('location' => 'query', 'type' => 'string'))))));
    }
}
/*
 * Licensed under the Apache License, Version 2.0 (the "License"); you may not
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Appsactivity', 'VendorDuplicator\\Google_Service_Appsactivity', \false);
/**
...
class Google_Service_Appsactivity_Activities_Resource extends Google_Service_Resource
{
    ...
    public function listActivities($optParams = array())
    {
        ...
        return $this->call('list', array($params), "VendorDuplicator\\Google_Service_Appsactivity_ListActivitiesResponse");
    }
}
/**
 * The "activities" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Appsactivity_Activities_Resource', 'VendorDuplicator\\Google_Service_Appsactivity_Activities_Resource', \false);
/** @internal */
class Google_Service_Appsactivity_Activity extends Google_Collection
{
    protected $collection_key = 'singleEvents';
    protected $internal_gapi_mappings = array();
    protected $combinedEventType = 'VendorDuplicator\\Google_Service_Appsactivity_Event';
    protected $combinedEventDataType = '';
    protected $singleEventsType = 'VendorDuplicator\\Google_Service_Appsactivity_Event';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Appsactivity_Activity', 'VendorDuplicator\\Google_Service_Appsactivity_Activity', \false);
/** @internal */
class Google_Service_Appsactivity_Event extends Google_Collection
{
    ...
    protected $moveType = 'VendorDuplicator\\Google_Service_Appsactivity_Move';
    protected $moveDataType = '';
    protected $permissionChangesType = 'VendorDuplicator\\Google_Service_Appsactivity_PermissionChange';
    protected $permissionChangesDataType = 'array';
    public $primaryEventType;
    protected $renameType = 'VendorDuplicator\\Google_Service_Appsactivity_Rename';
    protected $renameDataType = '';
    protected $targetType = 'VendorDuplicator\\Google_Service_Appsactivity_Target';
    protected $targetDataType = '';
    protected $userType = 'VendorDuplicator\\Google_Service_Appsactivity_User';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Appsactivity_Event', 'VendorDuplicator\\Google_Service_Appsactivity_Event', \false);
/** @internal */
class Google_Service_Appsactivity_ListActivitiesResponse extends Google_Collection
{
    protected $collection_key = 'activities';
    protected $internal_gapi_mappings = array();
    protected $activitiesType = 'VendorDuplicator\\Google_Service_Appsactivity_Activity';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Appsactivity_ListActivitiesResponse', 'VendorDuplicator\\Google_Service_Appsactivity_ListActivitiesResponse', \false);
/** @internal */
class Google_Service_Appsactivity_Move extends Google_Collection
{
    protected $collection_key = 'removedParents';
    protected $internal_gapi_mappings = array();
    protected $addedParentsType = 'VendorDuplicator\\Google_Service_Appsactivity_Parent';
    protected $addedParentsDataType = 'array';
    protected $removedParentsType = 'VendorDuplicator\\Google_Service_Appsactivity_Parent';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Appsactivity_Move', 'VendorDuplicator\\Google_Service_Appsactivity_Move', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Appsactivity_Parent', 'VendorDuplicator\\Google_Service_Appsactivity_Parent', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Appsactivity_Permission', 'VendorDuplicator\\Google_Service_Appsactivity_Permission', \false);
/** @internal */
class Google_Service_Appsactivity_PermissionChange extends Google_Collection
{
    protected $collection_key = 'removedPermissions';
    protected $internal_gapi_mappings = array();
    protected $addedPermissionsType = 'VendorDuplicator\\Google_Service_Appsactivity_Permission';
    protected $addedPermissionsDataType = 'array';
    protected $removedPermissionsType = 'VendorDuplicator\\Google_Service_Appsactivity_Permission';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Appsactivity_PermissionChange', 'VendorDuplicator\\Google_Service_Appsactivity_PermissionChange', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Appsactivity_Photo', 'VendorDuplicator\\Google_Service_Appsactivity_Photo', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Appsactivity_Rename', 'VendorDuplicator\\Google_Service_Appsactivity_Rename', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Appsactivity_Target', 'VendorDuplicator\\Google_Service_Appsactivity_Target', \false);
/** @internal */
class Google_Service_Appsactivity_User extends Google_Model
{
    protected $internal_gapi_mappings = array();
    public $name;
    protected $photoType = 'VendorDuplicator\\Google_Service_Appsactivity_Photo';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Appsactivity_User', 'VendorDuplicator\\Google_Service_Appsactivity_User', \false);
