...
class Google_Service_AdSenseHost extends Google_Service
{
    ...
    public function __construct(Google_Client $client)
    {
        ...
        $this->accounts = new Google_Service_AdSenseHost_Accounts_Resource($this, $this->serviceName, 'accounts', array('methods' => array('get' => array('path' => 'accounts/{accountId}', 'httpMethod' => 'GET', 'parameters' => array('accountId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'list' => array('path' => 'accounts', 'httpMethod' => 'GET', 'parameters' => array('filterAdClientId' => array('location' => 'query', 'type' => 'string', 'repeated' => \true, 'required' => \true))))));
        $this->accounts_adclients = new Google_Service_AdSenseHost_AccountsAdclients_Resource($this, $this->serviceName, 'adclients', array('methods' => array('get' => array('path' => 'accounts/{accountId}/adclients/{adClientId}', 'httpMethod' => 'GET', 'parameters' => array('accountId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'adClientId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'list' => array('path' => 'accounts/{accountId}/adclients', 'httpMethod' => 'GET', 'parameters' => array('accountId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'maxResults' => array('location' => 'query', 'type' => 'integer'), 'pageToken' => array('location' => 'query', 'type' => 'string'))))));
        $this->accounts_adunits = new Google_Service_AdSenseHost_AccountsAdunits_Resource($this, $this->serviceName, 'adunits', array('methods' => array('delete' => array('path' => 'accounts/{accountId}/adclients/{adClientId}/adunits/{adUnitId}', 'httpMethod' => 'DELETE', 'parameters' => array('accountId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'adClientId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'adUnitId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'get' => array('path' => 'accounts/{accountId}/adclients/{adClientId}/adunits/{adUnitId}', 'httpMethod' => 'GET', 'parameters' => array('accountId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'adClientId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'adUnitId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'getAdCode' => array('path' => 'accounts/{accountId}/adclients/{adClientId}/adunits/{adUnitId}/adcode', 'httpMethod' => 'GET', 'parameters' => array('accountId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'adClientId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'adUnitId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'hostCustomChannelId' => array('location' => 'query', 'type' => 'string', 'repeated' => \true))), 'insert' => array('path' => 'accounts/{accountId}/adclients/{adClientId}/adunits', 'httpMethod' => 'POST', 'parameters' => array('accountId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'adClientId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'list' => array('path' => 'accounts/{accountId}/adclients/{adClientId}/adunits', 'httpMethod' => 'GET', 'parameters' => array('accountId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'adClientId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'includeInactive' => array('location' => 'query', 'type' => 'boolean'), 'maxResults' => array('location' => 'query', 'type' => 'integer'), 'pageToken' => array('location' => 'query', 'type' => 'string'))), 'patch' => array('path' => 'accounts/{accountId}/adclients/{adClientId}/adunits', 'httpMethod' => 'PATCH', 'parameters' => array('accountId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'adClientId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'adUnitId' => array('location' => 'query', 'type' => 'string', 'required' => \true))), 'update' => array('path' => 'accounts/{accountId}/adclients/{adClientId}/adunits', 'httpMethod' => 'PUT', 'parameters' => array('accountId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'adClientId' => array('location' => 'path', 'type' => 'string', 'required' => \true))))));
        $this->accounts_reports = new Google_Service_AdSenseHost_AccountsReports_Resource($this, $this->serviceName, 'reports', array('methods' => array('generate' => array('path' => 'accounts/{accountId}/reports', 'httpMethod' => 'GET', 'parameters' => array('accountId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'startDate' => array('location' => 'query', 'type' => 'string', 'required' => \true), 'endDate' => array('location' => 'query', 'type' => 'string', 'required' => \true), 'dimension' => array('location' => 'query', 'type' => 'string', 'repeated' => \true), 'filter' => array('location' => 'query', 'type' => 'string', 'repeated' => \true), 'locale' => array('location' => 'query', 'type' => 'string'), 'maxResults' => array('location' => 'query', 'type' => 'integer'), 'metric' => array('location' => 'query', 'type' => 'string', 'repeated' => \true), 'sort' => array('location' => 'query', 'type' => 'string', 'repeated' => \true), 'startIndex' => array('location' => 'query', 'type' => 'integer'))))));
        $this->adclients = new Google_Service_AdSenseHost_Adclients_Resource($this, $this->serviceName, 'adclients', array('methods' => array('get' => array('path' => 'adclients/{adClientId}', 'httpMethod' => 'GET', 'parameters' => array('adClientId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'list' => array('path' => 'adclients', 'httpMethod' => 'GET', 'parameters' => array('maxResults' => array('location' => 'query', 'type' => 'integer'), 'pageToken' => array('location' => 'query', 'type' => 'string'))))));
        $this->associationsessions = new Google_Service_AdSenseHost_Associationsessions_Resource($this, $this->serviceName, 'associationsessions', array('methods' => array('start' => array('path' => 'associationsessions/start', 'httpMethod' => 'GET', 'parameters' => array('productCode' => array('location' => 'query', 'type' => 'string', 'repeated' => \true, 'required' => \true), 'websiteUrl' => array('location' => 'query', 'type' => 'string', 'required' => \true), 'userLocale' => array('location' => 'query', 'type' => 'string'), 'websiteLocale' => array('location' => 'query', 'type' => 'string'))), 'verify' => array('path' => 'associationsessions/verify', 'httpMethod' => 'GET', 'parameters' => array('token' => array('location' => 'query', 'type' => 'string', 'required' => \true))))));
        $this->customchannels = new Google_Service_AdSenseHost_Customchannels_Resource($this, $this->serviceName, 'customchannels', array('methods' => array('delete' => array('path' => 'adclients/{adClientId}/customchannels/{customChannelId}', 'httpMethod' => 'DELETE', 'parameters' => array('adClientId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'customChannelId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'get' => array('path' => 'adclients/{adClientId}/customchannels/{customChannelId}', 'httpMethod' => 'GET', 'parameters' => array('adClientId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'customChannelId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'insert' => array('path' => 'adclients/{adClientId}/customchannels', 'httpMethod' => 'POST', 'parameters' => array('adClientId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'list' => array('path' => 'adclients/{adClientId}/customchannels', 'httpMethod' => 'GET', 'parameters' => array('adClientId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'maxResults' => array('location' => 'query', 'type' => 'integer'), 'pageToken' => array('location' => 'query', 'type' => 'string'))), 'patch' => array('path' => 'adclients/{adClientId}/customchannels', 'httpMethod' => 'PATCH', 'parameters' => array('adClientId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'customChannelId' => array('location' => 'query', 'type' => 'string', 'required' => \true))), 'update' => array('path' => 'adclients/{adClientId}/customchannels', 'httpMethod' => 'PUT', 'parameters' => array('adClientId' => array('location' => 'path', 'type' => 'string', 'required' => \true))))));
        $this->reports = new Google_Service_AdSenseHost_Reports_Resource($this, $this->serviceName, 'reports', array('methods' => array('generate' => array('path' => 'reports', 'httpMethod' => 'GET', 'parameters' => array('startDate' => array('location' => 'query', 'type' => 'string', 'required' => \true), 'endDate' => array('location' => 'query', 'type' => 'string', 'required' => \true), 'dimension' => array('location' => 'query', 'type' => 'string', 'repeated' => \true), 'filter' => array('location' => 'query', 'type' => 'string', 'repeated' => \true), 'locale' => array('location' => 'query', 'type' => 'string'), 'maxResults' => array('location' => 'query', 'type' => 'integer'), 'metric' => array('location' => 'query', 'type' => 'string', 'repeated' => \true), 'sort' => array('location' => 'query', 'type' => 'string', 'repeated' => \true), 'startIndex' => array('location' => 'query', 'type' => 'integer'))))));
        $this->urlchannels = new Google_Service_AdSenseHost_Urlchannels_Resource($this, $this->serviceName, 'urlchannels', array('methods' => array('delete' => array('path' => 'adclients/{adClientId}/urlchannels/{urlChannelId}', 'httpMethod' => 'DELETE', 'parameters' => array('adClientId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'urlChannelId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'insert' => array('path' => 'adclients/{adClientId}/urlchannels', 'httpMethod' => 'POST', 'parameters' => array('adClientId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'list' => array('path' => 'adclients/{adClientId}/urlchannels', 'httpMethod' => 'GET', 'parameters' => array('adClientId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'maxResults' => array('location' => 'query', 'type' => 'integer'), 'pageToken' => array('location' => 'query', 'type' => 'string'))))));
    }
}
/*
 * Licensed under the Apache License, Version 2.0 (the "License"); you may not
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_AdSenseHost', 'VendorDuplicator\\Google_Service_AdSenseHost', \false);
/**
...
class Google_Service_AdSenseHost_Accounts_Resource extends Google_Service_Resource
{
    ...
    public function get($accountId, $optParams = array())
    {
        ...
        return $this->call('get', array($params), "VendorDuplicator\\Google_Service_AdSenseHost_Account");
    }
    /**
    ...
    public function listAccounts($filterAdClientId, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('list', array($params), "VendorDuplicator\\Google_Service_AdSenseHost_Accounts");
    }
}
/**
 * The "accounts" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_AdSenseHost_Accounts_Resource', 'VendorDuplicator\\Google_Service_AdSenseHost_Accounts_Resource', \false);
/**
...
class Google_Service_AdSenseHost_AccountsAdclients_Resource extends Google_Service_Resource
{
    ...
    public function get($accountId, $adClientId, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('get', array($params), "VendorDuplicator\\Google_Service_AdSenseHost_AdClient");
    }
    /**
    ...
    public function listAccountsAdclients($accountId, $optParams = array())
    {
        $params = array('accountId' => $accountId);
        $params = \array_merge($params, $optParams);
        return $this->call('list', array($params), "VendorDuplicator\\Google_Service_AdSenseHost_AdClients");
    }
}
/**
 * The "adclients" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_AdSenseHost_AccountsAdclients_Resource', 'VendorDuplicator\\Google_Service_AdSenseHost_AccountsAdclients_Resource', \false);
/**
...
class Google_Service_AdSenseHost_AccountsAdunits_Resource extends Google_Service_Resource
{
    ...
    public function delete($accountId, $adClientId, $adUnitId, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('delete', array($params), "VendorDuplicator\\Google_Service_AdSenseHost_AdUnit");
    }
    /**
    ...
    public function get($accountId, $adClientId, $adUnitId, $optParams = array())
    {
        $params = array('accountId' => $accountId, 'adClientId' => $adClientId, 'adUnitId' => $adUnitId);
        $params = \array_merge($params, $optParams);
        return $this->call('get', array($params), "VendorDuplicator\\Google_Service_AdSenseHost_AdUnit");
    }
    /**
    ...
    public function getAdCode($accountId, $adClientId, $adUnitId, $optParams = array())
    {
        $params = array('accountId' => $accountId, 'adClientId' => $adClientId, 'adUnitId' => $adUnitId);
        $params = \array_merge($params, $optParams);
        return $this->call('getAdCode', array($params), "VendorDuplicator\\Google_Service_AdSenseHost_AdCode");
    }
    /**
    ...
    public function insert($accountId, $adClientId, Google_Service_AdSenseHost_AdUnit $postBody, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('insert', array($params), "VendorDuplicator\\Google_Service_AdSenseHost_AdUnit");
    }
    /**
    ...
    public function listAccountsAdunits($accountId, $adClientId, $optParams = array())
    {
        $params = array('accountId' => $accountId, 'adClientId' => $adClientId);
        $params = \array_merge($params, $optParams);
        return $this->call('list', array($params), "VendorDuplicator\\Google_Service_AdSenseHost_AdUnits");
    }
    /**
    ...
    public function patch($accountId, $adClientId, $adUnitId, Google_Service_AdSenseHost_AdUnit $postBody, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('patch', array($params), "VendorDuplicator\\Google_Service_AdSenseHost_AdUnit");
    }
    /**
    ...
    public function update($accountId, $adClientId, Google_Service_AdSenseHost_AdUnit $postBody, $optParams = array())
    {
        $params = array('accountId' => $accountId, 'adClientId' => $adClientId, 'postBody' => $postBody);
        $params = \array_merge($params, $optParams);
        return $this->call('update', array($params), "VendorDuplicator\\Google_Service_AdSenseHost_AdUnit");
    }
}
/**
 * The "adunits" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_AdSenseHost_AccountsAdunits_Resource', 'VendorDuplicator\\Google_Service_AdSenseHost_AccountsAdunits_Resource', \false);
/**
...
class Google_Service_AdSenseHost_AccountsReports_Resource extends Google_Service_Resource
{
    ...
    public function generate($accountId, $startDate, $endDate, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('generate', array($params), "VendorDuplicator\\Google_Service_AdSenseHost_Report");
    }
}
/**
 * The "reports" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_AdSenseHost_AccountsReports_Resource', 'VendorDuplicator\\Google_Service_AdSenseHost_AccountsReports_Resource', \false);
/**
 * The "adclients" collection of methods.
 * Typical usage is:
 *  <code>
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_AdSenseHost_Adclients_Resource', 'VendorDuplicator\\Google_Service_AdSenseHost_Adclients_Resource', \false);
/**
...
class Google_Service_AdSenseHost_Associationsessions_Resource extends Google_Service_Resource
{
    ...
    public function start($productCode, $websiteUrl, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('start', array($params), "VendorDuplicator\\Google_Service_AdSenseHost_AssociationSession");
    }
    /**
    ...
    public function verify($token, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('verify', array($params), "VendorDuplicator\\Google_Service_AdSenseHost_AssociationSession");
    }
}
/**
 * The "associationsessions" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_AdSenseHost_Associationsessions_Resource', 'VendorDuplicator\\Google_Service_AdSenseHost_Associationsessions_Resource', \false);
/**
...
class Google_Service_AdSenseHost_Customchannels_Resource extends Google_Service_Resource
{
    ...
    public function delete($adClientId, $customChannelId, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('delete', array($params), "VendorDuplicator\\Google_Service_AdSenseHost_CustomChannel");
    }
    /**
    ...
    public function get($adClientId, $customChannelId, $optParams = array())
    {
        $params = array('adClientId' => $adClientId, 'customChannelId' => $customChannelId);
        $params = \array_merge($params, $optParams);
        return $this->call('get', array($params), "VendorDuplicator\\Google_Service_AdSenseHost_CustomChannel");
    }
    /**
    ...
    public function insert($adClientId, Google_Service_AdSenseHost_CustomChannel $postBody, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('insert', array($params), "VendorDuplicator\\Google_Service_AdSenseHost_CustomChannel");
    }
    /**
    ...
    public function listCustomchannels($adClientId, $optParams = array())
    {
        $params = array('adClientId' => $adClientId);
        $params = \array_merge($params, $optParams);
        return $this->call('list', array($params), "VendorDuplicator\\Google_Service_AdSenseHost_CustomChannels");
    }
    /**
    ...
    public function patch($adClientId, $customChannelId, Google_Service_AdSenseHost_CustomChannel $postBody, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('patch', array($params), "VendorDuplicator\\Google_Service_AdSenseHost_CustomChannel");
    }
    /**
    ...
    public function update($adClientId, Google_Service_AdSenseHost_CustomChannel $postBody, $optParams = array())
    {
        $params = array('adClientId' => $adClientId, 'postBody' => $postBody);
        $params = \array_merge($params, $optParams);
        return $this->call('update', array($params), "VendorDuplicator\\Google_Service_AdSenseHost_CustomChannel");
    }
}
/**
 * The "customchannels" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_AdSenseHost_Customchannels_Resource', 'VendorDuplicator\\Google_Service_AdSenseHost_Customchannels_Resource', \false);
/**
 * The "reports" collection of methods.
 * Typical usage is:
 *  <code>
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_AdSenseHost_Reports_Resource', 'VendorDuplicator\\Google_Service_AdSenseHost_Reports_Resource', \false);
/**
...
class Google_Service_AdSenseHost_Urlchannels_Resource extends Google_Service_Resource
{
    ...
    public function delete($adClientId, $urlChannelId, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('delete', array($params), "VendorDuplicator\\Google_Service_AdSenseHost_UrlChannel");
    }
    /**
    ...
    public function insert($adClientId, Google_Service_AdSenseHost_UrlChannel $postBody, $optParams = array())
    {
        $params = array('adClientId' => $adClientId, 'postBody' => $postBody);
        $params = \array_merge($params, $optParams);
        return $this->call('insert', array($params), "VendorDuplicator\\Google_Service_AdSenseHost_UrlChannel");
    }
    /**
    ...
    public function listUrlchannels($adClientId, $optParams = array())
    {
        $params = array('adClientId' => $adClientId);
        $params = \array_merge($params, $optParams);
        return $this->call('list', array($params), "VendorDuplicator\\Google_Service_AdSenseHost_UrlChannels");
    }
}
/**
 * The "urlchannels" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_AdSenseHost_Urlchannels_Resource', 'VendorDuplicator\\Google_Service_AdSenseHost_Urlchannels_Resource', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_AdSenseHost_Account', 'VendorDuplicator\\Google_Service_AdSenseHost_Account', \false);
/** @internal */
class Google_Service_AdSenseHost_Accounts extends Google_Collection
{
    ...
    protected $internal_gapi_mappings = array();
    public $etag;
    protected $itemsType = 'VendorDuplicator\\Google_Service_AdSenseHost_Account';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_AdSenseHost_Accounts', 'VendorDuplicator\\Google_Service_AdSenseHost_Accounts', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_AdSenseHost_AdClient', 'VendorDuplicator\\Google_Service_AdSenseHost_AdClient', \false);
/** @internal */
class Google_Service_AdSenseHost_AdClients extends Google_Collection
{
    ...
    protected $internal_gapi_mappings = array();
    public $etag;
    protected $itemsType = 'VendorDuplicator\\Google_Service_AdSenseHost_AdClient';
    protected $itemsDataType = 'array';
    public $kind;
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_AdSenseHost_AdClients', 'VendorDuplicator\\Google_Service_AdSenseHost_AdClients', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_AdSenseHost_AdCode', 'VendorDuplicator\\Google_Service_AdSenseHost_AdCode', \false);
/** @internal */
class Google_Service_AdSenseHost_AdStyle extends Google_Model
{
    protected $internal_gapi_mappings = array();
    protected $colorsType = 'VendorDuplicator\\Google_Service_AdSenseHost_AdStyleColors';
    protected $colorsDataType = '';
    public $corners;
    protected $fontType = 'VendorDuplicator\\Google_Service_AdSenseHost_AdStyleFont';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_AdSenseHost_AdStyle', 'VendorDuplicator\\Google_Service_AdSenseHost_AdStyle', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_AdSenseHost_AdStyleColors', 'VendorDuplicator\\Google_Service_AdSenseHost_AdStyleColors', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_AdSenseHost_AdStyleFont', 'VendorDuplicator\\Google_Service_AdSenseHost_AdStyleFont', \false);
/** @internal */
class Google_Service_AdSenseHost_AdUnit extends Google_Model
{
    protected $internal_gapi_mappings = array();
    public $code;
    protected $contentAdsSettingsType = 'VendorDuplicator\\Google_Service_AdSenseHost_AdUnitContentAdsSettings';
    protected $contentAdsSettingsDataType = '';
    protected $customStyleType = 'VendorDuplicator\\Google_Service_AdSenseHost_AdStyle';
    protected $customStyleDataType = '';
    public $id;
    public $kind;
    protected $mobileContentAdsSettingsType = 'VendorDuplicator\\Google_Service_AdSenseHost_AdUnitMobileContentAdsSettings';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_AdSenseHost_AdUnit', 'VendorDuplicator\\Google_Service_AdSenseHost_AdUnit', \false);
/** @internal */
class Google_Service_AdSenseHost_AdUnitContentAdsSettings extends Google_Model
{
    protected $internal_gapi_mappings = array();
    protected $backupOptionType = 'VendorDuplicator\\Google_Service_AdSenseHost_AdUnitContentAdsSettingsBackupOption';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_AdSenseHost_AdUnitContentAdsSettings', 'VendorDuplicator\\Google_Service_AdSenseHost_AdUnitContentAdsSettings', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_AdSenseHost_AdUnitContentAdsSettingsBackupOption', 'VendorDuplicator\\Google_Service_AdSenseHost_AdUnitContentAdsSettingsBackupOption', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_AdSenseHost_AdUnitMobileContentAdsSettings', 'VendorDuplicator\\Google_Service_AdSenseHost_AdUnitMobileContentAdsSettings', \false);
/** @internal */
class Google_Service_AdSenseHost_AdUnits extends Google_Collection
{
    ...
    protected $internal_gapi_mappings = array();
    public $etag;
    protected $itemsType = 'VendorDuplicator\\Google_Service_AdSenseHost_AdUnit';
    protected $itemsDataType = 'array';
    public $kind;
    public $nextPageToken;
    public function setEtag($etag)
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_AdSenseHost_AdUnits', 'VendorDuplicator\\Google_Service_AdSenseHost_AdUnits', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_AdSenseHost_AssociationSession', 'VendorDuplicator\\Google_Service_AdSenseHost_AssociationSession', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_AdSenseHost_CustomChannel', 'VendorDuplicator\\Google_Service_AdSenseHost_CustomChannel', \false);
/** @internal */
class Google_Service_AdSenseHost_CustomChannels extends Google_Collection
{
    ...
    protected $internal_gapi_mappings = array();
    public $etag;
    protected $itemsType = 'VendorDuplicator\\Google_Service_AdSenseHost_CustomChannel';
    protected $itemsDataType = 'array';
    public $kind;
    public $nextPageToken;
    public function setEtag($etag)
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_AdSenseHost_CustomChannels', 'VendorDuplicator\\Google_Service_AdSenseHost_CustomChannels', \false);
/** @internal */
class Google_Service_AdSenseHost_Report extends Google_Collection
{
    ...
    protected $internal_gapi_mappings = array();
    public $averages;
    protected $headersType = 'VendorDuplicator\\Google_Service_AdSenseHost_ReportHeaders';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_AdSenseHost_Report', 'VendorDuplicator\\Google_Service_AdSenseHost_Report', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_AdSenseHost_ReportHeaders', 'VendorDuplicator\\Google_Service_AdSenseHost_ReportHeaders', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_AdSenseHost_UrlChannel', 'VendorDuplicator\\Google_Service_AdSenseHost_UrlChannel', \false);
/** @internal */
class Google_Service_AdSenseHost_UrlChannels extends Google_Collection
{
    ...
    protected $internal_gapi_mappings = array();
    public $etag;
    protected $itemsType = 'VendorDuplicator\\Google_Service_AdSenseHost_UrlChannel';
    protected $itemsDataType = 'array';
    public $kind;
    public $nextPageToken;
    public function setEtag($etag)
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_AdSenseHost_UrlChannels', 'VendorDuplicator\\Google_Service_AdSenseHost_UrlChannels', \false);
