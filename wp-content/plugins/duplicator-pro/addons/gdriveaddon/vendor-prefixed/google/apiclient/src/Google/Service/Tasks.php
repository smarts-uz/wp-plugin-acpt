 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Tasks', 'VendorDuplicator\\Google_Service_Tasks', \false);
/**
...
class Google_Service_Tasks_Tasklists_Resource extends Google_Service_Resource
{
    ...
    public function get($tasklist, $optParams = array())
    {
        $params = array('tasklist' => $tasklist);
        $params = \array_merge($params, $optParams);
        return $this->call('get', array($params), "VendorDuplicator\\Google_Service_Tasks_TaskList");
    }
    /**
    ...
    public function insert(Google_Service_Tasks_TaskList $postBody, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('insert', array($params), "VendorDuplicator\\Google_Service_Tasks_TaskList");
    }
    /**
    ...
    public function listTasklists($optParams = array())
    {
        $params = array();
        $params = \array_merge($params, $optParams);
        return $this->call('list', array($params), "VendorDuplicator\\Google_Service_Tasks_TaskLists");
    }
    /**
    ...
    public function patch($tasklist, Google_Service_Tasks_TaskList $postBody, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('patch', array($params), "VendorDuplicator\\Google_Service_Tasks_TaskList");
    }
    /**
    ...
    public function update($tasklist, Google_Service_Tasks_TaskList $postBody, $optParams = array())
    {
        $params = array('tasklist' => $tasklist, 'postBody' => $postBody);
        $params = \array_merge($params, $optParams);
        return $this->call('update', array($params), "VendorDuplicator\\Google_Service_Tasks_TaskList");
    }
}
/**
 * The "tasklists" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Tasks_Tasklists_Resource', 'VendorDuplicator\\Google_Service_Tasks_Tasklists_Resource', \false);
/**
...
class Google_Service_Tasks_Tasks_Resource extends Google_Service_Resource
{
    ...
    public function get($tasklist, $task, $optParams = array())
    {
        $params = array('tasklist' => $tasklist, 'task' => $task);
        $params = \array_merge($params, $optParams);
        return $this->call('get', array($params), "VendorDuplicator\\Google_Service_Tasks_Task");
    }
    /**
    ...
    public function insert($tasklist, Google_Service_Tasks_Task $postBody, $optParams = array())
    {
        $params = array('tasklist' => $tasklist, 'postBody' => $postBody);
        $params = \array_merge($params, $optParams);
        return $this->call('insert', array($params), "VendorDuplicator\\Google_Service_Tasks_Task");
    }
    /**
    ...
    public function listTasks($tasklist, $optParams = array())
    {
        $params = array('tasklist' => $tasklist);
        $params = \array_merge($params, $optParams);
        return $this->call('list', array($params), "VendorDuplicator\\Google_Service_Tasks_Tasks");
    }
    /**
    ...
    public function move($tasklist, $task, $optParams = array())
    {
        $params = array('tasklist' => $tasklist, 'task' => $task);
        $params = \array_merge($params, $optParams);
        return $this->call('move', array($params), "VendorDuplicator\\Google_Service_Tasks_Task");
    }
    /**
    ...
    public function patch($tasklist, $task, Google_Service_Tasks_Task $postBody, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('patch', array($params), "VendorDuplicator\\Google_Service_Tasks_Task");
    }
    /**
    ...
    public function update($tasklist, $task, Google_Service_Tasks_Task $postBody, $optParams = array())
    {
        $params = array('tasklist' => $tasklist, 'task' => $task, 'postBody' => $postBody);
        $params = \array_merge($params, $optParams);
        return $this->call('update', array($params), "VendorDuplicator\\Google_Service_Tasks_Task");
    }
}
/**
 * The "tasks" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Tasks_Tasks_Resource', 'VendorDuplicator\\Google_Service_Tasks_Tasks_Resource', \false);
/** @internal */
class Google_Service_Tasks_Task extends Google_Collection
{
    ...
    public $id;
    public $kind;
    protected $linksType = 'VendorDuplicator\\Google_Service_Tasks_TaskLinks';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Tasks_Task', 'VendorDuplicator\\Google_Service_Tasks_Task', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Tasks_TaskLinks', 'VendorDuplicator\\Google_Service_Tasks_TaskLinks', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Tasks_TaskList', 'VendorDuplicator\\Google_Service_Tasks_TaskList', \false);
/** @internal */
class Google_Service_Tasks_TaskLists extends Google_Collection
{
    ...
    protected $internal_gapi_mappings = array();
    public $etag;
    protected $itemsType = 'VendorDuplicator\\Google_Service_Tasks_TaskList';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Tasks_TaskLists', 'VendorDuplicator\\Google_Service_Tasks_TaskLists', \false);
/** @internal */
class Google_Service_Tasks_Tasks extends Google_Collection
{
    ...
    protected $internal_gapi_mappings = array();
    public $etag;
    protected $itemsType = 'VendorDuplicator\\Google_Service_Tasks_Task';
    protected $itemsDataType = 'array';
    public $kind;
    public $nextPageToken;
    public function setEtag($etag)
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Tasks_Tasks', 'VendorDuplicator\\Google_Service_Tasks_Tasks', \false);
