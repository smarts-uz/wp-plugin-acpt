 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Audit', 'VendorDuplicator\\Google_Service_Audit', \false);
/**
...
class Google_Service_Audit_Activities_Resource extends Google_Service_Resource
{
    ...
    public function listActivities($customerId, $applicationId, $optParams = array())
    {
        ...
        return $this->call('list', array($params), "VendorDuplicator\\Google_Service_Audit_Activities");
    }
}
/**
 * The "activities" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Audit_Activities_Resource', 'VendorDuplicator\\Google_Service_Audit_Activities_Resource', \false);
/** @internal */
class Google_Service_Audit_Activities extends Google_Collection
{
    protected $collection_key = 'items';
    protected $internal_gapi_mappings = array();
    protected $itemsType = 'VendorDuplicator\\Google_Service_Audit_Activity';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Audit_Activities', 'VendorDuplicator\\Google_Service_Audit_Activities', \false);
/** @internal */
class Google_Service_Audit_Activity extends Google_Collection
{
    protected $collection_key = 'events';
    protected $internal_gapi_mappings = array();
    protected $actorType = 'VendorDuplicator\\Google_Service_Audit_ActivityActor';
    protected $actorDataType = '';
    protected $eventsType = 'VendorDuplicator\\Google_Service_Audit_ActivityEvents';
    protected $eventsDataType = 'array';
    protected $idType = 'VendorDuplicator\\Google_Service_Audit_ActivityId';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Audit_Activity', 'VendorDuplicator\\Google_Service_Audit_Activity', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Audit_ActivityActor', 'VendorDuplicator\\Google_Service_Audit_ActivityActor', \false);
/** @internal */
class Google_Service_Audit_ActivityEvents extends Google_Collection
{
    ...
    public $eventType;
    public $name;
    protected $parametersType = 'VendorDuplicator\\Google_Service_Audit_ActivityEventsParameters';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Audit_ActivityEvents', 'VendorDuplicator\\Google_Service_Audit_ActivityEvents', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Audit_ActivityEventsParameters', 'VendorDuplicator\\Google_Service_Audit_ActivityEventsParameters', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Audit_ActivityId', 'VendorDuplicator\\Google_Service_Audit_ActivityId', \false);
