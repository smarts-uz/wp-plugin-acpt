...
class Google_Service_Groupssettings extends Google_Service
{
    ...
    public function __construct(Google_Client $client)
    {
        ...
        $this->groups = new Google_Service_Groupssettings_Groups_Resource($this, $this->serviceName, 'groups', array('methods' => array('get' => array('path' => '{groupUniqueId}', 'httpMethod' => 'GET', 'parameters' => array('groupUniqueId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'patch' => array('path' => '{groupUniqueId}', 'httpMethod' => 'PATCH', 'parameters' => array('groupUniqueId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'update' => array('path' => '{groupUniqueId}', 'httpMethod' => 'PUT', 'parameters' => array('groupUniqueId' => array('location' => 'path', 'type' => 'string', 'required' => \true))))));
    }
}
/*
 * Licensed under the Apache License, Version 2.0 (the "License"); you may not
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Groupssettings', 'VendorDuplicator\\Google_Service_Groupssettings', \false);
/**
...
class Google_Service_Groupssettings_Groups_Resource extends Google_Service_Resource
{
    ...
    public function get($groupUniqueId, $optParams = array())
    {
        ...
        return $this->call('get', array($params), "VendorDuplicator\\Google_Service_Groupssettings_Groups");
    }
    /**
    ...
    public function patch($groupUniqueId, Google_Service_Groupssettings_Groups $postBody, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('patch', array($params), "VendorDuplicator\\Google_Service_Groupssettings_Groups");
    }
    /**
    ...
    public function update($groupUniqueId, Google_Service_Groupssettings_Groups $postBody, $optParams = array())
    {
        $params = array('groupUniqueId' => $groupUniqueId, 'postBody' => $postBody);
        $params = \array_merge($params, $optParams);
        return $this->call('update', array($params), "VendorDuplicator\\Google_Service_Groupssettings_Groups");
    }
}
/**
 * The "groups" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Groupssettings_Groups_Resource', 'VendorDuplicator\\Google_Service_Groupssettings_Groups_Resource', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Groupssettings_Groups', 'VendorDuplicator\\Google_Service_Groupssettings_Groups', \false);
