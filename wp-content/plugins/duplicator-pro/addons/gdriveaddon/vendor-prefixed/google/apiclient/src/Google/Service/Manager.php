...
class Google_Service_Manager extends Google_Service
{
    ...
    public function __construct(Google_Client $client)
    {
        ...
        $this->deployments = new Google_Service_Manager_Deployments_Resource($this, $this->serviceName, 'deployments', array('methods' => array('delete' => array('path' => '{projectId}/regions/{region}/deployments/{deploymentName}', 'httpMethod' => 'DELETE', 'parameters' => array('projectId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'region' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'deploymentName' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'get' => array('path' => '{projectId}/regions/{region}/deployments/{deploymentName}', 'httpMethod' => 'GET', 'parameters' => array('projectId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'region' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'deploymentName' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'insert' => array('path' => '{projectId}/regions/{region}/deployments', 'httpMethod' => 'POST', 'parameters' => array('projectId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'region' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'list' => array('path' => '{projectId}/regions/{region}/deployments', 'httpMethod' => 'GET', 'parameters' => array('projectId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'region' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'maxResults' => array('location' => 'query', 'type' => 'integer'), 'pageToken' => array('location' => 'query', 'type' => 'string'))))));
        $this->templates = new Google_Service_Manager_Templates_Resource($this, $this->serviceName, 'templates', array('methods' => array('delete' => array('path' => '{projectId}/templates/{templateName}', 'httpMethod' => 'DELETE', 'parameters' => array('projectId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'templateName' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'get' => array('path' => '{projectId}/templates/{templateName}', 'httpMethod' => 'GET', 'parameters' => array('projectId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'templateName' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'insert' => array('path' => '{projectId}/templates', 'httpMethod' => 'POST', 'parameters' => array('projectId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'list' => array('path' => '{projectId}/templates', 'httpMethod' => 'GET', 'parameters' => array('projectId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'maxResults' => array('location' => 'query', 'type' => 'integer'), 'pageToken' => array('location' => 'query', 'type' => 'string'))))));
    }
}
/*
 * Licensed under the Apache License, Version 2.0 (the "License"); you may not
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Manager', 'VendorDuplicator\\Google_Service_Manager', \false);
/**
...
class Google_Service_Manager_Deployments_Resource extends Google_Service_Resource
{
    ...
    public function get($projectId, $region, $deploymentName, $optParams = array())
    {
        $params = array('projectId' => $projectId, 'region' => $region, 'deploymentName' => $deploymentName);
        $params = \array_merge($params, $optParams);
        return $this->call('get', array($params), "VendorDuplicator\\Google_Service_Manager_Deployment");
    }
    /**
     * (deployments.insert)
     *
    ...
    public function insert($projectId, $region, Google_Service_Manager_Deployment $postBody, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('insert', array($params), "VendorDuplicator\\Google_Service_Manager_Deployment");
    }
    /**
    ...
    public function listDeployments($projectId, $region, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('list', array($params), "VendorDuplicator\\Google_Service_Manager_DeploymentsListResponse");
    }
}
/**
 * The "deployments" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Manager_Deployments_Resource', 'VendorDuplicator\\Google_Service_Manager_Deployments_Resource', \false);
/**
...
class Google_Service_Manager_Templates_Resource extends Google_Service_Resource
{
    ...
    public function get($projectId, $templateName, $optParams = array())
    {
        $params = array('projectId' => $projectId, 'templateName' => $templateName);
        $params = \array_merge($params, $optParams);
        return $this->call('get', array($params), "VendorDuplicator\\Google_Service_Manager_Template");
    }
    /**
     * (templates.insert)
     *
    ...
    public function insert($projectId, Google_Service_Manager_Template $postBody, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('insert', array($params), "VendorDuplicator\\Google_Service_Manager_Template");
    }
    /**
    ...
    public function listTemplates($projectId, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('list', array($params), "VendorDuplicator\\Google_Service_Manager_TemplatesListResponse");
    }
}
/**
 * The "templates" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Manager_Templates_Resource', 'VendorDuplicator\\Google_Service_Manager_Templates_Resource', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Manager_AccessConfig', 'VendorDuplicator\\Google_Service_Manager_AccessConfig', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Manager_Action', 'VendorDuplicator\\Google_Service_Manager_Action', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Manager_AllowedRule', 'VendorDuplicator\\Google_Service_Manager_AllowedRule', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Manager_AutoscalingModule', 'VendorDuplicator\\Google_Service_Manager_AutoscalingModule', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Manager_AutoscalingModuleStatus', 'VendorDuplicator\\Google_Service_Manager_AutoscalingModuleStatus', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Manager_DeployState', 'VendorDuplicator\\Google_Service_Manager_DeployState', \false);
/** @internal */
class Google_Service_Manager_Deployment extends Google_Collection
{
    ...
    public $creationDate;
    public $description;
    protected $modulesType = 'VendorDuplicator\\Google_Service_Manager_ModuleStatus';
    protected $modulesDataType = 'map';
    public $name;
    protected $overridesType = 'VendorDuplicator\\Google_Service_Manager_ParamOverride';
    protected $overridesDataType = 'array';
    protected $stateType = 'VendorDuplicator\\Google_Service_Manager_DeployState';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Manager_Deployment', 'VendorDuplicator\\Google_Service_Manager_Deployment', \false);
/** @internal */
class Google_Service_Manager_DeploymentsListResponse extends Google_Collection
{
    ...
    protected $resourcesType = 'VendorDuplicator\\Google_Service_Manager_Deployment';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Manager_DeploymentsListResponse', 'VendorDuplicator\\Google_Service_Manager_DeploymentsListResponse', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Manager_DiskAttachment', 'VendorDuplicator\\Google_Service_Manager_DiskAttachment', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Manager_EnvVariable', 'VendorDuplicator\\Google_Service_Manager_EnvVariable', \false);
/** @internal */
class Google_Service_Manager_ExistingDisk extends Google_Model
{
    protected $internal_gapi_mappings = array();
    protected $attachmentType = 'VendorDuplicator\\Google_Service_Manager_DiskAttachment';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Manager_ExistingDisk', 'VendorDuplicator\\Google_Service_Manager_ExistingDisk', \false);
/** @internal */
class Google_Service_Manager_FirewallModule extends Google_Collection
{
    protected $collection_key = 'targetTags';
    protected $internal_gapi_mappings = array();
    protected $allowedType = 'VendorDuplicator\\Google_Service_Manager_AllowedRule';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Manager_FirewallModule', 'VendorDuplicator\\Google_Service_Manager_FirewallModule', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Manager_FirewallModuleStatus', 'VendorDuplicator\\Google_Service_Manager_FirewallModuleStatus', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Manager_HealthCheckModule', 'VendorDuplicator\\Google_Service_Manager_HealthCheckModule', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Manager_HealthCheckModuleStatus', 'VendorDuplicator\\Google_Service_Manager_HealthCheckModuleStatus', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Manager_LbModule', 'VendorDuplicator\\Google_Service_Manager_LbModule', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Manager_LbModuleStatus', 'VendorDuplicator\\Google_Service_Manager_LbModuleStatus', \false);
/** @internal */
class Google_Service_Manager_Metadata extends Google_Collection
{
    ...
    protected $internal_gapi_mappings = array();
    public $fingerPrint;
    protected $itemsType = 'VendorDuplicator\\Google_Service_Manager_MetadataItem';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Manager_Metadata', 'VendorDuplicator\\Google_Service_Manager_Metadata', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Manager_MetadataItem', 'VendorDuplicator\\Google_Service_Manager_MetadataItem', \false);
/** @internal */
class Google_Service_Manager_Module extends Google_Model
{
    protected $internal_gapi_mappings = array();
    protected $autoscalingModuleType = 'VendorDuplicator\\Google_Service_Manager_AutoscalingModule';
    protected $autoscalingModuleDataType = '';
    protected $firewallModuleType = 'VendorDuplicator\\Google_Service_Manager_FirewallModule';
    protected $firewallModuleDataType = '';
    protected $healthCheckModuleType = 'VendorDuplicator\\Google_Service_Manager_HealthCheckModule';
    protected $healthCheckModuleDataType = '';
    protected $lbModuleType = 'VendorDuplicator\\Google_Service_Manager_LbModule';
    protected $lbModuleDataType = '';
    protected $networkModuleType = 'VendorDuplicator\\Google_Service_Manager_NetworkModule';
    protected $networkModuleDataType = '';
    protected $replicaPoolModuleType = 'VendorDuplicator\\Google_Service_Manager_ReplicaPoolModule';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Manager_Module', 'VendorDuplicator\\Google_Service_Manager_Module', \false);
/** @internal */
class Google_Service_Manager_ModuleStatus extends Google_Model
{
    protected $internal_gapi_mappings = array();
    protected $autoscalingModuleStatusType = 'VendorDuplicator\\Google_Service_Manager_AutoscalingModuleStatus';
    protected $autoscalingModuleStatusDataType = '';
    protected $firewallModuleStatusType = 'VendorDuplicator\\Google_Service_Manager_FirewallModuleStatus';
    protected $firewallModuleStatusDataType = '';
    protected $healthCheckModuleStatusType = 'VendorDuplicator\\Google_Service_Manager_HealthCheckModuleStatus';
    protected $healthCheckModuleStatusDataType = '';
    protected $lbModuleStatusType = 'VendorDuplicator\\Google_Service_Manager_LbModuleStatus';
    protected $lbModuleStatusDataType = '';
    protected $networkModuleStatusType = 'VendorDuplicator\\Google_Service_Manager_NetworkModuleStatus';
    protected $networkModuleStatusDataType = '';
    protected $replicaPoolModuleStatusType = 'VendorDuplicator\\Google_Service_Manager_ReplicaPoolModuleStatus';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Manager_ModuleStatus', 'VendorDuplicator\\Google_Service_Manager_ModuleStatus', \false);
/** @internal */
class Google_Service_Manager_NetworkInterface extends Google_Collection
{
    protected $collection_key = 'accessConfigs';
    protected $internal_gapi_mappings = array();
    protected $accessConfigsType = 'VendorDuplicator\\Google_Service_Manager_AccessConfig';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Manager_NetworkInterface', 'VendorDuplicator\\Google_Service_Manager_NetworkInterface', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Manager_NetworkModule', 'VendorDuplicator\\Google_Service_Manager_NetworkModule', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Manager_NetworkModuleStatus', 'VendorDuplicator\\Google_Service_Manager_NetworkModuleStatus', \false);
/** @internal */
class Google_Service_Manager_NewDisk extends Google_Model
{
    ...
    public $autoDelete;
    public $boot;
    protected $initializeParamsType = 'VendorDuplicator\\Google_Service_Manager_NewDiskInitializeParams';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Manager_NewDisk', 'VendorDuplicator\\Google_Service_Manager_NewDisk', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Manager_NewDiskInitializeParams', 'VendorDuplicator\\Google_Service_Manager_NewDiskInitializeParams', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Manager_ParamOverride', 'VendorDuplicator\\Google_Service_Manager_ParamOverride', \false);
/** @internal */
class Google_Service_Manager_ReplicaPoolModule extends Google_Collection
{
    protected $collection_key = 'healthChecks';
    protected $internal_gapi_mappings = array();
    protected $envVariablesType = 'VendorDuplicator\\Google_Service_Manager_EnvVariable';
    protected $envVariablesDataType = 'map';
    public $healthChecks;
    public $numReplicas;
    protected $replicaPoolParamsType = 'VendorDuplicator\\Google_Service_Manager_ReplicaPoolParams';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Manager_ReplicaPoolModule', 'VendorDuplicator\\Google_Service_Manager_ReplicaPoolModule', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Manager_ReplicaPoolModuleStatus', 'VendorDuplicator\\Google_Service_Manager_ReplicaPoolModuleStatus', \false);
/** @internal */
class Google_Service_Manager_ReplicaPoolParams extends Google_Model
{
    protected $internal_gapi_mappings = array();
    protected $v1beta1Type = 'VendorDuplicator\\Google_Service_Manager_ReplicaPoolParamsV1Beta1';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Manager_ReplicaPoolParams', 'VendorDuplicator\\Google_Service_Manager_ReplicaPoolParams', \false);
/** @internal */
class Google_Service_Manager_ReplicaPoolParamsV1Beta1 extends Google_Collection
{
    ...
    public $canIpForward;
    public $description;
    protected $disksToAttachType = 'VendorDuplicator\\Google_Service_Manager_ExistingDisk';
    protected $disksToAttachDataType = 'array';
    protected $disksToCreateType = 'VendorDuplicator\\Google_Service_Manager_NewDisk';
    protected $disksToCreateDataType = 'array';
    public $initAction;
    public $machineType;
    protected $metadataType = 'VendorDuplicator\\Google_Service_Manager_Metadata';
    protected $metadataDataType = '';
    protected $networkInterfacesType = 'VendorDuplicator\\Google_Service_Manager_NetworkInterface';
    protected $networkInterfacesDataType = 'array';
    public $onHostMaintenance;
    protected $serviceAccountsType = 'VendorDuplicator\\Google_Service_Manager_ServiceAccount';
    protected $serviceAccountsDataType = 'array';
    protected $tagsType = 'VendorDuplicator\\Google_Service_Manager_Tag';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Manager_ReplicaPoolParamsV1Beta1', 'VendorDuplicator\\Google_Service_Manager_ReplicaPoolParamsV1Beta1', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Manager_ServiceAccount', 'VendorDuplicator\\Google_Service_Manager_ServiceAccount', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Manager_Tag', 'VendorDuplicator\\Google_Service_Manager_Tag', \false);
/** @internal */
class Google_Service_Manager_Template extends Google_Model
{
    protected $internal_gapi_mappings = array();
    protected $actionsType = 'VendorDuplicator\\Google_Service_Manager_Action';
    protected $actionsDataType = 'map';
    public $description;
    protected $modulesType = 'VendorDuplicator\\Google_Service_Manager_Module';
    protected $modulesDataType = 'map';
    public $name;
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Manager_Template', 'VendorDuplicator\\Google_Service_Manager_Template', \false);
/** @internal */
class Google_Service_Manager_TemplatesListResponse extends Google_Collection
{
    ...
    protected $internal_gapi_mappings = array();
    public $nextPageToken;
    protected $resourcesType = 'VendorDuplicator\\Google_Service_Manager_Template';
    protected $resourcesDataType = 'array';
    public function setNextPageToken($nextPageToken)
    {
        $this->nextPageToken = $nextPageToken;
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Manager_TemplatesListResponse', 'VendorDuplicator\\Google_Service_Manager_TemplatesListResponse', \false);
