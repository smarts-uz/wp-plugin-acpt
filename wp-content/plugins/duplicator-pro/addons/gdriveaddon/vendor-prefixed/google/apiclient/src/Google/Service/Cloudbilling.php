...
class Google_Service_Cloudbilling extends Google_Service
{
    ...
    public function __construct(Google_Client $client)
    {
        ...
        $this->projects = new Google_Service_Cloudbilling_Projects_Resource($this, $this->serviceName, 'projects', array('methods' => array('getBillingInfo' => array('path' => 'v1/{+name}/billingInfo', 'httpMethod' => 'GET', 'parameters' => array('name' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'updateBillingInfo' => array('path' => 'v1/{+name}/billingInfo', 'httpMethod' => 'PUT', 'parameters' => array('name' => array('location' => 'path', 'type' => 'string', 'required' => \true))))));
    }
}
/*
 * Licensed under the Apache License, Version 2.0 (the "License"); you may not
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Cloudbilling', 'VendorDuplicator\\Google_Service_Cloudbilling', \false);
/**
...
class Google_Service_Cloudbilling_BillingAccounts_Resource extends Google_Service_Resource
{
    ...
    public function get($name, $optParams = array())
    {
        ...
        return $this->call('get', array($params), "VendorDuplicator\\Google_Service_Cloudbilling_BillingAccount");
    }
    /**
    ...
    public function listBillingAccounts($optParams = array())
    {
        $params = array();
        $params = \array_merge($params, $optParams);
        return $this->call('list', array($params), "VendorDuplicator\\Google_Service_Cloudbilling_ListBillingAccountsResponse");
    }
}
/**
 * The "billingAccounts" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Cloudbilling_BillingAccounts_Resource', 'VendorDuplicator\\Google_Service_Cloudbilling_BillingAccounts_Resource', \false);
/**
...
class Google_Service_Cloudbilling_BillingAccountsProjects_Resource extends Google_Service_Resource
{
    ...
    public function listBillingAccountsProjects($name, $optParams = array())
    {
        $params = array('name' => $name);
        $params = \array_merge($params, $optParams);
        return $this->call('list', array($params), "VendorDuplicator\\Google_Service_Cloudbilling_ListProjectBillingInfoResponse");
    }
}
/**
 * The "projects" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Cloudbilling_BillingAccountsProjects_Resource', 'VendorDuplicator\\Google_Service_Cloudbilling_BillingAccountsProjects_Resource', \false);
/**
 * The "projects" collection of methods.
 * Typical usage is:
 *  <code>
...
class Google_Service_Cloudbilling_Projects_Resource extends Google_Service_Resource
{
    ...
    public function getBillingInfo($name, $optParams = array())
    {
        $params = array('name' => $name);
        $params = \array_merge($params, $optParams);
        return $this->call('getBillingInfo', array($params), "VendorDuplicator\\Google_Service_Cloudbilling_ProjectBillingInfo");
    }
    /**
    ...
    public function updateBillingInfo($name, Google_Service_Cloudbilling_ProjectBillingInfo $postBody, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('updateBillingInfo', array($params), "VendorDuplicator\\Google_Service_Cloudbilling_ProjectBillingInfo");
    }
}
/**
 * The "projects" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Cloudbilling_Projects_Resource', 'VendorDuplicator\\Google_Service_Cloudbilling_Projects_Resource', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Cloudbilling_BillingAccount', 'VendorDuplicator\\Google_Service_Cloudbilling_BillingAccount', \false);
/** @internal */
class Google_Service_Cloudbilling_ListBillingAccountsResponse extends Google_Collection
{
    ...
    protected $internal_gapi_mappings = array();
    protected $billingAccountsType = 'VendorDuplicator\\Google_Service_Cloudbilling_BillingAccount';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Cloudbilling_ListBillingAccountsResponse', 'VendorDuplicator\\Google_Service_Cloudbilling_ListBillingAccountsResponse', \false);
/** @internal */
class Google_Service_Cloudbilling_ListProjectBillingInfoResponse extends Google_Collection
{
    ...
    protected $internal_gapi_mappings = array();
    public $nextPageToken;
    protected $projectBillingInfoType = 'VendorDuplicator\\Google_Service_Cloudbilling_ProjectBillingInfo';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Cloudbilling_ListProjectBillingInfoResponse', 'VendorDuplicator\\Google_Service_Cloudbilling_ListProjectBillingInfoResponse', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Cloudbilling_ProjectBillingInfo', 'VendorDuplicator\\Google_Service_Cloudbilling_ProjectBillingInfo', \false);
