...
class Google_Service_Licensing extends Google_Service
{
    ...
    public function __construct(Google_Client $client)
    {
        ...
        $this->licenseAssignments = new Google_Service_Licensing_LicenseAssignments_Resource($this, $this->serviceName, 'licenseAssignments', array('methods' => array('delete' => array('path' => '{productId}/sku/{skuId}/user/{userId}', 'httpMethod' => 'DELETE', 'parameters' => array('productId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'skuId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'userId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'get' => array('path' => '{productId}/sku/{skuId}/user/{userId}', 'httpMethod' => 'GET', 'parameters' => array('productId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'skuId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'userId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'insert' => array('path' => '{productId}/sku/{skuId}/user', 'httpMethod' => 'POST', 'parameters' => array('productId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'skuId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'listForProduct' => array('path' => '{productId}/users', 'httpMethod' => 'GET', 'parameters' => array('productId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'customerId' => array('location' => 'query', 'type' => 'string', 'required' => \true), 'maxResults' => array('location' => 'query', 'type' => 'integer'), 'pageToken' => array('location' => 'query', 'type' => 'string'))), 'listForProductAndSku' => array('path' => '{productId}/sku/{skuId}/users', 'httpMethod' => 'GET', 'parameters' => array('productId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'skuId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'customerId' => array('location' => 'query', 'type' => 'string', 'required' => \true), 'maxResults' => array('location' => 'query', 'type' => 'integer'), 'pageToken' => array('location' => 'query', 'type' => 'string'))), 'patch' => array('path' => '{productId}/sku/{skuId}/user/{userId}', 'httpMethod' => 'PATCH', 'parameters' => array('productId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'skuId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'userId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'update' => array('path' => '{productId}/sku/{skuId}/user/{userId}', 'httpMethod' => 'PUT', 'parameters' => array('productId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'skuId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'userId' => array('location' => 'path', 'type' => 'string', 'required' => \true))))));
    }
}
/*
 * Licensed under the Apache License, Version 2.0 (the "License"); you may not
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Licensing', 'VendorDuplicator\\Google_Service_Licensing', \false);
/**
...
class Google_Service_Licensing_LicenseAssignments_Resource extends Google_Service_Resource
{
    ...
    public function get($productId, $skuId, $userId, $optParams = array())
    {
        $params = array('productId' => $productId, 'skuId' => $skuId, 'userId' => $userId);
        $params = \array_merge($params, $optParams);
        return $this->call('get', array($params), "VendorDuplicator\\Google_Service_Licensing_LicenseAssignment");
    }
    /**
    ...
    public function insert($productId, $skuId, Google_Service_Licensing_LicenseAssignmentInsert $postBody, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('insert', array($params), "VendorDuplicator\\Google_Service_Licensing_LicenseAssignment");
    }
    /**
    ...
    public function listForProduct($productId, $customerId, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('listForProduct', array($params), "VendorDuplicator\\Google_Service_Licensing_LicenseAssignmentList");
    }
    /**
    ...
    public function listForProductAndSku($productId, $skuId, $customerId, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('listForProductAndSku', array($params), "VendorDuplicator\\Google_Service_Licensing_LicenseAssignmentList");
    }
    /**
    ...
    public function patch($productId, $skuId, $userId, Google_Service_Licensing_LicenseAssignment $postBody, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('patch', array($params), "VendorDuplicator\\Google_Service_Licensing_LicenseAssignment");
    }
    /**
    ...
    public function update($productId, $skuId, $userId, Google_Service_Licensing_LicenseAssignment $postBody, $optParams = array())
    {
        $params = array('productId' => $productId, 'skuId' => $skuId, 'userId' => $userId, 'postBody' => $postBody);
        $params = \array_merge($params, $optParams);
        return $this->call('update', array($params), "VendorDuplicator\\Google_Service_Licensing_LicenseAssignment");
    }
}
/**
 * The "licenseAssignments" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Licensing_LicenseAssignments_Resource', 'VendorDuplicator\\Google_Service_Licensing_LicenseAssignments_Resource', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Licensing_LicenseAssignment', 'VendorDuplicator\\Google_Service_Licensing_LicenseAssignment', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Licensing_LicenseAssignmentInsert', 'VendorDuplicator\\Google_Service_Licensing_LicenseAssignmentInsert', \false);
/** @internal */
class Google_Service_Licensing_LicenseAssignmentList extends Google_Collection
{
    ...
    protected $internal_gapi_mappings = array();
    public $etag;
    protected $itemsType = 'VendorDuplicator\\Google_Service_Licensing_LicenseAssignment';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Licensing_LicenseAssignmentList', 'VendorDuplicator\\Google_Service_Licensing_LicenseAssignmentList', \false);
