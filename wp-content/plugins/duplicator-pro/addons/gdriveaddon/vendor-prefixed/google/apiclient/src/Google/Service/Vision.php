...
class Google_Service_Vision extends Google_Service
{
    ...
    public function __construct(Google_Client $client)
    {
        ...
        $this->images = new Google_Service_Vision_Images_Resource($this, $this->serviceName, 'images', array('methods' => array('annotate' => array('path' => 'v1/images:annotate', 'httpMethod' => 'POST', 'parameters' => array()))));
    }
}
/*
 * Licensed under the Apache License, Version 2.0 (the "License"); you may not
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Vision', 'VendorDuplicator\\Google_Service_Vision', \false);
/**
...
class Google_Service_Vision_Images_Resource extends Google_Service_Resource
{
    ...
    public function annotate(Google_Service_Vision_BatchAnnotateImagesRequest $postBody, $optParams = array())
    {
        ...
        return $this->call('annotate', array($params), "VendorDuplicator\\Google_Service_Vision_BatchAnnotateImagesResponse");
    }
}
/**
 * The "images" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Vision_Images_Resource', 'VendorDuplicator\\Google_Service_Vision_Images_Resource', \false);
/** @internal */
class Google_Service_Vision_AnnotateImageRequest extends Google_Collection
{
    protected $collection_key = 'features';
    protected $internal_gapi_mappings = array();
    protected $featuresType = 'VendorDuplicator\\Google_Service_Vision_Feature';
    protected $featuresDataType = 'array';
    protected $imageType = 'VendorDuplicator\\Google_Service_Vision_Image';
    protected $imageDataType = '';
    protected $imageContextType = 'VendorDuplicator\\Google_Service_Vision_ImageContext';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Vision_AnnotateImageRequest', 'VendorDuplicator\\Google_Service_Vision_AnnotateImageRequest', \false);
/** @internal */
class Google_Service_Vision_AnnotateImageResponse extends Google_Collection
{
    protected $collection_key = 'textAnnotations';
    protected $internal_gapi_mappings = array();
    protected $errorType = 'VendorDuplicator\\Google_Service_Vision_Status';
    protected $errorDataType = '';
    protected $faceAnnotationsType = 'VendorDuplicator\\Google_Service_Vision_FaceAnnotation';
    protected $faceAnnotationsDataType = 'array';
    protected $imagePropertiesAnnotationType = 'VendorDuplicator\\Google_Service_Vision_ImageProperties';
    protected $imagePropertiesAnnotationDataType = '';
    protected $labelAnnotationsType = 'VendorDuplicator\\Google_Service_Vision_EntityAnnotation';
    protected $labelAnnotationsDataType = 'array';
    protected $landmarkAnnotationsType = 'VendorDuplicator\\Google_Service_Vision_EntityAnnotation';
    protected $landmarkAnnotationsDataType = 'array';
    protected $logoAnnotationsType = 'VendorDuplicator\\Google_Service_Vision_EntityAnnotation';
    protected $logoAnnotationsDataType = 'array';
    protected $safeSearchAnnotationType = 'VendorDuplicator\\Google_Service_Vision_SafeSearchAnnotation';
    protected $safeSearchAnnotationDataType = '';
    protected $textAnnotationsType = 'VendorDuplicator\\Google_Service_Vision_EntityAnnotation';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Vision_AnnotateImageResponse', 'VendorDuplicator\\Google_Service_Vision_AnnotateImageResponse', \false);
/** @internal */
class Google_Service_Vision_BatchAnnotateImagesRequest extends Google_Collection
{
    protected $collection_key = 'requests';
    protected $internal_gapi_mappings = array();
    protected $requestsType = 'VendorDuplicator\\Google_Service_Vision_AnnotateImageRequest';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Vision_BatchAnnotateImagesRequest', 'VendorDuplicator\\Google_Service_Vision_BatchAnnotateImagesRequest', \false);
/** @internal */
class Google_Service_Vision_BatchAnnotateImagesResponse extends Google_Collection
{
    protected $collection_key = 'responses';
    protected $internal_gapi_mappings = array();
    protected $responsesType = 'VendorDuplicator\\Google_Service_Vision_AnnotateImageResponse';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Vision_BatchAnnotateImagesResponse', 'VendorDuplicator\\Google_Service_Vision_BatchAnnotateImagesResponse', \false);
/** @internal */
class Google_Service_Vision_BoundingPoly extends Google_Collection
{
    protected $collection_key = 'vertices';
    protected $internal_gapi_mappings = array();
    protected $verticesType = 'VendorDuplicator\\Google_Service_Vision_Vertex';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Vision_BoundingPoly', 'VendorDuplicator\\Google_Service_Vision_BoundingPoly', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Vision_Color', 'VendorDuplicator\\Google_Service_Vision_Color', \false);
/** @internal */
class Google_Service_Vision_ColorInfo extends Google_Model
{
    protected $internal_gapi_mappings = array();
    protected $colorType = 'VendorDuplicator\\Google_Service_Vision_Color';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Vision_ColorInfo', 'VendorDuplicator\\Google_Service_Vision_ColorInfo', \false);
/** @internal */
class Google_Service_Vision_DominantColorsAnnotation extends Google_Collection
{
    protected $collection_key = 'colors';
    protected $internal_gapi_mappings = array();
    protected $colorsType = 'VendorDuplicator\\Google_Service_Vision_ColorInfo';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Vision_DominantColorsAnnotation', 'VendorDuplicator\\Google_Service_Vision_DominantColorsAnnotation', \false);
/** @internal */
class Google_Service_Vision_EntityAnnotation extends Google_Collection
{
    protected $collection_key = 'properties';
    protected $internal_gapi_mappings = array();
    protected $boundingPolyType = 'VendorDuplicator\\Google_Service_Vision_BoundingPoly';
    protected $boundingPolyDataType = '';
    public $confidence;
    public $description;
    public $locale;
    protected $locationsType = 'VendorDuplicator\\Google_Service_Vision_LocationInfo';
    protected $locationsDataType = 'array';
    public $mid;
    protected $propertiesType = 'VendorDuplicator\\Google_Service_Vision_Property';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Vision_EntityAnnotation', 'VendorDuplicator\\Google_Service_Vision_EntityAnnotation', \false);
/** @internal */
class Google_Service_Vision_FaceAnnotation extends Google_Collection
{
    ...
    protected $fdBoundingPolyType = 'VendorDuplicator\\Google_Service_Vision_BoundingPoly';
    protected $fdBoundingPolyDataType = '';
    public $headwearLikelihood;
    public $joyLikelihood;
    public $landmarkingConfidence;
    protected $landmarksType = 'VendorDuplicator\\Google_Service_Vision_Landmark';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Vision_FaceAnnotation', 'VendorDuplicator\\Google_Service_Vision_FaceAnnotation', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Vision_Feature', 'VendorDuplicator\\Google_Service_Vision_Feature', \false);
/** @internal */
class Google_Service_Vision_Image extends Google_Model
{
    protected $internal_gapi_mappings = array();
    public $content;
    protected $sourceType = 'VendorDuplicator\\Google_Service_Vision_ImageSource';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Vision_Image', 'VendorDuplicator\\Google_Service_Vision_Image', \false);
/** @internal */
class Google_Service_Vision_ImageContext extends Google_Collection
{
    ...
    protected $latLongRectType = 'VendorDuplicator\\Google_Service_Vision_LatLongRect';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Vision_ImageContext', 'VendorDuplicator\\Google_Service_Vision_ImageContext', \false);
/** @internal */
class Google_Service_Vision_ImageProperties extends Google_Model
{
    protected $internal_gapi_mappings = array();
    protected $dominantColorsType = 'VendorDuplicator\\Google_Service_Vision_DominantColorsAnnotation';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Vision_ImageProperties', 'VendorDuplicator\\Google_Service_Vision_ImageProperties', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Vision_ImageSource', 'VendorDuplicator\\Google_Service_Vision_ImageSource', \false);
/** @internal */
class Google_Service_Vision_Landmark extends Google_Model
{
    protected $internal_gapi_mappings = array();
    protected $positionType = 'VendorDuplicator\\Google_Service_Vision_Position';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Vision_Landmark', 'VendorDuplicator\\Google_Service_Vision_Landmark', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Vision_LatLng', 'VendorDuplicator\\Google_Service_Vision_LatLng', \false);
/** @internal */
class Google_Service_Vision_LatLongRect extends Google_Model
{
    protected $internal_gapi_mappings = array();
    protected $maxLatLngType = 'VendorDuplicator\\Google_Service_Vision_LatLng';
    protected $maxLatLngDataType = '';
    protected $minLatLngType = 'VendorDuplicator\\Google_Service_Vision_LatLng';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Vision_LatLongRect', 'VendorDuplicator\\Google_Service_Vision_LatLongRect', \false);
/** @internal */
class Google_Service_Vision_LocationInfo extends Google_Model
{
    protected $internal_gapi_mappings = array();
    protected $latLngType = 'VendorDuplicator\\Google_Service_Vision_LatLng';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Vision_LocationInfo', 'VendorDuplicator\\Google_Service_Vision_LocationInfo', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Vision_Position', 'VendorDuplicator\\Google_Service_Vision_Position', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Vision_Property', 'VendorDuplicator\\Google_Service_Vision_Property', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Vision_SafeSearchAnnotation', 'VendorDuplicator\\Google_Service_Vision_SafeSearchAnnotation', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Vision_Status', 'VendorDuplicator\\Google_Service_Vision_Status', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Vision_Vertex', 'VendorDuplicator\\Google_Service_Vision_Vertex', \false);
