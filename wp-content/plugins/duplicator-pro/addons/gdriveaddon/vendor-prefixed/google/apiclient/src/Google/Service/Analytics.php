...
class Google_Service_Analytics extends Google_Service
{
    ...
    public function __construct(Google_Client $client)
    {
        ...
        $this->data_ga = new Google_Service_Analytics_DataGa_Resource($this, $this->serviceName, 'ga', array('methods' => array('get' => array('path' => 'data/ga', 'httpMethod' => 'GET', 'parameters' => array('ids' => array('location' => 'query', 'type' => 'string', 'required' => \true), 'start-date' => array('location' => 'query', 'type' => 'string', 'required' => \true), 'end-date' => array('location' => 'query', 'type' => 'string', 'required' => \true), 'metrics' => array('location' => 'query', 'type' => 'string', 'required' => \true), 'dimensions' => array('location' => 'query', 'type' => 'string'), 'filters' => array('location' => 'query', 'type' => 'string'), 'include-empty-rows' => array('location' => 'query', 'type' => 'boolean'), 'max-results' => array('location' => 'query', 'type' => 'integer'), 'output' => array('location' => 'query', 'type' => 'string'), 'samplingLevel' => array('location' => 'query', 'type' => 'string'), 'segment' => array('location' => 'query', 'type' => 'string'), 'sort' => array('location' => 'query', 'type' => 'string'), 'start-index' => array('location' => 'query', 'type' => 'integer'))))));
        $this->data_mcf = new Google_Service_Analytics_DataMcf_Resource($this, $this->serviceName, 'mcf', array('methods' => array('get' => array('path' => 'data/mcf', 'httpMethod' => 'GET', 'parameters' => array('ids' => array('location' => 'query', 'type' => 'string', 'required' => \true), 'start-date' => array('location' => 'query', 'type' => 'string', 'required' => \true), 'end-date' => array('location' => 'query', 'type' => 'string', 'required' => \true), 'metrics' => array('location' => 'query', 'type' => 'string', 'required' => \true), 'dimensions' => array('location' => 'query', 'type' => 'string'), 'filters' => array('location' => 'query', 'type' => 'string'), 'max-results' => array('location' => 'query', 'type' => 'integer'), 'samplingLevel' => array('location' => 'query', 'type' => 'string'), 'sort' => array('location' => 'query', 'type' => 'string'), 'start-index' => array('location' => 'query', 'type' => 'integer'))))));
        $this->data_realtime = new Google_Service_Analytics_DataRealtime_Resource($this, $this->serviceName, 'realtime', array('methods' => array('get' => array('path' => 'data/realtime', 'httpMethod' => 'GET', 'parameters' => array('ids' => array('location' => 'query', 'type' => 'string', 'required' => \true), 'metrics' => array('location' => 'query', 'type' => 'string', 'required' => \true), 'dimensions' => array('location' => 'query', 'type' => 'string'), 'filters' => array('location' => 'query', 'type' => 'string'), 'max-results' => array('location' => 'query', 'type' => 'integer'), 'sort' => array('location' => 'query', 'type' => 'string'))))));
        ...
        $this->management_accountUserLinks = new Google_Service_Analytics_ManagementAccountUserLinks_Resource($this, $this->serviceName, 'accountUserLinks', array('methods' => array('delete' => array('path' => 'management/accounts/{accountId}/entityUserLinks/{linkId}', 'httpMethod' => 'DELETE', 'parameters' => array('accountId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'linkId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'insert' => array('path' => 'management/accounts/{accountId}/entityUserLinks', 'httpMethod' => 'POST', 'parameters' => array('accountId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'list' => array('path' => 'management/accounts/{accountId}/entityUserLinks', 'httpMethod' => 'GET', 'parameters' => array('accountId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'max-results' => array('location' => 'query', 'type' => 'integer'), 'start-index' => array('location' => 'query', 'type' => 'integer'))), 'update' => array('path' => 'management/accounts/{accountId}/entityUserLinks/{linkId}', 'httpMethod' => 'PUT', 'parameters' => array('accountId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'linkId' => array('location' => 'path', 'type' => 'string', 'required' => \true))))));
        ...
        $this->management_customDataSources = new Google_Service_Analytics_ManagementCustomDataSources_Resource($this, $this->serviceName, 'customDataSources', array('methods' => array('list' => array('path' => 'management/accounts/{accountId}/webproperties/{webPropertyId}/customDataSources', 'httpMethod' => 'GET', 'parameters' => array('accountId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'webPropertyId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'max-results' => array('location' => 'query', 'type' => 'integer'), 'start-index' => array('location' => 'query', 'type' => 'integer'))))));
        $this->management_customDimensions = new Google_Service_Analytics_ManagementCustomDimensions_Resource($this, $this->serviceName, 'customDimensions', array('methods' => array('get' => array('path' => 'management/accounts/{accountId}/webproperties/{webPropertyId}/customDimensions/{customDimensionId}', 'httpMethod' => 'GET', 'parameters' => array('accountId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'webPropertyId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'customDimensionId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'insert' => array('path' => 'management/accounts/{accountId}/webproperties/{webPropertyId}/customDimensions', 'httpMethod' => 'POST', 'parameters' => array('accountId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'webPropertyId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'list' => array('path' => 'management/accounts/{accountId}/webproperties/{webPropertyId}/customDimensions', 'httpMethod' => 'GET', 'parameters' => array('accountId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'webPropertyId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'max-results' => array('location' => 'query', 'type' => 'integer'), 'start-index' => array('location' => 'query', 'type' => 'integer'))), 'patch' => array('path' => 'management/accounts/{accountId}/webproperties/{webPropertyId}/customDimensions/{customDimensionId}', 'httpMethod' => 'PATCH', 'parameters' => array('accountId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'webPropertyId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'customDimensionId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'ignoreCustomDataSourceLinks' => array('location' => 'query', 'type' => 'boolean'))), 'update' => array('path' => 'management/accounts/{accountId}/webproperties/{webPropertyId}/customDimensions/{customDimensionId}', 'httpMethod' => 'PUT', 'parameters' => array('accountId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'webPropertyId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'customDimensionId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'ignoreCustomDataSourceLinks' => array('location' => 'query', 'type' => 'boolean'))))));
        $this->management_customMetrics = new Google_Service_Analytics_ManagementCustomMetrics_Resource($this, $this->serviceName, 'customMetrics', array('methods' => array('get' => array('path' => 'management/accounts/{accountId}/webproperties/{webPropertyId}/customMetrics/{customMetricId}', 'httpMethod' => 'GET', 'parameters' => array('accountId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'webPropertyId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'customMetricId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'insert' => array('path' => 'management/accounts/{accountId}/webproperties/{webPropertyId}/customMetrics', 'httpMethod' => 'POST', 'parameters' => array('accountId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'webPropertyId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'list' => array('path' => 'management/accounts/{accountId}/webproperties/{webPropertyId}/customMetrics', 'httpMethod' => 'GET', 'parameters' => array('accountId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'webPropertyId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'max-results' => array('location' => 'query', 'type' => 'integer'), 'start-index' => array('location' => 'query', 'type' => 'integer'))), 'patch' => array('path' => 'management/accounts/{accountId}/webproperties/{webPropertyId}/customMetrics/{customMetricId}', 'httpMethod' => 'PATCH', 'parameters' => array('accountId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'webPropertyId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'customMetricId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'ignoreCustomDataSourceLinks' => array('location' => 'query', 'type' => 'boolean'))), 'update' => array('path' => 'management/accounts/{accountId}/webproperties/{webPropertyId}/customMetrics/{customMetricId}', 'httpMethod' => 'PUT', 'parameters' => array('accountId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'webPropertyId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'customMetricId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'ignoreCustomDataSourceLinks' => array('location' => 'query', 'type' => 'boolean'))))));
        $this->management_experiments = new Google_Service_Analytics_ManagementExperiments_Resource($this, $this->serviceName, 'experiments', array('methods' => array('delete' => array('path' => 'management/accounts/{accountId}/webproperties/{webPropertyId}/profiles/{profileId}/experiments/{experimentId}', 'httpMethod' => 'DELETE', 'parameters' => array('accountId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'webPropertyId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'profileId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'experimentId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'get' => array('path' => 'management/accounts/{accountId}/webproperties/{webPropertyId}/profiles/{profileId}/experiments/{experimentId}', 'httpMethod' => 'GET', 'parameters' => array('accountId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'webPropertyId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'profileId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'experimentId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'insert' => array('path' => 'management/accounts/{accountId}/webproperties/{webPropertyId}/profiles/{profileId}/experiments', 'httpMethod' => 'POST', 'parameters' => array('accountId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'webPropertyId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'profileId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'list' => array('path' => 'management/accounts/{accountId}/webproperties/{webPropertyId}/profiles/{profileId}/experiments', 'httpMethod' => 'GET', 'parameters' => array('accountId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'webPropertyId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'profileId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'max-results' => array('location' => 'query', 'type' => 'integer'), 'start-index' => array('location' => 'query', 'type' => 'integer'))), 'patch' => array('path' => 'management/accounts/{accountId}/webproperties/{webPropertyId}/profiles/{profileId}/experiments/{experimentId}', 'httpMethod' => 'PATCH', 'parameters' => array('accountId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'webPropertyId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'profileId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'experimentId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'update' => array('path' => 'management/accounts/{accountId}/webproperties/{webPropertyId}/profiles/{profileId}/experiments/{experimentId}', 'httpMethod' => 'PUT', 'parameters' => array('accountId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'webPropertyId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'profileId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'experimentId' => array('location' => 'path', 'type' => 'string', 'required' => \true))))));
        $this->management_filters = new Google_Service_Analytics_ManagementFilters_Resource($this, $this->serviceName, 'filters', array('methods' => array('delete' => array('path' => 'management/accounts/{accountId}/filters/{filterId}', 'httpMethod' => 'DELETE', 'parameters' => array('accountId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'filterId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'get' => array('path' => 'management/accounts/{accountId}/filters/{filterId}', 'httpMethod' => 'GET', 'parameters' => array('accountId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'filterId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'insert' => array('path' => 'management/accounts/{accountId}/filters', 'httpMethod' => 'POST', 'parameters' => array('accountId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'list' => array('path' => 'management/accounts/{accountId}/filters', 'httpMethod' => 'GET', 'parameters' => array('accountId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'max-results' => array('location' => 'query', 'type' => 'integer'), 'start-index' => array('location' => 'query', 'type' => 'integer'))), 'patch' => array('path' => 'management/accounts/{accountId}/filters/{filterId}', 'httpMethod' => 'PATCH', 'parameters' => array('accountId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'filterId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'update' => array('path' => 'management/accounts/{accountId}/filters/{filterId}', 'httpMethod' => 'PUT', 'parameters' => array('accountId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'filterId' => array('location' => 'path', 'type' => 'string', 'required' => \true))))));
        $this->management_goals = new Google_Service_Analytics_ManagementGoals_Resource($this, $this->serviceName, 'goals', array('methods' => array('get' => array('path' => 'management/accounts/{accountId}/webproperties/{webPropertyId}/profiles/{profileId}/goals/{goalId}', 'httpMethod' => 'GET', 'parameters' => array('accountId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'webPropertyId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'profileId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'goalId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'insert' => array('path' => 'management/accounts/{accountId}/webproperties/{webPropertyId}/profiles/{profileId}/goals', 'httpMethod' => 'POST', 'parameters' => array('accountId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'webPropertyId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'profileId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'list' => array('path' => 'management/accounts/{accountId}/webproperties/{webPropertyId}/profiles/{profileId}/goals', 'httpMethod' => 'GET', 'parameters' => array('accountId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'webPropertyId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'profileId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'max-results' => array('location' => 'query', 'type' => 'integer'), 'start-index' => array('location' => 'query', 'type' => 'integer'))), 'patch' => array('path' => 'management/accounts/{accountId}/webproperties/{webPropertyId}/profiles/{profileId}/goals/{goalId}', 'httpMethod' => 'PATCH', 'parameters' => array('accountId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'webPropertyId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'profileId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'goalId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'update' => array('path' => 'management/accounts/{accountId}/webproperties/{webPropertyId}/profiles/{profileId}/goals/{goalId}', 'httpMethod' => 'PUT', 'parameters' => array('accountId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'webPropertyId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'profileId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'goalId' => array('location' => 'path', 'type' => 'string', 'required' => \true))))));
        ...
        $this->management_unsampledReports = new Google_Service_Analytics_ManagementUnsampledReports_Resource($this, $this->serviceName, 'unsampledReports', array('methods' => array('delete' => array('path' => 'management/accounts/{accountId}/webproperties/{webPropertyId}/profiles/{profileId}/unsampledReports/{unsampledReportId}', 'httpMethod' => 'DELETE', 'parameters' => array('accountId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'webPropertyId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'profileId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'unsampledReportId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'get' => array('path' => 'management/accounts/{accountId}/webproperties/{webPropertyId}/profiles/{profileId}/unsampledReports/{unsampledReportId}', 'httpMethod' => 'GET', 'parameters' => array('accountId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'webPropertyId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'profileId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'unsampledReportId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'insert' => array('path' => 'management/accounts/{accountId}/webproperties/{webPropertyId}/profiles/{profileId}/unsampledReports', 'httpMethod' => 'POST', 'parameters' => array('accountId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'webPropertyId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'profileId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'list' => array('path' => 'management/accounts/{accountId}/webproperties/{webPropertyId}/profiles/{profileId}/unsampledReports', 'httpMethod' => 'GET', 'parameters' => array('accountId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'webPropertyId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'profileId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'max-results' => array('location' => 'query', 'type' => 'integer'), 'start-index' => array('location' => 'query', 'type' => 'integer'))))));
        $this->management_uploads = new Google_Service_Analytics_ManagementUploads_Resource($this, $this->serviceName, 'uploads', array('methods' => array('deleteUploadData' => array('path' => 'management/accounts/{accountId}/webproperties/{webPropertyId}/customDataSources/{customDataSourceId}/deleteUploadData', 'httpMethod' => 'POST', 'parameters' => array('accountId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'webPropertyId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'customDataSourceId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'get' => array('path' => 'management/accounts/{accountId}/webproperties/{webPropertyId}/customDataSources/{customDataSourceId}/uploads/{uploadId}', 'httpMethod' => 'GET', 'parameters' => array('accountId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'webPropertyId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'customDataSourceId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'uploadId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'list' => array('path' => 'management/accounts/{accountId}/webproperties/{webPropertyId}/customDataSources/{customDataSourceId}/uploads', 'httpMethod' => 'GET', 'parameters' => array('accountId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'webPropertyId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'customDataSourceId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'max-results' => array('location' => 'query', 'type' => 'integer'), 'start-index' => array('location' => 'query', 'type' => 'integer'))), 'uploadData' => array('path' => 'management/accounts/{accountId}/webproperties/{webPropertyId}/customDataSources/{customDataSourceId}/uploads', 'httpMethod' => 'POST', 'parameters' => array('accountId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'webPropertyId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'customDataSourceId' => array('location' => 'path', 'type' => 'string', 'required' => \true))))));
        $this->management_webPropertyAdWordsLinks = new Google_Service_Analytics_ManagementWebPropertyAdWordsLinks_Resource($this, $this->serviceName, 'webPropertyAdWordsLinks', array('methods' => array('delete' => array('path' => 'management/accounts/{accountId}/webproperties/{webPropertyId}/entityAdWordsLinks/{webPropertyAdWordsLinkId}', 'httpMethod' => 'DELETE', 'parameters' => array('accountId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'webPropertyId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'webPropertyAdWordsLinkId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'get' => array('path' => 'management/accounts/{accountId}/webproperties/{webPropertyId}/entityAdWordsLinks/{webPropertyAdWordsLinkId}', 'httpMethod' => 'GET', 'parameters' => array('accountId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'webPropertyId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'webPropertyAdWordsLinkId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'insert' => array('path' => 'management/accounts/{accountId}/webproperties/{webPropertyId}/entityAdWordsLinks', 'httpMethod' => 'POST', 'parameters' => array('accountId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'webPropertyId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'list' => array('path' => 'management/accounts/{accountId}/webproperties/{webPropertyId}/entityAdWordsLinks', 'httpMethod' => 'GET', 'parameters' => array('accountId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'webPropertyId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'max-results' => array('location' => 'query', 'type' => 'integer'), 'start-index' => array('location' => 'query', 'type' => 'integer'))), 'patch' => array('path' => 'management/accounts/{accountId}/webproperties/{webPropertyId}/entityAdWordsLinks/{webPropertyAdWordsLinkId}', 'httpMethod' => 'PATCH', 'parameters' => array('accountId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'webPropertyId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'webPropertyAdWordsLinkId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'update' => array('path' => 'management/accounts/{accountId}/webproperties/{webPropertyId}/entityAdWordsLinks/{webPropertyAdWordsLinkId}', 'httpMethod' => 'PUT', 'parameters' => array('accountId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'webPropertyId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'webPropertyAdWordsLinkId' => array('location' => 'path', 'type' => 'string', 'required' => \true))))));
        $this->management_webproperties = new Google_Service_Analytics_ManagementWebproperties_Resource($this, $this->serviceName, 'webproperties', array('methods' => array('get' => array('path' => 'management/accounts/{accountId}/webproperties/{webPropertyId}', 'httpMethod' => 'GET', 'parameters' => array('accountId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'webPropertyId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'insert' => array('path' => 'management/accounts/{accountId}/webproperties', 'httpMethod' => 'POST', 'parameters' => array('accountId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'list' => array('path' => 'management/accounts/{accountId}/webproperties', 'httpMethod' => 'GET', 'parameters' => array('accountId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'max-results' => array('location' => 'query', 'type' => 'integer'), 'start-index' => array('location' => 'query', 'type' => 'integer'))), 'patch' => array('path' => 'management/accounts/{accountId}/webproperties/{webPropertyId}', 'httpMethod' => 'PATCH', 'parameters' => array('accountId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'webPropertyId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'update' => array('path' => 'management/accounts/{accountId}/webproperties/{webPropertyId}', 'httpMethod' => 'PUT', 'parameters' => array('accountId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'webPropertyId' => array('location' => 'path', 'type' => 'string', 'required' => \true))))));
        $this->management_webpropertyUserLinks = new Google_Service_Analytics_ManagementWebpropertyUserLinks_Resource($this, $this->serviceName, 'webpropertyUserLinks', array('methods' => array('delete' => array('path' => 'management/accounts/{accountId}/webproperties/{webPropertyId}/entityUserLinks/{linkId}', 'httpMethod' => 'DELETE', 'parameters' => array('accountId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'webPropertyId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'linkId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'insert' => array('path' => 'management/accounts/{accountId}/webproperties/{webPropertyId}/entityUserLinks', 'httpMethod' => 'POST', 'parameters' => array('accountId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'webPropertyId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'list' => array('path' => 'management/accounts/{accountId}/webproperties/{webPropertyId}/entityUserLinks', 'httpMethod' => 'GET', 'parameters' => array('accountId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'webPropertyId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'max-results' => array('location' => 'query', 'type' => 'integer'), 'start-index' => array('location' => 'query', 'type' => 'integer'))), 'update' => array('path' => 'management/accounts/{accountId}/webproperties/{webPropertyId}/entityUserLinks/{linkId}', 'httpMethod' => 'PUT', 'parameters' => array('accountId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'webPropertyId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'linkId' => array('location' => 'path', 'type' => 'string', 'required' => \true))))));
        $this->metadata_columns = new Google_Service_Analytics_MetadataColumns_Resource($this, $this->serviceName, 'columns', array('methods' => array('list' => array('path' => 'metadata/{reportType}/columns', 'httpMethod' => 'GET', 'parameters' => array('reportType' => array('location' => 'path', 'type' => 'string', 'required' => \true))))));
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Analytics', 'VendorDuplicator\\Google_Service_Analytics', \false);
/**
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Analytics_Data_Resource', 'VendorDuplicator\\Google_Service_Analytics_Data_Resource', \false);
/**
...
class Google_Service_Analytics_DataGa_Resource extends Google_Service_Resource
{
    ...
    public function get($ids, $startDate, $endDate, $metrics, $optParams = array())
    {
        ...
        return $this->call('get', array($params), "VendorDuplicator\\Google_Service_Analytics_GaData");
    }
}
/**
 * The "ga" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Analytics_DataGa_Resource', 'VendorDuplicator\\Google_Service_Analytics_DataGa_Resource', \false);
/**
...
class Google_Service_Analytics_DataMcf_Resource extends Google_Service_Resource
{
    ...
    public function get($ids, $startDate, $endDate, $metrics, $optParams = array())
    {
        $params = array('ids' => $ids, 'start-date' => $startDate, 'end-date' => $endDate, 'metrics' => $metrics);
        $params = \array_merge($params, $optParams);
        return $this->call('get', array($params), "VendorDuplicator\\Google_Service_Analytics_McfData");
    }
}
/**
 * The "mcf" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Analytics_DataMcf_Resource', 'VendorDuplicator\\Google_Service_Analytics_DataMcf_Resource', \false);
/**
...
class Google_Service_Analytics_DataRealtime_Resource extends Google_Service_Resource
{
    ...
    public function get($ids, $metrics, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('get', array($params), "VendorDuplicator\\Google_Service_Analytics_RealtimeData");
    }
}
/**
 * The "realtime" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Analytics_DataRealtime_Resource', 'VendorDuplicator\\Google_Service_Analytics_DataRealtime_Resource', \false);
/**
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Analytics_Management_Resource', 'VendorDuplicator\\Google_Service_Analytics_Management_Resource', \false);
/**
...
class Google_Service_Analytics_ManagementAccountSummaries_Resource extends Google_Service_Resource
{
    ...
    public function listManagementAccountSummaries($optParams = array())
    {
        $params = array();
        $params = \array_merge($params, $optParams);
        return $this->call('list', array($params), "VendorDuplicator\\Google_Service_Analytics_AccountSummaries");
    }
}
/**
 * The "accountSummaries" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Analytics_ManagementAccountSummaries_Resource', 'VendorDuplicator\\Google_Service_Analytics_ManagementAccountSummaries_Resource', \false);
/**
...
class Google_Service_Analytics_ManagementAccountUserLinks_Resource extends Google_Service_Resource
{
    ...
    public function insert($accountId, Google_Service_Analytics_EntityUserLink $postBody, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('insert', array($params), "VendorDuplicator\\Google_Service_Analytics_EntityUserLink");
    }
    /**
    ...
    public function listManagementAccountUserLinks($accountId, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('list', array($params), "VendorDuplicator\\Google_Service_Analytics_EntityUserLinks");
    }
    /**
    ...
    public function update($accountId, $linkId, Google_Service_Analytics_EntityUserLink $postBody, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('update', array($params), "VendorDuplicator\\Google_Service_Analytics_EntityUserLink");
    }
}
/**
 * The "accountUserLinks" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Analytics_ManagementAccountUserLinks_Resource', 'VendorDuplicator\\Google_Service_Analytics_ManagementAccountUserLinks_Resource', \false);
/**
...
class Google_Service_Analytics_ManagementAccounts_Resource extends Google_Service_Resource
{
    ...
    public function listManagementAccounts($optParams = array())
    {
        $params = array();
        $params = \array_merge($params, $optParams);
        return $this->call('list', array($params), "VendorDuplicator\\Google_Service_Analytics_Accounts");
    }
}
/**
 * The "accounts" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Analytics_ManagementAccounts_Resource', 'VendorDuplicator\\Google_Service_Analytics_ManagementAccounts_Resource', \false);
/**
...
class Google_Service_Analytics_ManagementCustomDataSources_Resource extends Google_Service_Resource
{
    ...
    public function listManagementCustomDataSources($accountId, $webPropertyId, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('list', array($params), "VendorDuplicator\\Google_Service_Analytics_CustomDataSources");
    }
}
/**
 * The "customDataSources" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Analytics_ManagementCustomDataSources_Resource', 'VendorDuplicator\\Google_Service_Analytics_ManagementCustomDataSources_Resource', \false);
/**
...
class Google_Service_Analytics_ManagementCustomDimensions_Resource extends Google_Service_Resource
{
    ...
    public function get($accountId, $webPropertyId, $customDimensionId, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('get', array($params), "VendorDuplicator\\Google_Service_Analytics_CustomDimension");
    }
    /**
    ...
    public function insert($accountId, $webPropertyId, Google_Service_Analytics_CustomDimension $postBody, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('insert', array($params), "VendorDuplicator\\Google_Service_Analytics_CustomDimension");
    }
    /**
    ...
    public function listManagementCustomDimensions($accountId, $webPropertyId, $optParams = array())
    {
        $params = array('accountId' => $accountId, 'webPropertyId' => $webPropertyId);
        $params = \array_merge($params, $optParams);
        return $this->call('list', array($params), "VendorDuplicator\\Google_Service_Analytics_CustomDimensions");
    }
    /**
    ...
    public function patch($accountId, $webPropertyId, $customDimensionId, Google_Service_Analytics_CustomDimension $postBody, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('patch', array($params), "VendorDuplicator\\Google_Service_Analytics_CustomDimension");
    }
    /**
    ...
    public function update($accountId, $webPropertyId, $customDimensionId, Google_Service_Analytics_CustomDimension $postBody, $optParams = array())
    {
        $params = array('accountId' => $accountId, 'webPropertyId' => $webPropertyId, 'customDimensionId' => $customDimensionId, 'postBody' => $postBody);
        $params = \array_merge($params, $optParams);
        return $this->call('update', array($params), "VendorDuplicator\\Google_Service_Analytics_CustomDimension");
    }
}
/**
 * The "customDimensions" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Analytics_ManagementCustomDimensions_Resource', 'VendorDuplicator\\Google_Service_Analytics_ManagementCustomDimensions_Resource', \false);
/**
...
class Google_Service_Analytics_ManagementCustomMetrics_Resource extends Google_Service_Resource
{
    ...
    public function get($accountId, $webPropertyId, $customMetricId, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('get', array($params), "VendorDuplicator\\Google_Service_Analytics_CustomMetric");
    }
    /**
    ...
    public function insert($accountId, $webPropertyId, Google_Service_Analytics_CustomMetric $postBody, $optParams = array())
    {
        $params = array('accountId' => $accountId, 'webPropertyId' => $webPropertyId, 'postBody' => $postBody);
        $params = \array_merge($params, $optParams);
        return $this->call('insert', array($params), "VendorDuplicator\\Google_Service_Analytics_CustomMetric");
    }
    /**
    ...
    public function listManagementCustomMetrics($accountId, $webPropertyId, $optParams = array())
    {
        $params = array('accountId' => $accountId, 'webPropertyId' => $webPropertyId);
        $params = \array_merge($params, $optParams);
        return $this->call('list', array($params), "VendorDuplicator\\Google_Service_Analytics_CustomMetrics");
    }
    /**
    ...
    public function patch($accountId, $webPropertyId, $customMetricId, Google_Service_Analytics_CustomMetric $postBody, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('patch', array($params), "VendorDuplicator\\Google_Service_Analytics_CustomMetric");
    }
    /**
    ...
    public function update($accountId, $webPropertyId, $customMetricId, Google_Service_Analytics_CustomMetric $postBody, $optParams = array())
    {
        $params = array('accountId' => $accountId, 'webPropertyId' => $webPropertyId, 'customMetricId' => $customMetricId, 'postBody' => $postBody);
        $params = \array_merge($params, $optParams);
        return $this->call('update', array($params), "VendorDuplicator\\Google_Service_Analytics_CustomMetric");
    }
}
/**
 * The "customMetrics" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Analytics_ManagementCustomMetrics_Resource', 'VendorDuplicator\\Google_Service_Analytics_ManagementCustomMetrics_Resource', \false);
/**
...
class Google_Service_Analytics_ManagementExperiments_Resource extends Google_Service_Resource
{
    ...
    public function get($accountId, $webPropertyId, $profileId, $experimentId, $optParams = array())
    {
        $params = array('accountId' => $accountId, 'webPropertyId' => $webPropertyId, 'profileId' => $profileId, 'experimentId' => $experimentId);
        $params = \array_merge($params, $optParams);
        return $this->call('get', array($params), "VendorDuplicator\\Google_Service_Analytics_Experiment");
    }
    /**
    ...
    public function insert($accountId, $webPropertyId, $profileId, Google_Service_Analytics_Experiment $postBody, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('insert', array($params), "VendorDuplicator\\Google_Service_Analytics_Experiment");
    }
    /**
    ...
    public function listManagementExperiments($accountId, $webPropertyId, $profileId, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('list', array($params), "VendorDuplicator\\Google_Service_Analytics_Experiments");
    }
    /**
    ...
    public function patch($accountId, $webPropertyId, $profileId, $experimentId, Google_Service_Analytics_Experiment $postBody, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('patch', array($params), "VendorDuplicator\\Google_Service_Analytics_Experiment");
    }
    /**
    ...
    public function update($accountId, $webPropertyId, $profileId, $experimentId, Google_Service_Analytics_Experiment $postBody, $optParams = array())
    {
        $params = array('accountId' => $accountId, 'webPropertyId' => $webPropertyId, 'profileId' => $profileId, 'experimentId' => $experimentId, 'postBody' => $postBody);
        $params = \array_merge($params, $optParams);
        return $this->call('update', array($params), "VendorDuplicator\\Google_Service_Analytics_Experiment");
    }
}
/**
 * The "experiments" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Analytics_ManagementExperiments_Resource', 'VendorDuplicator\\Google_Service_Analytics_ManagementExperiments_Resource', \false);
/**
...
class Google_Service_Analytics_ManagementFilters_Resource extends Google_Service_Resource
{
    ...
    public function delete($accountId, $filterId, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('delete', array($params), "VendorDuplicator\\Google_Service_Analytics_Filter");
    }
    /**
    ...
    public function get($accountId, $filterId, $optParams = array())
    {
        $params = array('accountId' => $accountId, 'filterId' => $filterId);
        $params = \array_merge($params, $optParams);
        return $this->call('get', array($params), "VendorDuplicator\\Google_Service_Analytics_Filter");
    }
    /**
    ...
    public function insert($accountId, Google_Service_Analytics_Filter $postBody, $optParams = array())
    {
        $params = array('accountId' => $accountId, 'postBody' => $postBody);
        $params = \array_merge($params, $optParams);
        return $this->call('insert', array($params), "VendorDuplicator\\Google_Service_Analytics_Filter");
    }
    /**
    ...
    public function listManagementFilters($accountId, $optParams = array())
    {
        $params = array('accountId' => $accountId);
        $params = \array_merge($params, $optParams);
        return $this->call('list', array($params), "VendorDuplicator\\Google_Service_Analytics_Filters");
    }
    /**
    ...
    public function patch($accountId, $filterId, Google_Service_Analytics_Filter $postBody, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('patch', array($params), "VendorDuplicator\\Google_Service_Analytics_Filter");
    }
    /**
    ...
    public function update($accountId, $filterId, Google_Service_Analytics_Filter $postBody, $optParams = array())
    {
        $params = array('accountId' => $accountId, 'filterId' => $filterId, 'postBody' => $postBody);
        $params = \array_merge($params, $optParams);
        return $this->call('update', array($params), "VendorDuplicator\\Google_Service_Analytics_Filter");
    }
}
/**
 * The "filters" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Analytics_ManagementFilters_Resource', 'VendorDuplicator\\Google_Service_Analytics_ManagementFilters_Resource', \false);
/**
...
class Google_Service_Analytics_ManagementGoals_Resource extends Google_Service_Resource
{
    ...
    public function get($accountId, $webPropertyId, $profileId, $goalId, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('get', array($params), "VendorDuplicator\\Google_Service_Analytics_Goal");
    }
    /**
    ...
    public function insert($accountId, $webPropertyId, $profileId, Google_Service_Analytics_Goal $postBody, $optParams = array())
    {
        $params = array('accountId' => $accountId, 'webPropertyId' => $webPropertyId, 'profileId' => $profileId, 'postBody' => $postBody);
        $params = \array_merge($params, $optParams);
        return $this->call('insert', array($params), "VendorDuplicator\\Google_Service_Analytics_Goal");
    }
    /**
    ...
    public function listManagementGoals($accountId, $webPropertyId, $profileId, $optParams = array())
    {
        $params = array('accountId' => $accountId, 'webPropertyId' => $webPropertyId, 'profileId' => $profileId);
        $params = \array_merge($params, $optParams);
        return $this->call('list', array($params), "VendorDuplicator\\Google_Service_Analytics_Goals");
    }
    /**
    ...
    public function patch($accountId, $webPropertyId, $profileId, $goalId, Google_Service_Analytics_Goal $postBody, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('patch', array($params), "VendorDuplicator\\Google_Service_Analytics_Goal");
    }
    /**
    ...
    public function update($accountId, $webPropertyId, $profileId, $goalId, Google_Service_Analytics_Goal $postBody, $optParams = array())
    {
        $params = array('accountId' => $accountId, 'webPropertyId' => $webPropertyId, 'profileId' => $profileId, 'goalId' => $goalId, 'postBody' => $postBody);
        $params = \array_merge($params, $optParams);
        return $this->call('update', array($params), "VendorDuplicator\\Google_Service_Analytics_Goal");
    }
}
/**
 * The "goals" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Analytics_ManagementGoals_Resource', 'VendorDuplicator\\Google_Service_Analytics_ManagementGoals_Resource', \false);
/**
...
class Google_Service_Analytics_ManagementProfileFilterLinks_Resource extends Google_Service_Resource
{
    ...
    public function get($accountId, $webPropertyId, $profileId, $linkId, $optParams = array())
    {
        $params = array('accountId' => $accountId, 'webPropertyId' => $webPropertyId, 'profileId' => $profileId, 'linkId' => $linkId);
        $params = \array_merge($params, $optParams);
        return $this->call('get', array($params), "VendorDuplicator\\Google_Service_Analytics_ProfileFilterLink");
    }
    /**
    ...
    public function insert($accountId, $webPropertyId, $profileId, Google_Service_Analytics_ProfileFilterLink $postBody, $optParams = array())
    {
        $params = array('accountId' => $accountId, 'webPropertyId' => $webPropertyId, 'profileId' => $profileId, 'postBody' => $postBody);
        $params = \array_merge($params, $optParams);
        return $this->call('insert', array($params), "VendorDuplicator\\Google_Service_Analytics_ProfileFilterLink");
    }
    /**
    ...
    public function listManagementProfileFilterLinks($accountId, $webPropertyId, $profileId, $optParams = array())
    {
        $params = array('accountId' => $accountId, 'webPropertyId' => $webPropertyId, 'profileId' => $profileId);
        $params = \array_merge($params, $optParams);
        return $this->call('list', array($params), "VendorDuplicator\\Google_Service_Analytics_ProfileFilterLinks");
    }
    /**
    ...
    public function patch($accountId, $webPropertyId, $profileId, $linkId, Google_Service_Analytics_ProfileFilterLink $postBody, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('patch', array($params), "VendorDuplicator\\Google_Service_Analytics_ProfileFilterLink");
    }
    /**
    ...
    public function update($accountId, $webPropertyId, $profileId, $linkId, Google_Service_Analytics_ProfileFilterLink $postBody, $optParams = array())
    {
        $params = array('accountId' => $accountId, 'webPropertyId' => $webPropertyId, 'profileId' => $profileId, 'linkId' => $linkId, 'postBody' => $postBody);
        $params = \array_merge($params, $optParams);
        return $this->call('update', array($params), "VendorDuplicator\\Google_Service_Analytics_ProfileFilterLink");
    }
}
/**
 * The "profileFilterLinks" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Analytics_ManagementProfileFilterLinks_Resource', 'VendorDuplicator\\Google_Service_Analytics_ManagementProfileFilterLinks_Resource', \false);
/**
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Analytics_ManagementProfileUserLinks_Resource', 'VendorDuplicator\\Google_Service_Analytics_ManagementProfileUserLinks_Resource', \false);
/**
...
class Google_Service_Analytics_ManagementProfiles_Resource extends Google_Service_Resource
{
    ...
    public function get($accountId, $webPropertyId, $profileId, $optParams = array())
    {
        $params = array('accountId' => $accountId, 'webPropertyId' => $webPropertyId, 'profileId' => $profileId);
        $params = \array_merge($params, $optParams);
        return $this->call('get', array($params), "VendorDuplicator\\Google_Service_Analytics_Profile");
    }
    /**
    ...
    public function insert($accountId, $webPropertyId, Google_Service_Analytics_Profile $postBody, $optParams = array())
    {
        $params = array('accountId' => $accountId, 'webPropertyId' => $webPropertyId, 'postBody' => $postBody);
        $params = \array_merge($params, $optParams);
        return $this->call('insert', array($params), "VendorDuplicator\\Google_Service_Analytics_Profile");
    }
    /**
    ...
    public function listManagementProfiles($accountId, $webPropertyId, $optParams = array())
    {
        $params = array('accountId' => $accountId, 'webPropertyId' => $webPropertyId);
        $params = \array_merge($params, $optParams);
        return $this->call('list', array($params), "VendorDuplicator\\Google_Service_Analytics_Profiles");
    }
    /**
     * Updates an existing view (profile). This method supports patch semantics.
     * (profiles.patch)
    ...
    public function patch($accountId, $webPropertyId, $profileId, Google_Service_Analytics_Profile $postBody, $optParams = array())
    {
        $params = array('accountId' => $accountId, 'webPropertyId' => $webPropertyId, 'profileId' => $profileId, 'postBody' => $postBody);
        $params = \array_merge($params, $optParams);
        return $this->call('patch', array($params), "VendorDuplicator\\Google_Service_Analytics_Profile");
    }
    /**
    ...
    public function update($accountId, $webPropertyId, $profileId, Google_Service_Analytics_Profile $postBody, $optParams = array())
    {
        $params = array('accountId' => $accountId, 'webPropertyId' => $webPropertyId, 'profileId' => $profileId, 'postBody' => $postBody);
        $params = \array_merge($params, $optParams);
        return $this->call('update', array($params), "VendorDuplicator\\Google_Service_Analytics_Profile");
    }
}
/**
 * The "profiles" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Analytics_ManagementProfiles_Resource', 'VendorDuplicator\\Google_Service_Analytics_ManagementProfiles_Resource', \false);
/**
...
class Google_Service_Analytics_ManagementSegments_Resource extends Google_Service_Resource
{
    ...
    public function listManagementSegments($optParams = array())
    {
        $params = array();
        $params = \array_merge($params, $optParams);
        return $this->call('list', array($params), "VendorDuplicator\\Google_Service_Analytics_Segments");
    }
}
/**
 * The "segments" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Analytics_ManagementSegments_Resource', 'VendorDuplicator\\Google_Service_Analytics_ManagementSegments_Resource', \false);
/**
...
class Google_Service_Analytics_ManagementUnsampledReports_Resource extends Google_Service_Resource
{
    ...
    public function get($accountId, $webPropertyId, $profileId, $unsampledReportId, $optParams = array())
    {
        $params = array('accountId' => $accountId, 'webPropertyId' => $webPropertyId, 'profileId' => $profileId, 'unsampledReportId' => $unsampledReportId);
        $params = \array_merge($params, $optParams);
        return $this->call('get', array($params), "VendorDuplicator\\Google_Service_Analytics_UnsampledReport");
    }
    /**
    ...
    public function insert($accountId, $webPropertyId, $profileId, Google_Service_Analytics_UnsampledReport $postBody, $optParams = array())
    {
        $params = array('accountId' => $accountId, 'webPropertyId' => $webPropertyId, 'profileId' => $profileId, 'postBody' => $postBody);
        $params = \array_merge($params, $optParams);
        return $this->call('insert', array($params), "VendorDuplicator\\Google_Service_Analytics_UnsampledReport");
    }
    /**
    ...
    public function listManagementUnsampledReports($accountId, $webPropertyId, $profileId, $optParams = array())
    {
        $params = array('accountId' => $accountId, 'webPropertyId' => $webPropertyId, 'profileId' => $profileId);
        $params = \array_merge($params, $optParams);
        return $this->call('list', array($params), "VendorDuplicator\\Google_Service_Analytics_UnsampledReports");
    }
}
/**
 * The "unsampledReports" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Analytics_ManagementUnsampledReports_Resource', 'VendorDuplicator\\Google_Service_Analytics_ManagementUnsampledReports_Resource', \false);
/**
...
class Google_Service_Analytics_ManagementUploads_Resource extends Google_Service_Resource
{
    ...
    public function get($accountId, $webPropertyId, $customDataSourceId, $uploadId, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('get', array($params), "VendorDuplicator\\Google_Service_Analytics_Upload");
    }
    /**
    ...
    public function listManagementUploads($accountId, $webPropertyId, $customDataSourceId, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('list', array($params), "VendorDuplicator\\Google_Service_Analytics_Uploads");
    }
    /**
    ...
    public function uploadData($accountId, $webPropertyId, $customDataSourceId, $optParams = array())
    {
        $params = array('accountId' => $accountId, 'webPropertyId' => $webPropertyId, 'customDataSourceId' => $customDataSourceId);
        $params = \array_merge($params, $optParams);
        return $this->call('uploadData', array($params), "VendorDuplicator\\Google_Service_Analytics_Upload");
    }
}
/**
 * The "uploads" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Analytics_ManagementUploads_Resource', 'VendorDuplicator\\Google_Service_Analytics_ManagementUploads_Resource', \false);
/**
...
class Google_Service_Analytics_ManagementWebPropertyAdWordsLinks_Resource extends Google_Service_Resource
{
    ...
    public function get($accountId, $webPropertyId, $webPropertyAdWordsLinkId, $optParams = array())
    {
        $params = array('accountId' => $accountId, 'webPropertyId' => $webPropertyId, 'webPropertyAdWordsLinkId' => $webPropertyAdWordsLinkId);
        $params = \array_merge($params, $optParams);
        return $this->call('get', array($params), "VendorDuplicator\\Google_Service_Analytics_EntityAdWordsLink");
    }
    /**
    ...
    public function insert($accountId, $webPropertyId, Google_Service_Analytics_EntityAdWordsLink $postBody, $optParams = array())
    {
        $params = array('accountId' => $accountId, 'webPropertyId' => $webPropertyId, 'postBody' => $postBody);
        $params = \array_merge($params, $optParams);
        return $this->call('insert', array($params), "VendorDuplicator\\Google_Service_Analytics_EntityAdWordsLink");
    }
    /**
    ...
    public function listManagementWebPropertyAdWordsLinks($accountId, $webPropertyId, $optParams = array())
    {
        $params = array('accountId' => $accountId, 'webPropertyId' => $webPropertyId);
        $params = \array_merge($params, $optParams);
        return $this->call('list', array($params), "VendorDuplicator\\Google_Service_Analytics_EntityAdWordsLinks");
    }
    /**
    ...
    public function patch($accountId, $webPropertyId, $webPropertyAdWordsLinkId, Google_Service_Analytics_EntityAdWordsLink $postBody, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('patch', array($params), "VendorDuplicator\\Google_Service_Analytics_EntityAdWordsLink");
    }
    /**
    ...
    public function update($accountId, $webPropertyId, $webPropertyAdWordsLinkId, Google_Service_Analytics_EntityAdWordsLink $postBody, $optParams = array())
    {
        $params = array('accountId' => $accountId, 'webPropertyId' => $webPropertyId, 'webPropertyAdWordsLinkId' => $webPropertyAdWordsLinkId, 'postBody' => $postBody);
        $params = \array_merge($params, $optParams);
        return $this->call('update', array($params), "VendorDuplicator\\Google_Service_Analytics_EntityAdWordsLink");
    }
}
/**
 * The "webPropertyAdWordsLinks" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Analytics_ManagementWebPropertyAdWordsLinks_Resource', 'VendorDuplicator\\Google_Service_Analytics_ManagementWebPropertyAdWordsLinks_Resource', \false);
/**
...
class Google_Service_Analytics_ManagementWebproperties_Resource extends Google_Service_Resource
{
    ...
    public function get($accountId, $webPropertyId, $optParams = array())
    {
        $params = array('accountId' => $accountId, 'webPropertyId' => $webPropertyId);
        $params = \array_merge($params, $optParams);
        return $this->call('get', array($params), "VendorDuplicator\\Google_Service_Analytics_Webproperty");
    }
    /**
    ...
    public function insert($accountId, Google_Service_Analytics_Webproperty $postBody, $optParams = array())
    {
        $params = array('accountId' => $accountId, 'postBody' => $postBody);
        $params = \array_merge($params, $optParams);
        return $this->call('insert', array($params), "VendorDuplicator\\Google_Service_Analytics_Webproperty");
    }
    /**
    ...
    public function listManagementWebproperties($accountId, $optParams = array())
    {
        $params = array('accountId' => $accountId);
        $params = \array_merge($params, $optParams);
        return $this->call('list', array($params), "VendorDuplicator\\Google_Service_Analytics_Webproperties");
    }
    /**
    ...
    public function patch($accountId, $webPropertyId, Google_Service_Analytics_Webproperty $postBody, $optParams = array())
    {
        $params = array('accountId' => $accountId, 'webPropertyId' => $webPropertyId, 'postBody' => $postBody);
        $params = \array_merge($params, $optParams);
        return $this->call('patch', array($params), "VendorDuplicator\\Google_Service_Analytics_Webproperty");
    }
    /**
    ...
    public function update($accountId, $webPropertyId, Google_Service_Analytics_Webproperty $postBody, $optParams = array())
    {
        $params = array('accountId' => $accountId, 'webPropertyId' => $webPropertyId, 'postBody' => $postBody);
        $params = \array_merge($params, $optParams);
        return $this->call('update', array($params), "VendorDuplicator\\Google_Service_Analytics_Webproperty");
    }
}
/**
 * The "webproperties" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Analytics_ManagementWebproperties_Resource', 'VendorDuplicator\\Google_Service_Analytics_ManagementWebproperties_Resource', \false);
/**
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Analytics_ManagementWebpropertyUserLinks_Resource', 'VendorDuplicator\\Google_Service_Analytics_ManagementWebpropertyUserLinks_Resource', \false);
/**
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Analytics_Metadata_Resource', 'VendorDuplicator\\Google_Service_Analytics_Metadata_Resource', \false);
/**
...
class Google_Service_Analytics_MetadataColumns_Resource extends Google_Service_Resource
{
    ...
    public function listMetadataColumns($reportType, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('list', array($params), "VendorDuplicator\\Google_Service_Analytics_Columns");
    }
}
/**
 * The "columns" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Analytics_MetadataColumns_Resource', 'VendorDuplicator\\Google_Service_Analytics_MetadataColumns_Resource', \false);
/**
...
class Google_Service_Analytics_Provisioning_Resource extends Google_Service_Resource
{
    ...
    public function createAccountTicket(Google_Service_Analytics_AccountTicket $postBody, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('createAccountTicket', array($params), "VendorDuplicator\\Google_Service_Analytics_AccountTicket");
    }
}
/**
 * The "provisioning" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Analytics_Provisioning_Resource', 'VendorDuplicator\\Google_Service_Analytics_Provisioning_Resource', \false);
/** @internal */
class Google_Service_Analytics_Account extends Google_Model
{
    protected $internal_gapi_mappings = array();
    protected $childLinkType = 'VendorDuplicator\\Google_Service_Analytics_AccountChildLink';
    protected $childLinkDataType = '';
    public $created;
    public $id;
    public $kind;
    public $name;
    protected $permissionsType = 'VendorDuplicator\\Google_Service_Analytics_AccountPermissions';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Analytics_Account', 'VendorDuplicator\\Google_Service_Analytics_Account', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Analytics_AccountChildLink', 'VendorDuplicator\\Google_Service_Analytics_AccountChildLink', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Analytics_AccountPermissions', 'VendorDuplicator\\Google_Service_Analytics_AccountPermissions', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Analytics_AccountRef', 'VendorDuplicator\\Google_Service_Analytics_AccountRef', \false);
/** @internal */
class Google_Service_Analytics_AccountSummaries extends Google_Collection
{
    protected $collection_key = 'items';
    protected $internal_gapi_mappings = array();
    protected $itemsType = 'VendorDuplicator\\Google_Service_Analytics_AccountSummary';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Analytics_AccountSummaries', 'VendorDuplicator\\Google_Service_Analytics_AccountSummaries', \false);
/** @internal */
class Google_Service_Analytics_AccountSummary extends Google_Collection
{
    ...
    public $kind;
    public $name;
    protected $webPropertiesType = 'VendorDuplicator\\Google_Service_Analytics_WebPropertySummary';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Analytics_AccountSummary', 'VendorDuplicator\\Google_Service_Analytics_AccountSummary', \false);
/** @internal */
class Google_Service_Analytics_AccountTicket extends Google_Model
{
    protected $internal_gapi_mappings = array();
    protected $accountType = 'VendorDuplicator\\Google_Service_Analytics_Account';
    protected $accountDataType = '';
    public $id;
    public $kind;
    protected $profileType = 'VendorDuplicator\\Google_Service_Analytics_Profile';
    protected $profileDataType = '';
    public $redirectUri;
    protected $webpropertyType = 'VendorDuplicator\\Google_Service_Analytics_Webproperty';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Analytics_AccountTicket', 'VendorDuplicator\\Google_Service_Analytics_AccountTicket', \false);
/** @internal */
class Google_Service_Analytics_Accounts extends Google_Collection
{
    protected $collection_key = 'items';
    protected $internal_gapi_mappings = array();
    protected $itemsType = 'VendorDuplicator\\Google_Service_Analytics_Account';
    protected $itemsDataType = 'array';
    public $itemsPerPage;
    public $kind;
    public $nextLink;
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Analytics_Accounts', 'VendorDuplicator\\Google_Service_Analytics_Accounts', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Analytics_AdWordsAccount', 'VendorDuplicator\\Google_Service_Analytics_AdWordsAccount', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Analytics_AnalyticsDataimportDeleteUploadDataRequest', 'VendorDuplicator\\Google_Service_Analytics_AnalyticsDataimportDeleteUploadDataRequest', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Analytics_Column', 'VendorDuplicator\\Google_Service_Analytics_Column', \false);
/** @internal */
class Google_Service_Analytics_Columns extends Google_Collection
{
    ...
    public $etag;
    protected $itemsType = 'VendorDuplicator\\Google_Service_Analytics_Column';
    protected $itemsDataType = 'array';
    public $kind;
    public $totalResults;
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Analytics_Columns', 'VendorDuplicator\\Google_Service_Analytics_Columns', \false);
/** @internal */
class Google_Service_Analytics_CustomDataSource extends Google_Collection
{
    ...
    protected $internal_gapi_mappings = array();
    public $accountId;
    protected $childLinkType = 'VendorDuplicator\\Google_Service_Analytics_CustomDataSourceChildLink';
    protected $childLinkDataType = '';
    public $created;
    public $description;
    public $id;
    ...
    public $kind;
    public $name;
    protected $parentLinkType = 'VendorDuplicator\\Google_Service_Analytics_CustomDataSourceParentLink';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Analytics_CustomDataSource', 'VendorDuplicator\\Google_Service_Analytics_CustomDataSource', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Analytics_CustomDataSourceChildLink', 'VendorDuplicator\\Google_Service_Analytics_CustomDataSourceChildLink', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Analytics_CustomDataSourceParentLink', 'VendorDuplicator\\Google_Service_Analytics_CustomDataSourceParentLink', \false);
/** @internal */
class Google_Service_Analytics_CustomDataSources extends Google_Collection
{
    protected $collection_key = 'items';
    protected $internal_gapi_mappings = array();
    protected $itemsType = 'VendorDuplicator\\Google_Service_Analytics_CustomDataSource';
    protected $itemsDataType = 'array';
    public $itemsPerPage;
    public $kind;
    public $nextLink;
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Analytics_CustomDataSources', 'VendorDuplicator\\Google_Service_Analytics_CustomDataSources', \false);
/** @internal */
class Google_Service_Analytics_CustomDimension extends Google_Model
{
    ...
    public $kind;
    public $name;
    protected $parentLinkType = 'VendorDuplicator\\Google_Service_Analytics_CustomDimensionParentLink';
    protected $parentLinkDataType = '';
    public $scope;
    public $selfLink;
    public $updated;
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Analytics_CustomDimension', 'VendorDuplicator\\Google_Service_Analytics_CustomDimension', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Analytics_CustomDimensionParentLink', 'VendorDuplicator\\Google_Service_Analytics_CustomDimensionParentLink', \false);
/** @internal */
class Google_Service_Analytics_CustomDimensions extends Google_Collection
{
    protected $collection_key = 'items';
    protected $internal_gapi_mappings = array();
    protected $itemsType = 'VendorDuplicator\\Google_Service_Analytics_CustomDimension';
    protected $itemsDataType = 'array';
    public $itemsPerPage;
    public $kind;
    public $nextLink;
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Analytics_CustomDimensions', 'VendorDuplicator\\Google_Service_Analytics_CustomDimensions', \false);
/** @internal */
class Google_Service_Analytics_CustomMetric extends Google_Model
{
    ...
    public $minValue;
    public $name;
    protected $parentLinkType = 'VendorDuplicator\\Google_Service_Analytics_CustomMetricParentLink';
    protected $parentLinkDataType = '';
    public $scope;
    public $selfLink;
    public $type;
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Analytics_CustomMetric', 'VendorDuplicator\\Google_Service_Analytics_CustomMetric', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Analytics_CustomMetricParentLink', 'VendorDuplicator\\Google_Service_Analytics_CustomMetricParentLink', \false);
/** @internal */
class Google_Service_Analytics_CustomMetrics extends Google_Collection
{
    protected $collection_key = 'items';
    protected $internal_gapi_mappings = array();
    protected $itemsType = 'VendorDuplicator\\Google_Service_Analytics_CustomMetric';
    protected $itemsDataType = 'array';
    public $itemsPerPage;
    public $kind;
    public $nextLink;
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Analytics_CustomMetrics', 'VendorDuplicator\\Google_Service_Analytics_CustomMetrics', \false);
/** @internal */
class Google_Service_Analytics_EntityAdWordsLink extends Google_Collection
{
    protected $collection_key = 'profileIds';
    protected $internal_gapi_mappings = array();
    protected $adWordsAccountsType = 'VendorDuplicator\\Google_Service_Analytics_AdWordsAccount';
    protected $adWordsAccountsDataType = 'array';
    protected $entityType = 'VendorDuplicator\\Google_Service_Analytics_EntityAdWordsLinkEntity';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Analytics_EntityAdWordsLink', 'VendorDuplicator\\Google_Service_Analytics_EntityAdWordsLink', \false);
/** @internal */
class Google_Service_Analytics_EntityAdWordsLinkEntity extends Google_Model
{
    protected $internal_gapi_mappings = array();
    protected $webPropertyRefType = 'VendorDuplicator\\Google_Service_Analytics_WebPropertyRef';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Analytics_EntityAdWordsLinkEntity', 'VendorDuplicator\\Google_Service_Analytics_EntityAdWordsLinkEntity', \false);
/** @internal */
class Google_Service_Analytics_EntityAdWordsLinks extends Google_Collection
{
    protected $collection_key = 'items';
    protected $internal_gapi_mappings = array();
    protected $itemsType = 'VendorDuplicator\\Google_Service_Analytics_EntityAdWordsLink';
    protected $itemsDataType = 'array';
    public $itemsPerPage;
    public $kind;
    public $nextLink;
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Analytics_EntityAdWordsLinks', 'VendorDuplicator\\Google_Service_Analytics_EntityAdWordsLinks', \false);
/** @internal */
class Google_Service_Analytics_EntityUserLink extends Google_Model
{
    protected $internal_gapi_mappings = array();
    protected $entityType = 'VendorDuplicator\\Google_Service_Analytics_EntityUserLinkEntity';
    protected $entityDataType = '';
    public $id;
    public $kind;
    protected $permissionsType = 'VendorDuplicator\\Google_Service_Analytics_EntityUserLinkPermissions';
    protected $permissionsDataType = '';
    public $selfLink;
    protected $userRefType = 'VendorDuplicator\\Google_Service_Analytics_UserRef';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Analytics_EntityUserLink', 'VendorDuplicator\\Google_Service_Analytics_EntityUserLink', \false);
/** @internal */
class Google_Service_Analytics_EntityUserLinkEntity extends Google_Model
{
    protected $internal_gapi_mappings = array();
    protected $accountRefType = 'VendorDuplicator\\Google_Service_Analytics_AccountRef';
    protected $accountRefDataType = '';
    protected $profileRefType = 'VendorDuplicator\\Google_Service_Analytics_ProfileRef';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Analytics_EntityUserLinkEntity', 'VendorDuplicator\\Google_Service_Analytics_EntityUserLinkEntity', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Analytics_EntityUserLinkPermissions', 'VendorDuplicator\\Google_Service_Analytics_EntityUserLinkPermissions', \false);
/** @internal */
class Google_Service_Analytics_EntityUserLinks extends Google_Collection
{
    protected $collection_key = 'items';
    protected $internal_gapi_mappings = array();
    protected $itemsType = 'VendorDuplicator\\Google_Service_Analytics_EntityUserLink';
    protected $itemsDataType = 'array';
    public $itemsPerPage;
    public $kind;
    public $nextLink;
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Analytics_EntityUserLinks', 'VendorDuplicator\\Google_Service_Analytics_EntityUserLinks', \false);
/** @internal */
class Google_Service_Analytics_Experiment extends Google_Collection
{
    ...
    protected $parentLinkType = 'VendorDuplicator\\Google_Service_Analytics_ExperimentParentLink';
    protected $parentLinkDataType = '';
    public $profileId;
    ...
    public $updated;
    protected $variationsType = 'VendorDuplicator\\Google_Service_Analytics_ExperimentVariations';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Analytics_Experiment', 'VendorDuplicator\\Google_Service_Analytics_Experiment', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Analytics_ExperimentParentLink', 'VendorDuplicator\\Google_Service_Analytics_ExperimentParentLink', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Analytics_ExperimentVariations', 'VendorDuplicator\\Google_Service_Analytics_ExperimentVariations', \false);
/** @internal */
class Google_Service_Analytics_Experiments extends Google_Collection
{
    protected $collection_key = 'items';
    protected $internal_gapi_mappings = array();
    protected $itemsType = 'VendorDuplicator\\Google_Service_Analytics_Experiment';
    protected $itemsDataType = 'array';
    public $itemsPerPage;
    public $kind;
    public $nextLink;
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Analytics_Experiments', 'VendorDuplicator\\Google_Service_Analytics_Experiments', \false);
/** @internal */
class Google_Service_Analytics_Filter extends Google_Model
{
    protected $internal_gapi_mappings = array();
    public $accountId;
    protected $advancedDetailsType = 'VendorDuplicator\\Google_Service_Analytics_FilterAdvancedDetails';
    protected $advancedDetailsDataType = '';
    public $created;
    protected $excludeDetailsType = 'VendorDuplicator\\Google_Service_Analytics_FilterExpression';
    protected $excludeDetailsDataType = '';
    public $id;
    protected $includeDetailsType = 'VendorDuplicator\\Google_Service_Analytics_FilterExpression';
    protected $includeDetailsDataType = '';
    public $kind;
    protected $lowercaseDetailsType = 'VendorDuplicator\\Google_Service_Analytics_FilterLowercaseDetails';
    protected $lowercaseDetailsDataType = '';
    public $name;
    protected $parentLinkType = 'VendorDuplicator\\Google_Service_Analytics_FilterParentLink';
    protected $parentLinkDataType = '';
    protected $searchAndReplaceDetailsType = 'VendorDuplicator\\Google_Service_Analytics_FilterSearchAndReplaceDetails';
    protected $searchAndReplaceDetailsDataType = '';
    public $selfLink;
    public $type;
    public $updated;
    protected $uppercaseDetailsType = 'VendorDuplicator\\Google_Service_Analytics_FilterUppercaseDetails';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Analytics_Filter', 'VendorDuplicator\\Google_Service_Analytics_Filter', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Analytics_FilterAdvancedDetails', 'VendorDuplicator\\Google_Service_Analytics_FilterAdvancedDetails', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Analytics_FilterExpression', 'VendorDuplicator\\Google_Service_Analytics_FilterExpression', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Analytics_FilterLowercaseDetails', 'VendorDuplicator\\Google_Service_Analytics_FilterLowercaseDetails', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Analytics_FilterParentLink', 'VendorDuplicator\\Google_Service_Analytics_FilterParentLink', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Analytics_FilterRef', 'VendorDuplicator\\Google_Service_Analytics_FilterRef', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Analytics_FilterSearchAndReplaceDetails', 'VendorDuplicator\\Google_Service_Analytics_FilterSearchAndReplaceDetails', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Analytics_FilterUppercaseDetails', 'VendorDuplicator\\Google_Service_Analytics_FilterUppercaseDetails', \false);
/** @internal */
class Google_Service_Analytics_Filters extends Google_Collection
{
    protected $collection_key = 'items';
    protected $internal_gapi_mappings = array();
    protected $itemsType = 'VendorDuplicator\\Google_Service_Analytics_Filter';
    protected $itemsDataType = 'array';
    public $itemsPerPage;
    public $kind;
    public $nextLink;
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Analytics_Filters', 'VendorDuplicator\\Google_Service_Analytics_Filters', \false);
/** @internal */
class Google_Service_Analytics_GaData extends Google_Collection
{
    protected $collection_key = 'rows';
    protected $internal_gapi_mappings = array();
    protected $columnHeadersType = 'VendorDuplicator\\Google_Service_Analytics_GaDataColumnHeaders';
    protected $columnHeadersDataType = 'array';
    public $containsSampledData;
    protected $dataTableType = 'VendorDuplicator\\Google_Service_Analytics_GaDataDataTable';
    ...
    public $nextLink;
    public $previousLink;
    protected $profileInfoType = 'VendorDuplicator\\Google_Service_Analytics_GaDataProfileInfo';
    protected $profileInfoDataType = '';
    protected $queryType = 'VendorDuplicator\\Google_Service_Analytics_GaDataQuery';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Analytics_GaData', 'VendorDuplicator\\Google_Service_Analytics_GaData', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Analytics_GaDataColumnHeaders', 'VendorDuplicator\\Google_Service_Analytics_GaDataColumnHeaders', \false);
/** @internal */
class Google_Service_Analytics_GaDataDataTable extends Google_Collection
{
    protected $collection_key = 'rows';
    protected $internal_gapi_mappings = array();
    protected $colsType = 'VendorDuplicator\\Google_Service_Analytics_GaDataDataTableCols';
    protected $colsDataType = 'array';
    protected $rowsType = 'VendorDuplicator\\Google_Service_Analytics_GaDataDataTableRows';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Analytics_GaDataDataTable', 'VendorDuplicator\\Google_Service_Analytics_GaDataDataTable', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Analytics_GaDataDataTableCols', 'VendorDuplicator\\Google_Service_Analytics_GaDataDataTableCols', \false);
/** @internal */
class Google_Service_Analytics_GaDataDataTableRows extends Google_Collection
{
    protected $collection_key = 'c';
    protected $internal_gapi_mappings = array();
    protected $cType = 'VendorDuplicator\\Google_Service_Analytics_GaDataDataTableRowsC';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Analytics_GaDataDataTableRows', 'VendorDuplicator\\Google_Service_Analytics_GaDataDataTableRows', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Analytics_GaDataDataTableRowsC', 'VendorDuplicator\\Google_Service_Analytics_GaDataDataTableRowsC', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Analytics_GaDataProfileInfo', 'VendorDuplicator\\Google_Service_Analytics_GaDataProfileInfo', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Analytics_GaDataQuery', 'VendorDuplicator\\Google_Service_Analytics_GaDataQuery', \false);
/** @internal */
class Google_Service_Analytics_Goal extends Google_Model
{
    ...
    public $active;
    public $created;
    protected $eventDetailsType = 'VendorDuplicator\\Google_Service_Analytics_GoalEventDetails';
    protected $eventDetailsDataType = '';
    public $id;
    public $internalWebPropertyId;
    public $kind;
    public $name;
    protected $parentLinkType = 'VendorDuplicator\\Google_Service_Analytics_GoalParentLink';
    protected $parentLinkDataType = '';
    public $profileId;
    public $selfLink;
    public $type;
    public $updated;
    protected $urlDestinationDetailsType = 'VendorDuplicator\\Google_Service_Analytics_GoalUrlDestinationDetails';
    protected $urlDestinationDetailsDataType = '';
    public $value;
    protected $visitNumPagesDetailsType = 'VendorDuplicator\\Google_Service_Analytics_GoalVisitNumPagesDetails';
    protected $visitNumPagesDetailsDataType = '';
    protected $visitTimeOnSiteDetailsType = 'VendorDuplicator\\Google_Service_Analytics_GoalVisitTimeOnSiteDetails';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Analytics_Goal', 'VendorDuplicator\\Google_Service_Analytics_Goal', \false);
/** @internal */
class Google_Service_Analytics_GoalEventDetails extends Google_Collection
{
    protected $collection_key = 'eventConditions';
    protected $internal_gapi_mappings = array();
    protected $eventConditionsType = 'VendorDuplicator\\Google_Service_Analytics_GoalEventDetailsEventConditions';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Analytics_GoalEventDetails', 'VendorDuplicator\\Google_Service_Analytics_GoalEventDetails', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Analytics_GoalEventDetailsEventConditions', 'VendorDuplicator\\Google_Service_Analytics_GoalEventDetailsEventConditions', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Analytics_GoalParentLink', 'VendorDuplicator\\Google_Service_Analytics_GoalParentLink', \false);
/** @internal */
class Google_Service_Analytics_GoalUrlDestinationDetails extends Google_Collection
{
    ...
    public $matchType;
    protected $stepsType = 'VendorDuplicator\\Google_Service_Analytics_GoalUrlDestinationDetailsSteps';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Analytics_GoalUrlDestinationDetails', 'VendorDuplicator\\Google_Service_Analytics_GoalUrlDestinationDetails', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Analytics_GoalUrlDestinationDetailsSteps', 'VendorDuplicator\\Google_Service_Analytics_GoalUrlDestinationDetailsSteps', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Analytics_GoalVisitNumPagesDetails', 'VendorDuplicator\\Google_Service_Analytics_GoalVisitNumPagesDetails', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Analytics_GoalVisitTimeOnSiteDetails', 'VendorDuplicator\\Google_Service_Analytics_GoalVisitTimeOnSiteDetails', \false);
/** @internal */
class Google_Service_Analytics_Goals extends Google_Collection
{
    protected $collection_key = 'items';
    protected $internal_gapi_mappings = array();
    protected $itemsType = 'VendorDuplicator\\Google_Service_Analytics_Goal';
    protected $itemsDataType = 'array';
    public $itemsPerPage;
    public $kind;
    public $nextLink;
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Analytics_Goals', 'VendorDuplicator\\Google_Service_Analytics_Goals', \false);
/** @internal */
class Google_Service_Analytics_McfData extends Google_Collection
{
    protected $collection_key = 'rows';
    protected $internal_gapi_mappings = array();
    protected $columnHeadersType = 'VendorDuplicator\\Google_Service_Analytics_McfDataColumnHeaders';
    protected $columnHeadersDataType = 'array';
    public $containsSampledData;
    public $id;
    public $itemsPerPage;
    ...
    public $nextLink;
    public $previousLink;
    protected $profileInfoType = 'VendorDuplicator\\Google_Service_Analytics_McfDataProfileInfo';
    protected $profileInfoDataType = '';
    protected $queryType = 'VendorDuplicator\\Google_Service_Analytics_McfDataQuery';
    protected $queryDataType = '';
    protected $rowsType = 'VendorDuplicator\\Google_Service_Analytics_McfDataRows';
    protected $rowsDataType = 'array';
    public $sampleSize;
    public $sampleSpace;
    public $selfLink;
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Analytics_McfData', 'VendorDuplicator\\Google_Service_Analytics_McfData', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Analytics_McfDataColumnHeaders', 'VendorDuplicator\\Google_Service_Analytics_McfDataColumnHeaders', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Analytics_McfDataProfileInfo', 'VendorDuplicator\\Google_Service_Analytics_McfDataProfileInfo', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Analytics_McfDataQuery', 'VendorDuplicator\\Google_Service_Analytics_McfDataQuery', \false);
/** @internal */
class Google_Service_Analytics_McfDataRows extends Google_Collection
{
    protected $collection_key = 'conversionPathValue';
    protected $internal_gapi_mappings = array();
    protected $conversionPathValueType = 'VendorDuplicator\\Google_Service_Analytics_McfDataRowsConversionPathValue';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Analytics_McfDataRows', 'VendorDuplicator\\Google_Service_Analytics_McfDataRows', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Analytics_McfDataRowsConversionPathValue', 'VendorDuplicator\\Google_Service_Analytics_McfDataRowsConversionPathValue', \false);
/** @internal */
class Google_Service_Analytics_Profile extends Google_Model
{
    ...
    protected $childLinkType = 'VendorDuplicator\\Google_Service_Analytics_ProfileChildLink';
    protected $childLinkDataType = '';
    public $created;
    public $currency;
    public $defaultPage;
    ...
    public $kind;
    public $name;
    protected $parentLinkType = 'VendorDuplicator\\Google_Service_Analytics_ProfileParentLink';
    protected $parentLinkDataType = '';
    protected $permissionsType = 'VendorDuplicator\\Google_Service_Analytics_ProfilePermissions';
    protected $permissionsDataType = '';
    public $selfLink;
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Analytics_Profile', 'VendorDuplicator\\Google_Service_Analytics_Profile', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Analytics_ProfileChildLink', 'VendorDuplicator\\Google_Service_Analytics_ProfileChildLink', \false);
/** @internal */
class Google_Service_Analytics_ProfileFilterLink extends Google_Model
{
    protected $internal_gapi_mappings = array();
    protected $filterRefType = 'VendorDuplicator\\Google_Service_Analytics_FilterRef';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Analytics_ProfileFilterLink', 'VendorDuplicator\\Google_Service_Analytics_ProfileFilterLink', \false);
/** @internal */
class Google_Service_Analytics_ProfileFilterLinks extends Google_Collection
{
    protected $collection_key = 'items';
    protected $internal_gapi_mappings = array();
    protected $itemsType = 'VendorDuplicator\\Google_Service_Analytics_ProfileFilterLink';
    protected $itemsDataType = 'array';
    public $itemsPerPage;
    public $kind;
    public $nextLink;
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Analytics_ProfileFilterLinks', 'VendorDuplicator\\Google_Service_Analytics_ProfileFilterLinks', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Analytics_ProfileParentLink', 'VendorDuplicator\\Google_Service_Analytics_ProfileParentLink', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Analytics_ProfilePermissions', 'VendorDuplicator\\Google_Service_Analytics_ProfilePermissions', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Analytics_ProfileRef', 'VendorDuplicator\\Google_Service_Analytics_ProfileRef', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Analytics_ProfileSummary', 'VendorDuplicator\\Google_Service_Analytics_ProfileSummary', \false);
/** @internal */
class Google_Service_Analytics_Profiles extends Google_Collection
{
    protected $collection_key = 'items';
    protected $internal_gapi_mappings = array();
    protected $itemsType = 'VendorDuplicator\\Google_Service_Analytics_Profile';
    protected $itemsDataType = 'array';
    public $itemsPerPage;
    public $kind;
    public $nextLink;
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Analytics_Profiles', 'VendorDuplicator\\Google_Service_Analytics_Profiles', \false);
/** @internal */
class Google_Service_Analytics_RealtimeData extends Google_Collection
{
    protected $collection_key = 'rows';
    protected $internal_gapi_mappings = array();
    protected $columnHeadersType = 'VendorDuplicator\\Google_Service_Analytics_RealtimeDataColumnHeaders';
    protected $columnHeadersDataType = 'array';
    public $id;
    public $kind;
    protected $profileInfoType = 'VendorDuplicator\\Google_Service_Analytics_RealtimeDataProfileInfo';
    protected $profileInfoDataType = '';
    protected $queryType = 'VendorDuplicator\\Google_Service_Analytics_RealtimeDataQuery';
    protected $queryDataType = '';
    public $rows;
    public $selfLink;
    public $totalResults;
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Analytics_RealtimeData', 'VendorDuplicator\\Google_Service_Analytics_RealtimeData', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Analytics_RealtimeDataColumnHeaders', 'VendorDuplicator\\Google_Service_Analytics_RealtimeDataColumnHeaders', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Analytics_RealtimeDataProfileInfo', 'VendorDuplicator\\Google_Service_Analytics_RealtimeDataProfileInfo', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Analytics_RealtimeDataQuery', 'VendorDuplicator\\Google_Service_Analytics_RealtimeDataQuery', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Analytics_Segment', 'VendorDuplicator\\Google_Service_Analytics_Segment', \false);
/** @internal */
class Google_Service_Analytics_Segments extends Google_Collection
{
    protected $collection_key = 'items';
    protected $internal_gapi_mappings = array();
    protected $itemsType = 'VendorDuplicator\\Google_Service_Analytics_Segment';
    protected $itemsDataType = 'array';
    public $itemsPerPage;
    public $kind;
    public $nextLink;
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Analytics_Segments', 'VendorDuplicator\\Google_Service_Analytics_Segments', \false);
/** @internal */
class Google_Service_Analytics_UnsampledReport extends Google_Model
{
    ...
    public $accountId;
    protected $cloudStorageDownloadDetailsType = 'VendorDuplicator\\Google_Service_Analytics_UnsampledReportCloudStorageDownloadDetails';
    protected $cloudStorageDownloadDetailsDataType = '';
    public $created;
    public $dimensions;
    public $downloadType;
    protected $driveDownloadDetailsType = 'VendorDuplicator\\Google_Service_Analytics_UnsampledReportDriveDownloadDetails';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Analytics_UnsampledReport', 'VendorDuplicator\\Google_Service_Analytics_UnsampledReport', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Analytics_UnsampledReportCloudStorageDownloadDetails', 'VendorDuplicator\\Google_Service_Analytics_UnsampledReportCloudStorageDownloadDetails', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Analytics_UnsampledReportDriveDownloadDetails', 'VendorDuplicator\\Google_Service_Analytics_UnsampledReportDriveDownloadDetails', \false);
/** @internal */
class Google_Service_Analytics_UnsampledReports extends Google_Collection
{
    protected $collection_key = 'items';
    protected $internal_gapi_mappings = array();
    protected $itemsType = 'VendorDuplicator\\Google_Service_Analytics_UnsampledReport';
    protected $itemsDataType = 'array';
    public $itemsPerPage;
    public $kind;
    public $nextLink;
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Analytics_UnsampledReports', 'VendorDuplicator\\Google_Service_Analytics_UnsampledReports', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Analytics_Upload', 'VendorDuplicator\\Google_Service_Analytics_Upload', \false);
/** @internal */
class Google_Service_Analytics_Uploads extends Google_Collection
{
    protected $collection_key = 'items';
    protected $internal_gapi_mappings = array();
    protected $itemsType = 'VendorDuplicator\\Google_Service_Analytics_Upload';
    protected $itemsDataType = 'array';
    public $itemsPerPage;
    public $kind;
    public $nextLink;
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Analytics_Uploads', 'VendorDuplicator\\Google_Service_Analytics_Uploads', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Analytics_UserRef', 'VendorDuplicator\\Google_Service_Analytics_UserRef', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Analytics_WebPropertyRef', 'VendorDuplicator\\Google_Service_Analytics_WebPropertyRef', \false);
/** @internal */
class Google_Service_Analytics_WebPropertySummary extends Google_Collection
{
    ...
    public $level;
    public $name;
    protected $profilesType = 'VendorDuplicator\\Google_Service_Analytics_ProfileSummary';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Analytics_WebPropertySummary', 'VendorDuplicator\\Google_Service_Analytics_WebPropertySummary', \false);
/** @internal */
class Google_Service_Analytics_Webproperties extends Google_Collection
{
    protected $collection_key = 'items';
    protected $internal_gapi_mappings = array();
    protected $itemsType = 'VendorDuplicator\\Google_Service_Analytics_Webproperty';
    protected $itemsDataType = 'array';
    public $itemsPerPage;
    public $kind;
    public $nextLink;
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Analytics_Webproperties', 'VendorDuplicator\\Google_Service_Analytics_Webproperties', \false);
/** @internal */
class Google_Service_Analytics_Webproperty extends Google_Model
{
    protected $internal_gapi_mappings = array();
    public $accountId;
    protected $childLinkType = 'VendorDuplicator\\Google_Service_Analytics_WebpropertyChildLink';
    protected $childLinkDataType = '';
    public $created;
    ...
    public $level;
    public $name;
    protected $parentLinkType = 'VendorDuplicator\\Google_Service_Analytics_WebpropertyParentLink';
    protected $parentLinkDataType = '';
    protected $permissionsType = 'VendorDuplicator\\Google_Service_Analytics_WebpropertyPermissions';
    protected $permissionsDataType = '';
    public $profileCount;
    public $selfLink;
    public $updated;
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Analytics_Webproperty', 'VendorDuplicator\\Google_Service_Analytics_Webproperty', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Analytics_WebpropertyChildLink', 'VendorDuplicator\\Google_Service_Analytics_WebpropertyChildLink', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Analytics_WebpropertyParentLink', 'VendorDuplicator\\Google_Service_Analytics_WebpropertyParentLink', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Analytics_WebpropertyPermissions', 'VendorDuplicator\\Google_Service_Analytics_WebpropertyPermissions', \false);
