...
class Google_Service_Mirror extends Google_Service
{
    ...
    public function __construct(Google_Client $client)
    {
        ...
        $this->accounts = new Google_Service_Mirror_Accounts_Resource($this, $this->serviceName, 'accounts', array('methods' => array('insert' => array('path' => 'accounts/{userToken}/{accountType}/{accountName}', 'httpMethod' => 'POST', 'parameters' => array('userToken' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'accountType' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'accountName' => array('location' => 'path', 'type' => 'string', 'required' => \true))))));
        $this->contacts = new Google_Service_Mirror_Contacts_Resource($this, $this->serviceName, 'contacts', array('methods' => array('delete' => array('path' => 'contacts/{id}', 'httpMethod' => 'DELETE', 'parameters' => array('id' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'get' => array('path' => 'contacts/{id}', 'httpMethod' => 'GET', 'parameters' => array('id' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'insert' => array('path' => 'contacts', 'httpMethod' => 'POST', 'parameters' => array()), 'list' => array('path' => 'contacts', 'httpMethod' => 'GET', 'parameters' => array()), 'patch' => array('path' => 'contacts/{id}', 'httpMethod' => 'PATCH', 'parameters' => array('id' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'update' => array('path' => 'contacts/{id}', 'httpMethod' => 'PUT', 'parameters' => array('id' => array('location' => 'path', 'type' => 'string', 'required' => \true))))));
        $this->locations = new Google_Service_Mirror_Locations_Resource($this, $this->serviceName, 'locations', array('methods' => array('get' => array('path' => 'locations/{id}', 'httpMethod' => 'GET', 'parameters' => array('id' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'list' => array('path' => 'locations', 'httpMethod' => 'GET', 'parameters' => array()))));
        $this->settings = new Google_Service_Mirror_Settings_Resource($this, $this->serviceName, 'settings', array('methods' => array('get' => array('path' => 'settings/{id}', 'httpMethod' => 'GET', 'parameters' => array('id' => array('location' => 'path', 'type' => 'string', 'required' => \true))))));
        $this->subscriptions = new Google_Service_Mirror_Subscriptions_Resource($this, $this->serviceName, 'subscriptions', array('methods' => array('delete' => array('path' => 'subscriptions/{id}', 'httpMethod' => 'DELETE', 'parameters' => array('id' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'insert' => array('path' => 'subscriptions', 'httpMethod' => 'POST', 'parameters' => array()), 'list' => array('path' => 'subscriptions', 'httpMethod' => 'GET', 'parameters' => array()), 'update' => array('path' => 'subscriptions/{id}', 'httpMethod' => 'PUT', 'parameters' => array('id' => array('location' => 'path', 'type' => 'string', 'required' => \true))))));
        $this->timeline = new Google_Service_Mirror_Timeline_Resource($this, $this->serviceName, 'timeline', array('methods' => array('delete' => array('path' => 'timeline/{id}', 'httpMethod' => 'DELETE', 'parameters' => array('id' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'get' => array('path' => 'timeline/{id}', 'httpMethod' => 'GET', 'parameters' => array('id' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'insert' => array('path' => 'timeline', 'httpMethod' => 'POST', 'parameters' => array()), 'list' => array('path' => 'timeline', 'httpMethod' => 'GET', 'parameters' => array('bundleId' => array('location' => 'query', 'type' => 'string'), 'includeDeleted' => array('location' => 'query', 'type' => 'boolean'), 'maxResults' => array('location' => 'query', 'type' => 'integer'), 'orderBy' => array('location' => 'query', 'type' => 'string'), 'pageToken' => array('location' => 'query', 'type' => 'string'), 'pinnedOnly' => array('location' => 'query', 'type' => 'boolean'), 'sourceItemId' => array('location' => 'query', 'type' => 'string'))), 'patch' => array('path' => 'timeline/{id}', 'httpMethod' => 'PATCH', 'parameters' => array('id' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'update' => array('path' => 'timeline/{id}', 'httpMethod' => 'PUT', 'parameters' => array('id' => array('location' => 'path', 'type' => 'string', 'required' => \true))))));
        $this->timeline_attachments = new Google_Service_Mirror_TimelineAttachments_Resource($this, $this->serviceName, 'attachments', array('methods' => array('delete' => array('path' => 'timeline/{itemId}/attachments/{attachmentId}', 'httpMethod' => 'DELETE', 'parameters' => array('itemId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'attachmentId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'get' => array('path' => 'timeline/{itemId}/attachments/{attachmentId}', 'httpMethod' => 'GET', 'parameters' => array('itemId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'attachmentId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'insert' => array('path' => 'timeline/{itemId}/attachments', 'httpMethod' => 'POST', 'parameters' => array('itemId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'list' => array('path' => 'timeline/{itemId}/attachments', 'httpMethod' => 'GET', 'parameters' => array('itemId' => array('location' => 'path', 'type' => 'string', 'required' => \true))))));
    }
}
/*
 * Licensed under the Apache License, Version 2.0 (the "License"); you may not
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Mirror', 'VendorDuplicator\\Google_Service_Mirror', \false);
/**
...
class Google_Service_Mirror_Accounts_Resource extends Google_Service_Resource
{
    ...
    public function insert($userToken, $accountType, $accountName, Google_Service_Mirror_Account $postBody, $optParams = array())
    {
        ...
        return $this->call('insert', array($params), "VendorDuplicator\\Google_Service_Mirror_Account");
    }
}
/**
 * The "accounts" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Mirror_Accounts_Resource', 'VendorDuplicator\\Google_Service_Mirror_Accounts_Resource', \false);
/**
...
class Google_Service_Mirror_Contacts_Resource extends Google_Service_Resource
{
    ...
    public function get($id, $optParams = array())
    {
        $params = array('id' => $id);
        $params = \array_merge($params, $optParams);
        return $this->call('get', array($params), "VendorDuplicator\\Google_Service_Mirror_Contact");
    }
    /**
    ...
    public function insert(Google_Service_Mirror_Contact $postBody, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('insert', array($params), "VendorDuplicator\\Google_Service_Mirror_Contact");
    }
    /**
    ...
    public function listContacts($optParams = array())
    {
        $params = array();
        $params = \array_merge($params, $optParams);
        return $this->call('list', array($params), "VendorDuplicator\\Google_Service_Mirror_ContactsListResponse");
    }
    /**
    ...
    public function patch($id, Google_Service_Mirror_Contact $postBody, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('patch', array($params), "VendorDuplicator\\Google_Service_Mirror_Contact");
    }
    /**
    ...
    public function update($id, Google_Service_Mirror_Contact $postBody, $optParams = array())
    {
        $params = array('id' => $id, 'postBody' => $postBody);
        $params = \array_merge($params, $optParams);
        return $this->call('update', array($params), "VendorDuplicator\\Google_Service_Mirror_Contact");
    }
}
/**
 * The "contacts" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Mirror_Contacts_Resource', 'VendorDuplicator\\Google_Service_Mirror_Contacts_Resource', \false);
/**
...
class Google_Service_Mirror_Locations_Resource extends Google_Service_Resource
{
    ...
    public function get($id, $optParams = array())
    {
        $params = array('id' => $id);
        $params = \array_merge($params, $optParams);
        return $this->call('get', array($params), "VendorDuplicator\\Google_Service_Mirror_Location");
    }
    /**
    ...
    public function listLocations($optParams = array())
    {
        $params = array();
        $params = \array_merge($params, $optParams);
        return $this->call('list', array($params), "VendorDuplicator\\Google_Service_Mirror_LocationsListResponse");
    }
}
/**
 * The "locations" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Mirror_Locations_Resource', 'VendorDuplicator\\Google_Service_Mirror_Locations_Resource', \false);
/**
...
class Google_Service_Mirror_Settings_Resource extends Google_Service_Resource
{
    ...
    public function get($id, $optParams = array())
    {
        $params = array('id' => $id);
        $params = \array_merge($params, $optParams);
        return $this->call('get', array($params), "VendorDuplicator\\Google_Service_Mirror_Setting");
    }
}
/**
 * The "settings" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Mirror_Settings_Resource', 'VendorDuplicator\\Google_Service_Mirror_Settings_Resource', \false);
/**
...
class Google_Service_Mirror_Subscriptions_Resource extends Google_Service_Resource
{
    ...
    public function insert(Google_Service_Mirror_Subscription $postBody, $optParams = array())
    {
        $params = array('postBody' => $postBody);
        $params = \array_merge($params, $optParams);
        return $this->call('insert', array($params), "VendorDuplicator\\Google_Service_Mirror_Subscription");
    }
    /**
    ...
    public function listSubscriptions($optParams = array())
    {
        $params = array();
        $params = \array_merge($params, $optParams);
        return $this->call('list', array($params), "VendorDuplicator\\Google_Service_Mirror_SubscriptionsListResponse");
    }
    /**
    ...
    public function update($id, Google_Service_Mirror_Subscription $postBody, $optParams = array())
    {
        $params = array('id' => $id, 'postBody' => $postBody);
        $params = \array_merge($params, $optParams);
        return $this->call('update', array($params), "VendorDuplicator\\Google_Service_Mirror_Subscription");
    }
}
/**
 * The "subscriptions" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Mirror_Subscriptions_Resource', 'VendorDuplicator\\Google_Service_Mirror_Subscriptions_Resource', \false);
/**
...
class Google_Service_Mirror_Timeline_Resource extends Google_Service_Resource
{
    ...
    public function get($id, $optParams = array())
    {
        $params = array('id' => $id);
        $params = \array_merge($params, $optParams);
        return $this->call('get', array($params), "VendorDuplicator\\Google_Service_Mirror_TimelineItem");
    }
    /**
    ...
    public function insert(Google_Service_Mirror_TimelineItem $postBody, $optParams = array())
    {
        $params = array('postBody' => $postBody);
        $params = \array_merge($params, $optParams);
        return $this->call('insert', array($params), "VendorDuplicator\\Google_Service_Mirror_TimelineItem");
    }
    /**
    ...
    public function listTimeline($optParams = array())
    {
        $params = array();
        $params = \array_merge($params, $optParams);
        return $this->call('list', array($params), "VendorDuplicator\\Google_Service_Mirror_TimelineListResponse");
    }
    /**
    ...
    public function patch($id, Google_Service_Mirror_TimelineItem $postBody, $optParams = array())
    {
        $params = array('id' => $id, 'postBody' => $postBody);
        $params = \array_merge($params, $optParams);
        return $this->call('patch', array($params), "VendorDuplicator\\Google_Service_Mirror_TimelineItem");
    }
    /**
    ...
    public function update($id, Google_Service_Mirror_TimelineItem $postBody, $optParams = array())
    {
        $params = array('id' => $id, 'postBody' => $postBody);
        $params = \array_merge($params, $optParams);
        return $this->call('update', array($params), "VendorDuplicator\\Google_Service_Mirror_TimelineItem");
    }
}
/**
 * The "timeline" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Mirror_Timeline_Resource', 'VendorDuplicator\\Google_Service_Mirror_Timeline_Resource', \false);
/**
...
class Google_Service_Mirror_TimelineAttachments_Resource extends Google_Service_Resource
{
    ...
    public function get($itemId, $attachmentId, $optParams = array())
    {
        $params = array('itemId' => $itemId, 'attachmentId' => $attachmentId);
        $params = \array_merge($params, $optParams);
        return $this->call('get', array($params), "VendorDuplicator\\Google_Service_Mirror_Attachment");
    }
    /**
    ...
    public function insert($itemId, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('insert', array($params), "VendorDuplicator\\Google_Service_Mirror_Attachment");
    }
    /**
    ...
    public function listTimelineAttachments($itemId, $optParams = array())
    {
        $params = array('itemId' => $itemId);
        $params = \array_merge($params, $optParams);
        return $this->call('list', array($params), "VendorDuplicator\\Google_Service_Mirror_AttachmentsListResponse");
    }
}
/**
 * The "attachments" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Mirror_TimelineAttachments_Resource', 'VendorDuplicator\\Google_Service_Mirror_TimelineAttachments_Resource', \false);
/** @internal */
class Google_Service_Mirror_Account extends Google_Collection
{
    protected $collection_key = 'userData';
    protected $internal_gapi_mappings = array();
    protected $authTokensType = 'VendorDuplicator\\Google_Service_Mirror_AuthToken';
    protected $authTokensDataType = 'array';
    public $features;
    public $password;
    protected $userDataType = 'VendorDuplicator\\Google_Service_Mirror_UserData';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Mirror_Account', 'VendorDuplicator\\Google_Service_Mirror_Account', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Mirror_Attachment', 'VendorDuplicator\\Google_Service_Mirror_Attachment', \false);
/** @internal */
class Google_Service_Mirror_AttachmentsListResponse extends Google_Collection
{
    protected $collection_key = 'items';
    protected $internal_gapi_mappings = array();
    protected $itemsType = 'VendorDuplicator\\Google_Service_Mirror_Attachment';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Mirror_AttachmentsListResponse', 'VendorDuplicator\\Google_Service_Mirror_AttachmentsListResponse', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Mirror_AuthToken', 'VendorDuplicator\\Google_Service_Mirror_AuthToken', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Mirror_Command', 'VendorDuplicator\\Google_Service_Mirror_Command', \false);
/** @internal */
class Google_Service_Mirror_Contact extends Google_Collection
{
    protected $collection_key = 'sharingFeatures';
    protected $internal_gapi_mappings = array();
    protected $acceptCommandsType = 'VendorDuplicator\\Google_Service_Mirror_Command';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Mirror_Contact', 'VendorDuplicator\\Google_Service_Mirror_Contact', \false);
/** @internal */
class Google_Service_Mirror_ContactsListResponse extends Google_Collection
{
    protected $collection_key = 'items';
    protected $internal_gapi_mappings = array();
    protected $itemsType = 'VendorDuplicator\\Google_Service_Mirror_Contact';
    protected $itemsDataType = 'array';
    public $kind;
    public function setItems($items)
    {
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Mirror_ContactsListResponse', 'VendorDuplicator\\Google_Service_Mirror_ContactsListResponse', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Mirror_Location', 'VendorDuplicator\\Google_Service_Mirror_Location', \false);
/** @internal */
class Google_Service_Mirror_LocationsListResponse extends Google_Collection
{
    protected $collection_key = 'items';
    protected $internal_gapi_mappings = array();
    protected $itemsType = 'VendorDuplicator\\Google_Service_Mirror_Location';
    protected $itemsDataType = 'array';
    public $kind;
    public function setItems($items)
    {
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Mirror_LocationsListResponse', 'VendorDuplicator\\Google_Service_Mirror_LocationsListResponse', \false);
/** @internal */
class Google_Service_Mirror_MenuItem extends Google_Collection
{
    ...
    protected $valuesType = 'VendorDuplicator\\Google_Service_Mirror_MenuValue';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Mirror_MenuItem', 'VendorDuplicator\\Google_Service_Mirror_MenuItem', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Mirror_MenuValue', 'VendorDuplicator\\Google_Service_Mirror_MenuValue', \false);
/** @internal */
class Google_Service_Mirror_Notification extends Google_Collection
{
    ...
    public $itemId;
    public $operation;
    protected $userActionsType = 'VendorDuplicator\\Google_Service_Mirror_UserAction';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Mirror_Notification', 'VendorDuplicator\\Google_Service_Mirror_Notification', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Mirror_NotificationConfig', 'VendorDuplicator\\Google_Service_Mirror_NotificationConfig', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Mirror_Setting', 'VendorDuplicator\\Google_Service_Mirror_Setting', \false);
/** @internal */
class Google_Service_Mirror_Subscription extends Google_Collection
{
    ...
    public $id;
    public $kind;
    protected $notificationType = 'VendorDuplicator\\Google_Service_Mirror_Notification';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Mirror_Subscription', 'VendorDuplicator\\Google_Service_Mirror_Subscription', \false);
/** @internal */
class Google_Service_Mirror_SubscriptionsListResponse extends Google_Collection
{
    protected $collection_key = 'items';
    protected $internal_gapi_mappings = array();
    protected $itemsType = 'VendorDuplicator\\Google_Service_Mirror_Subscription';
    protected $itemsDataType = 'array';
    public $kind;
    public function setItems($items)
    {
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Mirror_SubscriptionsListResponse', 'VendorDuplicator\\Google_Service_Mirror_SubscriptionsListResponse', \false);
/** @internal */
class Google_Service_Mirror_TimelineItem extends Google_Collection
{
    protected $collection_key = 'recipients';
    protected $internal_gapi_mappings = array();
    protected $attachmentsType = 'VendorDuplicator\\Google_Service_Mirror_Attachment';
    protected $attachmentsDataType = 'array';
    public $bundleId;
    public $canonicalUrl;
    public $created;
    protected $creatorType = 'VendorDuplicator\\Google_Service_Mirror_Contact';
    ...
    public $isPinned;
    public $kind;
    protected $locationType = 'VendorDuplicator\\Google_Service_Mirror_Location';
    protected $locationDataType = '';
    protected $menuItemsType = 'VendorDuplicator\\Google_Service_Mirror_MenuItem';
    protected $menuItemsDataType = 'array';
    protected $notificationType = 'VendorDuplicator\\Google_Service_Mirror_NotificationConfig';
    protected $notificationDataType = '';
    public $pinScore;
    protected $recipientsType = 'VendorDuplicator\\Google_Service_Mirror_Contact';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Mirror_TimelineItem', 'VendorDuplicator\\Google_Service_Mirror_TimelineItem', \false);
/** @internal */
class Google_Service_Mirror_TimelineListResponse extends Google_Collection
{
    protected $collection_key = 'items';
    protected $internal_gapi_mappings = array();
    protected $itemsType = 'VendorDuplicator\\Google_Service_Mirror_TimelineItem';
    protected $itemsDataType = 'array';
    public $kind;
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Mirror_TimelineListResponse', 'VendorDuplicator\\Google_Service_Mirror_TimelineListResponse', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Mirror_UserAction', 'VendorDuplicator\\Google_Service_Mirror_UserAction', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Mirror_UserData', 'VendorDuplicator\\Google_Service_Mirror_UserData', \false);
