...
class Google_IO_Curl extends Google_IO_Abstract
{
    ...
    public function __construct(Google_Client $client)
    {
        ...
        $this->disableProxyWorkaround = $this->client->getClassConfig('VendorDuplicator\\Google_IO_Curl', 'disable_proxy_workaround');
    }
    /**
    ...
    public function executeRequest(Google_Http_Request $request)
    {
        ...
        $options = $this->client->getClassConfig('VendorDuplicator\\Google_IO_Curl', 'options');
        if (\is_array($options)) {
        ...
        if ($response === \false) {
            ...
            $map = $this->client->getClassConfig('VendorDuplicator\\Google_IO_Exception', 'retry_map');
...
/** @internal */
\class_alias('VendorDuplicator\\Google_IO_Curl', 'VendorDuplicator\\Google_IO_Curl', \false);
