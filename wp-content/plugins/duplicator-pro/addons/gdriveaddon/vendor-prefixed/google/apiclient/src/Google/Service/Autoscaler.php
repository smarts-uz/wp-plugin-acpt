...
class Google_Service_Autoscaler extends Google_Service
{
    ...
    public function __construct(Google_Client $client)
    {
        ...
        $this->autoscalers = new Google_Service_Autoscaler_Autoscalers_Resource($this, $this->serviceName, 'autoscalers', array('methods' => array('delete' => array('path' => 'projects/{project}/zones/{zone}/autoscalers/{autoscaler}', 'httpMethod' => 'DELETE', 'parameters' => array('project' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'zone' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'autoscaler' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'get' => array('path' => 'projects/{project}/zones/{zone}/autoscalers/{autoscaler}', 'httpMethod' => 'GET', 'parameters' => array('project' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'zone' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'autoscaler' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'insert' => array('path' => 'projects/{project}/zones/{zone}/autoscalers', 'httpMethod' => 'POST', 'parameters' => array('project' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'zone' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'list' => array('path' => 'projects/{project}/zones/{zone}/autoscalers', 'httpMethod' => 'GET', 'parameters' => array('project' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'zone' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'filter' => array('location' => 'query', 'type' => 'string'), 'maxResults' => array('location' => 'query', 'type' => 'integer'), 'pageToken' => array('location' => 'query', 'type' => 'string'))), 'patch' => array('path' => 'projects/{project}/zones/{zone}/autoscalers/{autoscaler}', 'httpMethod' => 'PATCH', 'parameters' => array('project' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'zone' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'autoscaler' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'update' => array('path' => 'projects/{project}/zones/{zone}/autoscalers/{autoscaler}', 'httpMethod' => 'PUT', 'parameters' => array('project' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'zone' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'autoscaler' => array('location' => 'path', 'type' => 'string', 'required' => \true))))));
        $this->zoneOperations = new Google_Service_Autoscaler_ZoneOperations_Resource($this, $this->serviceName, 'zoneOperations', array('methods' => array('delete' => array('path' => '{project}/zones/{zone}/operations/{operation}', 'httpMethod' => 'DELETE', 'parameters' => array('project' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'zone' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'operation' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'get' => array('path' => '{project}/zones/{zone}/operations/{operation}', 'httpMethod' => 'GET', 'parameters' => array('project' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'zone' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'operation' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'list' => array('path' => '{project}/zones/{zone}/operations', 'httpMethod' => 'GET', 'parameters' => array('project' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'zone' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'filter' => array('location' => 'query', 'type' => 'string'), 'maxResults' => array('location' => 'query', 'type' => 'integer'), 'pageToken' => array('location' => 'query', 'type' => 'string'))))));
        $this->zones = new Google_Service_Autoscaler_Zones_Resource($this, $this->serviceName, 'zones', array('methods' => array('list' => array('path' => '{project}/zones', 'httpMethod' => 'GET', 'parameters' => array('project' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'filter' => array('location' => 'query', 'type' => 'string'), 'maxResults' => array('location' => 'query', 'type' => 'integer'), 'pageToken' => array('location' => 'query', 'type' => 'string'))))));
    }
}
/*
 * Licensed under the Apache License, Version 2.0 (the "License"); you may not
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Autoscaler', 'VendorDuplicator\\Google_Service_Autoscaler', \false);
/**
...
class Google_Service_Autoscaler_Autoscalers_Resource extends Google_Service_Resource
{
    ...
    public function delete($project, $zone, $autoscaler, $optParams = array())
    {
        ...
        return $this->call('delete', array($params), "VendorDuplicator\\Google_Service_Autoscaler_Operation");
    }
    /**
    ...
    public function get($project, $zone, $autoscaler, $optParams = array())
    {
        $params = array('project' => $project, 'zone' => $zone, 'autoscaler' => $autoscaler);
        $params = \array_merge($params, $optParams);
        return $this->call('get', array($params), "VendorDuplicator\\Google_Service_Autoscaler_Autoscaler");
    }
    /**
    ...
    public function insert($project, $zone, Google_Service_Autoscaler_Autoscaler $postBody, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('insert', array($params), "VendorDuplicator\\Google_Service_Autoscaler_Operation");
    }
    /**
    ...
    public function listAutoscalers($project, $zone, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('list', array($params), "VendorDuplicator\\Google_Service_Autoscaler_AutoscalerListResponse");
    }
    /**
    ...
    public function patch($project, $zone, $autoscaler, Google_Service_Autoscaler_Autoscaler $postBody, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('patch', array($params), "VendorDuplicator\\Google_Service_Autoscaler_Operation");
    }
    /**
    ...
    public function update($project, $zone, $autoscaler, Google_Service_Autoscaler_Autoscaler $postBody, $optParams = array())
    {
        $params = array('project' => $project, 'zone' => $zone, 'autoscaler' => $autoscaler, 'postBody' => $postBody);
        $params = \array_merge($params, $optParams);
        return $this->call('update', array($params), "VendorDuplicator\\Google_Service_Autoscaler_Operation");
    }
}
/**
 * The "autoscalers" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Autoscaler_Autoscalers_Resource', 'VendorDuplicator\\Google_Service_Autoscaler_Autoscalers_Resource', \false);
/**
...
class Google_Service_Autoscaler_ZoneOperations_Resource extends Google_Service_Resource
{
    ...
    public function get($project, $zone, $operation, $optParams = array())
    {
        $params = array('project' => $project, 'zone' => $zone, 'operation' => $operation);
        $params = \array_merge($params, $optParams);
        return $this->call('get', array($params), "VendorDuplicator\\Google_Service_Autoscaler_Operation");
    }
    /**
    ...
    public function listZoneOperations($project, $zone, $optParams = array())
    {
        $params = array('project' => $project, 'zone' => $zone);
        $params = \array_merge($params, $optParams);
        return $this->call('list', array($params), "VendorDuplicator\\Google_Service_Autoscaler_OperationList");
    }
}
/**
 * The "zoneOperations" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Autoscaler_ZoneOperations_Resource', 'VendorDuplicator\\Google_Service_Autoscaler_ZoneOperations_Resource', \false);
/**
...
class Google_Service_Autoscaler_Zones_Resource extends Google_Service_Resource
{
    ...
    public function listZones($project, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('list', array($params), "VendorDuplicator\\Google_Service_Autoscaler_ZoneList");
    }
}
/**
 * The "zones" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Autoscaler_Zones_Resource', 'VendorDuplicator\\Google_Service_Autoscaler_Zones_Resource', \false);
/** @internal */
class Google_Service_Autoscaler_Autoscaler extends Google_Model
{
    protected $internal_gapi_mappings = array();
    protected $autoscalingPolicyType = 'VendorDuplicator\\Google_Service_Autoscaler_AutoscalingPolicy';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Autoscaler_Autoscaler', 'VendorDuplicator\\Google_Service_Autoscaler_Autoscaler', \false);
/** @internal */
class Google_Service_Autoscaler_AutoscalerListResponse extends Google_Collection
{
    protected $collection_key = 'items';
    protected $internal_gapi_mappings = array();
    protected $itemsType = 'VendorDuplicator\\Google_Service_Autoscaler_Autoscaler';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Autoscaler_AutoscalerListResponse', 'VendorDuplicator\\Google_Service_Autoscaler_AutoscalerListResponse', \false);
/** @internal */
class Google_Service_Autoscaler_AutoscalingPolicy extends Google_Collection
{
    ...
    protected $cpuUtilizationType = 'VendorDuplicator\\Google_Service_Autoscaler_AutoscalingPolicyCpuUtilization';
    protected $cpuUtilizationDataType = '';
    protected $customMetricUtilizationsType = 'VendorDuplicator\\Google_Service_Autoscaler_AutoscalingPolicyCustomMetricUtilization';
    protected $customMetricUtilizationsDataType = 'array';
    protected $loadBalancingUtilizationType = 'VendorDuplicator\\Google_Service_Autoscaler_AutoscalingPolicyLoadBalancingUtilization';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Autoscaler_AutoscalingPolicy', 'VendorDuplicator\\Google_Service_Autoscaler_AutoscalingPolicy', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Autoscaler_AutoscalingPolicyCpuUtilization', 'VendorDuplicator\\Google_Service_Autoscaler_AutoscalingPolicyCpuUtilization', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Autoscaler_AutoscalingPolicyCustomMetricUtilization', 'VendorDuplicator\\Google_Service_Autoscaler_AutoscalingPolicyCustomMetricUtilization', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Autoscaler_AutoscalingPolicyLoadBalancingUtilization', 'VendorDuplicator\\Google_Service_Autoscaler_AutoscalingPolicyLoadBalancingUtilization', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Autoscaler_DeprecationStatus', 'VendorDuplicator\\Google_Service_Autoscaler_DeprecationStatus', \false);
/** @internal */
class Google_Service_Autoscaler_Operation extends Google_Collection
{
    ...
    public $creationTimestamp;
    public $endTime;
    protected $errorType = 'VendorDuplicator\\Google_Service_Autoscaler_OperationError';
    ...
    public $targetLink;
    public $user;
    protected $warningsType = 'VendorDuplicator\\Google_Service_Autoscaler_OperationWarnings';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Autoscaler_Operation', 'VendorDuplicator\\Google_Service_Autoscaler_Operation', \false);
/** @internal */
class Google_Service_Autoscaler_OperationError extends Google_Collection
{
    protected $collection_key = 'errors';
    protected $internal_gapi_mappings = array();
    protected $errorsType = 'VendorDuplicator\\Google_Service_Autoscaler_OperationErrorErrors';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Autoscaler_OperationError', 'VendorDuplicator\\Google_Service_Autoscaler_OperationError', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Autoscaler_OperationErrorErrors', 'VendorDuplicator\\Google_Service_Autoscaler_OperationErrorErrors', \false);
/** @internal */
class Google_Service_Autoscaler_OperationList extends Google_Collection
{
    ...
    protected $internal_gapi_mappings = array();
    public $id;
    protected $itemsType = 'VendorDuplicator\\Google_Service_Autoscaler_Operation';
    protected $itemsDataType = 'array';
    public $kind;
    public $nextPageToken;
    public $selfLink;
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Autoscaler_OperationList', 'VendorDuplicator\\Google_Service_Autoscaler_OperationList', \false);
/** @internal */
class Google_Service_Autoscaler_OperationWarnings extends Google_Collection
{
    ...
    protected $internal_gapi_mappings = array();
    public $code;
    protected $dataType = 'VendorDuplicator\\Google_Service_Autoscaler_OperationWarningsData';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Autoscaler_OperationWarnings', 'VendorDuplicator\\Google_Service_Autoscaler_OperationWarnings', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Autoscaler_OperationWarningsData', 'VendorDuplicator\\Google_Service_Autoscaler_OperationWarningsData', \false);
/** @internal */
class Google_Service_Autoscaler_Zone extends Google_Collection
{
    ...
    protected $internal_gapi_mappings = array();
    public $creationTimestamp;
    protected $deprecatedType = 'VendorDuplicator\\Google_Service_Autoscaler_DeprecationStatus';
    protected $deprecatedDataType = '';
    public $description;
    public $id;
    public $kind;
    protected $maintenanceWindowsType = 'VendorDuplicator\\Google_Service_Autoscaler_ZoneMaintenanceWindows';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Autoscaler_Zone', 'VendorDuplicator\\Google_Service_Autoscaler_Zone', \false);
/** @internal */
class Google_Service_Autoscaler_ZoneList extends Google_Collection
{
    ...
    protected $internal_gapi_mappings = array();
    public $id;
    protected $itemsType = 'VendorDuplicator\\Google_Service_Autoscaler_Zone';
    protected $itemsDataType = 'array';
    public $kind;
    public $nextPageToken;
    public $selfLink;
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Autoscaler_ZoneList', 'VendorDuplicator\\Google_Service_Autoscaler_ZoneList', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Autoscaler_ZoneMaintenanceWindows', 'VendorDuplicator\\Google_Service_Autoscaler_ZoneMaintenanceWindows', \false);
