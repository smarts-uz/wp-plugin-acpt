...
class Google_Service_GamesConfiguration extends Google_Service
{
    ...
    public function __construct(Google_Client $client)
    {
        ...
        $this->achievementConfigurations = new Google_Service_GamesConfiguration_AchievementConfigurations_Resource($this, $this->serviceName, 'achievementConfigurations', array('methods' => array('delete' => array('path' => 'achievements/{achievementId}', 'httpMethod' => 'DELETE', 'parameters' => array('achievementId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'get' => array('path' => 'achievements/{achievementId}', 'httpMethod' => 'GET', 'parameters' => array('achievementId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'insert' => array('path' => 'applications/{applicationId}/achievements', 'httpMethod' => 'POST', 'parameters' => array('applicationId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'list' => array('path' => 'applications/{applicationId}/achievements', 'httpMethod' => 'GET', 'parameters' => array('applicationId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'maxResults' => array('location' => 'query', 'type' => 'integer'), 'pageToken' => array('location' => 'query', 'type' => 'string'))), 'patch' => array('path' => 'achievements/{achievementId}', 'httpMethod' => 'PATCH', 'parameters' => array('achievementId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'update' => array('path' => 'achievements/{achievementId}', 'httpMethod' => 'PUT', 'parameters' => array('achievementId' => array('location' => 'path', 'type' => 'string', 'required' => \true))))));
        ...
        $this->leaderboardConfigurations = new Google_Service_GamesConfiguration_LeaderboardConfigurations_Resource($this, $this->serviceName, 'leaderboardConfigurations', array('methods' => array('delete' => array('path' => 'leaderboards/{leaderboardId}', 'httpMethod' => 'DELETE', 'parameters' => array('leaderboardId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'get' => array('path' => 'leaderboards/{leaderboardId}', 'httpMethod' => 'GET', 'parameters' => array('leaderboardId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'insert' => array('path' => 'applications/{applicationId}/leaderboards', 'httpMethod' => 'POST', 'parameters' => array('applicationId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'list' => array('path' => 'applications/{applicationId}/leaderboards', 'httpMethod' => 'GET', 'parameters' => array('applicationId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'maxResults' => array('location' => 'query', 'type' => 'integer'), 'pageToken' => array('location' => 'query', 'type' => 'string'))), 'patch' => array('path' => 'leaderboards/{leaderboardId}', 'httpMethod' => 'PATCH', 'parameters' => array('leaderboardId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'update' => array('path' => 'leaderboards/{leaderboardId}', 'httpMethod' => 'PUT', 'parameters' => array('leaderboardId' => array('location' => 'path', 'type' => 'string', 'required' => \true))))));
    }
}
/*
 * Licensed under the Apache License, Version 2.0 (the "License"); you may not
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_GamesConfiguration', 'VendorDuplicator\\Google_Service_GamesConfiguration', \false);
/**
...
class Google_Service_GamesConfiguration_AchievementConfigurations_Resource extends Google_Service_Resource
{
    ...
    public function get($achievementId, $optParams = array())
    {
        $params = array('achievementId' => $achievementId);
        $params = \array_merge($params, $optParams);
        return $this->call('get', array($params), "VendorDuplicator\\Google_Service_GamesConfiguration_AchievementConfiguration");
    }
    /**
    ...
    public function insert($applicationId, Google_Service_GamesConfiguration_AchievementConfiguration $postBody, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('insert', array($params), "VendorDuplicator\\Google_Service_GamesConfiguration_AchievementConfiguration");
    }
    /**
    ...
    public function listAchievementConfigurations($applicationId, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('list', array($params), "VendorDuplicator\\Google_Service_GamesConfiguration_AchievementConfigurationListResponse");
    }
    /**
    ...
    public function patch($achievementId, Google_Service_GamesConfiguration_AchievementConfiguration $postBody, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('patch', array($params), "VendorDuplicator\\Google_Service_GamesConfiguration_AchievementConfiguration");
    }
    /**
    ...
    public function update($achievementId, Google_Service_GamesConfiguration_AchievementConfiguration $postBody, $optParams = array())
    {
        $params = array('achievementId' => $achievementId, 'postBody' => $postBody);
        $params = \array_merge($params, $optParams);
        return $this->call('update', array($params), "VendorDuplicator\\Google_Service_GamesConfiguration_AchievementConfiguration");
    }
}
/**
 * The "achievementConfigurations" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_GamesConfiguration_AchievementConfigurations_Resource', 'VendorDuplicator\\Google_Service_GamesConfiguration_AchievementConfigurations_Resource', \false);
/**
...
class Google_Service_GamesConfiguration_ImageConfigurations_Resource extends Google_Service_Resource
{
    ...
    public function upload($resourceId, $imageType, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('upload', array($params), "VendorDuplicator\\Google_Service_GamesConfiguration_ImageConfiguration");
    }
}
/**
 * The "imageConfigurations" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_GamesConfiguration_ImageConfigurations_Resource', 'VendorDuplicator\\Google_Service_GamesConfiguration_ImageConfigurations_Resource', \false);
/**
...
class Google_Service_GamesConfiguration_LeaderboardConfigurations_Resource extends Google_Service_Resource
{
    ...
    public function get($leaderboardId, $optParams = array())
    {
        $params = array('leaderboardId' => $leaderboardId);
        $params = \array_merge($params, $optParams);
        return $this->call('get', array($params), "VendorDuplicator\\Google_Service_GamesConfiguration_LeaderboardConfiguration");
    }
    /**
    ...
    public function insert($applicationId, Google_Service_GamesConfiguration_LeaderboardConfiguration $postBody, $optParams = array())
    {
        $params = array('applicationId' => $applicationId, 'postBody' => $postBody);
        $params = \array_merge($params, $optParams);
        return $this->call('insert', array($params), "VendorDuplicator\\Google_Service_GamesConfiguration_LeaderboardConfiguration");
    }
    /**
    ...
    public function listLeaderboardConfigurations($applicationId, $optParams = array())
    {
        $params = array('applicationId' => $applicationId);
        $params = \array_merge($params, $optParams);
        return $this->call('list', array($params), "VendorDuplicator\\Google_Service_GamesConfiguration_LeaderboardConfigurationListResponse");
    }
    /**
    ...
    public function patch($leaderboardId, Google_Service_GamesConfiguration_LeaderboardConfiguration $postBody, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('patch', array($params), "VendorDuplicator\\Google_Service_GamesConfiguration_LeaderboardConfiguration");
    }
    /**
    ...
    public function update($leaderboardId, Google_Service_GamesConfiguration_LeaderboardConfiguration $postBody, $optParams = array())
    {
        $params = array('leaderboardId' => $leaderboardId, 'postBody' => $postBody);
        $params = \array_merge($params, $optParams);
        return $this->call('update', array($params), "VendorDuplicator\\Google_Service_GamesConfiguration_LeaderboardConfiguration");
    }
}
/**
 * The "leaderboardConfigurations" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_GamesConfiguration_LeaderboardConfigurations_Resource', 'VendorDuplicator\\Google_Service_GamesConfiguration_LeaderboardConfigurations_Resource', \false);
/** @internal */
class Google_Service_GamesConfiguration_AchievementConfiguration extends Google_Model
{
    protected $internal_gapi_mappings = array();
    public $achievementType;
    protected $draftType = 'VendorDuplicator\\Google_Service_GamesConfiguration_AchievementConfigurationDetail';
    protected $draftDataType = '';
    public $id;
    public $initialState;
    public $kind;
    protected $publishedType = 'VendorDuplicator\\Google_Service_GamesConfiguration_AchievementConfigurationDetail';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_GamesConfiguration_AchievementConfiguration', 'VendorDuplicator\\Google_Service_GamesConfiguration_AchievementConfiguration', \false);
/** @internal */
class Google_Service_GamesConfiguration_AchievementConfigurationDetail extends Google_Model
{
    protected $internal_gapi_mappings = array();
    protected $descriptionType = 'VendorDuplicator\\Google_Service_GamesConfiguration_LocalizedStringBundle';
    protected $descriptionDataType = '';
    public $iconUrl;
    public $kind;
    protected $nameType = 'VendorDuplicator\\Google_Service_GamesConfiguration_LocalizedStringBundle';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_GamesConfiguration_AchievementConfigurationDetail', 'VendorDuplicator\\Google_Service_GamesConfiguration_AchievementConfigurationDetail', \false);
/** @internal */
class Google_Service_GamesConfiguration_AchievementConfigurationListResponse extends Google_Collection
{
    protected $collection_key = 'items';
    protected $internal_gapi_mappings = array();
    protected $itemsType = 'VendorDuplicator\\Google_Service_GamesConfiguration_AchievementConfiguration';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_GamesConfiguration_AchievementConfigurationListResponse', 'VendorDuplicator\\Google_Service_GamesConfiguration_AchievementConfigurationListResponse', \false);
/** @internal */
class Google_Service_GamesConfiguration_GamesNumberAffixConfiguration extends Google_Model
{
    protected $internal_gapi_mappings = array();
    protected $fewType = 'VendorDuplicator\\Google_Service_GamesConfiguration_LocalizedStringBundle';
    protected $fewDataType = '';
    protected $manyType = 'VendorDuplicator\\Google_Service_GamesConfiguration_LocalizedStringBundle';
    protected $manyDataType = '';
    protected $oneType = 'VendorDuplicator\\Google_Service_GamesConfiguration_LocalizedStringBundle';
    protected $oneDataType = '';
    protected $otherType = 'VendorDuplicator\\Google_Service_GamesConfiguration_LocalizedStringBundle';
    protected $otherDataType = '';
    protected $twoType = 'VendorDuplicator\\Google_Service_GamesConfiguration_LocalizedStringBundle';
    protected $twoDataType = '';
    protected $zeroType = 'VendorDuplicator\\Google_Service_GamesConfiguration_LocalizedStringBundle';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_GamesConfiguration_GamesNumberAffixConfiguration', 'VendorDuplicator\\Google_Service_GamesConfiguration_GamesNumberAffixConfiguration', \false);
/** @internal */
class Google_Service_GamesConfiguration_GamesNumberFormatConfiguration extends Google_Model
{
    ...
    protected $suffixType = 'VendorDuplicator\\Google_Service_GamesConfiguration_GamesNumberAffixConfiguration';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_GamesConfiguration_GamesNumberFormatConfiguration', 'VendorDuplicator\\Google_Service_GamesConfiguration_GamesNumberFormatConfiguration', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_GamesConfiguration_ImageConfiguration', 'VendorDuplicator\\Google_Service_GamesConfiguration_ImageConfiguration', \false);
/** @internal */
class Google_Service_GamesConfiguration_LeaderboardConfiguration extends Google_Model
{
    protected $internal_gapi_mappings = array();
    protected $draftType = 'VendorDuplicator\\Google_Service_GamesConfiguration_LeaderboardConfigurationDetail';
    protected $draftDataType = '';
    public $id;
    public $kind;
    protected $publishedType = 'VendorDuplicator\\Google_Service_GamesConfiguration_LeaderboardConfigurationDetail';
    protected $publishedDataType = '';
    public $scoreMax;
    public $scoreMin;
    public $scoreOrder;
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_GamesConfiguration_LeaderboardConfiguration', 'VendorDuplicator\\Google_Service_GamesConfiguration_LeaderboardConfiguration', \false);
/** @internal */
class Google_Service_GamesConfiguration_LeaderboardConfigurationDetail extends Google_Model
{
    ...
    protected $nameType = 'VendorDuplicator\\Google_Service_GamesConfiguration_LocalizedStringBundle';
    protected $nameDataType = '';
    protected $scoreFormatType = 'VendorDuplicator\\Google_Service_GamesConfiguration_GamesNumberFormatConfiguration';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_GamesConfiguration_LeaderboardConfigurationDetail', 'VendorDuplicator\\Google_Service_GamesConfiguration_LeaderboardConfigurationDetail', \false);
/** @internal */
class Google_Service_GamesConfiguration_LeaderboardConfigurationListResponse extends Google_Collection
{
    protected $collection_key = 'items';
    protected $internal_gapi_mappings = array();
    protected $itemsType = 'VendorDuplicator\\Google_Service_GamesConfiguration_LeaderboardConfiguration';
    protected $itemsDataType = 'array';
    public $kind;
    public $nextPageToken;
    public function setItems($items)
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_GamesConfiguration_LeaderboardConfigurationListResponse', 'VendorDuplicator\\Google_Service_GamesConfiguration_LeaderboardConfigurationListResponse', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_GamesConfiguration_LocalizedString', 'VendorDuplicator\\Google_Service_GamesConfiguration_LocalizedString', \false);
/** @internal */
class Google_Service_GamesConfiguration_LocalizedStringBundle extends Google_Collection
{
    ...
    protected $internal_gapi_mappings = array();
    public $kind;
    protected $translationsType = 'VendorDuplicator\\Google_Service_GamesConfiguration_LocalizedString';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_GamesConfiguration_LocalizedStringBundle', 'VendorDuplicator\\Google_Service_GamesConfiguration_LocalizedStringBundle', \false);
