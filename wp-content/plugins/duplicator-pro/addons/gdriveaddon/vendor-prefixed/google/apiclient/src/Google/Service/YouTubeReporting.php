...
class Google_Service_YouTubeReporting extends Google_Service
{
    ...
    public function __construct(Google_Client $client)
    {
        ...
        $this->jobs = new Google_Service_YouTubeReporting_Jobs_Resource($this, $this->serviceName, 'jobs', array('methods' => array('create' => array('path' => 'v1/jobs', 'httpMethod' => 'POST', 'parameters' => array('onBehalfOfContentOwner' => array('location' => 'query', 'type' => 'string'))), 'delete' => array('path' => 'v1/jobs/{jobId}', 'httpMethod' => 'DELETE', 'parameters' => array('jobId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'onBehalfOfContentOwner' => array('location' => 'query', 'type' => 'string'))), 'get' => array('path' => 'v1/jobs/{jobId}', 'httpMethod' => 'GET', 'parameters' => array('jobId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'onBehalfOfContentOwner' => array('location' => 'query', 'type' => 'string'))), 'list' => array('path' => 'v1/jobs', 'httpMethod' => 'GET', 'parameters' => array('onBehalfOfContentOwner' => array('location' => 'query', 'type' => 'string'), 'pageSize' => array('location' => 'query', 'type' => 'integer'), 'pageToken' => array('location' => 'query', 'type' => 'string'))))));
        $this->jobs_reports = new Google_Service_YouTubeReporting_JobsReports_Resource($this, $this->serviceName, 'reports', array('methods' => array('get' => array('path' => 'v1/jobs/{jobId}/reports/{reportId}', 'httpMethod' => 'GET', 'parameters' => array('jobId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'reportId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'onBehalfOfContentOwner' => array('location' => 'query', 'type' => 'string'))), 'list' => array('path' => 'v1/jobs/{jobId}/reports', 'httpMethod' => 'GET', 'parameters' => array('jobId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'onBehalfOfContentOwner' => array('location' => 'query', 'type' => 'string'), 'pageSize' => array('location' => 'query', 'type' => 'integer'), 'pageToken' => array('location' => 'query', 'type' => 'string'), 'createdAfter' => array('location' => 'query', 'type' => 'string'))))));
        $this->media = new Google_Service_YouTubeReporting_Media_Resource($this, $this->serviceName, 'media', array('methods' => array('download' => array('path' => 'v1/media/{+resourceName}', 'httpMethod' => 'GET', 'parameters' => array('resourceName' => array('location' => 'path', 'type' => 'string', 'required' => \true))))));
        $this->reportTypes = new Google_Service_YouTubeReporting_ReportTypes_Resource($this, $this->serviceName, 'reportTypes', array('methods' => array('list' => array('path' => 'v1/reportTypes', 'httpMethod' => 'GET', 'parameters' => array('onBehalfOfContentOwner' => array('location' => 'query', 'type' => 'string'), 'pageSize' => array('location' => 'query', 'type' => 'integer'), 'pageToken' => array('location' => 'query', 'type' => 'string'))))));
    }
}
/*
 * Licensed under the Apache License, Version 2.0 (the "License"); you may not
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_YouTubeReporting', 'VendorDuplicator\\Google_Service_YouTubeReporting', \false);
/**
...
class Google_Service_YouTubeReporting_Jobs_Resource extends Google_Service_Resource
{
    ...
    public function create(Google_Service_YouTubeReporting_Job $postBody, $optParams = array())
    {
        ...
        return $this->call('create', array($params), "VendorDuplicator\\Google_Service_YouTubeReporting_Job");
    }
    /**
    ...
    public function delete($jobId, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('delete', array($params), "VendorDuplicator\\Google_Service_YouTubeReporting_Empty");
    }
    /**
     * Gets a job. (jobs.get)
     *
    ...
    public function get($jobId, $optParams = array())
    {
        $params = array('jobId' => $jobId);
        $params = \array_merge($params, $optParams);
        return $this->call('get', array($params), "VendorDuplicator\\Google_Service_YouTubeReporting_Job");
    }
    /**
    ...
    public function listJobs($optParams = array())
    {
        $params = array();
        $params = \array_merge($params, $optParams);
        return $this->call('list', array($params), "VendorDuplicator\\Google_Service_YouTubeReporting_ListJobsResponse");
    }
}
/**
 * The "jobs" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_YouTubeReporting_Jobs_Resource', 'VendorDuplicator\\Google_Service_YouTubeReporting_Jobs_Resource', \false);
/**
...
class Google_Service_YouTubeReporting_JobsReports_Resource extends Google_Service_Resource
{
    ...
    public function get($jobId, $reportId, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('get', array($params), "VendorDuplicator\\Google_Service_YouTubeReporting_Report");
    }
    /**
    ...
    public function listJobsReports($jobId, $optParams = array())
    {
        $params = array('jobId' => $jobId);
        $params = \array_merge($params, $optParams);
        return $this->call('list', array($params), "VendorDuplicator\\Google_Service_YouTubeReporting_ListReportsResponse");
    }
}
/**
 * The "reports" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_YouTubeReporting_JobsReports_Resource', 'VendorDuplicator\\Google_Service_YouTubeReporting_JobsReports_Resource', \false);
/**
...
class Google_Service_YouTubeReporting_Media_Resource extends Google_Service_Resource
{
    ...
    public function download($resourceName, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('download', array($params), "VendorDuplicator\\Google_Service_YouTubeReporting_Media");
    }
}
/**
 * The "media" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_YouTubeReporting_Media_Resource', 'VendorDuplicator\\Google_Service_YouTubeReporting_Media_Resource', \false);
/**
...
class Google_Service_YouTubeReporting_ReportTypes_Resource extends Google_Service_Resource
{
    ...
    public function listReportTypes($optParams = array())
    {
        $params = array();
        $params = \array_merge($params, $optParams);
        return $this->call('list', array($params), "VendorDuplicator\\Google_Service_YouTubeReporting_ListReportTypesResponse");
    }
}
/**
 * The "reportTypes" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_YouTubeReporting_ReportTypes_Resource', 'VendorDuplicator\\Google_Service_YouTubeReporting_ReportTypes_Resource', \false);
/** @internal */
class Google_Service_YouTubeReporting_Empty extends Google_Model
{
}
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_YouTubeReporting_Empty', 'VendorDuplicator\\Google_Service_YouTubeReporting_Empty', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_YouTubeReporting_Job', 'VendorDuplicator\\Google_Service_YouTubeReporting_Job', \false);
/** @internal */
class Google_Service_YouTubeReporting_ListJobsResponse extends Google_Collection
{
    protected $collection_key = 'jobs';
    protected $internal_gapi_mappings = array();
    protected $jobsType = 'VendorDuplicator\\Google_Service_YouTubeReporting_Job';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_YouTubeReporting_ListJobsResponse', 'VendorDuplicator\\Google_Service_YouTubeReporting_ListJobsResponse', \false);
/** @internal */
class Google_Service_YouTubeReporting_ListReportTypesResponse extends Google_Collection
{
    ...
    protected $internal_gapi_mappings = array();
    public $nextPageToken;
    protected $reportTypesType = 'VendorDuplicator\\Google_Service_YouTubeReporting_ReportType';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_YouTubeReporting_ListReportTypesResponse', 'VendorDuplicator\\Google_Service_YouTubeReporting_ListReportTypesResponse', \false);
/** @internal */
class Google_Service_YouTubeReporting_ListReportsResponse extends Google_Collection
{
    ...
    protected $internal_gapi_mappings = array();
    public $nextPageToken;
    protected $reportsType = 'VendorDuplicator\\Google_Service_YouTubeReporting_Report';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_YouTubeReporting_ListReportsResponse', 'VendorDuplicator\\Google_Service_YouTubeReporting_ListReportsResponse', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_YouTubeReporting_Media', 'VendorDuplicator\\Google_Service_YouTubeReporting_Media', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_YouTubeReporting_Report', 'VendorDuplicator\\Google_Service_YouTubeReporting_Report', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_YouTubeReporting_ReportType', 'VendorDuplicator\\Google_Service_YouTubeReporting_ReportType', \false);
