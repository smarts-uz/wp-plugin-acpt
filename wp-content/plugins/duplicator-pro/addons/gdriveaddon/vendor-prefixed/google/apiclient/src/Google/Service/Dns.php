...
class Google_Service_Dns extends Google_Service
{
    ...
    public function __construct(Google_Client $client)
    {
        ...
        $this->changes = new Google_Service_Dns_Changes_Resource($this, $this->serviceName, 'changes', array('methods' => array('create' => array('path' => '{project}/managedZones/{managedZone}/changes', 'httpMethod' => 'POST', 'parameters' => array('project' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'managedZone' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'get' => array('path' => '{project}/managedZones/{managedZone}/changes/{changeId}', 'httpMethod' => 'GET', 'parameters' => array('project' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'managedZone' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'changeId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'list' => array('path' => '{project}/managedZones/{managedZone}/changes', 'httpMethod' => 'GET', 'parameters' => array('project' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'managedZone' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'maxResults' => array('location' => 'query', 'type' => 'integer'), 'pageToken' => array('location' => 'query', 'type' => 'string'), 'sortBy' => array('location' => 'query', 'type' => 'string'), 'sortOrder' => array('location' => 'query', 'type' => 'string'))))));
        $this->managedZones = new Google_Service_Dns_ManagedZones_Resource($this, $this->serviceName, 'managedZones', array('methods' => array('create' => array('path' => '{project}/managedZones', 'httpMethod' => 'POST', 'parameters' => array('project' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'delete' => array('path' => '{project}/managedZones/{managedZone}', 'httpMethod' => 'DELETE', 'parameters' => array('project' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'managedZone' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'get' => array('path' => '{project}/managedZones/{managedZone}', 'httpMethod' => 'GET', 'parameters' => array('project' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'managedZone' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'list' => array('path' => '{project}/managedZones', 'httpMethod' => 'GET', 'parameters' => array('project' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'dnsName' => array('location' => 'query', 'type' => 'string'), 'maxResults' => array('location' => 'query', 'type' => 'integer'), 'pageToken' => array('location' => 'query', 'type' => 'string'))))));
        $this->projects = new Google_Service_Dns_Projects_Resource($this, $this->serviceName, 'projects', array('methods' => array('get' => array('path' => '{project}', 'httpMethod' => 'GET', 'parameters' => array('project' => array('location' => 'path', 'type' => 'string', 'required' => \true))))));
        $this->resourceRecordSets = new Google_Service_Dns_ResourceRecordSets_Resource($this, $this->serviceName, 'resourceRecordSets', array('methods' => array('list' => array('path' => '{project}/managedZones/{managedZone}/rrsets', 'httpMethod' => 'GET', 'parameters' => array('project' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'managedZone' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'maxResults' => array('location' => 'query', 'type' => 'integer'), 'name' => array('location' => 'query', 'type' => 'string'), 'pageToken' => array('location' => 'query', 'type' => 'string'), 'type' => array('location' => 'query', 'type' => 'string'))))));
    }
}
/*
 * Licensed under the Apache License, Version 2.0 (the "License"); you may not
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Dns', 'VendorDuplicator\\Google_Service_Dns', \false);
/**
...
class Google_Service_Dns_Changes_Resource extends Google_Service_Resource
{
    ...
    public function create($project, $managedZone, Google_Service_Dns_Change $postBody, $optParams = array())
    {
        ...
        return $this->call('create', array($params), "VendorDuplicator\\Google_Service_Dns_Change");
    }
    /**
    ...
    public function get($project, $managedZone, $changeId, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('get', array($params), "VendorDuplicator\\Google_Service_Dns_Change");
    }
    /**
    ...
    public function listChanges($project, $managedZone, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('list', array($params), "VendorDuplicator\\Google_Service_Dns_ChangesListResponse");
    }
}
/**
 * The "changes" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Dns_Changes_Resource', 'VendorDuplicator\\Google_Service_Dns_Changes_Resource', \false);
/**
...
class Google_Service_Dns_ManagedZones_Resource extends Google_Service_Resource
{
    ...
    public function create($project, Google_Service_Dns_ManagedZone $postBody, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('create', array($params), "VendorDuplicator\\Google_Service_Dns_ManagedZone");
    }
    /**
    ...
    public function get($project, $managedZone, $optParams = array())
    {
        $params = array('project' => $project, 'managedZone' => $managedZone);
        $params = \array_merge($params, $optParams);
        return $this->call('get', array($params), "VendorDuplicator\\Google_Service_Dns_ManagedZone");
    }
    /**
    ...
    public function listManagedZones($project, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('list', array($params), "VendorDuplicator\\Google_Service_Dns_ManagedZonesListResponse");
    }
}
/**
 * The "managedZones" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Dns_ManagedZones_Resource', 'VendorDuplicator\\Google_Service_Dns_ManagedZones_Resource', \false);
/**
...
class Google_Service_Dns_Projects_Resource extends Google_Service_Resource
{
    ...
    public function get($project, $optParams = array())
    {
        $params = array('project' => $project);
        $params = \array_merge($params, $optParams);
        return $this->call('get', array($params), "VendorDuplicator\\Google_Service_Dns_Project");
    }
}
/**
 * The "projects" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Dns_Projects_Resource', 'VendorDuplicator\\Google_Service_Dns_Projects_Resource', \false);
/**
...
class Google_Service_Dns_ResourceRecordSets_Resource extends Google_Service_Resource
{
    ...
    public function listResourceRecordSets($project, $managedZone, $optParams = array())
    {
        $params = array('project' => $project, 'managedZone' => $managedZone);
        $params = \array_merge($params, $optParams);
        return $this->call('list', array($params), "VendorDuplicator\\Google_Service_Dns_ResourceRecordSetsListResponse");
    }
}
/**
 * The "resourceRecordSets" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Dns_ResourceRecordSets_Resource', 'VendorDuplicator\\Google_Service_Dns_ResourceRecordSets_Resource', \false);
/** @internal */
class Google_Service_Dns_Change extends Google_Collection
{
    protected $collection_key = 'deletions';
    protected $internal_gapi_mappings = array();
    protected $additionsType = 'VendorDuplicator\\Google_Service_Dns_ResourceRecordSet';
    protected $additionsDataType = 'array';
    protected $deletionsType = 'VendorDuplicator\\Google_Service_Dns_ResourceRecordSet';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Dns_Change', 'VendorDuplicator\\Google_Service_Dns_Change', \false);
/** @internal */
class Google_Service_Dns_ChangesListResponse extends Google_Collection
{
    protected $collection_key = 'changes';
    protected $internal_gapi_mappings = array();
    protected $changesType = 'VendorDuplicator\\Google_Service_Dns_Change';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Dns_ChangesListResponse', 'VendorDuplicator\\Google_Service_Dns_ChangesListResponse', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Dns_ManagedZone', 'VendorDuplicator\\Google_Service_Dns_ManagedZone', \false);
/** @internal */
class Google_Service_Dns_ManagedZonesListResponse extends Google_Collection
{
    ...
    protected $internal_gapi_mappings = array();
    public $kind;
    protected $managedZonesType = 'VendorDuplicator\\Google_Service_Dns_ManagedZone';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Dns_ManagedZonesListResponse', 'VendorDuplicator\\Google_Service_Dns_ManagedZonesListResponse', \false);
/** @internal */
class Google_Service_Dns_Project extends Google_Model
{
    ...
    public $kind;
    public $number;
    protected $quotaType = 'VendorDuplicator\\Google_Service_Dns_Quota';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Dns_Project', 'VendorDuplicator\\Google_Service_Dns_Project', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Dns_Quota', 'VendorDuplicator\\Google_Service_Dns_Quota', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Dns_ResourceRecordSet', 'VendorDuplicator\\Google_Service_Dns_ResourceRecordSet', \false);
/** @internal */
class Google_Service_Dns_ResourceRecordSetsListResponse extends Google_Collection
{
    ...
    public $kind;
    public $nextPageToken;
    protected $rrsetsType = 'VendorDuplicator\\Google_Service_Dns_ResourceRecordSet';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Dns_ResourceRecordSetsListResponse', 'VendorDuplicator\\Google_Service_Dns_ResourceRecordSetsListResponse', \false);
