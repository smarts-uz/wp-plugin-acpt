 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_SiteVerification', 'VendorDuplicator\\Google_Service_SiteVerification', \false);
/**
...
class Google_Service_SiteVerification_WebResource_Resource extends Google_Service_Resource
{
    ...
    public function get($id, $optParams = array())
    {
        $params = array('id' => $id);
        $params = \array_merge($params, $optParams);
        return $this->call('get', array($params), "VendorDuplicator\\Google_Service_SiteVerification_SiteVerificationWebResourceResource");
    }
    /**
    ...
    public function getToken(Google_Service_SiteVerification_SiteVerificationWebResourceGettokenRequest $postBody, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('getToken', array($params), "VendorDuplicator\\Google_Service_SiteVerification_SiteVerificationWebResourceGettokenResponse");
    }
    /**
    ...
    public function insert($verificationMethod, Google_Service_SiteVerification_SiteVerificationWebResourceResource $postBody, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('insert', array($params), "VendorDuplicator\\Google_Service_SiteVerification_SiteVerificationWebResourceResource");
    }
    /**
    ...
    public function listWebResource($optParams = array())
    {
        $params = array();
        $params = \array_merge($params, $optParams);
        return $this->call('list', array($params), "VendorDuplicator\\Google_Service_SiteVerification_SiteVerificationWebResourceListResponse");
    }
    /**
    ...
    public function patch($id, Google_Service_SiteVerification_SiteVerificationWebResourceResource $postBody, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('patch', array($params), "VendorDuplicator\\Google_Service_SiteVerification_SiteVerificationWebResourceResource");
    }
    /**
    ...
    public function update($id, Google_Service_SiteVerification_SiteVerificationWebResourceResource $postBody, $optParams = array())
    {
        $params = array('id' => $id, 'postBody' => $postBody);
        $params = \array_merge($params, $optParams);
        return $this->call('update', array($params), "VendorDuplicator\\Google_Service_SiteVerification_SiteVerificationWebResourceResource");
    }
}
/**
 * The "webResource" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_SiteVerification_WebResource_Resource', 'VendorDuplicator\\Google_Service_SiteVerification_WebResource_Resource', \false);
/** @internal */
class Google_Service_SiteVerification_SiteVerificationWebResourceGettokenRequest extends Google_Model
{
    protected $internal_gapi_mappings = array();
    protected $siteType = 'VendorDuplicator\\Google_Service_SiteVerification_SiteVerificationWebResourceGettokenRequestSite';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_SiteVerification_SiteVerificationWebResourceGettokenRequest', 'VendorDuplicator\\Google_Service_SiteVerification_SiteVerificationWebResourceGettokenRequest', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_SiteVerification_SiteVerificationWebResourceGettokenRequestSite', 'VendorDuplicator\\Google_Service_SiteVerification_SiteVerificationWebResourceGettokenRequestSite', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_SiteVerification_SiteVerificationWebResourceGettokenResponse', 'VendorDuplicator\\Google_Service_SiteVerification_SiteVerificationWebResourceGettokenResponse', \false);
/** @internal */
class Google_Service_SiteVerification_SiteVerificationWebResourceListResponse extends Google_Collection
{
    protected $collection_key = 'items';
    protected $internal_gapi_mappings = array();
    protected $itemsType = 'VendorDuplicator\\Google_Service_SiteVerification_SiteVerificationWebResourceResource';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_SiteVerification_SiteVerificationWebResourceListResponse', 'VendorDuplicator\\Google_Service_SiteVerification_SiteVerificationWebResourceListResponse', \false);
/** @internal */
class Google_Service_SiteVerification_SiteVerificationWebResourceResource extends Google_Collection
{
    ...
    public $id;
    public $owners;
    protected $siteType = 'VendorDuplicator\\Google_Service_SiteVerification_SiteVerificationWebResourceResourceSite';
    protected $siteDataType = '';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_SiteVerification_SiteVerificationWebResourceResource', 'VendorDuplicator\\Google_Service_SiteVerification_SiteVerificationWebResourceResource', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_SiteVerification_SiteVerificationWebResourceResourceSite', 'VendorDuplicator\\Google_Service_SiteVerification_SiteVerificationWebResourceResourceSite', \false);
