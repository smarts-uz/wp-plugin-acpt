...
{
    const CACHE_PREFIX = "VendorDuplicator\\Google_Auth_AppIdentity::";
    private $client;
    private $token = \false;
    ...
    public function authenticateForScope($scopes)
    {
        ...
        if (!$this->token) {
            ...
            if ($this->token['expiration_time'] < \time()) {
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Auth_AppIdentity', 'VendorDuplicator\\Google_Auth_AppIdentity', \false);
