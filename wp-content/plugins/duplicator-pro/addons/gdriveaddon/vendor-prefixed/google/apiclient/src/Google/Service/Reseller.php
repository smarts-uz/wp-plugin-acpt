...
class Google_Service_Reseller extends Google_Service
{
    ...
    public function __construct(Google_Client $client)
    {
        ...
        $this->customers = new Google_Service_Reseller_Customers_Resource($this, $this->serviceName, 'customers', array('methods' => array('get' => array('path' => 'customers/{customerId}', 'httpMethod' => 'GET', 'parameters' => array('customerId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'insert' => array('path' => 'customers', 'httpMethod' => 'POST', 'parameters' => array('customerAuthToken' => array('location' => 'query', 'type' => 'string'))), 'patch' => array('path' => 'customers/{customerId}', 'httpMethod' => 'PATCH', 'parameters' => array('customerId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'update' => array('path' => 'customers/{customerId}', 'httpMethod' => 'PUT', 'parameters' => array('customerId' => array('location' => 'path', 'type' => 'string', 'required' => \true))))));
        $this->subscriptions = new Google_Service_Reseller_Subscriptions_Resource($this, $this->serviceName, 'subscriptions', array('methods' => array('activate' => array('path' => 'customers/{customerId}/subscriptions/{subscriptionId}/activate', 'httpMethod' => 'POST', 'parameters' => array('customerId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'subscriptionId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'changePlan' => array('path' => 'customers/{customerId}/subscriptions/{subscriptionId}/changePlan', 'httpMethod' => 'POST', 'parameters' => array('customerId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'subscriptionId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'changeRenewalSettings' => array('path' => 'customers/{customerId}/subscriptions/{subscriptionId}/changeRenewalSettings', 'httpMethod' => 'POST', 'parameters' => array('customerId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'subscriptionId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'changeSeats' => array('path' => 'customers/{customerId}/subscriptions/{subscriptionId}/changeSeats', 'httpMethod' => 'POST', 'parameters' => array('customerId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'subscriptionId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'delete' => array('path' => 'customers/{customerId}/subscriptions/{subscriptionId}', 'httpMethod' => 'DELETE', 'parameters' => array('customerId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'subscriptionId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'deletionType' => array('location' => 'query', 'type' => 'string', 'required' => \true))), 'get' => array('path' => 'customers/{customerId}/subscriptions/{subscriptionId}', 'httpMethod' => 'GET', 'parameters' => array('customerId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'subscriptionId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'insert' => array('path' => 'customers/{customerId}/subscriptions', 'httpMethod' => 'POST', 'parameters' => array('customerId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'customerAuthToken' => array('location' => 'query', 'type' => 'string'))), 'list' => array('path' => 'subscriptions', 'httpMethod' => 'GET', 'parameters' => array('customerAuthToken' => array('location' => 'query', 'type' => 'string'), 'customerId' => array('location' => 'query', 'type' => 'string'), 'customerNamePrefix' => array('location' => 'query', 'type' => 'string'), 'maxResults' => array('location' => 'query', 'type' => 'integer'), 'pageToken' => array('location' => 'query', 'type' => 'string'))), 'startPaidService' => array('path' => 'customers/{customerId}/subscriptions/{subscriptionId}/startPaidService', 'httpMethod' => 'POST', 'parameters' => array('customerId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'subscriptionId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'suspend' => array('path' => 'customers/{customerId}/subscriptions/{subscriptionId}/suspend', 'httpMethod' => 'POST', 'parameters' => array('customerId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'subscriptionId' => array('location' => 'path', 'type' => 'string', 'required' => \true))))));
    }
}
/*
 * Licensed under the Apache License, Version 2.0 (the "License"); you may not
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Reseller', 'VendorDuplicator\\Google_Service_Reseller', \false);
/**
...
class Google_Service_Reseller_Customers_Resource extends Google_Service_Resource
{
    ...
    public function get($customerId, $optParams = array())
    {
        ...
        return $this->call('get', array($params), "VendorDuplicator\\Google_Service_Reseller_Customer");
    }
    /**
    ...
    public function insert(Google_Service_Reseller_Customer $postBody, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('insert', array($params), "VendorDuplicator\\Google_Service_Reseller_Customer");
    }
    /**
    ...
    public function patch($customerId, Google_Service_Reseller_Customer $postBody, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('patch', array($params), "VendorDuplicator\\Google_Service_Reseller_Customer");
    }
    /**
     * Update a customer resource if one it exists and is owned by the reseller.
     * (customers.update)
    ...
    public function update($customerId, Google_Service_Reseller_Customer $postBody, $optParams = array())
    {
        $params = array('customerId' => $customerId, 'postBody' => $postBody);
        $params = \array_merge($params, $optParams);
        return $this->call('update', array($params), "VendorDuplicator\\Google_Service_Reseller_Customer");
    }
}
/**
 * The "customers" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Reseller_Customers_Resource', 'VendorDuplicator\\Google_Service_Reseller_Customers_Resource', \false);
/**
...
class Google_Service_Reseller_Subscriptions_Resource extends Google_Service_Resource
{
    ...
    public function activate($customerId, $subscriptionId, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('activate', array($params), "VendorDuplicator\\Google_Service_Reseller_Subscription");
    }
    /**
    ...
    public function changePlan($customerId, $subscriptionId, Google_Service_Reseller_ChangePlanRequest $postBody, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('changePlan', array($params), "VendorDuplicator\\Google_Service_Reseller_Subscription");
    }
    /**
    ...
    public function changeRenewalSettings($customerId, $subscriptionId, Google_Service_Reseller_RenewalSettings $postBody, $optParams = array())
    {
        $params = array('customerId' => $customerId, 'subscriptionId' => $subscriptionId, 'postBody' => $postBody);
        $params = \array_merge($params, $optParams);
        return $this->call('changeRenewalSettings', array($params), "VendorDuplicator\\Google_Service_Reseller_Subscription");
    }
    /**
    ...
    public function changeSeats($customerId, $subscriptionId, Google_Service_Reseller_Seats $postBody, $optParams = array())
    {
        $params = array('customerId' => $customerId, 'subscriptionId' => $subscriptionId, 'postBody' => $postBody);
        $params = \array_merge($params, $optParams);
        return $this->call('changeSeats', array($params), "VendorDuplicator\\Google_Service_Reseller_Subscription");
    }
    /**
    ...
    public function get($customerId, $subscriptionId, $optParams = array())
    {
        $params = array('customerId' => $customerId, 'subscriptionId' => $subscriptionId);
        $params = \array_merge($params, $optParams);
        return $this->call('get', array($params), "VendorDuplicator\\Google_Service_Reseller_Subscription");
    }
    /**
    ...
    public function insert($customerId, Google_Service_Reseller_Subscription $postBody, $optParams = array())
    {
        $params = array('customerId' => $customerId, 'postBody' => $postBody);
        $params = \array_merge($params, $optParams);
        return $this->call('insert', array($params), "VendorDuplicator\\Google_Service_Reseller_Subscription");
    }
    /**
    ...
    public function listSubscriptions($optParams = array())
    {
        $params = array();
        $params = \array_merge($params, $optParams);
        return $this->call('list', array($params), "VendorDuplicator\\Google_Service_Reseller_Subscriptions");
    }
    /**
    ...
    public function startPaidService($customerId, $subscriptionId, $optParams = array())
    {
        $params = array('customerId' => $customerId, 'subscriptionId' => $subscriptionId);
        $params = \array_merge($params, $optParams);
        return $this->call('startPaidService', array($params), "VendorDuplicator\\Google_Service_Reseller_Subscription");
    }
    /**
    ...
    public function suspend($customerId, $subscriptionId, $optParams = array())
    {
        $params = array('customerId' => $customerId, 'subscriptionId' => $subscriptionId);
        $params = \array_merge($params, $optParams);
        return $this->call('suspend', array($params), "VendorDuplicator\\Google_Service_Reseller_Subscription");
    }
}
/**
 * The "subscriptions" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Reseller_Subscriptions_Resource', 'VendorDuplicator\\Google_Service_Reseller_Subscriptions_Resource', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Reseller_Address', 'VendorDuplicator\\Google_Service_Reseller_Address', \false);
/** @internal */
class Google_Service_Reseller_ChangePlanRequest extends Google_Model
{
    ...
    protected $seatsType = 'VendorDuplicator\\Google_Service_Reseller_Seats';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Reseller_ChangePlanRequest', 'VendorDuplicator\\Google_Service_Reseller_ChangePlanRequest', \false);
/** @internal */
class Google_Service_Reseller_Customer extends Google_Model
{
    ...
    public $kind;
    public $phoneNumber;
    protected $postalAddressType = 'VendorDuplicator\\Google_Service_Reseller_Address';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Reseller_Customer', 'VendorDuplicator\\Google_Service_Reseller_Customer', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Reseller_RenewalSettings', 'VendorDuplicator\\Google_Service_Reseller_RenewalSettings', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Reseller_Seats', 'VendorDuplicator\\Google_Service_Reseller_Seats', \false);
/** @internal */
class Google_Service_Reseller_Subscription extends Google_Collection
{
    ...
    public $customerId;
    public $kind;
    protected $planType = 'VendorDuplicator\\Google_Service_Reseller_SubscriptionPlan';
    protected $planDataType = '';
    public $purchaseOrderId;
    protected $renewalSettingsType = 'VendorDuplicator\\Google_Service_Reseller_RenewalSettings';
    ...
    protected $transferInfoType = 'VendorDuplicator\\Google_Service_Reseller_SubscriptionTransferInfo';
    protected $transferInfoDataType = '';
    protected $trialSettingsType = 'VendorDuplicator\\Google_Service_Reseller_SubscriptionTrialSettings';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Reseller_Subscription', 'VendorDuplicator\\Google_Service_Reseller_Subscription', \false);
/** @internal */
class Google_Service_Reseller_SubscriptionPlan extends Google_Model
{
    protected $internal_gapi_mappings = array();
    protected $commitmentIntervalType = 'VendorDuplicator\\Google_Service_Reseller_SubscriptionPlanCommitmentInterval';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Reseller_SubscriptionPlan', 'VendorDuplicator\\Google_Service_Reseller_SubscriptionPlan', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Reseller_SubscriptionPlanCommitmentInterval', 'VendorDuplicator\\Google_Service_Reseller_SubscriptionPlanCommitmentInterval', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Reseller_SubscriptionTransferInfo', 'VendorDuplicator\\Google_Service_Reseller_SubscriptionTransferInfo', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Reseller_SubscriptionTrialSettings', 'VendorDuplicator\\Google_Service_Reseller_SubscriptionTrialSettings', \false);
/** @internal */
class Google_Service_Reseller_Subscriptions extends Google_Collection
{
    ...
    protected $subscriptionsType = 'VendorDuplicator\\Google_Service_Reseller_Subscription';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Reseller_Subscriptions', 'VendorDuplicator\\Google_Service_Reseller_Subscriptions', \false);
