...
class Google_Service_Directory extends Google_Service
{
    ...
    public function __construct(Google_Client $client)
    {
        ...
        $this->asps = new Google_Service_Directory_Asps_Resource($this, $this->serviceName, 'asps', array('methods' => array('delete' => array('path' => 'users/{userKey}/asps/{codeId}', 'httpMethod' => 'DELETE', 'parameters' => array('userKey' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'codeId' => array('location' => 'path', 'type' => 'integer', 'required' => \true))), 'get' => array('path' => 'users/{userKey}/asps/{codeId}', 'httpMethod' => 'GET', 'parameters' => array('userKey' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'codeId' => array('location' => 'path', 'type' => 'integer', 'required' => \true))), 'list' => array('path' => 'users/{userKey}/asps', 'httpMethod' => 'GET', 'parameters' => array('userKey' => array('location' => 'path', 'type' => 'string', 'required' => \true))))));
        $this->channels = new Google_Service_Directory_Channels_Resource($this, $this->serviceName, 'channels', array('methods' => array('stop' => array('path' => '/admin/directory_v1/channels/stop', 'httpMethod' => 'POST', 'parameters' => array()))));
        $this->chromeosdevices = new Google_Service_Directory_Chromeosdevices_Resource($this, $this->serviceName, 'chromeosdevices', array('methods' => array('get' => array('path' => 'customer/{customerId}/devices/chromeos/{deviceId}', 'httpMethod' => 'GET', 'parameters' => array('customerId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'deviceId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'projection' => array('location' => 'query', 'type' => 'string'))), 'list' => array('path' => 'customer/{customerId}/devices/chromeos', 'httpMethod' => 'GET', 'parameters' => array('customerId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'maxResults' => array('location' => 'query', 'type' => 'integer'), 'orderBy' => array('location' => 'query', 'type' => 'string'), 'pageToken' => array('location' => 'query', 'type' => 'string'), 'projection' => array('location' => 'query', 'type' => 'string'), 'query' => array('location' => 'query', 'type' => 'string'), 'sortOrder' => array('location' => 'query', 'type' => 'string'))), 'patch' => array('path' => 'customer/{customerId}/devices/chromeos/{deviceId}', 'httpMethod' => 'PATCH', 'parameters' => array('customerId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'deviceId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'projection' => array('location' => 'query', 'type' => 'string'))), 'update' => array('path' => 'customer/{customerId}/devices/chromeos/{deviceId}', 'httpMethod' => 'PUT', 'parameters' => array('customerId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'deviceId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'projection' => array('location' => 'query', 'type' => 'string'))))));
        $this->customers = new Google_Service_Directory_Customers_Resource($this, $this->serviceName, 'customers', array('methods' => array('get' => array('path' => 'customers/{customerKey}', 'httpMethod' => 'GET', 'parameters' => array('customerKey' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'patch' => array('path' => 'customers/{customerKey}', 'httpMethod' => 'PATCH', 'parameters' => array('customerKey' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'update' => array('path' => 'customers/{customerKey}', 'httpMethod' => 'PUT', 'parameters' => array('customerKey' => array('location' => 'path', 'type' => 'string', 'required' => \true))))));
        $this->domainAliases = new Google_Service_Directory_DomainAliases_Resource($this, $this->serviceName, 'domainAliases', array('methods' => array('delete' => array('path' => 'customer/{customer}/domainaliases/{domainAliasName}', 'httpMethod' => 'DELETE', 'parameters' => array('customer' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'domainAliasName' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'get' => array('path' => 'customer/{customer}/domainaliases/{domainAliasName}', 'httpMethod' => 'GET', 'parameters' => array('customer' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'domainAliasName' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'insert' => array('path' => 'customer/{customer}/domainaliases', 'httpMethod' => 'POST', 'parameters' => array('customer' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'list' => array('path' => 'customer/{customer}/domainaliases', 'httpMethod' => 'GET', 'parameters' => array('customer' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'parentDomainName' => array('location' => 'query', 'type' => 'string'))))));
        $this->domains = new Google_Service_Directory_Domains_Resource($this, $this->serviceName, 'domains', array('methods' => array('delete' => array('path' => 'customer/{customer}/domains/{domainName}', 'httpMethod' => 'DELETE', 'parameters' => array('customer' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'domainName' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'get' => array('path' => 'customer/{customer}/domains/{domainName}', 'httpMethod' => 'GET', 'parameters' => array('customer' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'domainName' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'insert' => array('path' => 'customer/{customer}/domains', 'httpMethod' => 'POST', 'parameters' => array('customer' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'list' => array('path' => 'customer/{customer}/domains', 'httpMethod' => 'GET', 'parameters' => array('customer' => array('location' => 'path', 'type' => 'string', 'required' => \true))))));
        $this->groups = new Google_Service_Directory_Groups_Resource($this, $this->serviceName, 'groups', array('methods' => array('delete' => array('path' => 'groups/{groupKey}', 'httpMethod' => 'DELETE', 'parameters' => array('groupKey' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'get' => array('path' => 'groups/{groupKey}', 'httpMethod' => 'GET', 'parameters' => array('groupKey' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'insert' => array('path' => 'groups', 'httpMethod' => 'POST', 'parameters' => array()), 'list' => array('path' => 'groups', 'httpMethod' => 'GET', 'parameters' => array('customer' => array('location' => 'query', 'type' => 'string'), 'domain' => array('location' => 'query', 'type' => 'string'), 'maxResults' => array('location' => 'query', 'type' => 'integer'), 'pageToken' => array('location' => 'query', 'type' => 'string'), 'userKey' => array('location' => 'query', 'type' => 'string'))), 'patch' => array('path' => 'groups/{groupKey}', 'httpMethod' => 'PATCH', 'parameters' => array('groupKey' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'update' => array('path' => 'groups/{groupKey}', 'httpMethod' => 'PUT', 'parameters' => array('groupKey' => array('location' => 'path', 'type' => 'string', 'required' => \true))))));
        $this->groups_aliases = new Google_Service_Directory_GroupsAliases_Resource($this, $this->serviceName, 'aliases', array('methods' => array('delete' => array('path' => 'groups/{groupKey}/aliases/{alias}', 'httpMethod' => 'DELETE', 'parameters' => array('groupKey' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'alias' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'insert' => array('path' => 'groups/{groupKey}/aliases', 'httpMethod' => 'POST', 'parameters' => array('groupKey' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'list' => array('path' => 'groups/{groupKey}/aliases', 'httpMethod' => 'GET', 'parameters' => array('groupKey' => array('location' => 'path', 'type' => 'string', 'required' => \true))))));
        $this->members = new Google_Service_Directory_Members_Resource($this, $this->serviceName, 'members', array('methods' => array('delete' => array('path' => 'groups/{groupKey}/members/{memberKey}', 'httpMethod' => 'DELETE', 'parameters' => array('groupKey' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'memberKey' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'get' => array('path' => 'groups/{groupKey}/members/{memberKey}', 'httpMethod' => 'GET', 'parameters' => array('groupKey' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'memberKey' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'insert' => array('path' => 'groups/{groupKey}/members', 'httpMethod' => 'POST', 'parameters' => array('groupKey' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'list' => array('path' => 'groups/{groupKey}/members', 'httpMethod' => 'GET', 'parameters' => array('groupKey' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'maxResults' => array('location' => 'query', 'type' => 'integer'), 'pageToken' => array('location' => 'query', 'type' => 'string'), 'roles' => array('location' => 'query', 'type' => 'string'))), 'patch' => array('path' => 'groups/{groupKey}/members/{memberKey}', 'httpMethod' => 'PATCH', 'parameters' => array('groupKey' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'memberKey' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'update' => array('path' => 'groups/{groupKey}/members/{memberKey}', 'httpMethod' => 'PUT', 'parameters' => array('groupKey' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'memberKey' => array('location' => 'path', 'type' => 'string', 'required' => \true))))));
        $this->mobiledevices = new Google_Service_Directory_Mobiledevices_Resource($this, $this->serviceName, 'mobiledevices', array('methods' => array('action' => array('path' => 'customer/{customerId}/devices/mobile/{resourceId}/action', 'httpMethod' => 'POST', 'parameters' => array('customerId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'resourceId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'delete' => array('path' => 'customer/{customerId}/devices/mobile/{resourceId}', 'httpMethod' => 'DELETE', 'parameters' => array('customerId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'resourceId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'get' => array('path' => 'customer/{customerId}/devices/mobile/{resourceId}', 'httpMethod' => 'GET', 'parameters' => array('customerId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'resourceId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'projection' => array('location' => 'query', 'type' => 'string'))), 'list' => array('path' => 'customer/{customerId}/devices/mobile', 'httpMethod' => 'GET', 'parameters' => array('customerId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'maxResults' => array('location' => 'query', 'type' => 'integer'), 'orderBy' => array('location' => 'query', 'type' => 'string'), 'pageToken' => array('location' => 'query', 'type' => 'string'), 'projection' => array('location' => 'query', 'type' => 'string'), 'query' => array('location' => 'query', 'type' => 'string'), 'sortOrder' => array('location' => 'query', 'type' => 'string'))))));
        $this->notifications = new Google_Service_Directory_Notifications_Resource($this, $this->serviceName, 'notifications', array('methods' => array('delete' => array('path' => 'customer/{customer}/notifications/{notificationId}', 'httpMethod' => 'DELETE', 'parameters' => array('customer' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'notificationId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'get' => array('path' => 'customer/{customer}/notifications/{notificationId}', 'httpMethod' => 'GET', 'parameters' => array('customer' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'notificationId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'list' => array('path' => 'customer/{customer}/notifications', 'httpMethod' => 'GET', 'parameters' => array('customer' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'language' => array('location' => 'query', 'type' => 'string'), 'maxResults' => array('location' => 'query', 'type' => 'integer'), 'pageToken' => array('location' => 'query', 'type' => 'string'))), 'patch' => array('path' => 'customer/{customer}/notifications/{notificationId}', 'httpMethod' => 'PATCH', 'parameters' => array('customer' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'notificationId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'update' => array('path' => 'customer/{customer}/notifications/{notificationId}', 'httpMethod' => 'PUT', 'parameters' => array('customer' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'notificationId' => array('location' => 'path', 'type' => 'string', 'required' => \true))))));
        $this->orgunits = new Google_Service_Directory_Orgunits_Resource($this, $this->serviceName, 'orgunits', array('methods' => array('delete' => array('path' => 'customer/{customerId}/orgunits{/orgUnitPath*}', 'httpMethod' => 'DELETE', 'parameters' => array('customerId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'orgUnitPath' => array('location' => 'path', 'type' => 'string', 'repeated' => \true, 'required' => \true))), 'get' => array('path' => 'customer/{customerId}/orgunits{/orgUnitPath*}', 'httpMethod' => 'GET', 'parameters' => array('customerId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'orgUnitPath' => array('location' => 'path', 'type' => 'string', 'repeated' => \true, 'required' => \true))), 'insert' => array('path' => 'customer/{customerId}/orgunits', 'httpMethod' => 'POST', 'parameters' => array('customerId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'list' => array('path' => 'customer/{customerId}/orgunits', 'httpMethod' => 'GET', 'parameters' => array('customerId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'orgUnitPath' => array('location' => 'query', 'type' => 'string'), 'type' => array('location' => 'query', 'type' => 'string'))), 'patch' => array('path' => 'customer/{customerId}/orgunits{/orgUnitPath*}', 'httpMethod' => 'PATCH', 'parameters' => array('customerId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'orgUnitPath' => array('location' => 'path', 'type' => 'string', 'repeated' => \true, 'required' => \true))), 'update' => array('path' => 'customer/{customerId}/orgunits{/orgUnitPath*}', 'httpMethod' => 'PUT', 'parameters' => array('customerId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'orgUnitPath' => array('location' => 'path', 'type' => 'string', 'repeated' => \true, 'required' => \true))))));
        $this->privileges = new Google_Service_Directory_Privileges_Resource($this, $this->serviceName, 'privileges', array('methods' => array('list' => array('path' => 'customer/{customer}/roles/ALL/privileges', 'httpMethod' => 'GET', 'parameters' => array('customer' => array('location' => 'path', 'type' => 'string', 'required' => \true))))));
        $this->resources_calendars = new Google_Service_Directory_ResourcesCalendars_Resource($this, $this->serviceName, 'calendars', array('methods' => array('delete' => array('path' => 'customer/{customer}/resources/calendars/{calendarResourceId}', 'httpMethod' => 'DELETE', 'parameters' => array('customer' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'calendarResourceId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'get' => array('path' => 'customer/{customer}/resources/calendars/{calendarResourceId}', 'httpMethod' => 'GET', 'parameters' => array('customer' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'calendarResourceId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'insert' => array('path' => 'customer/{customer}/resources/calendars', 'httpMethod' => 'POST', 'parameters' => array('customer' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'list' => array('path' => 'customer/{customer}/resources/calendars', 'httpMethod' => 'GET', 'parameters' => array('customer' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'maxResults' => array('location' => 'query', 'type' => 'integer'), 'pageToken' => array('location' => 'query', 'type' => 'string'))), 'patch' => array('path' => 'customer/{customer}/resources/calendars/{calendarResourceId}', 'httpMethod' => 'PATCH', 'parameters' => array('customer' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'calendarResourceId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'update' => array('path' => 'customer/{customer}/resources/calendars/{calendarResourceId}', 'httpMethod' => 'PUT', 'parameters' => array('customer' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'calendarResourceId' => array('location' => 'path', 'type' => 'string', 'required' => \true))))));
        $this->roleAssignments = new Google_Service_Directory_RoleAssignments_Resource($this, $this->serviceName, 'roleAssignments', array('methods' => array('delete' => array('path' => 'customer/{customer}/roleassignments/{roleAssignmentId}', 'httpMethod' => 'DELETE', 'parameters' => array('customer' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'roleAssignmentId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'get' => array('path' => 'customer/{customer}/roleassignments/{roleAssignmentId}', 'httpMethod' => 'GET', 'parameters' => array('customer' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'roleAssignmentId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'insert' => array('path' => 'customer/{customer}/roleassignments', 'httpMethod' => 'POST', 'parameters' => array('customer' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'list' => array('path' => 'customer/{customer}/roleassignments', 'httpMethod' => 'GET', 'parameters' => array('customer' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'maxResults' => array('location' => 'query', 'type' => 'integer'), 'pageToken' => array('location' => 'query', 'type' => 'string'), 'roleId' => array('location' => 'query', 'type' => 'string'), 'userKey' => array('location' => 'query', 'type' => 'string'))))));
        $this->roles = new Google_Service_Directory_Roles_Resource($this, $this->serviceName, 'roles', array('methods' => array('delete' => array('path' => 'customer/{customer}/roles/{roleId}', 'httpMethod' => 'DELETE', 'parameters' => array('customer' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'roleId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'get' => array('path' => 'customer/{customer}/roles/{roleId}', 'httpMethod' => 'GET', 'parameters' => array('customer' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'roleId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'insert' => array('path' => 'customer/{customer}/roles', 'httpMethod' => 'POST', 'parameters' => array('customer' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'list' => array('path' => 'customer/{customer}/roles', 'httpMethod' => 'GET', 'parameters' => array('customer' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'maxResults' => array('location' => 'query', 'type' => 'integer'), 'pageToken' => array('location' => 'query', 'type' => 'string'))), 'patch' => array('path' => 'customer/{customer}/roles/{roleId}', 'httpMethod' => 'PATCH', 'parameters' => array('customer' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'roleId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'update' => array('path' => 'customer/{customer}/roles/{roleId}', 'httpMethod' => 'PUT', 'parameters' => array('customer' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'roleId' => array('location' => 'path', 'type' => 'string', 'required' => \true))))));
        $this->schemas = new Google_Service_Directory_Schemas_Resource($this, $this->serviceName, 'schemas', array('methods' => array('delete' => array('path' => 'customer/{customerId}/schemas/{schemaKey}', 'httpMethod' => 'DELETE', 'parameters' => array('customerId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'schemaKey' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'get' => array('path' => 'customer/{customerId}/schemas/{schemaKey}', 'httpMethod' => 'GET', 'parameters' => array('customerId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'schemaKey' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'insert' => array('path' => 'customer/{customerId}/schemas', 'httpMethod' => 'POST', 'parameters' => array('customerId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'list' => array('path' => 'customer/{customerId}/schemas', 'httpMethod' => 'GET', 'parameters' => array('customerId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'patch' => array('path' => 'customer/{customerId}/schemas/{schemaKey}', 'httpMethod' => 'PATCH', 'parameters' => array('customerId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'schemaKey' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'update' => array('path' => 'customer/{customerId}/schemas/{schemaKey}', 'httpMethod' => 'PUT', 'parameters' => array('customerId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'schemaKey' => array('location' => 'path', 'type' => 'string', 'required' => \true))))));
        $this->tokens = new Google_Service_Directory_Tokens_Resource($this, $this->serviceName, 'tokens', array('methods' => array('delete' => array('path' => 'users/{userKey}/tokens/{clientId}', 'httpMethod' => 'DELETE', 'parameters' => array('userKey' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'clientId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'get' => array('path' => 'users/{userKey}/tokens/{clientId}', 'httpMethod' => 'GET', 'parameters' => array('userKey' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'clientId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'list' => array('path' => 'users/{userKey}/tokens', 'httpMethod' => 'GET', 'parameters' => array('userKey' => array('location' => 'path', 'type' => 'string', 'required' => \true))))));
        $this->users = new Google_Service_Directory_Users_Resource($this, $this->serviceName, 'users', array('methods' => array('delete' => array('path' => 'users/{userKey}', 'httpMethod' => 'DELETE', 'parameters' => array('userKey' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'get' => array('path' => 'users/{userKey}', 'httpMethod' => 'GET', 'parameters' => array('userKey' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'customFieldMask' => array('location' => 'query', 'type' => 'string'), 'projection' => array('location' => 'query', 'type' => 'string'), 'viewType' => array('location' => 'query', 'type' => 'string'))), 'insert' => array('path' => 'users', 'httpMethod' => 'POST', 'parameters' => array()), 'list' => array('path' => 'users', 'httpMethod' => 'GET', 'parameters' => array('customFieldMask' => array('location' => 'query', 'type' => 'string'), 'customer' => array('location' => 'query', 'type' => 'string'), 'domain' => array('location' => 'query', 'type' => 'string'), 'event' => array('location' => 'query', 'type' => 'string'), 'maxResults' => array('location' => 'query', 'type' => 'integer'), 'orderBy' => array('location' => 'query', 'type' => 'string'), 'pageToken' => array('location' => 'query', 'type' => 'string'), 'projection' => array('location' => 'query', 'type' => 'string'), 'query' => array('location' => 'query', 'type' => 'string'), 'showDeleted' => array('location' => 'query', 'type' => 'string'), 'sortOrder' => array('location' => 'query', 'type' => 'string'), 'viewType' => array('location' => 'query', 'type' => 'string'))), 'makeAdmin' => array('path' => 'users/{userKey}/makeAdmin', 'httpMethod' => 'POST', 'parameters' => array('userKey' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'patch' => array('path' => 'users/{userKey}', 'httpMethod' => 'PATCH', 'parameters' => array('userKey' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'undelete' => array('path' => 'users/{userKey}/undelete', 'httpMethod' => 'POST', 'parameters' => array('userKey' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'update' => array('path' => 'users/{userKey}', 'httpMethod' => 'PUT', 'parameters' => array('userKey' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'watch' => array('path' => 'users/watch', 'httpMethod' => 'POST', 'parameters' => array('customFieldMask' => array('location' => 'query', 'type' => 'string'), 'customer' => array('location' => 'query', 'type' => 'string'), 'domain' => array('location' => 'query', 'type' => 'string'), 'event' => array('location' => 'query', 'type' => 'string'), 'maxResults' => array('location' => 'query', 'type' => 'integer'), 'orderBy' => array('location' => 'query', 'type' => 'string'), 'pageToken' => array('location' => 'query', 'type' => 'string'), 'projection' => array('location' => 'query', 'type' => 'string'), 'query' => array('location' => 'query', 'type' => 'string'), 'showDeleted' => array('location' => 'query', 'type' => 'string'), 'sortOrder' => array('location' => 'query', 'type' => 'string'), 'viewType' => array('location' => 'query', 'type' => 'string'))))));
        $this->users_aliases = new Google_Service_Directory_UsersAliases_Resource($this, $this->serviceName, 'aliases', array('methods' => array('delete' => array('path' => 'users/{userKey}/aliases/{alias}', 'httpMethod' => 'DELETE', 'parameters' => array('userKey' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'alias' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'insert' => array('path' => 'users/{userKey}/aliases', 'httpMethod' => 'POST', 'parameters' => array('userKey' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'list' => array('path' => 'users/{userKey}/aliases', 'httpMethod' => 'GET', 'parameters' => array('userKey' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'event' => array('location' => 'query', 'type' => 'string'))), 'watch' => array('path' => 'users/{userKey}/aliases/watch', 'httpMethod' => 'POST', 'parameters' => array('userKey' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'event' => array('location' => 'query', 'type' => 'string'))))));
        $this->users_photos = new Google_Service_Directory_UsersPhotos_Resource($this, $this->serviceName, 'photos', array('methods' => array('delete' => array('path' => 'users/{userKey}/photos/thumbnail', 'httpMethod' => 'DELETE', 'parameters' => array('userKey' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'get' => array('path' => 'users/{userKey}/photos/thumbnail', 'httpMethod' => 'GET', 'parameters' => array('userKey' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'patch' => array('path' => 'users/{userKey}/photos/thumbnail', 'httpMethod' => 'PATCH', 'parameters' => array('userKey' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'update' => array('path' => 'users/{userKey}/photos/thumbnail', 'httpMethod' => 'PUT', 'parameters' => array('userKey' => array('location' => 'path', 'type' => 'string', 'required' => \true))))));
        $this->verificationCodes = new Google_Service_Directory_VerificationCodes_Resource($this, $this->serviceName, 'verificationCodes', array('methods' => array('generate' => array('path' => 'users/{userKey}/verificationCodes/generate', 'httpMethod' => 'POST', 'parameters' => array('userKey' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'invalidate' => array('path' => 'users/{userKey}/verificationCodes/invalidate', 'httpMethod' => 'POST', 'parameters' => array('userKey' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'list' => array('path' => 'users/{userKey}/verificationCodes', 'httpMethod' => 'GET', 'parameters' => array('userKey' => array('location' => 'path', 'type' => 'string', 'required' => \true))))));
    }
}
/*
 * Licensed under the Apache License, Version 2.0 (the "License"); you may not
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Directory', 'VendorDuplicator\\Google_Service_Directory', \false);
/**
...
class Google_Service_Directory_Asps_Resource extends Google_Service_Resource
{
    ...
    public function get($userKey, $codeId, $optParams = array())
    {
        $params = array('userKey' => $userKey, 'codeId' => $codeId);
        $params = \array_merge($params, $optParams);
        return $this->call('get', array($params), "VendorDuplicator\\Google_Service_Directory_Asp");
    }
    /**
    ...
    public function listAsps($userKey, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('list', array($params), "VendorDuplicator\\Google_Service_Directory_Asps");
    }
}
/**
 * The "asps" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Directory_Asps_Resource', 'VendorDuplicator\\Google_Service_Directory_Asps_Resource', \false);
/**
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Directory_Channels_Resource', 'VendorDuplicator\\Google_Service_Directory_Channels_Resource', \false);
/**
...
class Google_Service_Directory_Chromeosdevices_Resource extends Google_Service_Resource
{
    ...
    public function get($customerId, $deviceId, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('get', array($params), "VendorDuplicator\\Google_Service_Directory_ChromeOsDevice");
    }
    /**
    ...
    public function listChromeosdevices($customerId, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('list', array($params), "VendorDuplicator\\Google_Service_Directory_ChromeOsDevices");
    }
    /**
    ...
    public function patch($customerId, $deviceId, Google_Service_Directory_ChromeOsDevice $postBody, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('patch', array($params), "VendorDuplicator\\Google_Service_Directory_ChromeOsDevice");
    }
    /**
    ...
    public function update($customerId, $deviceId, Google_Service_Directory_ChromeOsDevice $postBody, $optParams = array())
    {
        $params = array('customerId' => $customerId, 'deviceId' => $deviceId, 'postBody' => $postBody);
        $params = \array_merge($params, $optParams);
        return $this->call('update', array($params), "VendorDuplicator\\Google_Service_Directory_ChromeOsDevice");
    }
}
/**
 * The "chromeosdevices" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Directory_Chromeosdevices_Resource', 'VendorDuplicator\\Google_Service_Directory_Chromeosdevices_Resource', \false);
/**
...
class Google_Service_Directory_Customers_Resource extends Google_Service_Resource
{
    ...
    public function get($customerKey, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('get', array($params), "VendorDuplicator\\Google_Service_Directory_Customer");
    }
    /**
    ...
    public function patch($customerKey, Google_Service_Directory_Customer $postBody, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('patch', array($params), "VendorDuplicator\\Google_Service_Directory_Customer");
    }
    /**
    ...
    public function update($customerKey, Google_Service_Directory_Customer $postBody, $optParams = array())
    {
        $params = array('customerKey' => $customerKey, 'postBody' => $postBody);
        $params = \array_merge($params, $optParams);
        return $this->call('update', array($params), "VendorDuplicator\\Google_Service_Directory_Customer");
    }
}
/**
 * The "customers" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Directory_Customers_Resource', 'VendorDuplicator\\Google_Service_Directory_Customers_Resource', \false);
/**
...
class Google_Service_Directory_DomainAliases_Resource extends Google_Service_Resource
{
    ...
    public function get($customer, $domainAliasName, $optParams = array())
    {
        $params = array('customer' => $customer, 'domainAliasName' => $domainAliasName);
        $params = \array_merge($params, $optParams);
        return $this->call('get', array($params), "VendorDuplicator\\Google_Service_Directory_DomainAlias");
    }
    /**
    ...
    public function insert($customer, Google_Service_Directory_DomainAlias $postBody, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('insert', array($params), "VendorDuplicator\\Google_Service_Directory_DomainAlias");
    }
    /**
    ...
    public function listDomainAliases($customer, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('list', array($params), "VendorDuplicator\\Google_Service_Directory_DomainAliases");
    }
}
/**
 * The "domainAliases" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Directory_DomainAliases_Resource', 'VendorDuplicator\\Google_Service_Directory_DomainAliases_Resource', \false);
/**
...
class Google_Service_Directory_Domains_Resource extends Google_Service_Resource
{
    ...
    public function get($customer, $domainName, $optParams = array())
    {
        $params = array('customer' => $customer, 'domainName' => $domainName);
        $params = \array_merge($params, $optParams);
        return $this->call('get', array($params), "VendorDuplicator\\Google_Service_Directory_Domains");
    }
    /**
    ...
    public function insert($customer, Google_Service_Directory_Domains $postBody, $optParams = array())
    {
        $params = array('customer' => $customer, 'postBody' => $postBody);
        $params = \array_merge($params, $optParams);
        return $this->call('insert', array($params), "VendorDuplicator\\Google_Service_Directory_Domains");
    }
    /**
    ...
    public function listDomains($customer, $optParams = array())
    {
        $params = array('customer' => $customer);
        $params = \array_merge($params, $optParams);
        return $this->call('list', array($params), "VendorDuplicator\\Google_Service_Directory_Domains2");
    }
}
/**
 * The "domains" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Directory_Domains_Resource', 'VendorDuplicator\\Google_Service_Directory_Domains_Resource', \false);
/**
...
class Google_Service_Directory_Groups_Resource extends Google_Service_Resource
{
    ...
    public function get($groupKey, $optParams = array())
    {
        $params = array('groupKey' => $groupKey);
        $params = \array_merge($params, $optParams);
        return $this->call('get', array($params), "VendorDuplicator\\Google_Service_Directory_Group");
    }
    /**
    ...
    public function insert(Google_Service_Directory_Group $postBody, $optParams = array())
    {
        $params = array('postBody' => $postBody);
        $params = \array_merge($params, $optParams);
        return $this->call('insert', array($params), "VendorDuplicator\\Google_Service_Directory_Group");
    }
    /**
    ...
    public function listGroups($optParams = array())
    {
        $params = array();
        $params = \array_merge($params, $optParams);
        return $this->call('list', array($params), "VendorDuplicator\\Google_Service_Directory_Groups");
    }
    /**
    ...
    public function patch($groupKey, Google_Service_Directory_Group $postBody, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('patch', array($params), "VendorDuplicator\\Google_Service_Directory_Group");
    }
    /**
    ...
    public function update($groupKey, Google_Service_Directory_Group $postBody, $optParams = array())
    {
        $params = array('groupKey' => $groupKey, 'postBody' => $postBody);
        $params = \array_merge($params, $optParams);
        return $this->call('update', array($params), "VendorDuplicator\\Google_Service_Directory_Group");
    }
}
/**
 * The "groups" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Directory_Groups_Resource', 'VendorDuplicator\\Google_Service_Directory_Groups_Resource', \false);
/**
...
class Google_Service_Directory_GroupsAliases_Resource extends Google_Service_Resource
{
    ...
    public function insert($groupKey, Google_Service_Directory_Alias $postBody, $optParams = array())
    {
        $params = array('groupKey' => $groupKey, 'postBody' => $postBody);
        $params = \array_merge($params, $optParams);
        return $this->call('insert', array($params), "VendorDuplicator\\Google_Service_Directory_Alias");
    }
    /**
    ...
    public function listGroupsAliases($groupKey, $optParams = array())
    {
        $params = array('groupKey' => $groupKey);
        $params = \array_merge($params, $optParams);
        return $this->call('list', array($params), "VendorDuplicator\\Google_Service_Directory_Aliases");
    }
}
/**
 * The "aliases" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Directory_GroupsAliases_Resource', 'VendorDuplicator\\Google_Service_Directory_GroupsAliases_Resource', \false);
/**
...
class Google_Service_Directory_Members_Resource extends Google_Service_Resource
{
    ...
    public function get($groupKey, $memberKey, $optParams = array())
    {
        $params = array('groupKey' => $groupKey, 'memberKey' => $memberKey);
        $params = \array_merge($params, $optParams);
        return $this->call('get', array($params), "VendorDuplicator\\Google_Service_Directory_Member");
    }
    /**
    ...
    public function insert($groupKey, Google_Service_Directory_Member $postBody, $optParams = array())
    {
        $params = array('groupKey' => $groupKey, 'postBody' => $postBody);
        $params = \array_merge($params, $optParams);
        return $this->call('insert', array($params), "VendorDuplicator\\Google_Service_Directory_Member");
    }
    /**
    ...
    public function listMembers($groupKey, $optParams = array())
    {
        $params = array('groupKey' => $groupKey);
        $params = \array_merge($params, $optParams);
        return $this->call('list', array($params), "VendorDuplicator\\Google_Service_Directory_Members");
    }
    /**
    ...
    public function patch($groupKey, $memberKey, Google_Service_Directory_Member $postBody, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('patch', array($params), "VendorDuplicator\\Google_Service_Directory_Member");
    }
    /**
    ...
    public function update($groupKey, $memberKey, Google_Service_Directory_Member $postBody, $optParams = array())
    {
        $params = array('groupKey' => $groupKey, 'memberKey' => $memberKey, 'postBody' => $postBody);
        $params = \array_merge($params, $optParams);
        return $this->call('update', array($params), "VendorDuplicator\\Google_Service_Directory_Member");
    }
}
/**
 * The "members" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Directory_Members_Resource', 'VendorDuplicator\\Google_Service_Directory_Members_Resource', \false);
/**
...
class Google_Service_Directory_Mobiledevices_Resource extends Google_Service_Resource
{
    ...
    public function get($customerId, $resourceId, $optParams = array())
    {
        $params = array('customerId' => $customerId, 'resourceId' => $resourceId);
        $params = \array_merge($params, $optParams);
        return $this->call('get', array($params), "VendorDuplicator\\Google_Service_Directory_MobileDevice");
    }
    /**
    ...
    public function listMobiledevices($customerId, $optParams = array())
    {
        $params = array('customerId' => $customerId);
        $params = \array_merge($params, $optParams);
        return $this->call('list', array($params), "VendorDuplicator\\Google_Service_Directory_MobileDevices");
    }
}
/**
 * The "mobiledevices" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Directory_Mobiledevices_Resource', 'VendorDuplicator\\Google_Service_Directory_Mobiledevices_Resource', \false);
/**
...
class Google_Service_Directory_Notifications_Resource extends Google_Service_Resource
{
    ...
    public function get($customer, $notificationId, $optParams = array())
    {
        $params = array('customer' => $customer, 'notificationId' => $notificationId);
        $params = \array_merge($params, $optParams);
        return $this->call('get', array($params), "VendorDuplicator\\Google_Service_Directory_Notification");
    }
    /**
    ...
    public function listNotifications($customer, $optParams = array())
    {
        $params = array('customer' => $customer);
        $params = \array_merge($params, $optParams);
        return $this->call('list', array($params), "VendorDuplicator\\Google_Service_Directory_Notifications");
    }
    /**
    ...
    public function patch($customer, $notificationId, Google_Service_Directory_Notification $postBody, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('patch', array($params), "VendorDuplicator\\Google_Service_Directory_Notification");
    }
    /**
    ...
    public function update($customer, $notificationId, Google_Service_Directory_Notification $postBody, $optParams = array())
    {
        $params = array('customer' => $customer, 'notificationId' => $notificationId, 'postBody' => $postBody);
        $params = \array_merge($params, $optParams);
        return $this->call('update', array($params), "VendorDuplicator\\Google_Service_Directory_Notification");
    }
}
/**
 * The "notifications" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Directory_Notifications_Resource', 'VendorDuplicator\\Google_Service_Directory_Notifications_Resource', \false);
/**
...
class Google_Service_Directory_Orgunits_Resource extends Google_Service_Resource
{
    ...
    public function get($customerId, $orgUnitPath, $optParams = array())
    {
        $params = array('customerId' => $customerId, 'orgUnitPath' => $orgUnitPath);
        $params = \array_merge($params, $optParams);
        return $this->call('get', array($params), "VendorDuplicator\\Google_Service_Directory_OrgUnit");
    }
    /**
    ...
    public function insert($customerId, Google_Service_Directory_OrgUnit $postBody, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('insert', array($params), "VendorDuplicator\\Google_Service_Directory_OrgUnit");
    }
    /**
    ...
    public function listOrgunits($customerId, $optParams = array())
    {
        $params = array('customerId' => $customerId);
        $params = \array_merge($params, $optParams);
        return $this->call('list', array($params), "VendorDuplicator\\Google_Service_Directory_OrgUnits");
    }
    /**
    ...
    public function patch($customerId, $orgUnitPath, Google_Service_Directory_OrgUnit $postBody, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('patch', array($params), "VendorDuplicator\\Google_Service_Directory_OrgUnit");
    }
    /**
    ...
    public function update($customerId, $orgUnitPath, Google_Service_Directory_OrgUnit $postBody, $optParams = array())
    {
        $params = array('customerId' => $customerId, 'orgUnitPath' => $orgUnitPath, 'postBody' => $postBody);
        $params = \array_merge($params, $optParams);
        return $this->call('update', array($params), "VendorDuplicator\\Google_Service_Directory_OrgUnit");
    }
}
/**
 * The "orgunits" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Directory_Orgunits_Resource', 'VendorDuplicator\\Google_Service_Directory_Orgunits_Resource', \false);
/**
...
class Google_Service_Directory_Privileges_Resource extends Google_Service_Resource
{
    ...
    public function listPrivileges($customer, $optParams = array())
    {
        $params = array('customer' => $customer);
        $params = \array_merge($params, $optParams);
        return $this->call('list', array($params), "VendorDuplicator\\Google_Service_Directory_Privileges");
    }
}
/**
 * The "privileges" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Directory_Privileges_Resource', 'VendorDuplicator\\Google_Service_Directory_Privileges_Resource', \false);
/**
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Directory_Resources_Resource', 'VendorDuplicator\\Google_Service_Directory_Resources_Resource', \false);
/**
...
class Google_Service_Directory_ResourcesCalendars_Resource extends Google_Service_Resource
{
    ...
    public function get($customer, $calendarResourceId, $optParams = array())
    {
        $params = array('customer' => $customer, 'calendarResourceId' => $calendarResourceId);
        $params = \array_merge($params, $optParams);
        return $this->call('get', array($params), "VendorDuplicator\\Google_Service_Directory_CalendarResource");
    }
    /**
    ...
    public function insert($customer, Google_Service_Directory_CalendarResource $postBody, $optParams = array())
    {
        $params = array('customer' => $customer, 'postBody' => $postBody);
        $params = \array_merge($params, $optParams);
        return $this->call('insert', array($params), "VendorDuplicator\\Google_Service_Directory_CalendarResource");
    }
    /**
    ...
    public function listResourcesCalendars($customer, $optParams = array())
    {
        $params = array('customer' => $customer);
        $params = \array_merge($params, $optParams);
        return $this->call('list', array($params), "VendorDuplicator\\Google_Service_Directory_CalendarResources");
    }
    /**
    ...
    public function patch($customer, $calendarResourceId, Google_Service_Directory_CalendarResource $postBody, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('patch', array($params), "VendorDuplicator\\Google_Service_Directory_CalendarResource");
    }
    /**
    ...
    public function update($customer, $calendarResourceId, Google_Service_Directory_CalendarResource $postBody, $optParams = array())
    {
        $params = array('customer' => $customer, 'calendarResourceId' => $calendarResourceId, 'postBody' => $postBody);
        $params = \array_merge($params, $optParams);
        return $this->call('update', array($params), "VendorDuplicator\\Google_Service_Directory_CalendarResource");
    }
}
/**
 * The "calendars" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Directory_ResourcesCalendars_Resource', 'VendorDuplicator\\Google_Service_Directory_ResourcesCalendars_Resource', \false);
/**
...
class Google_Service_Directory_RoleAssignments_Resource extends Google_Service_Resource
{
    ...
    public function get($customer, $roleAssignmentId, $optParams = array())
    {
        $params = array('customer' => $customer, 'roleAssignmentId' => $roleAssignmentId);
        $params = \array_merge($params, $optParams);
        return $this->call('get', array($params), "VendorDuplicator\\Google_Service_Directory_RoleAssignment");
    }
    /**
    ...
    public function insert($customer, Google_Service_Directory_RoleAssignment $postBody, $optParams = array())
    {
        $params = array('customer' => $customer, 'postBody' => $postBody);
        $params = \array_merge($params, $optParams);
        return $this->call('insert', array($params), "VendorDuplicator\\Google_Service_Directory_RoleAssignment");
    }
    /**
    ...
    public function listRoleAssignments($customer, $optParams = array())
    {
        $params = array('customer' => $customer);
        $params = \array_merge($params, $optParams);
        return $this->call('list', array($params), "VendorDuplicator\\Google_Service_Directory_RoleAssignments");
    }
}
/**
 * The "roleAssignments" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Directory_RoleAssignments_Resource', 'VendorDuplicator\\Google_Service_Directory_RoleAssignments_Resource', \false);
/**
...
class Google_Service_Directory_Roles_Resource extends Google_Service_Resource
{
    ...
    public function get($customer, $roleId, $optParams = array())
    {
        $params = array('customer' => $customer, 'roleId' => $roleId);
        $params = \array_merge($params, $optParams);
        return $this->call('get', array($params), "VendorDuplicator\\Google_Service_Directory_Role");
    }
    /**
    ...
    public function insert($customer, Google_Service_Directory_Role $postBody, $optParams = array())
    {
        $params = array('customer' => $customer, 'postBody' => $postBody);
        $params = \array_merge($params, $optParams);
        return $this->call('insert', array($params), "VendorDuplicator\\Google_Service_Directory_Role");
    }
    /**
    ...
    public function listRoles($customer, $optParams = array())
    {
        $params = array('customer' => $customer);
        $params = \array_merge($params, $optParams);
        return $this->call('list', array($params), "VendorDuplicator\\Google_Service_Directory_Roles");
    }
    /**
    ...
    public function patch($customer, $roleId, Google_Service_Directory_Role $postBody, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('patch', array($params), "VendorDuplicator\\Google_Service_Directory_Role");
    }
    /**
    ...
    public function update($customer, $roleId, Google_Service_Directory_Role $postBody, $optParams = array())
    {
        $params = array('customer' => $customer, 'roleId' => $roleId, 'postBody' => $postBody);
        $params = \array_merge($params, $optParams);
        return $this->call('update', array($params), "VendorDuplicator\\Google_Service_Directory_Role");
    }
}
/**
 * The "roles" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Directory_Roles_Resource', 'VendorDuplicator\\Google_Service_Directory_Roles_Resource', \false);
/**
...
class Google_Service_Directory_Schemas_Resource extends Google_Service_Resource
{
    ...
    public function get($customerId, $schemaKey, $optParams = array())
    {
        $params = array('customerId' => $customerId, 'schemaKey' => $schemaKey);
        $params = \array_merge($params, $optParams);
        return $this->call('get', array($params), "VendorDuplicator\\Google_Service_Directory_Schema");
    }
    /**
    ...
    public function insert($customerId, Google_Service_Directory_Schema $postBody, $optParams = array())
    {
        $params = array('customerId' => $customerId, 'postBody' => $postBody);
        $params = \array_merge($params, $optParams);
        return $this->call('insert', array($params), "VendorDuplicator\\Google_Service_Directory_Schema");
    }
    /**
    ...
    public function listSchemas($customerId, $optParams = array())
    {
        $params = array('customerId' => $customerId);
        $params = \array_merge($params, $optParams);
        return $this->call('list', array($params), "VendorDuplicator\\Google_Service_Directory_Schemas");
    }
    /**
    ...
    public function patch($customerId, $schemaKey, Google_Service_Directory_Schema $postBody, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('patch', array($params), "VendorDuplicator\\Google_Service_Directory_Schema");
    }
    /**
    ...
    public function update($customerId, $schemaKey, Google_Service_Directory_Schema $postBody, $optParams = array())
    {
        $params = array('customerId' => $customerId, 'schemaKey' => $schemaKey, 'postBody' => $postBody);
        $params = \array_merge($params, $optParams);
        return $this->call('update', array($params), "VendorDuplicator\\Google_Service_Directory_Schema");
    }
}
/**
 * The "schemas" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Directory_Schemas_Resource', 'VendorDuplicator\\Google_Service_Directory_Schemas_Resource', \false);
/**
...
class Google_Service_Directory_Tokens_Resource extends Google_Service_Resource
{
    ...
    public function get($userKey, $clientId, $optParams = array())
    {
        $params = array('userKey' => $userKey, 'clientId' => $clientId);
        $params = \array_merge($params, $optParams);
        return $this->call('get', array($params), "VendorDuplicator\\Google_Service_Directory_Token");
    }
    /**
    ...
    public function listTokens($userKey, $optParams = array())
    {
        $params = array('userKey' => $userKey);
        $params = \array_merge($params, $optParams);
        return $this->call('list', array($params), "VendorDuplicator\\Google_Service_Directory_Tokens");
    }
}
/**
 * The "tokens" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Directory_Tokens_Resource', 'VendorDuplicator\\Google_Service_Directory_Tokens_Resource', \false);
/**
...
class Google_Service_Directory_Users_Resource extends Google_Service_Resource
{
    ...
    public function get($userKey, $optParams = array())
    {
        $params = array('userKey' => $userKey);
        $params = \array_merge($params, $optParams);
        return $this->call('get', array($params), "VendorDuplicator\\Google_Service_Directory_User");
    }
    /**
    ...
    public function insert(Google_Service_Directory_User $postBody, $optParams = array())
    {
        $params = array('postBody' => $postBody);
        $params = \array_merge($params, $optParams);
        return $this->call('insert', array($params), "VendorDuplicator\\Google_Service_Directory_User");
    }
    /**
    ...
    public function listUsers($optParams = array())
    {
        $params = array();
        $params = \array_merge($params, $optParams);
        return $this->call('list', array($params), "VendorDuplicator\\Google_Service_Directory_Users");
    }
    /**
    ...
    public function patch($userKey, Google_Service_Directory_User $postBody, $optParams = array())
    {
        $params = array('userKey' => $userKey, 'postBody' => $postBody);
        $params = \array_merge($params, $optParams);
        return $this->call('patch', array($params), "VendorDuplicator\\Google_Service_Directory_User");
    }
    /**
    ...
    public function update($userKey, Google_Service_Directory_User $postBody, $optParams = array())
    {
        $params = array('userKey' => $userKey, 'postBody' => $postBody);
        $params = \array_merge($params, $optParams);
        return $this->call('update', array($params), "VendorDuplicator\\Google_Service_Directory_User");
    }
    /**
    ...
    public function watch(Google_Service_Directory_Channel $postBody, $optParams = array())
    {
        $params = array('postBody' => $postBody);
        $params = \array_merge($params, $optParams);
        return $this->call('watch', array($params), "VendorDuplicator\\Google_Service_Directory_Channel");
    }
}
/**
 * The "users" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Directory_Users_Resource', 'VendorDuplicator\\Google_Service_Directory_Users_Resource', \false);
/**
 * The "aliases" collection of methods.
 * Typical usage is:
 *  <code>
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Directory_UsersAliases_Resource', 'VendorDuplicator\\Google_Service_Directory_UsersAliases_Resource', \false);
/**
...
class Google_Service_Directory_UsersPhotos_Resource extends Google_Service_Resource
{
    ...
    public function get($userKey, $optParams = array())
    {
        $params = array('userKey' => $userKey);
        $params = \array_merge($params, $optParams);
        return $this->call('get', array($params), "VendorDuplicator\\Google_Service_Directory_UserPhoto");
    }
    /**
    ...
    public function patch($userKey, Google_Service_Directory_UserPhoto $postBody, $optParams = array())
    {
        $params = array('userKey' => $userKey, 'postBody' => $postBody);
        $params = \array_merge($params, $optParams);
        return $this->call('patch', array($params), "VendorDuplicator\\Google_Service_Directory_UserPhoto");
    }
    /**
    ...
    public function update($userKey, Google_Service_Directory_UserPhoto $postBody, $optParams = array())
    {
        $params = array('userKey' => $userKey, 'postBody' => $postBody);
        $params = \array_merge($params, $optParams);
        return $this->call('update', array($params), "VendorDuplicator\\Google_Service_Directory_UserPhoto");
    }
}
/**
 * The "photos" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Directory_UsersPhotos_Resource', 'VendorDuplicator\\Google_Service_Directory_UsersPhotos_Resource', \false);
/**
...
class Google_Service_Directory_VerificationCodes_Resource extends Google_Service_Resource
{
    ...
    public function listVerificationCodes($userKey, $optParams = array())
    {
        $params = array('userKey' => $userKey);
        $params = \array_merge($params, $optParams);
        return $this->call('list', array($params), "VendorDuplicator\\Google_Service_Directory_VerificationCodes");
    }
}
/**
 * The "verificationCodes" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Directory_VerificationCodes_Resource', 'VendorDuplicator\\Google_Service_Directory_VerificationCodes_Resource', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Directory_Alias', 'VendorDuplicator\\Google_Service_Directory_Alias', \false);
/** @internal */
class Google_Service_Directory_Aliases extends Google_Collection
{
    protected $collection_key = 'aliases';
    protected $internal_gapi_mappings = array();
    protected $aliasesType = 'VendorDuplicator\\Google_Service_Directory_Alias';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Directory_Aliases', 'VendorDuplicator\\Google_Service_Directory_Aliases', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Directory_Asp', 'VendorDuplicator\\Google_Service_Directory_Asp', \false);
/** @internal */
class Google_Service_Directory_Asps extends Google_Collection
{
    ...
    protected $internal_gapi_mappings = array();
    public $etag;
    protected $itemsType = 'VendorDuplicator\\Google_Service_Directory_Asp';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Directory_Asps', 'VendorDuplicator\\Google_Service_Directory_Asps', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Directory_CalendarResource', 'VendorDuplicator\\Google_Service_Directory_CalendarResource', \false);
/** @internal */
class Google_Service_Directory_CalendarResources extends Google_Collection
{
    ...
    protected $internal_gapi_mappings = array();
    public $etag;
    protected $itemsType = 'VendorDuplicator\\Google_Service_Directory_CalendarResource';
    protected $itemsDataType = 'array';
    public $kind;
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Directory_CalendarResources', 'VendorDuplicator\\Google_Service_Directory_CalendarResources', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Directory_Channel', 'VendorDuplicator\\Google_Service_Directory_Channel', \false);
/** @internal */
class Google_Service_Directory_ChromeOsDevice extends Google_Collection
{
    protected $collection_key = 'recentUsers';
    protected $internal_gapi_mappings = array();
    protected $activeTimeRangesType = 'VendorDuplicator\\Google_Service_Directory_ChromeOsDeviceActiveTimeRanges';
    ...
    protected $recentUsersType = 'VendorDuplicator\\Google_Service_Directory_ChromeOsDeviceRecentUsers';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Directory_ChromeOsDevice', 'VendorDuplicator\\Google_Service_Directory_ChromeOsDevice', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Directory_ChromeOsDeviceActiveTimeRanges', 'VendorDuplicator\\Google_Service_Directory_ChromeOsDeviceActiveTimeRanges', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Directory_ChromeOsDeviceRecentUsers', 'VendorDuplicator\\Google_Service_Directory_ChromeOsDeviceRecentUsers', \false);
/** @internal */
class Google_Service_Directory_ChromeOsDevices extends Google_Collection
{
    protected $collection_key = 'chromeosdevices';
    protected $internal_gapi_mappings = array();
    protected $chromeosdevicesType = 'VendorDuplicator\\Google_Service_Directory_ChromeOsDevice';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Directory_ChromeOsDevices', 'VendorDuplicator\\Google_Service_Directory_ChromeOsDevices', \false);
/** @internal */
class Google_Service_Directory_Customer extends Google_Model
{
    ...
    public $language;
    public $phoneNumber;
    protected $postalAddressType = 'VendorDuplicator\\Google_Service_Directory_CustomerPostalAddress';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Directory_Customer', 'VendorDuplicator\\Google_Service_Directory_Customer', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Directory_CustomerPostalAddress', 'VendorDuplicator\\Google_Service_Directory_CustomerPostalAddress', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Directory_DomainAlias', 'VendorDuplicator\\Google_Service_Directory_DomainAlias', \false);
/** @internal */
class Google_Service_Directory_DomainAliases extends Google_Collection
{
    protected $collection_key = 'domainAliases';
    protected $internal_gapi_mappings = array();
    protected $domainAliasesType = 'VendorDuplicator\\Google_Service_Directory_DomainAlias';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Directory_DomainAliases', 'VendorDuplicator\\Google_Service_Directory_DomainAliases', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Directory_Domains', 'VendorDuplicator\\Google_Service_Directory_Domains', \false);
/** @internal */
class Google_Service_Directory_Domains2 extends Google_Collection
{
    protected $collection_key = 'domains';
    protected $internal_gapi_mappings = array();
    protected $domainsType = 'VendorDuplicator\\Google_Service_Directory_Domains';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Directory_Domains2', 'VendorDuplicator\\Google_Service_Directory_Domains2', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Directory_Group', 'VendorDuplicator\\Google_Service_Directory_Group', \false);
/** @internal */
class Google_Service_Directory_Groups extends Google_Collection
{
    ...
    protected $internal_gapi_mappings = array();
    public $etag;
    protected $groupsType = 'VendorDuplicator\\Google_Service_Directory_Group';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Directory_Groups', 'VendorDuplicator\\Google_Service_Directory_Groups', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Directory_Member', 'VendorDuplicator\\Google_Service_Directory_Member', \false);
/** @internal */
class Google_Service_Directory_Members extends Google_Collection
{
    ...
    public $etag;
    public $kind;
    protected $membersType = 'VendorDuplicator\\Google_Service_Directory_Member';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Directory_Members', 'VendorDuplicator\\Google_Service_Directory_Members', \false);
/** @internal */
class Google_Service_Directory_MobileDevice extends Google_Collection
{
    ...
    protected $internal_gapi_mappings = array();
    public $adbStatus;
    protected $applicationsType = 'VendorDuplicator\\Google_Service_Directory_MobileDeviceApplications';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Directory_MobileDevice', 'VendorDuplicator\\Google_Service_Directory_MobileDevice', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Directory_MobileDeviceAction', 'VendorDuplicator\\Google_Service_Directory_MobileDeviceAction', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Directory_MobileDeviceApplications', 'VendorDuplicator\\Google_Service_Directory_MobileDeviceApplications', \false);
/** @internal */
class Google_Service_Directory_MobileDevices extends Google_Collection
{
    ...
    public $etag;
    public $kind;
    protected $mobiledevicesType = 'VendorDuplicator\\Google_Service_Directory_MobileDevice';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Directory_MobileDevices', 'VendorDuplicator\\Google_Service_Directory_MobileDevices', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Directory_Notification', 'VendorDuplicator\\Google_Service_Directory_Notification', \false);
/** @internal */
class Google_Service_Directory_Notifications extends Google_Collection
{
    ...
    protected $internal_gapi_mappings = array();
    public $etag;
    protected $itemsType = 'VendorDuplicator\\Google_Service_Directory_Notification';
    protected $itemsDataType = 'array';
    public $kind;
    public $nextPageToken;
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Directory_Notifications', 'VendorDuplicator\\Google_Service_Directory_Notifications', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Directory_OrgUnit', 'VendorDuplicator\\Google_Service_Directory_OrgUnit', \false);
/** @internal */
class Google_Service_Directory_OrgUnits extends Google_Collection
{
    ...
    public $etag;
    public $kind;
    protected $organizationUnitsType = 'VendorDuplicator\\Google_Service_Directory_OrgUnit';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Directory_OrgUnits', 'VendorDuplicator\\Google_Service_Directory_OrgUnits', \false);
/** @internal */
class Google_Service_Directory_Privilege extends Google_Collection
{
    protected $collection_key = 'childPrivileges';
    protected $internal_gapi_mappings = array();
    protected $childPrivilegesType = 'VendorDuplicator\\Google_Service_Directory_Privilege';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Directory_Privilege', 'VendorDuplicator\\Google_Service_Directory_Privilege', \false);
/** @internal */
class Google_Service_Directory_Privileges extends Google_Collection
{
    ...
    protected $internal_gapi_mappings = array();
    public $etag;
    protected $itemsType = 'VendorDuplicator\\Google_Service_Directory_Privilege';
    protected $itemsDataType = 'array';
    public $kind;
    public function setEtag($etag)
    {
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Directory_Privileges', 'VendorDuplicator\\Google_Service_Directory_Privileges', \false);
/** @internal */
class Google_Service_Directory_Role extends Google_Collection
{
    ...
    public $roleId;
    public $roleName;
    protected $rolePrivilegesType = 'VendorDuplicator\\Google_Service_Directory_RoleRolePrivileges';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Directory_Role', 'VendorDuplicator\\Google_Service_Directory_Role', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Directory_RoleAssignment', 'VendorDuplicator\\Google_Service_Directory_RoleAssignment', \false);
/** @internal */
class Google_Service_Directory_RoleAssignments extends Google_Collection
{
    ...
    protected $internal_gapi_mappings = array();
    public $etag;
    protected $itemsType = 'VendorDuplicator\\Google_Service_Directory_RoleAssignment';
    protected $itemsDataType = 'array';
    public $kind;
    public $nextPageToken;
    public function setEtag($etag)
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Directory_RoleAssignments', 'VendorDuplicator\\Google_Service_Directory_RoleAssignments', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Directory_RoleRolePrivileges', 'VendorDuplicator\\Google_Service_Directory_RoleRolePrivileges', \false);
/** @internal */
class Google_Service_Directory_Roles extends Google_Collection
{
    ...
    protected $internal_gapi_mappings = array();
    public $etag;
    protected $itemsType = 'VendorDuplicator\\Google_Service_Directory_Role';
    protected $itemsDataType = 'array';
    public $kind;
    public $nextPageToken;
    public function setEtag($etag)
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Directory_Roles', 'VendorDuplicator\\Google_Service_Directory_Roles', \false);
/** @internal */
class Google_Service_Directory_Schema extends Google_Collection
{
    ...
    protected $internal_gapi_mappings = array();
    public $etag;
    protected $fieldsType = 'VendorDuplicator\\Google_Service_Directory_SchemaFieldSpec';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Directory_Schema', 'VendorDuplicator\\Google_Service_Directory_Schema', \false);
/** @internal */
class Google_Service_Directory_SchemaFieldSpec extends Google_Model
{
    ...
    public $kind;
    public $multiValued;
    protected $numericIndexingSpecType = 'VendorDuplicator\\Google_Service_Directory_SchemaFieldSpecNumericIndexingSpec';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Directory_SchemaFieldSpec', 'VendorDuplicator\\Google_Service_Directory_SchemaFieldSpec', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Directory_SchemaFieldSpecNumericIndexingSpec', 'VendorDuplicator\\Google_Service_Directory_SchemaFieldSpecNumericIndexingSpec', \false);
/** @internal */
class Google_Service_Directory_Schemas extends Google_Collection
{
    ...
    public $etag;
    public $kind;
    protected $schemasType = 'VendorDuplicator\\Google_Service_Directory_Schema';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Directory_Schemas', 'VendorDuplicator\\Google_Service_Directory_Schemas', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Directory_Token', 'VendorDuplicator\\Google_Service_Directory_Token', \false);
/** @internal */
class Google_Service_Directory_Tokens extends Google_Collection
{
    ...
    protected $internal_gapi_mappings = array();
    public $etag;
    protected $itemsType = 'VendorDuplicator\\Google_Service_Directory_Token';
    protected $itemsDataType = 'array';
    public $kind;
    public function setEtag($etag)
    {
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Directory_Tokens', 'VendorDuplicator\\Google_Service_Directory_Tokens', \false);
/** @internal */
class Google_Service_Directory_User extends Google_Collection
{
    ...
    protected $nameType = 'VendorDuplicator\\Google_Service_Directory_UserName';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Directory_User', 'VendorDuplicator\\Google_Service_Directory_User', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Directory_UserAbout', 'VendorDuplicator\\Google_Service_Directory_UserAbout', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Directory_UserAddress', 'VendorDuplicator\\Google_Service_Directory_UserAddress', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Directory_UserEmail', 'VendorDuplicator\\Google_Service_Directory_UserEmail', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Directory_UserExternalId', 'VendorDuplicator\\Google_Service_Directory_UserExternalId', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Directory_UserIm', 'VendorDuplicator\\Google_Service_Directory_UserIm', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Directory_UserMakeAdmin', 'VendorDuplicator\\Google_Service_Directory_UserMakeAdmin', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Directory_UserName', 'VendorDuplicator\\Google_Service_Directory_UserName', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Directory_UserOrganization', 'VendorDuplicator\\Google_Service_Directory_UserOrganization', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Directory_UserPhone', 'VendorDuplicator\\Google_Service_Directory_UserPhone', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Directory_UserPhoto', 'VendorDuplicator\\Google_Service_Directory_UserPhoto', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Directory_UserRelation', 'VendorDuplicator\\Google_Service_Directory_UserRelation', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Directory_UserUndelete', 'VendorDuplicator\\Google_Service_Directory_UserUndelete', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Directory_UserWebsite', 'VendorDuplicator\\Google_Service_Directory_UserWebsite', \false);
/** @internal */
class Google_Service_Directory_Users extends Google_Collection
{
    ...
    public $nextPageToken;
    public $triggerEvent;
    protected $usersType = 'VendorDuplicator\\Google_Service_Directory_User';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Directory_Users', 'VendorDuplicator\\Google_Service_Directory_Users', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Directory_VerificationCode', 'VendorDuplicator\\Google_Service_Directory_VerificationCode', \false);
/** @internal */
class Google_Service_Directory_VerificationCodes extends Google_Collection
{
    ...
    protected $internal_gapi_mappings = array();
    public $etag;
    protected $itemsType = 'VendorDuplicator\\Google_Service_Directory_VerificationCode';
    protected $itemsDataType = 'array';
    public $kind;
    public function setEtag($etag)
    {
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Directory_VerificationCodes', 'VendorDuplicator\\Google_Service_Directory_VerificationCodes', \false);
