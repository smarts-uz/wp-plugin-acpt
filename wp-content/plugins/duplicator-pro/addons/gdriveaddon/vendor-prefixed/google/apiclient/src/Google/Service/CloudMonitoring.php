...
class Google_Service_CloudMonitoring extends Google_Service
{
    ...
    public function __construct(Google_Client $client)
    {
        ...
        $this->metricDescriptors = new Google_Service_CloudMonitoring_MetricDescriptors_Resource($this, $this->serviceName, 'metricDescriptors', array('methods' => array('create' => array('path' => '{project}/metricDescriptors', 'httpMethod' => 'POST', 'parameters' => array('project' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'delete' => array('path' => '{project}/metricDescriptors/{metric}', 'httpMethod' => 'DELETE', 'parameters' => array('project' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'metric' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'list' => array('path' => '{project}/metricDescriptors', 'httpMethod' => 'GET', 'parameters' => array('project' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'count' => array('location' => 'query', 'type' => 'integer'), 'pageToken' => array('location' => 'query', 'type' => 'string'), 'query' => array('location' => 'query', 'type' => 'string'))))));
        $this->timeseries = new Google_Service_CloudMonitoring_Timeseries_Resource($this, $this->serviceName, 'timeseries', array('methods' => array('list' => array('path' => '{project}/timeseries/{metric}', 'httpMethod' => 'GET', 'parameters' => array('project' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'metric' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'youngest' => array('location' => 'query', 'type' => 'string', 'required' => \true), 'aggregator' => array('location' => 'query', 'type' => 'string'), 'count' => array('location' => 'query', 'type' => 'integer'), 'labels' => array('location' => 'query', 'type' => 'string', 'repeated' => \true), 'oldest' => array('location' => 'query', 'type' => 'string'), 'pageToken' => array('location' => 'query', 'type' => 'string'), 'timespan' => array('location' => 'query', 'type' => 'string'), 'window' => array('location' => 'query', 'type' => 'string'))), 'write' => array('path' => '{project}/timeseries:write', 'httpMethod' => 'POST', 'parameters' => array('project' => array('location' => 'path', 'type' => 'string', 'required' => \true))))));
        $this->timeseriesDescriptors = new Google_Service_CloudMonitoring_TimeseriesDescriptors_Resource($this, $this->serviceName, 'timeseriesDescriptors', array('methods' => array('list' => array('path' => '{project}/timeseriesDescriptors/{metric}', 'httpMethod' => 'GET', 'parameters' => array('project' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'metric' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'youngest' => array('location' => 'query', 'type' => 'string', 'required' => \true), 'aggregator' => array('location' => 'query', 'type' => 'string'), 'count' => array('location' => 'query', 'type' => 'integer'), 'labels' => array('location' => 'query', 'type' => 'string', 'repeated' => \true), 'oldest' => array('location' => 'query', 'type' => 'string'), 'pageToken' => array('location' => 'query', 'type' => 'string'), 'timespan' => array('location' => 'query', 'type' => 'string'), 'window' => array('location' => 'query', 'type' => 'string'))))));
    }
}
/*
 * Licensed under the Apache License, Version 2.0 (the "License"); you may not
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_CloudMonitoring', 'VendorDuplicator\\Google_Service_CloudMonitoring', \false);
/**
...
class Google_Service_CloudMonitoring_MetricDescriptors_Resource extends Google_Service_Resource
{
    ...
    public function create($project, Google_Service_CloudMonitoring_MetricDescriptor $postBody, $optParams = array())
    {
        ...
        return $this->call('create', array($params), "VendorDuplicator\\Google_Service_CloudMonitoring_MetricDescriptor");
    }
    /**
    ...
    public function delete($project, $metric, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('delete', array($params), "VendorDuplicator\\Google_Service_CloudMonitoring_DeleteMetricDescriptorResponse");
    }
    /**
    ...
    public function listMetricDescriptors($project, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('list', array($params), "VendorDuplicator\\Google_Service_CloudMonitoring_ListMetricDescriptorsResponse");
    }
}
/**
 * The "metricDescriptors" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_CloudMonitoring_MetricDescriptors_Resource', 'VendorDuplicator\\Google_Service_CloudMonitoring_MetricDescriptors_Resource', \false);
/**
...
class Google_Service_CloudMonitoring_Timeseries_Resource extends Google_Service_Resource
{
    ...
    public function listTimeseries($project, $metric, $youngest, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('list', array($params), "VendorDuplicator\\Google_Service_CloudMonitoring_ListTimeseriesResponse");
    }
    /**
    ...
    public function write($project, Google_Service_CloudMonitoring_WriteTimeseriesRequest $postBody, $optParams = array())
    {
        $params = array('project' => $project, 'postBody' => $postBody);
        $params = \array_merge($params, $optParams);
        return $this->call('write', array($params), "VendorDuplicator\\Google_Service_CloudMonitoring_WriteTimeseriesResponse");
    }
}
/**
 * The "timeseries" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_CloudMonitoring_Timeseries_Resource', 'VendorDuplicator\\Google_Service_CloudMonitoring_Timeseries_Resource', \false);
/**
...
class Google_Service_CloudMonitoring_TimeseriesDescriptors_Resource extends Google_Service_Resource
{
    ...
    public function listTimeseriesDescriptors($project, $metric, $youngest, $optParams = array())
    {
        $params = array('project' => $project, 'metric' => $metric, 'youngest' => $youngest);
        $params = \array_merge($params, $optParams);
        return $this->call('list', array($params), "VendorDuplicator\\Google_Service_CloudMonitoring_ListTimeseriesDescriptorsResponse");
    }
}
/**
 * The "timeseriesDescriptors" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_CloudMonitoring_TimeseriesDescriptors_Resource', 'VendorDuplicator\\Google_Service_CloudMonitoring_TimeseriesDescriptors_Resource', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_CloudMonitoring_DeleteMetricDescriptorResponse', 'VendorDuplicator\\Google_Service_CloudMonitoring_DeleteMetricDescriptorResponse', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_CloudMonitoring_ListMetricDescriptorsRequest', 'VendorDuplicator\\Google_Service_CloudMonitoring_ListMetricDescriptorsRequest', \false);
/** @internal */
class Google_Service_CloudMonitoring_ListMetricDescriptorsResponse extends Google_Collection
{
    ...
    protected $internal_gapi_mappings = array();
    public $kind;
    protected $metricsType = 'VendorDuplicator\\Google_Service_CloudMonitoring_MetricDescriptor';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_CloudMonitoring_ListMetricDescriptorsResponse', 'VendorDuplicator\\Google_Service_CloudMonitoring_ListMetricDescriptorsResponse', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_CloudMonitoring_ListTimeseriesDescriptorsRequest', 'VendorDuplicator\\Google_Service_CloudMonitoring_ListTimeseriesDescriptorsRequest', \false);
/** @internal */
class Google_Service_CloudMonitoring_ListTimeseriesDescriptorsResponse extends Google_Collection
{
    ...
    public $nextPageToken;
    public $oldest;
    protected $timeseriesType = 'VendorDuplicator\\Google_Service_CloudMonitoring_TimeseriesDescriptor';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_CloudMonitoring_ListTimeseriesDescriptorsResponse', 'VendorDuplicator\\Google_Service_CloudMonitoring_ListTimeseriesDescriptorsResponse', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_CloudMonitoring_ListTimeseriesRequest', 'VendorDuplicator\\Google_Service_CloudMonitoring_ListTimeseriesRequest', \false);
/** @internal */
class Google_Service_CloudMonitoring_ListTimeseriesResponse extends Google_Collection
{
    ...
    public $nextPageToken;
    public $oldest;
    protected $timeseriesType = 'VendorDuplicator\\Google_Service_CloudMonitoring_Timeseries';
    protected $timeseriesDataType = 'array';
    public $youngest;
    public function setKind($kind)
    {
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_CloudMonitoring_ListTimeseriesResponse', 'VendorDuplicator\\Google_Service_CloudMonitoring_ListTimeseriesResponse', \false);
/** @internal */
class Google_Service_CloudMonitoring_MetricDescriptor extends Google_Collection
{
    ...
    protected $internal_gapi_mappings = array();
    public $description;
    protected $labelsType = 'VendorDuplicator\\Google_Service_CloudMonitoring_MetricDescriptorLabelDescriptor';
    protected $labelsDataType = 'array';
    public $name;
    public $project;
    protected $typeDescriptorType = 'VendorDuplicator\\Google_Service_CloudMonitoring_MetricDescriptorTypeDescriptor';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_CloudMonitoring_MetricDescriptor', 'VendorDuplicator\\Google_Service_CloudMonitoring_MetricDescriptor', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_CloudMonitoring_MetricDescriptorLabelDescriptor', 'VendorDuplicator\\Google_Service_CloudMonitoring_MetricDescriptorLabelDescriptor', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_CloudMonitoring_MetricDescriptorTypeDescriptor', 'VendorDuplicator\\Google_Service_CloudMonitoring_MetricDescriptorTypeDescriptor', \false);
/** @internal */
class Google_Service_CloudMonitoring_Point extends Google_Model
{
    protected $internal_gapi_mappings = array();
    public $boolValue;
    protected $distributionValueType = 'VendorDuplicator\\Google_Service_CloudMonitoring_PointDistribution';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_CloudMonitoring_Point', 'VendorDuplicator\\Google_Service_CloudMonitoring_Point', \false);
/** @internal */
class Google_Service_CloudMonitoring_PointDistribution extends Google_Collection
{
    protected $collection_key = 'buckets';
    protected $internal_gapi_mappings = array();
    protected $bucketsType = 'VendorDuplicator\\Google_Service_CloudMonitoring_PointDistributionBucket';
    protected $bucketsDataType = 'array';
    protected $overflowBucketType = 'VendorDuplicator\\Google_Service_CloudMonitoring_PointDistributionOverflowBucket';
    protected $overflowBucketDataType = '';
    protected $underflowBucketType = 'VendorDuplicator\\Google_Service_CloudMonitoring_PointDistributionUnderflowBucket';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_CloudMonitoring_PointDistribution', 'VendorDuplicator\\Google_Service_CloudMonitoring_PointDistribution', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_CloudMonitoring_PointDistributionBucket', 'VendorDuplicator\\Google_Service_CloudMonitoring_PointDistributionBucket', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_CloudMonitoring_PointDistributionOverflowBucket', 'VendorDuplicator\\Google_Service_CloudMonitoring_PointDistributionOverflowBucket', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_CloudMonitoring_PointDistributionUnderflowBucket', 'VendorDuplicator\\Google_Service_CloudMonitoring_PointDistributionUnderflowBucket', \false);
/** @internal */
class Google_Service_CloudMonitoring_Timeseries extends Google_Collection
{
    protected $collection_key = 'points';
    protected $internal_gapi_mappings = array();
    protected $pointsType = 'VendorDuplicator\\Google_Service_CloudMonitoring_Point';
    protected $pointsDataType = 'array';
    protected $timeseriesDescType = 'VendorDuplicator\\Google_Service_CloudMonitoring_TimeseriesDescriptor';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_CloudMonitoring_Timeseries', 'VendorDuplicator\\Google_Service_CloudMonitoring_Timeseries', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_CloudMonitoring_TimeseriesDescriptor', 'VendorDuplicator\\Google_Service_CloudMonitoring_TimeseriesDescriptor', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_CloudMonitoring_TimeseriesDescriptorLabel', 'VendorDuplicator\\Google_Service_CloudMonitoring_TimeseriesDescriptorLabel', \false);
/** @internal */
class Google_Service_CloudMonitoring_TimeseriesPoint extends Google_Model
{
    protected $internal_gapi_mappings = array();
    protected $pointType = 'VendorDuplicator\\Google_Service_CloudMonitoring_Point';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_CloudMonitoring_TimeseriesPoint', 'VendorDuplicator\\Google_Service_CloudMonitoring_TimeseriesPoint', \false);
/** @internal */
class Google_Service_CloudMonitoring_WriteTimeseriesRequest extends Google_Collection
{
    ...
    protected $internal_gapi_mappings = array();
    public $commonLabels;
    protected $timeseriesType = 'VendorDuplicator\\Google_Service_CloudMonitoring_TimeseriesPoint';
    protected $timeseriesDataType = 'array';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_CloudMonitoring_WriteTimeseriesRequest', 'VendorDuplicator\\Google_Service_CloudMonitoring_WriteTimeseriesRequest', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_CloudMonitoring_WriteTimeseriesResponse', 'VendorDuplicator\\Google_Service_CloudMonitoring_WriteTimeseriesResponse', \false);
