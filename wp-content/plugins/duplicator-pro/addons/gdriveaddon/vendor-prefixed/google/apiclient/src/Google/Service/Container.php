...
class Google_Service_Container extends Google_Service
{
    ...
    public function __construct(Google_Client $client)
    {
        ...
        $this->projects_zones = new Google_Service_Container_ProjectsZones_Resource($this, $this->serviceName, 'zones', array('methods' => array('getServerconfig' => array('path' => 'v1/projects/{projectId}/zones/{zone}/serverconfig', 'httpMethod' => 'GET', 'parameters' => array('projectId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'zone' => array('location' => 'path', 'type' => 'string', 'required' => \true))))));
        $this->projects_zones_clusters = new Google_Service_Container_ProjectsZonesClusters_Resource($this, $this->serviceName, 'clusters', array('methods' => array('create' => array('path' => 'v1/projects/{projectId}/zones/{zone}/clusters', 'httpMethod' => 'POST', 'parameters' => array('projectId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'zone' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'delete' => array('path' => 'v1/projects/{projectId}/zones/{zone}/clusters/{clusterId}', 'httpMethod' => 'DELETE', 'parameters' => array('projectId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'zone' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'clusterId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'get' => array('path' => 'v1/projects/{projectId}/zones/{zone}/clusters/{clusterId}', 'httpMethod' => 'GET', 'parameters' => array('projectId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'zone' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'clusterId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'list' => array('path' => 'v1/projects/{projectId}/zones/{zone}/clusters', 'httpMethod' => 'GET', 'parameters' => array('projectId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'zone' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'update' => array('path' => 'v1/projects/{projectId}/zones/{zone}/clusters/{clusterId}', 'httpMethod' => 'PUT', 'parameters' => array('projectId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'zone' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'clusterId' => array('location' => 'path', 'type' => 'string', 'required' => \true))))));
        $this->projects_zones_operations = new Google_Service_Container_ProjectsZonesOperations_Resource($this, $this->serviceName, 'operations', array('methods' => array('get' => array('path' => 'v1/projects/{projectId}/zones/{zone}/operations/{operationId}', 'httpMethod' => 'GET', 'parameters' => array('projectId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'zone' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'operationId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'list' => array('path' => 'v1/projects/{projectId}/zones/{zone}/operations', 'httpMethod' => 'GET', 'parameters' => array('projectId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'zone' => array('location' => 'path', 'type' => 'string', 'required' => \true))))));
    }
}
/*
 * Licensed under the Apache License, Version 2.0 (the "License"); you may not
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Container', 'VendorDuplicator\\Google_Service_Container', \false);
/**
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Container_Projects_Resource', 'VendorDuplicator\\Google_Service_Container_Projects_Resource', \false);
/**
...
class Google_Service_Container_ProjectsZones_Resource extends Google_Service_Resource
{
    ...
    public function getServerconfig($projectId, $zone, $optParams = array())
    {
        ...
        return $this->call('getServerconfig', array($params), "VendorDuplicator\\Google_Service_Container_ServerConfig");
    }
}
/**
 * The "zones" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Container_ProjectsZones_Resource', 'VendorDuplicator\\Google_Service_Container_ProjectsZones_Resource', \false);
/**
...
class Google_Service_Container_ProjectsZonesClusters_Resource extends Google_Service_Resource
{
    ...
    public function create($projectId, $zone, Google_Service_Container_CreateClusterRequest $postBody, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('create', array($params), "VendorDuplicator\\Google_Service_Container_Operation");
    }
    /**
    ...
    public function delete($projectId, $zone, $clusterId, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('delete', array($params), "VendorDuplicator\\Google_Service_Container_Operation");
    }
    /**
    ...
    public function get($projectId, $zone, $clusterId, $optParams = array())
    {
        $params = array('projectId' => $projectId, 'zone' => $zone, 'clusterId' => $clusterId);
        $params = \array_merge($params, $optParams);
        return $this->call('get', array($params), "VendorDuplicator\\Google_Service_Container_Cluster");
    }
    /**
    ...
    public function listProjectsZonesClusters($projectId, $zone, $optParams = array())
    {
        $params = array('projectId' => $projectId, 'zone' => $zone);
        $params = \array_merge($params, $optParams);
        return $this->call('list', array($params), "VendorDuplicator\\Google_Service_Container_ListClustersResponse");
    }
    /**
    ...
    public function update($projectId, $zone, $clusterId, Google_Service_Container_UpdateClusterRequest $postBody, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('update', array($params), "VendorDuplicator\\Google_Service_Container_Operation");
    }
}
/**
 * The "clusters" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Container_ProjectsZonesClusters_Resource', 'VendorDuplicator\\Google_Service_Container_ProjectsZonesClusters_Resource', \false);
/**
...
class Google_Service_Container_ProjectsZonesOperations_Resource extends Google_Service_Resource
{
    ...
    public function get($projectId, $zone, $operationId, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('get', array($params), "VendorDuplicator\\Google_Service_Container_Operation");
    }
    /**
    ...
    public function listProjectsZonesOperations($projectId, $zone, $optParams = array())
    {
        $params = array('projectId' => $projectId, 'zone' => $zone);
        $params = \array_merge($params, $optParams);
        return $this->call('list', array($params), "VendorDuplicator\\Google_Service_Container_ListOperationsResponse");
    }
}
/**
 * The "operations" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Container_ProjectsZonesOperations_Resource', 'VendorDuplicator\\Google_Service_Container_ProjectsZonesOperations_Resource', \false);
/** @internal */
class Google_Service_Container_Cluster extends Google_Collection
{
    ...
    protected $masterAuthType = 'VendorDuplicator\\Google_Service_Container_MasterAuth';
    protected $masterAuthDataType = '';
    public $monitoringService;
    public $name;
    public $network;
    protected $nodeConfigType = 'VendorDuplicator\\Google_Service_Container_NodeConfig';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Container_Cluster', 'VendorDuplicator\\Google_Service_Container_Cluster', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Container_ClusterUpdate', 'VendorDuplicator\\Google_Service_Container_ClusterUpdate', \false);
/** @internal */
class Google_Service_Container_CreateClusterRequest extends Google_Model
{
    protected $internal_gapi_mappings = array();
    protected $clusterType = 'VendorDuplicator\\Google_Service_Container_Cluster';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Container_CreateClusterRequest', 'VendorDuplicator\\Google_Service_Container_CreateClusterRequest', \false);
/** @internal */
class Google_Service_Container_ListClustersResponse extends Google_Collection
{
    protected $collection_key = 'clusters';
    protected $internal_gapi_mappings = array();
    protected $clustersType = 'VendorDuplicator\\Google_Service_Container_Cluster';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Container_ListClustersResponse', 'VendorDuplicator\\Google_Service_Container_ListClustersResponse', \false);
/** @internal */
class Google_Service_Container_ListOperationsResponse extends Google_Collection
{
    protected $collection_key = 'operations';
    protected $internal_gapi_mappings = array();
    protected $operationsType = 'VendorDuplicator\\Google_Service_Container_Operation';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Container_ListOperationsResponse', 'VendorDuplicator\\Google_Service_Container_ListOperationsResponse', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Container_MasterAuth', 'VendorDuplicator\\Google_Service_Container_MasterAuth', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Container_NodeConfig', 'VendorDuplicator\\Google_Service_Container_NodeConfig', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Container_Operation', 'VendorDuplicator\\Google_Service_Container_Operation', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Container_ServerConfig', 'VendorDuplicator\\Google_Service_Container_ServerConfig', \false);
/** @internal */
class Google_Service_Container_UpdateClusterRequest extends Google_Model
{
    protected $internal_gapi_mappings = array();
    protected $updateType = 'VendorDuplicator\\Google_Service_Container_ClusterUpdate';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Container_UpdateClusterRequest', 'VendorDuplicator\\Google_Service_Container_UpdateClusterRequest', \false);
