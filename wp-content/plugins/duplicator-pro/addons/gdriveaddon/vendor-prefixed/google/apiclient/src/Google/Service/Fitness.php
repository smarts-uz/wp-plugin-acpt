...
class Google_Service_Fitness extends Google_Service
{
    ...
    public function __construct(Google_Client $client)
    {
        ...
        $this->users_dataSources = new Google_Service_Fitness_UsersDataSources_Resource($this, $this->serviceName, 'dataSources', array('methods' => array('create' => array('path' => '{userId}/dataSources', 'httpMethod' => 'POST', 'parameters' => array('userId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'delete' => array('path' => '{userId}/dataSources/{dataSourceId}', 'httpMethod' => 'DELETE', 'parameters' => array('userId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'dataSourceId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'get' => array('path' => '{userId}/dataSources/{dataSourceId}', 'httpMethod' => 'GET', 'parameters' => array('userId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'dataSourceId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'list' => array('path' => '{userId}/dataSources', 'httpMethod' => 'GET', 'parameters' => array('userId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'dataTypeName' => array('location' => 'query', 'type' => 'string', 'repeated' => \true))), 'patch' => array('path' => '{userId}/dataSources/{dataSourceId}', 'httpMethod' => 'PATCH', 'parameters' => array('userId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'dataSourceId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'update' => array('path' => '{userId}/dataSources/{dataSourceId}', 'httpMethod' => 'PUT', 'parameters' => array('userId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'dataSourceId' => array('location' => 'path', 'type' => 'string', 'required' => \true))))));
        $this->users_dataSources_datasets = new Google_Service_Fitness_UsersDataSourcesDatasets_Resource($this, $this->serviceName, 'datasets', array('methods' => array('delete' => array('path' => '{userId}/dataSources/{dataSourceId}/datasets/{datasetId}', 'httpMethod' => 'DELETE', 'parameters' => array('userId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'dataSourceId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'datasetId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'currentTimeMillis' => array('location' => 'query', 'type' => 'string'), 'modifiedTimeMillis' => array('location' => 'query', 'type' => 'string'))), 'get' => array('path' => '{userId}/dataSources/{dataSourceId}/datasets/{datasetId}', 'httpMethod' => 'GET', 'parameters' => array('userId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'dataSourceId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'datasetId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'limit' => array('location' => 'query', 'type' => 'integer'), 'pageToken' => array('location' => 'query', 'type' => 'string'))), 'patch' => array('path' => '{userId}/dataSources/{dataSourceId}/datasets/{datasetId}', 'httpMethod' => 'PATCH', 'parameters' => array('userId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'dataSourceId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'datasetId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'currentTimeMillis' => array('location' => 'query', 'type' => 'string'))))));
        $this->users_dataset = new Google_Service_Fitness_UsersDataset_Resource($this, $this->serviceName, 'dataset', array('methods' => array('aggregate' => array('path' => '{userId}/dataset:aggregate', 'httpMethod' => 'POST', 'parameters' => array('userId' => array('location' => 'path', 'type' => 'string', 'required' => \true))))));
        $this->users_sessions = new Google_Service_Fitness_UsersSessions_Resource($this, $this->serviceName, 'sessions', array('methods' => array('delete' => array('path' => '{userId}/sessions/{sessionId}', 'httpMethod' => 'DELETE', 'parameters' => array('userId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'sessionId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'currentTimeMillis' => array('location' => 'query', 'type' => 'string'))), 'list' => array('path' => '{userId}/sessions', 'httpMethod' => 'GET', 'parameters' => array('userId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'endTime' => array('location' => 'query', 'type' => 'string'), 'includeDeleted' => array('location' => 'query', 'type' => 'boolean'), 'pageToken' => array('location' => 'query', 'type' => 'string'), 'startTime' => array('location' => 'query', 'type' => 'string'))), 'update' => array('path' => '{userId}/sessions/{sessionId}', 'httpMethod' => 'PUT', 'parameters' => array('userId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'sessionId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'currentTimeMillis' => array('location' => 'query', 'type' => 'string'))))));
    }
}
/*
 * Licensed under the Apache License, Version 2.0 (the "License"); you may not
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Fitness', 'VendorDuplicator\\Google_Service_Fitness', \false);
/**
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Fitness_Users_Resource', 'VendorDuplicator\\Google_Service_Fitness_Users_Resource', \false);
/**
...
class Google_Service_Fitness_UsersDataSources_Resource extends Google_Service_Resource
{
    ...
    public function create($userId, Google_Service_Fitness_DataSource $postBody, $optParams = array())
    {
        ...
        return $this->call('create', array($params), "VendorDuplicator\\Google_Service_Fitness_DataSource");
    }
    /**
    ...
    public function delete($userId, $dataSourceId, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('delete', array($params), "VendorDuplicator\\Google_Service_Fitness_DataSource");
    }
    /**
    ...
    public function get($userId, $dataSourceId, $optParams = array())
    {
        $params = array('userId' => $userId, 'dataSourceId' => $dataSourceId);
        $params = \array_merge($params, $optParams);
        return $this->call('get', array($params), "VendorDuplicator\\Google_Service_Fitness_DataSource");
    }
    /**
    ...
    public function listUsersDataSources($userId, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('list', array($params), "VendorDuplicator\\Google_Service_Fitness_ListDataSourcesResponse");
    }
    /**
    ...
    public function patch($userId, $dataSourceId, Google_Service_Fitness_DataSource $postBody, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('patch', array($params), "VendorDuplicator\\Google_Service_Fitness_DataSource");
    }
    /**
     * Updates a given data source. It is an error to modify the data source's data
     * stream ID, data type, type, stream name or device information apart from the
    ...
    public function update($userId, $dataSourceId, Google_Service_Fitness_DataSource $postBody, $optParams = array())
    {
        $params = array('userId' => $userId, 'dataSourceId' => $dataSourceId, 'postBody' => $postBody);
        $params = \array_merge($params, $optParams);
        return $this->call('update', array($params), "VendorDuplicator\\Google_Service_Fitness_DataSource");
    }
}
/**
 * The "dataSources" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Fitness_UsersDataSources_Resource', 'VendorDuplicator\\Google_Service_Fitness_UsersDataSources_Resource', \false);
/**
...
class Google_Service_Fitness_UsersDataSourcesDatasets_Resource extends Google_Service_Resource
{
    ...
    public function get($userId, $dataSourceId, $datasetId, $optParams = array())
    {
        $params = array('userId' => $userId, 'dataSourceId' => $dataSourceId, 'datasetId' => $datasetId);
        $params = \array_merge($params, $optParams);
        return $this->call('get', array($params), "VendorDuplicator\\Google_Service_Fitness_Dataset");
    }
    /**
    ...
    public function patch($userId, $dataSourceId, $datasetId, Google_Service_Fitness_Dataset $postBody, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('patch', array($params), "VendorDuplicator\\Google_Service_Fitness_Dataset");
    }
}
/**
 * The "datasets" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Fitness_UsersDataSourcesDatasets_Resource', 'VendorDuplicator\\Google_Service_Fitness_UsersDataSourcesDatasets_Resource', \false);
/**
...
class Google_Service_Fitness_UsersDataset_Resource extends Google_Service_Resource
{
    ...
    public function aggregate($userId, Google_Service_Fitness_AggregateRequest $postBody, $optParams = array())
    {
        $params = array('userId' => $userId, 'postBody' => $postBody);
        $params = \array_merge($params, $optParams);
        return $this->call('aggregate', array($params), "VendorDuplicator\\Google_Service_Fitness_AggregateResponse");
    }
}
/**
 * The "dataset" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Fitness_UsersDataset_Resource', 'VendorDuplicator\\Google_Service_Fitness_UsersDataset_Resource', \false);
/**
...
class Google_Service_Fitness_UsersSessions_Resource extends Google_Service_Resource
{
    ...
    public function listUsersSessions($userId, $optParams = array())
    {
        $params = array('userId' => $userId);
        $params = \array_merge($params, $optParams);
        return $this->call('list', array($params), "VendorDuplicator\\Google_Service_Fitness_ListSessionsResponse");
    }
    /**
    ...
    public function update($userId, $sessionId, Google_Service_Fitness_Session $postBody, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('update', array($params), "VendorDuplicator\\Google_Service_Fitness_Session");
    }
}
/**
 * The "sessions" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Fitness_UsersSessions_Resource', 'VendorDuplicator\\Google_Service_Fitness_UsersSessions_Resource', \false);
/** @internal */
class Google_Service_Fitness_AggregateBucket extends Google_Collection
{
    ...
    public $activity;
    protected $datasetType = 'VendorDuplicator\\Google_Service_Fitness_Dataset';
    protected $datasetDataType = 'array';
    public $endTimeMillis;
    protected $sessionType = 'VendorDuplicator\\Google_Service_Fitness_Session';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Fitness_AggregateBucket', 'VendorDuplicator\\Google_Service_Fitness_AggregateBucket', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Fitness_AggregateBy', 'VendorDuplicator\\Google_Service_Fitness_AggregateBy', \false);
/** @internal */
class Google_Service_Fitness_AggregateRequest extends Google_Collection
{
    protected $collection_key = 'aggregateBy';
    protected $internal_gapi_mappings = array();
    protected $aggregateByType = 'VendorDuplicator\\Google_Service_Fitness_AggregateBy';
    protected $aggregateByDataType = 'array';
    protected $bucketByActivitySegmentType = 'VendorDuplicator\\Google_Service_Fitness_BucketByActivity';
    protected $bucketByActivitySegmentDataType = '';
    protected $bucketByActivityTypeType = 'VendorDuplicator\\Google_Service_Fitness_BucketByActivity';
    protected $bucketByActivityTypeDataType = '';
    protected $bucketBySessionType = 'VendorDuplicator\\Google_Service_Fitness_BucketBySession';
    protected $bucketBySessionDataType = '';
    protected $bucketByTimeType = 'VendorDuplicator\\Google_Service_Fitness_BucketByTime';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Fitness_AggregateRequest', 'VendorDuplicator\\Google_Service_Fitness_AggregateRequest', \false);
/** @internal */
class Google_Service_Fitness_AggregateResponse extends Google_Collection
{
    protected $collection_key = 'bucket';
    protected $internal_gapi_mappings = array();
    protected $bucketType = 'VendorDuplicator\\Google_Service_Fitness_AggregateBucket';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Fitness_AggregateResponse', 'VendorDuplicator\\Google_Service_Fitness_AggregateResponse', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Fitness_Application', 'VendorDuplicator\\Google_Service_Fitness_Application', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Fitness_BucketByActivity', 'VendorDuplicator\\Google_Service_Fitness_BucketByActivity', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Fitness_BucketBySession', 'VendorDuplicator\\Google_Service_Fitness_BucketBySession', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Fitness_BucketByTime', 'VendorDuplicator\\Google_Service_Fitness_BucketByTime', \false);
/** @internal */
class Google_Service_Fitness_DataPoint extends Google_Collection
{
    ...
    protected $valueType = 'VendorDuplicator\\Google_Service_Fitness_Value';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Fitness_DataPoint', 'VendorDuplicator\\Google_Service_Fitness_DataPoint', \false);
/** @internal */
class Google_Service_Fitness_DataSource extends Google_Model
{
    protected $internal_gapi_mappings = array();
    protected $applicationType = 'VendorDuplicator\\Google_Service_Fitness_Application';
    protected $applicationDataType = '';
    public $dataStreamId;
    public $dataStreamName;
    protected $dataTypeType = 'VendorDuplicator\\Google_Service_Fitness_DataType';
    protected $dataTypeDataType = '';
    protected $deviceType = 'VendorDuplicator\\Google_Service_Fitness_Device';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Fitness_DataSource', 'VendorDuplicator\\Google_Service_Fitness_DataSource', \false);
/** @internal */
class Google_Service_Fitness_DataType extends Google_Collection
{
    protected $collection_key = 'field';
    protected $internal_gapi_mappings = array();
    protected $fieldType = 'VendorDuplicator\\Google_Service_Fitness_DataTypeField';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Fitness_DataType', 'VendorDuplicator\\Google_Service_Fitness_DataType', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Fitness_DataTypeField', 'VendorDuplicator\\Google_Service_Fitness_DataTypeField', \false);
/** @internal */
class Google_Service_Fitness_Dataset extends Google_Collection
{
    ...
    protected $pointType = 'VendorDuplicator\\Google_Service_Fitness_DataPoint';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Fitness_Dataset', 'VendorDuplicator\\Google_Service_Fitness_Dataset', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Fitness_Device', 'VendorDuplicator\\Google_Service_Fitness_Device', \false);
/** @internal */
class Google_Service_Fitness_ListDataSourcesResponse extends Google_Collection
{
    protected $collection_key = 'dataSource';
    protected $internal_gapi_mappings = array();
    protected $dataSourceType = 'VendorDuplicator\\Google_Service_Fitness_DataSource';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Fitness_ListDataSourcesResponse', 'VendorDuplicator\\Google_Service_Fitness_ListDataSourcesResponse', \false);
/** @internal */
class Google_Service_Fitness_ListSessionsResponse extends Google_Collection
{
    protected $collection_key = 'session';
    protected $internal_gapi_mappings = array();
    protected $deletedSessionType = 'VendorDuplicator\\Google_Service_Fitness_Session';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Fitness_ListSessionsResponse', 'VendorDuplicator\\Google_Service_Fitness_ListSessionsResponse', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Fitness_MapValue', 'VendorDuplicator\\Google_Service_Fitness_MapValue', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Fitness_Session', 'VendorDuplicator\\Google_Service_Fitness_Session', \false);
/** @internal */
class Google_Service_Fitness_Value extends Google_Collection
{
    ...
    public $fpVal;
    public $intVal;
    protected $mapValType = 'VendorDuplicator\\Google_Service_Fitness_ValueMapValEntry';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Fitness_Value', 'VendorDuplicator\\Google_Service_Fitness_Value', \false);
/** @internal */
class Google_Service_Fitness_ValueMapValEntry extends Google_Model
{
    protected $internal_gapi_mappings = array();
    public $key;
    protected $valueType = 'VendorDuplicator\\Google_Service_Fitness_MapValue';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Fitness_ValueMapValEntry', 'VendorDuplicator\\Google_Service_Fitness_ValueMapValEntry', \false);
