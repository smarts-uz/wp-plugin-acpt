 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_QPXExpress', 'VendorDuplicator\\Google_Service_QPXExpress', \false);
/**
...
class Google_Service_QPXExpress_Trips_Resource extends Google_Service_Resource
{
    ...
    public function search(Google_Service_QPXExpress_TripsSearchRequest $postBody, $optParams = array())
    {
        ...
        return $this->call('search', array($params), "VendorDuplicator\\Google_Service_QPXExpress_TripsSearchResponse");
    }
}
/**
 * The "trips" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_QPXExpress_Trips_Resource', 'VendorDuplicator\\Google_Service_QPXExpress_Trips_Resource', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_QPXExpress_AircraftData', 'VendorDuplicator\\Google_Service_QPXExpress_AircraftData', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_QPXExpress_AirportData', 'VendorDuplicator\\Google_Service_QPXExpress_AirportData', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_QPXExpress_BagDescriptor', 'VendorDuplicator\\Google_Service_QPXExpress_BagDescriptor', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_QPXExpress_CarrierData', 'VendorDuplicator\\Google_Service_QPXExpress_CarrierData', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_QPXExpress_CityData', 'VendorDuplicator\\Google_Service_QPXExpress_CityData', \false);
/** @internal */
class Google_Service_QPXExpress_Data extends Google_Collection
{
    protected $collection_key = 'tax';
    protected $internal_gapi_mappings = array();
    protected $aircraftType = 'VendorDuplicator\\Google_Service_QPXExpress_AircraftData';
    protected $aircraftDataType = 'array';
    protected $airportType = 'VendorDuplicator\\Google_Service_QPXExpress_AirportData';
    protected $airportDataType = 'array';
    protected $carrierType = 'VendorDuplicator\\Google_Service_QPXExpress_CarrierData';
    protected $carrierDataType = 'array';
    protected $cityType = 'VendorDuplicator\\Google_Service_QPXExpress_CityData';
    protected $cityDataType = 'array';
    public $kind;
    protected $taxType = 'VendorDuplicator\\Google_Service_QPXExpress_TaxData';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_QPXExpress_Data', 'VendorDuplicator\\Google_Service_QPXExpress_Data', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_QPXExpress_FareInfo', 'VendorDuplicator\\Google_Service_QPXExpress_FareInfo', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_QPXExpress_FlightInfo', 'VendorDuplicator\\Google_Service_QPXExpress_FlightInfo', \false);
/** @internal */
class Google_Service_QPXExpress_FreeBaggageAllowance extends Google_Collection
{
    protected $collection_key = 'bagDescriptor';
    protected $internal_gapi_mappings = array();
    protected $bagDescriptorType = 'VendorDuplicator\\Google_Service_QPXExpress_BagDescriptor';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_QPXExpress_FreeBaggageAllowance', 'VendorDuplicator\\Google_Service_QPXExpress_FreeBaggageAllowance', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_QPXExpress_LegInfo', 'VendorDuplicator\\Google_Service_QPXExpress_LegInfo', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_QPXExpress_PassengerCounts', 'VendorDuplicator\\Google_Service_QPXExpress_PassengerCounts', \false);
/** @internal */
class Google_Service_QPXExpress_PricingInfo extends Google_Collection
{
    ...
    protected $fareType = 'VendorDuplicator\\Google_Service_QPXExpress_FareInfo';
    protected $fareDataType = 'array';
    public $fareCalculation;
    public $kind;
    public $latestTicketingTime;
    protected $passengersType = 'VendorDuplicator\\Google_Service_QPXExpress_PassengerCounts';
    ...
    public $saleTaxTotal;
    public $saleTotal;
    protected $segmentPricingType = 'VendorDuplicator\\Google_Service_QPXExpress_SegmentPricing';
    protected $segmentPricingDataType = 'array';
    protected $taxType = 'VendorDuplicator\\Google_Service_QPXExpress_TaxInfo';
    protected $taxDataType = 'array';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_QPXExpress_PricingInfo', 'VendorDuplicator\\Google_Service_QPXExpress_PricingInfo', \false);
/** @internal */
class Google_Service_QPXExpress_SegmentInfo extends Google_Collection
{
    ...
    public $connectionDuration;
    public $duration;
    protected $flightType = 'VendorDuplicator\\Google_Service_QPXExpress_FlightInfo';
    protected $flightDataType = '';
    public $id;
    public $kind;
    protected $legType = 'VendorDuplicator\\Google_Service_QPXExpress_LegInfo';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_QPXExpress_SegmentInfo', 'VendorDuplicator\\Google_Service_QPXExpress_SegmentInfo', \false);
/** @internal */
class Google_Service_QPXExpress_SegmentPricing extends Google_Collection
{
    ...
    protected $internal_gapi_mappings = array();
    public $fareId;
    protected $freeBaggageOptionType = 'VendorDuplicator\\Google_Service_QPXExpress_FreeBaggageAllowance';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_QPXExpress_SegmentPricing', 'VendorDuplicator\\Google_Service_QPXExpress_SegmentPricing', \false);
/** @internal */
class Google_Service_QPXExpress_SliceInfo extends Google_Collection
{
    ...
    public $duration;
    public $kind;
    protected $segmentType = 'VendorDuplicator\\Google_Service_QPXExpress_SegmentInfo';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_QPXExpress_SliceInfo', 'VendorDuplicator\\Google_Service_QPXExpress_SliceInfo', \false);
/** @internal */
class Google_Service_QPXExpress_SliceInput extends Google_Collection
{
    ...
    protected $permittedDepartureTimeType = 'VendorDuplicator\\Google_Service_QPXExpress_TimeOfDayRange';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_QPXExpress_SliceInput', 'VendorDuplicator\\Google_Service_QPXExpress_SliceInput', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_QPXExpress_TaxData', 'VendorDuplicator\\Google_Service_QPXExpress_TaxData', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_QPXExpress_TaxInfo', 'VendorDuplicator\\Google_Service_QPXExpress_TaxInfo', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_QPXExpress_TimeOfDayRange', 'VendorDuplicator\\Google_Service_QPXExpress_TimeOfDayRange', \false);
/** @internal */
class Google_Service_QPXExpress_TripOption extends Google_Collection
{
    ...
    public $id;
    public $kind;
    protected $pricingType = 'VendorDuplicator\\Google_Service_QPXExpress_PricingInfo';
    protected $pricingDataType = 'array';
    public $saleTotal;
    protected $sliceType = 'VendorDuplicator\\Google_Service_QPXExpress_SliceInfo';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_QPXExpress_TripOption', 'VendorDuplicator\\Google_Service_QPXExpress_TripOption', \false);
/** @internal */
class Google_Service_QPXExpress_TripOptionsRequest extends Google_Collection
{
    ...
    public $refundable;
    public $saleCountry;
    protected $sliceType = 'VendorDuplicator\\Google_Service_QPXExpress_SliceInput';
    protected $sliceDataType = 'array';
    public $solutions;
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_QPXExpress_TripOptionsRequest', 'VendorDuplicator\\Google_Service_QPXExpress_TripOptionsRequest', \false);
/** @internal */
class Google_Service_QPXExpress_TripOptionsResponse extends Google_Collection
{
    protected $collection_key = 'tripOption';
    protected $internal_gapi_mappings = array();
    protected $dataType = 'VendorDuplicator\\Google_Service_QPXExpress_Data';
    protected $dataDataType = '';
    public $kind;
    public $requestId;
    protected $tripOptionType = 'VendorDuplicator\\Google_Service_QPXExpress_TripOption';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_QPXExpress_TripOptionsResponse', 'VendorDuplicator\\Google_Service_QPXExpress_TripOptionsResponse', \false);
/** @internal */
class Google_Service_QPXExpress_TripsSearchRequest extends Google_Model
{
    protected $internal_gapi_mappings = array();
    protected $requestType = 'VendorDuplicator\\Google_Service_QPXExpress_TripOptionsRequest';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_QPXExpress_TripsSearchRequest', 'VendorDuplicator\\Google_Service_QPXExpress_TripsSearchRequest', \false);
/** @internal */
class Google_Service_QPXExpress_TripsSearchResponse extends Google_Model
{
    protected $internal_gapi_mappings = array();
    public $kind;
    protected $tripsType = 'VendorDuplicator\\Google_Service_QPXExpress_TripOptionsResponse';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_QPXExpress_TripsSearchResponse', 'VendorDuplicator\\Google_Service_QPXExpress_TripsSearchResponse', \false);
