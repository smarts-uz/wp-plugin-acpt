...
class Google_Service_Pubsub extends Google_Service
{
    ...
    public function __construct(Google_Client $client)
    {
        ...
        $this->projects_subscriptions = new Google_Service_Pubsub_ProjectsSubscriptions_Resource($this, $this->serviceName, 'subscriptions', array('methods' => array('acknowledge' => array('path' => 'v1/{+subscription}:acknowledge', 'httpMethod' => 'POST', 'parameters' => array('subscription' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'create' => array('path' => 'v1/{+name}', 'httpMethod' => 'PUT', 'parameters' => array('name' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'delete' => array('path' => 'v1/{+subscription}', 'httpMethod' => 'DELETE', 'parameters' => array('subscription' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'get' => array('path' => 'v1/{+subscription}', 'httpMethod' => 'GET', 'parameters' => array('subscription' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'getIamPolicy' => array('path' => 'v1/{+resource}:getIamPolicy', 'httpMethod' => 'GET', 'parameters' => array('resource' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'list' => array('path' => 'v1/{+project}/subscriptions', 'httpMethod' => 'GET', 'parameters' => array('project' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'pageSize' => array('location' => 'query', 'type' => 'integer'), 'pageToken' => array('location' => 'query', 'type' => 'string'))), 'modifyAckDeadline' => array('path' => 'v1/{+subscription}:modifyAckDeadline', 'httpMethod' => 'POST', 'parameters' => array('subscription' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'modifyPushConfig' => array('path' => 'v1/{+subscription}:modifyPushConfig', 'httpMethod' => 'POST', 'parameters' => array('subscription' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'pull' => array('path' => 'v1/{+subscription}:pull', 'httpMethod' => 'POST', 'parameters' => array('subscription' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'setIamPolicy' => array('path' => 'v1/{+resource}:setIamPolicy', 'httpMethod' => 'POST', 'parameters' => array('resource' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'testIamPermissions' => array('path' => 'v1/{+resource}:testIamPermissions', 'httpMethod' => 'POST', 'parameters' => array('resource' => array('location' => 'path', 'type' => 'string', 'required' => \true))))));
        $this->projects_topics = new Google_Service_Pubsub_ProjectsTopics_Resource($this, $this->serviceName, 'topics', array('methods' => array('create' => array('path' => 'v1/{+name}', 'httpMethod' => 'PUT', 'parameters' => array('name' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'delete' => array('path' => 'v1/{+topic}', 'httpMethod' => 'DELETE', 'parameters' => array('topic' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'get' => array('path' => 'v1/{+topic}', 'httpMethod' => 'GET', 'parameters' => array('topic' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'getIamPolicy' => array('path' => 'v1/{+resource}:getIamPolicy', 'httpMethod' => 'GET', 'parameters' => array('resource' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'list' => array('path' => 'v1/{+project}/topics', 'httpMethod' => 'GET', 'parameters' => array('project' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'pageSize' => array('location' => 'query', 'type' => 'integer'), 'pageToken' => array('location' => 'query', 'type' => 'string'))), 'publish' => array('path' => 'v1/{+topic}:publish', 'httpMethod' => 'POST', 'parameters' => array('topic' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'setIamPolicy' => array('path' => 'v1/{+resource}:setIamPolicy', 'httpMethod' => 'POST', 'parameters' => array('resource' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'testIamPermissions' => array('path' => 'v1/{+resource}:testIamPermissions', 'httpMethod' => 'POST', 'parameters' => array('resource' => array('location' => 'path', 'type' => 'string', 'required' => \true))))));
        $this->projects_topics_subscriptions = new Google_Service_Pubsub_ProjectsTopicsSubscriptions_Resource($this, $this->serviceName, 'subscriptions', array('methods' => array('list' => array('path' => 'v1/{+topic}/subscriptions', 'httpMethod' => 'GET', 'parameters' => array('topic' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'pageSize' => array('location' => 'query', 'type' => 'integer'), 'pageToken' => array('location' => 'query', 'type' => 'string'))))));
    }
}
/*
 * Licensed under the Apache License, Version 2.0 (the "License"); you may not
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Pubsub', 'VendorDuplicator\\Google_Service_Pubsub', \false);
/**
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Pubsub_Projects_Resource', 'VendorDuplicator\\Google_Service_Pubsub_Projects_Resource', \false);
/**
...
class Google_Service_Pubsub_ProjectsSubscriptions_Resource extends Google_Service_Resource
{
    ...
    public function acknowledge($subscription, Google_Service_Pubsub_AcknowledgeRequest $postBody, $optParams = array())
    {
        ...
        return $this->call('acknowledge', array($params), "VendorDuplicator\\Google_Service_Pubsub_Empty");
    }
    /**
    ...
    public function create($name, Google_Service_Pubsub_Subscription $postBody, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('create', array($params), "VendorDuplicator\\Google_Service_Pubsub_Subscription");
    }
    /**
    ...
    public function delete($subscription, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('delete', array($params), "VendorDuplicator\\Google_Service_Pubsub_Empty");
    }
    /**
    ...
    public function get($subscription, $optParams = array())
    {
        $params = array('subscription' => $subscription);
        $params = \array_merge($params, $optParams);
        return $this->call('get', array($params), "VendorDuplicator\\Google_Service_Pubsub_Subscription");
    }
    /**
    ...
    public function getIamPolicy($resource, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('getIamPolicy', array($params), "VendorDuplicator\\Google_Service_Pubsub_Policy");
    }
    /**
    ...
    public function listProjectsSubscriptions($project, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('list', array($params), "VendorDuplicator\\Google_Service_Pubsub_ListSubscriptionsResponse");
    }
    /**
    ...
    public function modifyAckDeadline($subscription, Google_Service_Pubsub_ModifyAckDeadlineRequest $postBody, $optParams = array())
    {
        $params = array('subscription' => $subscription, 'postBody' => $postBody);
        $params = \array_merge($params, $optParams);
        return $this->call('modifyAckDeadline', array($params), "VendorDuplicator\\Google_Service_Pubsub_Empty");
    }
    /**
    ...
    public function modifyPushConfig($subscription, Google_Service_Pubsub_ModifyPushConfigRequest $postBody, $optParams = array())
    {
        $params = array('subscription' => $subscription, 'postBody' => $postBody);
        $params = \array_merge($params, $optParams);
        return $this->call('modifyPushConfig', array($params), "VendorDuplicator\\Google_Service_Pubsub_Empty");
    }
    /**
    ...
    public function pull($subscription, Google_Service_Pubsub_PullRequest $postBody, $optParams = array())
    {
        $params = array('subscription' => $subscription, 'postBody' => $postBody);
        $params = \array_merge($params, $optParams);
        return $this->call('pull', array($params), "VendorDuplicator\\Google_Service_Pubsub_PullResponse");
    }
    /**
    ...
    public function setIamPolicy($resource, Google_Service_Pubsub_SetIamPolicyRequest $postBody, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('setIamPolicy', array($params), "VendorDuplicator\\Google_Service_Pubsub_Policy");
    }
    /**
    ...
    public function testIamPermissions($resource, Google_Service_Pubsub_TestIamPermissionsRequest $postBody, $optParams = array())
    {
        $params = array('resource' => $resource, 'postBody' => $postBody);
        $params = \array_merge($params, $optParams);
        return $this->call('testIamPermissions', array($params), "VendorDuplicator\\Google_Service_Pubsub_TestIamPermissionsResponse");
    }
}
/**
 * The "subscriptions" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Pubsub_ProjectsSubscriptions_Resource', 'VendorDuplicator\\Google_Service_Pubsub_ProjectsSubscriptions_Resource', \false);
/**
...
class Google_Service_Pubsub_ProjectsTopics_Resource extends Google_Service_Resource
{
    ...
    public function create($name, Google_Service_Pubsub_Topic $postBody, $optParams = array())
    {
        $params = array('name' => $name, 'postBody' => $postBody);
        $params = \array_merge($params, $optParams);
        return $this->call('create', array($params), "VendorDuplicator\\Google_Service_Pubsub_Topic");
    }
    /**
    ...
    public function get($topic, $optParams = array())
    {
        $params = array('topic' => $topic);
        $params = \array_merge($params, $optParams);
        return $this->call('get', array($params), "VendorDuplicator\\Google_Service_Pubsub_Topic");
    }
    /**
     * Gets the access control policy for a `resource`. Is empty if the policy or
    ...
    public function listProjectsTopics($project, $optParams = array())
    {
        $params = array('project' => $project);
        $params = \array_merge($params, $optParams);
        return $this->call('list', array($params), "VendorDuplicator\\Google_Service_Pubsub_ListTopicsResponse");
    }
    /**
    ...
    public function publish($topic, Google_Service_Pubsub_PublishRequest $postBody, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('publish', array($params), "VendorDuplicator\\Google_Service_Pubsub_PublishResponse");
    }
    /**
     * Sets the access control policy on the specified resource. Replaces any
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Pubsub_ProjectsTopics_Resource', 'VendorDuplicator\\Google_Service_Pubsub_ProjectsTopics_Resource', \false);
/**
 * The "subscriptions" collection of methods.
 * Typical usage is:
 *  <code>
...
class Google_Service_Pubsub_ProjectsTopicsSubscriptions_Resource extends Google_Service_Resource
{
    ...
    public function listProjectsTopicsSubscriptions($topic, $optParams = array())
    {
        $params = array('topic' => $topic);
        $params = \array_merge($params, $optParams);
        return $this->call('list', array($params), "VendorDuplicator\\Google_Service_Pubsub_ListTopicSubscriptionsResponse");
    }
}
/**
 * The "subscriptions" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Pubsub_ProjectsTopicsSubscriptions_Resource', 'VendorDuplicator\\Google_Service_Pubsub_ProjectsTopicsSubscriptions_Resource', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Pubsub_AcknowledgeRequest', 'VendorDuplicator\\Google_Service_Pubsub_AcknowledgeRequest', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Pubsub_Binding', 'VendorDuplicator\\Google_Service_Pubsub_Binding', \false);
/** @internal */
class Google_Service_Pubsub_Empty extends Google_Model
{
}
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Pubsub_Empty', 'VendorDuplicator\\Google_Service_Pubsub_Empty', \false);
/** @internal */
class Google_Service_Pubsub_ListSubscriptionsResponse extends Google_Collection
{
    ...
    protected $subscriptionsType = 'VendorDuplicator\\Google_Service_Pubsub_Subscription';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Pubsub_ListSubscriptionsResponse', 'VendorDuplicator\\Google_Service_Pubsub_ListSubscriptionsResponse', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Pubsub_ListTopicSubscriptionsResponse', 'VendorDuplicator\\Google_Service_Pubsub_ListTopicSubscriptionsResponse', \false);
/** @internal */
class Google_Service_Pubsub_ListTopicsResponse extends Google_Collection
{
    ...
    protected $internal_gapi_mappings = array();
    public $nextPageToken;
    protected $topicsType = 'VendorDuplicator\\Google_Service_Pubsub_Topic';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Pubsub_ListTopicsResponse', 'VendorDuplicator\\Google_Service_Pubsub_ListTopicsResponse', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Pubsub_ModifyAckDeadlineRequest', 'VendorDuplicator\\Google_Service_Pubsub_ModifyAckDeadlineRequest', \false);
/** @internal */
class Google_Service_Pubsub_ModifyPushConfigRequest extends Google_Model
{
    protected $internal_gapi_mappings = array();
    protected $pushConfigType = 'VendorDuplicator\\Google_Service_Pubsub_PushConfig';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Pubsub_ModifyPushConfigRequest', 'VendorDuplicator\\Google_Service_Pubsub_ModifyPushConfigRequest', \false);
/** @internal */
class Google_Service_Pubsub_Policy extends Google_Collection
{
    protected $collection_key = 'bindings';
    protected $internal_gapi_mappings = array();
    protected $bindingsType = 'VendorDuplicator\\Google_Service_Pubsub_Binding';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Pubsub_Policy', 'VendorDuplicator\\Google_Service_Pubsub_Policy', \false);
/** @internal */
class Google_Service_Pubsub_PublishRequest extends Google_Collection
{
    protected $collection_key = 'messages';
    protected $internal_gapi_mappings = array();
    protected $messagesType = 'VendorDuplicator\\Google_Service_Pubsub_PubsubMessage';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Pubsub_PublishRequest', 'VendorDuplicator\\Google_Service_Pubsub_PublishRequest', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Pubsub_PublishResponse', 'VendorDuplicator\\Google_Service_Pubsub_PublishResponse', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Pubsub_PubsubMessage', 'VendorDuplicator\\Google_Service_Pubsub_PubsubMessage', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Pubsub_PullRequest', 'VendorDuplicator\\Google_Service_Pubsub_PullRequest', \false);
/** @internal */
class Google_Service_Pubsub_PullResponse extends Google_Collection
{
    protected $collection_key = 'receivedMessages';
    protected $internal_gapi_mappings = array();
    protected $receivedMessagesType = 'VendorDuplicator\\Google_Service_Pubsub_ReceivedMessage';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Pubsub_PullResponse', 'VendorDuplicator\\Google_Service_Pubsub_PullResponse', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Pubsub_PushConfig', 'VendorDuplicator\\Google_Service_Pubsub_PushConfig', \false);
/** @internal */
class Google_Service_Pubsub_ReceivedMessage extends Google_Model
{
    protected $internal_gapi_mappings = array();
    public $ackId;
    protected $messageType = 'VendorDuplicator\\Google_Service_Pubsub_PubsubMessage';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Pubsub_ReceivedMessage', 'VendorDuplicator\\Google_Service_Pubsub_ReceivedMessage', \false);
/** @internal */
class Google_Service_Pubsub_SetIamPolicyRequest extends Google_Model
{
    protected $internal_gapi_mappings = array();
    protected $policyType = 'VendorDuplicator\\Google_Service_Pubsub_Policy';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Pubsub_SetIamPolicyRequest', 'VendorDuplicator\\Google_Service_Pubsub_SetIamPolicyRequest', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Pubsub_Subscription', 'VendorDuplicator\\Google_Service_Pubsub_Subscription', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Pubsub_TestIamPermissionsRequest', 'VendorDuplicator\\Google_Service_Pubsub_TestIamPermissionsRequest', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Pubsub_TestIamPermissionsResponse', 'VendorDuplicator\\Google_Service_Pubsub_TestIamPermissionsResponse', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Pubsub_Topic', 'VendorDuplicator\\Google_Service_Pubsub_Topic', \false);
