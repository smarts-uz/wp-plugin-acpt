...
class Google_Config
{
    ...
    public function __construct($ini_file_location = null)
    {
        $this->configuration = array(
            ...
            'auth_class' => 'VendorDuplicator\\Google_Auth_OAuth2',
            'io_class' => self::USE_AUTO_IO_SELECTION,
            'cache_class' => 'VendorDuplicator\\Google_Cache_File',
            'logger_class' => 'VendorDuplicator\\Google_Logger_Null',
            // Don't change these unless you're working against a special development
            // or testing environment.
            'base_path' => 'https://www.googleapis.com',
            // Definition of class specific values, like file paths and so on.
            'classes' => array(
                'VendorDuplicator\\Google_IO_Abstract' => array('request_timeout_seconds' => 100),
                'VendorDuplicator\\Google_IO_Curl' => array('disable_proxy_workaround' => \false, 'options' => null),
                'VendorDuplicator\\Google_Logger_Abstract' => array('level' => 'debug', 'log_format' => "[%datetime%] %level%: %message% %context%\n", 'date_format' => 'd/M/Y:H:i:s O', 'allow_newlines' => \true),
                'VendorDuplicator\\Google_Logger_File' => array('file' => 'php://stdout', 'mode' => 0640, 'lock' => \false),
                'VendorDuplicator\\Google_Http_Request' => array(
                ...
                'VendorDuplicator\\Google_Auth_OAuth2' => array(
                ...
                'VendorDuplicator\\Google_Task_Runner' => array(
                ...
                'VendorDuplicator\\Google_Service_Exception' => array('retry_map' => array('500' => self::TASK_RETRY_ALWAYS, '503' => self::TASK_RETRY_ALWAYS, 'rateLimitExceeded' => self::TASK_RETRY_ALWAYS, 'userRateLimitExceeded' => self::TASK_RETRY_ALWAYS)),
                'VendorDuplicator\\Google_IO_Exception' => array('retry_map' => !\extension_loaded('curl') ? array() : array(\CURLE_COULDNT_RESOLVE_HOST => self::TASK_RETRY_ALWAYS, \CURLE_COULDNT_CONNECT => self::TASK_RETRY_ALWAYS, \CURLE_OPERATION_TIMEOUTED => self::TASK_RETRY_ALWAYS, \CURLE_SSL_CONNECT_ERROR => self::TASK_RETRY_ALWAYS, \CURLE_GOT_NOTHING => self::TASK_RETRY_ALWAYS)),
                // Set a default directory for the file cache.
                'VendorDuplicator\\Google_Cache_File' => array('directory' => \sys_get_temp_dir() . '/Google_Client'),
            ),
        );
        if ($ini_file_location) {
            $ini = \parse_ini_file($ini_file_location, \true);
     ...
     * $config->setClassConfig('VendorDuplicator\\Google_Cache_File',
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Config', 'VendorDuplicator\\Google_Config', \false);
