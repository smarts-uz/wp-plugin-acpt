...
class Google_Service_Webmasters extends Google_Service
{
    ...
    public function __construct(Google_Client $client)
    {
        ...
        $this->searchanalytics = new Google_Service_Webmasters_Searchanalytics_Resource($this, $this->serviceName, 'searchanalytics', array('methods' => array('query' => array('path' => 'sites/{siteUrl}/searchAnalytics/query', 'httpMethod' => 'POST', 'parameters' => array('siteUrl' => array('location' => 'path', 'type' => 'string', 'required' => \true))))));
        ...
        $this->sites = new Google_Service_Webmasters_Sites_Resource($this, $this->serviceName, 'sites', array('methods' => array('add' => array('path' => 'sites/{siteUrl}', 'httpMethod' => 'PUT', 'parameters' => array('siteUrl' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'delete' => array('path' => 'sites/{siteUrl}', 'httpMethod' => 'DELETE', 'parameters' => array('siteUrl' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'get' => array('path' => 'sites/{siteUrl}', 'httpMethod' => 'GET', 'parameters' => array('siteUrl' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'list' => array('path' => 'sites', 'httpMethod' => 'GET', 'parameters' => array()))));
        $this->urlcrawlerrorscounts = new Google_Service_Webmasters_Urlcrawlerrorscounts_Resource($this, $this->serviceName, 'urlcrawlerrorscounts', array('methods' => array('query' => array('path' => 'sites/{siteUrl}/urlCrawlErrorsCounts/query', 'httpMethod' => 'GET', 'parameters' => array('siteUrl' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'category' => array('location' => 'query', 'type' => 'string'), 'latestCountsOnly' => array('location' => 'query', 'type' => 'boolean'), 'platform' => array('location' => 'query', 'type' => 'string'))))));
        $this->urlcrawlerrorssamples = new Google_Service_Webmasters_Urlcrawlerrorssamples_Resource($this, $this->serviceName, 'urlcrawlerrorssamples', array('methods' => array('get' => array('path' => 'sites/{siteUrl}/urlCrawlErrorsSamples/{url}', 'httpMethod' => 'GET', 'parameters' => array('siteUrl' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'url' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'category' => array('location' => 'query', 'type' => 'string', 'required' => \true), 'platform' => array('location' => 'query', 'type' => 'string', 'required' => \true))), 'list' => array('path' => 'sites/{siteUrl}/urlCrawlErrorsSamples', 'httpMethod' => 'GET', 'parameters' => array('siteUrl' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'category' => array('location' => 'query', 'type' => 'string', 'required' => \true), 'platform' => array('location' => 'query', 'type' => 'string', 'required' => \true))), 'markAsFixed' => array('path' => 'sites/{siteUrl}/urlCrawlErrorsSamples/{url}', 'httpMethod' => 'DELETE', 'parameters' => array('siteUrl' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'url' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'category' => array('location' => 'query', 'type' => 'string', 'required' => \true), 'platform' => array('location' => 'query', 'type' => 'string', 'required' => \true))))));
    }
}
/*
 * Licensed under the Apache License, Version 2.0 (the "License"); you may not
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Webmasters', 'VendorDuplicator\\Google_Service_Webmasters', \false);
/**
...
class Google_Service_Webmasters_Searchanalytics_Resource extends Google_Service_Resource
{
    ...
    public function query($siteUrl, Google_Service_Webmasters_SearchAnalyticsQueryRequest $postBody, $optParams = array())
    {
        ...
        return $this->call('query', array($params), "VendorDuplicator\\Google_Service_Webmasters_SearchAnalyticsQueryResponse");
    }
}
/**
 * The "searchanalytics" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Webmasters_Searchanalytics_Resource', 'VendorDuplicator\\Google_Service_Webmasters_Searchanalytics_Resource', \false);
/**
...
class Google_Service_Webmasters_Sitemaps_Resource extends Google_Service_Resource
{
    ...
    public function get($siteUrl, $feedpath, $optParams = array())
    {
        $params = array('siteUrl' => $siteUrl, 'feedpath' => $feedpath);
        $params = \array_merge($params, $optParams);
        return $this->call('get', array($params), "VendorDuplicator\\Google_Service_Webmasters_WmxSitemap");
    }
    /**
    ...
    public function listSitemaps($siteUrl, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('list', array($params), "VendorDuplicator\\Google_Service_Webmasters_SitemapsListResponse");
    }
    /**
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Webmasters_Sitemaps_Resource', 'VendorDuplicator\\Google_Service_Webmasters_Sitemaps_Resource', \false);
/**
...
class Google_Service_Webmasters_Sites_Resource extends Google_Service_Resource
{
    ...
    public function get($siteUrl, $optParams = array())
    {
        $params = array('siteUrl' => $siteUrl);
        $params = \array_merge($params, $optParams);
        return $this->call('get', array($params), "VendorDuplicator\\Google_Service_Webmasters_WmxSite");
    }
    /**
    ...
    public function listSites($optParams = array())
    {
        $params = array();
        $params = \array_merge($params, $optParams);
        return $this->call('list', array($params), "VendorDuplicator\\Google_Service_Webmasters_SitesListResponse");
    }
}
/**
 * The "sites" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Webmasters_Sites_Resource', 'VendorDuplicator\\Google_Service_Webmasters_Sites_Resource', \false);
/**
...
class Google_Service_Webmasters_Urlcrawlerrorscounts_Resource extends Google_Service_Resource
{
    ...
    public function query($siteUrl, $optParams = array())
    {
        $params = array('siteUrl' => $siteUrl);
        $params = \array_merge($params, $optParams);
        return $this->call('query', array($params), "VendorDuplicator\\Google_Service_Webmasters_UrlCrawlErrorsCountsQueryResponse");
    }
}
/**
 * The "urlcrawlerrorscounts" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Webmasters_Urlcrawlerrorscounts_Resource', 'VendorDuplicator\\Google_Service_Webmasters_Urlcrawlerrorscounts_Resource', \false);
/**
...
class Google_Service_Webmasters_Urlcrawlerrorssamples_Resource extends Google_Service_Resource
{
    ...
    public function get($siteUrl, $url, $category, $platform, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('get', array($params), "VendorDuplicator\\Google_Service_Webmasters_UrlCrawlErrorsSample");
    }
    /**
    ...
    public function listUrlcrawlerrorssamples($siteUrl, $category, $platform, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('list', array($params), "VendorDuplicator\\Google_Service_Webmasters_UrlCrawlErrorsSamplesListResponse");
    }
    /**
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Webmasters_Urlcrawlerrorssamples_Resource', 'VendorDuplicator\\Google_Service_Webmasters_Urlcrawlerrorssamples_Resource', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Webmasters_ApiDataRow', 'VendorDuplicator\\Google_Service_Webmasters_ApiDataRow', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Webmasters_ApiDimensionFilter', 'VendorDuplicator\\Google_Service_Webmasters_ApiDimensionFilter', \false);
/** @internal */
class Google_Service_Webmasters_ApiDimensionFilterGroup extends Google_Collection
{
    protected $collection_key = 'filters';
    protected $internal_gapi_mappings = array();
    protected $filtersType = 'VendorDuplicator\\Google_Service_Webmasters_ApiDimensionFilter';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Webmasters_ApiDimensionFilterGroup', 'VendorDuplicator\\Google_Service_Webmasters_ApiDimensionFilterGroup', \false);
/** @internal */
class Google_Service_Webmasters_SearchAnalyticsQueryRequest extends Google_Collection
{
    ...
    protected $dimensionFilterGroupsType = 'VendorDuplicator\\Google_Service_Webmasters_ApiDimensionFilterGroup';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Webmasters_SearchAnalyticsQueryRequest', 'VendorDuplicator\\Google_Service_Webmasters_SearchAnalyticsQueryRequest', \false);
/** @internal */
class Google_Service_Webmasters_SearchAnalyticsQueryResponse extends Google_Collection
{
    ...
    protected $rowsType = 'VendorDuplicator\\Google_Service_Webmasters_ApiDataRow';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Webmasters_SearchAnalyticsQueryResponse', 'VendorDuplicator\\Google_Service_Webmasters_SearchAnalyticsQueryResponse', \false);
/** @internal */
class Google_Service_Webmasters_SitemapsListResponse extends Google_Collection
{
    protected $collection_key = 'sitemap';
    protected $internal_gapi_mappings = array();
    protected $sitemapType = 'VendorDuplicator\\Google_Service_Webmasters_WmxSitemap';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Webmasters_SitemapsListResponse', 'VendorDuplicator\\Google_Service_Webmasters_SitemapsListResponse', \false);
/** @internal */
class Google_Service_Webmasters_SitesListResponse extends Google_Collection
{
    protected $collection_key = 'siteEntry';
    protected $internal_gapi_mappings = array();
    protected $siteEntryType = 'VendorDuplicator\\Google_Service_Webmasters_WmxSite';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Webmasters_SitesListResponse', 'VendorDuplicator\\Google_Service_Webmasters_SitesListResponse', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Webmasters_UrlCrawlErrorCount', 'VendorDuplicator\\Google_Service_Webmasters_UrlCrawlErrorCount', \false);
/** @internal */
class Google_Service_Webmasters_UrlCrawlErrorCountsPerType extends Google_Collection
{
    ...
    protected $internal_gapi_mappings = array();
    public $category;
    protected $entriesType = 'VendorDuplicator\\Google_Service_Webmasters_UrlCrawlErrorCount';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Webmasters_UrlCrawlErrorCountsPerType', 'VendorDuplicator\\Google_Service_Webmasters_UrlCrawlErrorCountsPerType', \false);
/** @internal */
class Google_Service_Webmasters_UrlCrawlErrorsCountsQueryResponse extends Google_Collection
{
    ...
    protected $internal_gapi_mappings = array();
    protected $countPerTypesType = 'VendorDuplicator\\Google_Service_Webmasters_UrlCrawlErrorCountsPerType';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Webmasters_UrlCrawlErrorsCountsQueryResponse', 'VendorDuplicator\\Google_Service_Webmasters_UrlCrawlErrorsCountsQueryResponse', \false);
/** @internal */
class Google_Service_Webmasters_UrlCrawlErrorsSample extends Google_Model
{
    ...
    public $pageUrl;
    public $responseCode;
    protected $urlDetailsType = 'VendorDuplicator\\Google_Service_Webmasters_UrlSampleDetails';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Webmasters_UrlCrawlErrorsSample', 'VendorDuplicator\\Google_Service_Webmasters_UrlCrawlErrorsSample', \false);
/** @internal */
class Google_Service_Webmasters_UrlCrawlErrorsSamplesListResponse extends Google_Collection
{
    ...
    protected $internal_gapi_mappings = array();
    protected $urlCrawlErrorSampleType = 'VendorDuplicator\\Google_Service_Webmasters_UrlCrawlErrorsSample';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Webmasters_UrlCrawlErrorsSamplesListResponse', 'VendorDuplicator\\Google_Service_Webmasters_UrlCrawlErrorsSamplesListResponse', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Webmasters_UrlSampleDetails', 'VendorDuplicator\\Google_Service_Webmasters_UrlSampleDetails', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Webmasters_WmxSite', 'VendorDuplicator\\Google_Service_Webmasters_WmxSite', \false);
/** @internal */
class Google_Service_Webmasters_WmxSitemap extends Google_Collection
{
    protected $collection_key = 'contents';
    protected $internal_gapi_mappings = array();
    protected $contentsType = 'VendorDuplicator\\Google_Service_Webmasters_WmxSitemapContent';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Webmasters_WmxSitemap', 'VendorDuplicator\\Google_Service_Webmasters_WmxSitemap', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Webmasters_WmxSitemapContent', 'VendorDuplicator\\Google_Service_Webmasters_WmxSitemapContent', \false);
