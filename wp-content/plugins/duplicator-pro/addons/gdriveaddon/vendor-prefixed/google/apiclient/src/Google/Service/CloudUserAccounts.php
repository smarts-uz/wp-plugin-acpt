...
class Google_Service_CloudUserAccounts extends Google_Service
{
    ...
    public function __construct(Google_Client $client)
    {
        ...
        $this->globalAccountsOperations = new Google_Service_CloudUserAccounts_GlobalAccountsOperations_Resource($this, $this->serviceName, 'globalAccountsOperations', array('methods' => array('delete' => array('path' => '{project}/global/operations/{operation}', 'httpMethod' => 'DELETE', 'parameters' => array('project' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'operation' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'get' => array('path' => '{project}/global/operations/{operation}', 'httpMethod' => 'GET', 'parameters' => array('project' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'operation' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'list' => array('path' => '{project}/global/operations', 'httpMethod' => 'GET', 'parameters' => array('project' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'filter' => array('location' => 'query', 'type' => 'string'), 'maxResults' => array('location' => 'query', 'type' => 'integer'), 'orderBy' => array('location' => 'query', 'type' => 'string'), 'pageToken' => array('location' => 'query', 'type' => 'string'))))));
        $this->groups = new Google_Service_CloudUserAccounts_Groups_Resource($this, $this->serviceName, 'groups', array('methods' => array('addMember' => array('path' => '{project}/global/groups/{groupName}/addMember', 'httpMethod' => 'POST', 'parameters' => array('project' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'groupName' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'delete' => array('path' => '{project}/global/groups/{groupName}', 'httpMethod' => 'DELETE', 'parameters' => array('project' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'groupName' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'get' => array('path' => '{project}/global/groups/{groupName}', 'httpMethod' => 'GET', 'parameters' => array('project' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'groupName' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'getIamPolicy' => array('path' => '{project}/global/groups/{resource}/getIamPolicy', 'httpMethod' => 'GET', 'parameters' => array('project' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'resource' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'insert' => array('path' => '{project}/global/groups', 'httpMethod' => 'POST', 'parameters' => array('project' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'list' => array('path' => '{project}/global/groups', 'httpMethod' => 'GET', 'parameters' => array('project' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'filter' => array('location' => 'query', 'type' => 'string'), 'maxResults' => array('location' => 'query', 'type' => 'integer'), 'orderBy' => array('location' => 'query', 'type' => 'string'), 'pageToken' => array('location' => 'query', 'type' => 'string'))), 'removeMember' => array('path' => '{project}/global/groups/{groupName}/removeMember', 'httpMethod' => 'POST', 'parameters' => array('project' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'groupName' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'setIamPolicy' => array('path' => '{project}/global/groups/{resource}/setIamPolicy', 'httpMethod' => 'POST', 'parameters' => array('project' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'resource' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'testIamPermissions' => array('path' => '{project}/global/groups/{resource}/testIamPermissions', 'httpMethod' => 'POST', 'parameters' => array('project' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'resource' => array('location' => 'path', 'type' => 'string', 'required' => \true))))));
        $this->linux = new Google_Service_CloudUserAccounts_Linux_Resource($this, $this->serviceName, 'linux', array('methods' => array('getAuthorizedKeysView' => array('path' => '{project}/zones/{zone}/authorizedKeysView/{user}', 'httpMethod' => 'POST', 'parameters' => array('project' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'zone' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'user' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'instance' => array('location' => 'query', 'type' => 'string', 'required' => \true), 'login' => array('location' => 'query', 'type' => 'boolean'))), 'getLinuxAccountViews' => array('path' => '{project}/zones/{zone}/linuxAccountViews', 'httpMethod' => 'POST', 'parameters' => array('project' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'zone' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'instance' => array('location' => 'query', 'type' => 'string', 'required' => \true), 'filter' => array('location' => 'query', 'type' => 'string'), 'maxResults' => array('location' => 'query', 'type' => 'integer'), 'orderBy' => array('location' => 'query', 'type' => 'string'), 'pageToken' => array('location' => 'query', 'type' => 'string'))))));
        $this->users = new Google_Service_CloudUserAccounts_Users_Resource($this, $this->serviceName, 'users', array('methods' => array('addPublicKey' => array('path' => '{project}/global/users/{user}/addPublicKey', 'httpMethod' => 'POST', 'parameters' => array('project' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'user' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'delete' => array('path' => '{project}/global/users/{user}', 'httpMethod' => 'DELETE', 'parameters' => array('project' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'user' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'get' => array('path' => '{project}/global/users/{user}', 'httpMethod' => 'GET', 'parameters' => array('project' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'user' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'getIamPolicy' => array('path' => '{project}/global/users/{resource}/getIamPolicy', 'httpMethod' => 'GET', 'parameters' => array('project' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'resource' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'insert' => array('path' => '{project}/global/users', 'httpMethod' => 'POST', 'parameters' => array('project' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'list' => array('path' => '{project}/global/users', 'httpMethod' => 'GET', 'parameters' => array('project' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'filter' => array('location' => 'query', 'type' => 'string'), 'maxResults' => array('location' => 'query', 'type' => 'integer'), 'orderBy' => array('location' => 'query', 'type' => 'string'), 'pageToken' => array('location' => 'query', 'type' => 'string'))), 'removePublicKey' => array('path' => '{project}/global/users/{user}/removePublicKey', 'httpMethod' => 'POST', 'parameters' => array('project' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'user' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'fingerprint' => array('location' => 'query', 'type' => 'string', 'required' => \true))), 'setIamPolicy' => array('path' => '{project}/global/users/{resource}/setIamPolicy', 'httpMethod' => 'POST', 'parameters' => array('project' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'resource' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'testIamPermissions' => array('path' => '{project}/global/users/{resource}/testIamPermissions', 'httpMethod' => 'POST', 'parameters' => array('project' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'resource' => array('location' => 'path', 'type' => 'string', 'required' => \true))))));
    }
}
/*
 * Licensed under the Apache License, Version 2.0 (the "License"); you may not
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_CloudUserAccounts', 'VendorDuplicator\\Google_Service_CloudUserAccounts', \false);
/**
...
class Google_Service_CloudUserAccounts_GlobalAccountsOperations_Resource extends Google_Service_Resource
{
    ...
    public function get($project, $operation, $optParams = array())
    {
        $params = array('project' => $project, 'operation' => $operation);
        $params = \array_merge($params, $optParams);
        return $this->call('get', array($params), "VendorDuplicator\\Google_Service_CloudUserAccounts_Operation");
    }
    /**
    ...
    public function listGlobalAccountsOperations($project, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('list', array($params), "VendorDuplicator\\Google_Service_CloudUserAccounts_OperationList");
    }
}
/**
 * The "globalAccountsOperations" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_CloudUserAccounts_GlobalAccountsOperations_Resource', 'VendorDuplicator\\Google_Service_CloudUserAccounts_GlobalAccountsOperations_Resource', \false);
/**
...
class Google_Service_CloudUserAccounts_Groups_Resource extends Google_Service_Resource
{
    ...
    public function addMember($project, $groupName, Google_Service_CloudUserAccounts_GroupsAddMemberRequest $postBody, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('addMember', array($params), "VendorDuplicator\\Google_Service_CloudUserAccounts_Operation");
    }
    /**
    ...
    public function delete($project, $groupName, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('delete', array($params), "VendorDuplicator\\Google_Service_CloudUserAccounts_Operation");
    }
    /**
    ...
    public function get($project, $groupName, $optParams = array())
    {
        $params = array('project' => $project, 'groupName' => $groupName);
        $params = \array_merge($params, $optParams);
        return $this->call('get', array($params), "VendorDuplicator\\Google_Service_CloudUserAccounts_Group");
    }
    /**
    ...
    public function getIamPolicy($project, $resource, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('getIamPolicy', array($params), "VendorDuplicator\\Google_Service_CloudUserAccounts_Policy");
    }
    /**
    ...
    public function insert($project, Google_Service_CloudUserAccounts_Group $postBody, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('insert', array($params), "VendorDuplicator\\Google_Service_CloudUserAccounts_Operation");
    }
    /**
    ...
    public function listGroups($project, $optParams = array())
    {
        $params = array('project' => $project);
        $params = \array_merge($params, $optParams);
        return $this->call('list', array($params), "VendorDuplicator\\Google_Service_CloudUserAccounts_GroupList");
    }
    /**
    ...
    public function removeMember($project, $groupName, Google_Service_CloudUserAccounts_GroupsRemoveMemberRequest $postBody, $optParams = array())
    {
        $params = array('project' => $project, 'groupName' => $groupName, 'postBody' => $postBody);
        $params = \array_merge($params, $optParams);
        return $this->call('removeMember', array($params), "VendorDuplicator\\Google_Service_CloudUserAccounts_Operation");
    }
    /**
    ...
    public function setIamPolicy($project, $resource, Google_Service_CloudUserAccounts_Policy $postBody, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('setIamPolicy', array($params), "VendorDuplicator\\Google_Service_CloudUserAccounts_Policy");
    }
    /**
    ...
    public function testIamPermissions($project, $resource, Google_Service_CloudUserAccounts_TestPermissionsRequest $postBody, $optParams = array())
    {
        $params = array('project' => $project, 'resource' => $resource, 'postBody' => $postBody);
        $params = \array_merge($params, $optParams);
        return $this->call('testIamPermissions', array($params), "VendorDuplicator\\Google_Service_CloudUserAccounts_TestPermissionsResponse");
    }
}
/**
 * The "groups" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_CloudUserAccounts_Groups_Resource', 'VendorDuplicator\\Google_Service_CloudUserAccounts_Groups_Resource', \false);
/**
...
class Google_Service_CloudUserAccounts_Linux_Resource extends Google_Service_Resource
{
    ...
    public function getAuthorizedKeysView($project, $zone, $user, $instance, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('getAuthorizedKeysView', array($params), "VendorDuplicator\\Google_Service_CloudUserAccounts_LinuxGetAuthorizedKeysViewResponse");
    }
    /**
    ...
    public function getLinuxAccountViews($project, $zone, $instance, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('getLinuxAccountViews', array($params), "VendorDuplicator\\Google_Service_CloudUserAccounts_LinuxGetLinuxAccountViewsResponse");
    }
}
/**
 * The "linux" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_CloudUserAccounts_Linux_Resource', 'VendorDuplicator\\Google_Service_CloudUserAccounts_Linux_Resource', \false);
/**
...
class Google_Service_CloudUserAccounts_Users_Resource extends Google_Service_Resource
{
    ...
    public function addPublicKey($project, $user, Google_Service_CloudUserAccounts_PublicKey $postBody, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('addPublicKey', array($params), "VendorDuplicator\\Google_Service_CloudUserAccounts_Operation");
    }
    /**
    ...
    public function get($project, $user, $optParams = array())
    {
        $params = array('project' => $project, 'user' => $user);
        $params = \array_merge($params, $optParams);
        return $this->call('get', array($params), "VendorDuplicator\\Google_Service_CloudUserAccounts_User");
    }
    /**
     * Gets the access control policy for a resource. May be empty if no such policy
    ...
    public function listUsers($project, $optParams = array())
    {
        $params = array('project' => $project);
        $params = \array_merge($params, $optParams);
        return $this->call('list', array($params), "VendorDuplicator\\Google_Service_CloudUserAccounts_UserList");
    }
    /**
    ...
    public function removePublicKey($project, $user, $fingerprint, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('removePublicKey', array($params), "VendorDuplicator\\Google_Service_CloudUserAccounts_Operation");
    }
    /**
     * Sets the access control policy on the specified resource. Replaces any
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_CloudUserAccounts_Users_Resource', 'VendorDuplicator\\Google_Service_CloudUserAccounts_Users_Resource', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_CloudUserAccounts_AuthorizedKeysView', 'VendorDuplicator\\Google_Service_CloudUserAccounts_AuthorizedKeysView', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_CloudUserAccounts_Binding', 'VendorDuplicator\\Google_Service_CloudUserAccounts_Binding', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_CloudUserAccounts_Condition', 'VendorDuplicator\\Google_Service_CloudUserAccounts_Condition', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_CloudUserAccounts_Group', 'VendorDuplicator\\Google_Service_CloudUserAccounts_Group', \false);
/** @internal */
class Google_Service_CloudUserAccounts_GroupList extends Google_Collection
{
    ...
    protected $internal_gapi_mappings = array();
    public $id;
    protected $itemsType = 'VendorDuplicator\\Google_Service_CloudUserAccounts_Group';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_CloudUserAccounts_GroupList', 'VendorDuplicator\\Google_Service_CloudUserAccounts_GroupList', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_CloudUserAccounts_GroupsAddMemberRequest', 'VendorDuplicator\\Google_Service_CloudUserAccounts_GroupsAddMemberRequest', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_CloudUserAccounts_GroupsRemoveMemberRequest', 'VendorDuplicator\\Google_Service_CloudUserAccounts_GroupsRemoveMemberRequest', \false);
/** @internal */
class Google_Service_CloudUserAccounts_LinuxAccountViews extends Google_Collection
{
    protected $collection_key = 'userViews';
    protected $internal_gapi_mappings = array();
    protected $groupViewsType = 'VendorDuplicator\\Google_Service_CloudUserAccounts_LinuxGroupView';
    protected $groupViewsDataType = 'array';
    public $kind;
    protected $userViewsType = 'VendorDuplicator\\Google_Service_CloudUserAccounts_LinuxUserView';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_CloudUserAccounts_LinuxAccountViews', 'VendorDuplicator\\Google_Service_CloudUserAccounts_LinuxAccountViews', \false);
/** @internal */
class Google_Service_CloudUserAccounts_LinuxGetAuthorizedKeysViewResponse extends Google_Model
{
    protected $internal_gapi_mappings = array();
    protected $resourceType = 'VendorDuplicator\\Google_Service_CloudUserAccounts_AuthorizedKeysView';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_CloudUserAccounts_LinuxGetAuthorizedKeysViewResponse', 'VendorDuplicator\\Google_Service_CloudUserAccounts_LinuxGetAuthorizedKeysViewResponse', \false);
/** @internal */
class Google_Service_CloudUserAccounts_LinuxGetLinuxAccountViewsResponse extends Google_Model
{
    protected $internal_gapi_mappings = array();
    protected $resourceType = 'VendorDuplicator\\Google_Service_CloudUserAccounts_LinuxAccountViews';
    protected $resourceDataType = '';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_CloudUserAccounts_LinuxGetLinuxAccountViewsResponse', 'VendorDuplicator\\Google_Service_CloudUserAccounts_LinuxGetLinuxAccountViewsResponse', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_CloudUserAccounts_LinuxGroupView', 'VendorDuplicator\\Google_Service_CloudUserAccounts_LinuxGroupView', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_CloudUserAccounts_LinuxUserView', 'VendorDuplicator\\Google_Service_CloudUserAccounts_LinuxUserView', \false);
/** @internal */
class Google_Service_CloudUserAccounts_LogConfig extends Google_Model
{
    protected $internal_gapi_mappings = array();
    protected $counterType = 'VendorDuplicator\\Google_Service_CloudUserAccounts_LogConfigCounterOptions';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_CloudUserAccounts_LogConfig', 'VendorDuplicator\\Google_Service_CloudUserAccounts_LogConfig', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_CloudUserAccounts_LogConfigCounterOptions', 'VendorDuplicator\\Google_Service_CloudUserAccounts_LogConfigCounterOptions', \false);
/** @internal */
class Google_Service_CloudUserAccounts_Operation extends Google_Collection
{
    ...
    public $creationTimestamp;
    public $endTime;
    protected $errorType = 'VendorDuplicator\\Google_Service_CloudUserAccounts_OperationError';
    ...
    public $targetLink;
    public $user;
    protected $warningsType = 'VendorDuplicator\\Google_Service_CloudUserAccounts_OperationWarnings';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_CloudUserAccounts_Operation', 'VendorDuplicator\\Google_Service_CloudUserAccounts_Operation', \false);
/** @internal */
class Google_Service_CloudUserAccounts_OperationError extends Google_Collection
{
    protected $collection_key = 'errors';
    protected $internal_gapi_mappings = array();
    protected $errorsType = 'VendorDuplicator\\Google_Service_CloudUserAccounts_OperationErrorErrors';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_CloudUserAccounts_OperationError', 'VendorDuplicator\\Google_Service_CloudUserAccounts_OperationError', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_CloudUserAccounts_OperationErrorErrors', 'VendorDuplicator\\Google_Service_CloudUserAccounts_OperationErrorErrors', \false);
/** @internal */
class Google_Service_CloudUserAccounts_OperationList extends Google_Collection
{
    ...
    protected $internal_gapi_mappings = array();
    public $id;
    protected $itemsType = 'VendorDuplicator\\Google_Service_CloudUserAccounts_Operation';
    protected $itemsDataType = 'array';
    public $kind;
    public $nextPageToken;
    public $selfLink;
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_CloudUserAccounts_OperationList', 'VendorDuplicator\\Google_Service_CloudUserAccounts_OperationList', \false);
/** @internal */
class Google_Service_CloudUserAccounts_OperationWarnings extends Google_Collection
{
    ...
    protected $internal_gapi_mappings = array();
    public $code;
    protected $dataType = 'VendorDuplicator\\Google_Service_CloudUserAccounts_OperationWarningsData';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_CloudUserAccounts_OperationWarnings', 'VendorDuplicator\\Google_Service_CloudUserAccounts_OperationWarnings', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_CloudUserAccounts_OperationWarningsData', 'VendorDuplicator\\Google_Service_CloudUserAccounts_OperationWarningsData', \false);
/** @internal */
class Google_Service_CloudUserAccounts_Policy extends Google_Collection
{
    protected $collection_key = 'rules';
    protected $internal_gapi_mappings = array();
    protected $bindingsType = 'VendorDuplicator\\Google_Service_CloudUserAccounts_Binding';
    protected $bindingsDataType = 'array';
    public $etag;
    protected $rulesType = 'VendorDuplicator\\Google_Service_CloudUserAccounts_Rule';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_CloudUserAccounts_Policy', 'VendorDuplicator\\Google_Service_CloudUserAccounts_Policy', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_CloudUserAccounts_PublicKey', 'VendorDuplicator\\Google_Service_CloudUserAccounts_PublicKey', \false);
/** @internal */
class Google_Service_CloudUserAccounts_Rule extends Google_Collection
{
    ...
    protected $internal_gapi_mappings = array();
    public $action;
    protected $conditionsType = 'VendorDuplicator\\Google_Service_CloudUserAccounts_Condition';
    protected $conditionsDataType = 'array';
    public $description;
    public $ins;
    protected $logConfigsType = 'VendorDuplicator\\Google_Service_CloudUserAccounts_LogConfig';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_CloudUserAccounts_Rule', 'VendorDuplicator\\Google_Service_CloudUserAccounts_Rule', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_CloudUserAccounts_TestPermissionsRequest', 'VendorDuplicator\\Google_Service_CloudUserAccounts_TestPermissionsRequest', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_CloudUserAccounts_TestPermissionsResponse', 'VendorDuplicator\\Google_Service_CloudUserAccounts_TestPermissionsResponse', \false);
/** @internal */
class Google_Service_CloudUserAccounts_User extends Google_Collection
{
    ...
    public $name;
    public $owner;
    protected $publicKeysType = 'VendorDuplicator\\Google_Service_CloudUserAccounts_PublicKey';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_CloudUserAccounts_User', 'VendorDuplicator\\Google_Service_CloudUserAccounts_User', \false);
/** @internal */
class Google_Service_CloudUserAccounts_UserList extends Google_Collection
{
    ...
    protected $internal_gapi_mappings = array();
    public $id;
    protected $itemsType = 'VendorDuplicator\\Google_Service_CloudUserAccounts_User';
    protected $itemsDataType = 'array';
    public $kind;
    public $nextPageToken;
    public $selfLink;
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_CloudUserAccounts_UserList', 'VendorDuplicator\\Google_Service_CloudUserAccounts_UserList', \false);
