...
abstract class Google_IO_Abstract
{
    ...
    private static $HOP_BY_HOP = array('connection' => \true, 'keep-alive' => \true, 'proxy-authenticate' => \true, 'proxy-authorization' => \true, 'te' => \true, 'trailers' => \true, 'transfer-encoding' => \true, 'upgrade' => \true);
    /** @var Google_Client */
    protected $client;
    public function __construct(Google_Client $client)
    {
        $this->client = $client;
        $timeout = $client->getClassConfig('VendorDuplicator\\Google_IO_Abstract', 'request_timeout_seconds');
        if ($timeout > 0) {
     ...
     */
    public abstract function executeRequest(Google_Http_Request $request);
    /**
     ...
     * @return boolean
     */
    protected abstract function needsQuirk();
    /**
     * @visible for testing.
    ...
    protected function updateCachedRequest($cached, $responseHeaders)
    {
        ...
        if (!empty($responseHeaders['connection'])) {
            ...
            $hopByHop += \array_fill_keys($connectionHeaders, \true);
        }
...
/** @internal */
\class_alias('VendorDuplicator\\Google_IO_Abstract', 'VendorDuplicator\\Google_IO_Abstract', \false);
