...
class Google_Service_Script extends Google_Service
{
    ...
    public function __construct(Google_Client $client)
    {
        ...
        $this->scripts = new Google_Service_Script_Scripts_Resource($this, $this->serviceName, 'scripts', array('methods' => array('run' => array('path' => 'v1/scripts/{scriptId}:run', 'httpMethod' => 'POST', 'parameters' => array('scriptId' => array('location' => 'path', 'type' => 'string', 'required' => \true))))));
    }
}
/*
 * Licensed under the Apache License, Version 2.0 (the "License"); you may not
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Script', 'VendorDuplicator\\Google_Service_Script', \false);
/**
...
class Google_Service_Script_Scripts_Resource extends Google_Service_Resource
{
    ...
    public function run($scriptId, Google_Service_Script_ExecutionRequest $postBody, $optParams = array())
    {
        ...
        return $this->call('run', array($params), "VendorDuplicator\\Google_Service_Script_Operation");
    }
}
/**
 * The "scripts" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Script_Scripts_Resource', 'VendorDuplicator\\Google_Service_Script_Scripts_Resource', \false);
/** @internal */
class Google_Service_Script_ExecutionError extends Google_Collection
{
    ...
    public $errorMessage;
    public $errorType;
    protected $scriptStackTraceElementsType = 'VendorDuplicator\\Google_Service_Script_ScriptStackTraceElement';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Script_ExecutionError', 'VendorDuplicator\\Google_Service_Script_ExecutionError', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Script_ExecutionRequest', 'VendorDuplicator\\Google_Service_Script_ExecutionRequest', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Script_ExecutionResponse', 'VendorDuplicator\\Google_Service_Script_ExecutionResponse', \false);
/** @internal */
class Google_Service_Script_Operation extends Google_Model
{
    protected $internal_gapi_mappings = array();
    public $done;
    protected $errorType = 'VendorDuplicator\\Google_Service_Script_Status';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Script_Operation', 'VendorDuplicator\\Google_Service_Script_Operation', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Script_ScriptStackTraceElement', 'VendorDuplicator\\Google_Service_Script_ScriptStackTraceElement', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Script_Status', 'VendorDuplicator\\Google_Service_Script_Status', \false);
