...
class Google_Service_YouTubeAnalytics extends Google_Service
{
    ...
    public function __construct(Google_Client $client)
    {
        ...
        $this->batchReportDefinitions = new Google_Service_YouTubeAnalytics_BatchReportDefinitions_Resource($this, $this->serviceName, 'batchReportDefinitions', array('methods' => array('list' => array('path' => 'batchReportDefinitions', 'httpMethod' => 'GET', 'parameters' => array('onBehalfOfContentOwner' => array('location' => 'query', 'type' => 'string', 'required' => \true))))));
        $this->batchReports = new Google_Service_YouTubeAnalytics_BatchReports_Resource($this, $this->serviceName, 'batchReports', array('methods' => array('list' => array('path' => 'batchReports', 'httpMethod' => 'GET', 'parameters' => array('batchReportDefinitionId' => array('location' => 'query', 'type' => 'string', 'required' => \true), 'onBehalfOfContentOwner' => array('location' => 'query', 'type' => 'string', 'required' => \true))))));
        $this->groupItems = new Google_Service_YouTubeAnalytics_GroupItems_Resource($this, $this->serviceName, 'groupItems', array('methods' => array('delete' => array('path' => 'groupItems', 'httpMethod' => 'DELETE', 'parameters' => array('id' => array('location' => 'query', 'type' => 'string', 'required' => \true), 'onBehalfOfContentOwner' => array('location' => 'query', 'type' => 'string'))), 'insert' => array('path' => 'groupItems', 'httpMethod' => 'POST', 'parameters' => array('onBehalfOfContentOwner' => array('location' => 'query', 'type' => 'string'))), 'list' => array('path' => 'groupItems', 'httpMethod' => 'GET', 'parameters' => array('groupId' => array('location' => 'query', 'type' => 'string', 'required' => \true), 'onBehalfOfContentOwner' => array('location' => 'query', 'type' => 'string'))))));
        $this->groups = new Google_Service_YouTubeAnalytics_Groups_Resource($this, $this->serviceName, 'groups', array('methods' => array('delete' => array('path' => 'groups', 'httpMethod' => 'DELETE', 'parameters' => array('id' => array('location' => 'query', 'type' => 'string', 'required' => \true), 'onBehalfOfContentOwner' => array('location' => 'query', 'type' => 'string'))), 'insert' => array('path' => 'groups', 'httpMethod' => 'POST', 'parameters' => array('onBehalfOfContentOwner' => array('location' => 'query', 'type' => 'string'))), 'list' => array('path' => 'groups', 'httpMethod' => 'GET', 'parameters' => array('id' => array('location' => 'query', 'type' => 'string'), 'mine' => array('location' => 'query', 'type' => 'boolean'), 'onBehalfOfContentOwner' => array('location' => 'query', 'type' => 'string'), 'pageToken' => array('location' => 'query', 'type' => 'string'))), 'update' => array('path' => 'groups', 'httpMethod' => 'PUT', 'parameters' => array('onBehalfOfContentOwner' => array('location' => 'query', 'type' => 'string'))))));
        $this->reports = new Google_Service_YouTubeAnalytics_Reports_Resource($this, $this->serviceName, 'reports', array('methods' => array('query' => array('path' => 'reports', 'httpMethod' => 'GET', 'parameters' => array('ids' => array('location' => 'query', 'type' => 'string', 'required' => \true), 'start-date' => array('location' => 'query', 'type' => 'string', 'required' => \true), 'end-date' => array('location' => 'query', 'type' => 'string', 'required' => \true), 'metrics' => array('location' => 'query', 'type' => 'string', 'required' => \true), 'currency' => array('location' => 'query', 'type' => 'string'), 'dimensions' => array('location' => 'query', 'type' => 'string'), 'filters' => array('location' => 'query', 'type' => 'string'), 'max-results' => array('location' => 'query', 'type' => 'integer'), 'sort' => array('location' => 'query', 'type' => 'string'), 'start-index' => array('location' => 'query', 'type' => 'integer'))))));
    }
}
/*
 * Licensed under the Apache License, Version 2.0 (the "License"); you may not
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_YouTubeAnalytics', 'VendorDuplicator\\Google_Service_YouTubeAnalytics', \false);
/**
...
class Google_Service_YouTubeAnalytics_BatchReportDefinitions_Resource extends Google_Service_Resource
{
    ...
    public function listBatchReportDefinitions($onBehalfOfContentOwner, $optParams = array())
    {
        ...
        return $this->call('list', array($params), "VendorDuplicator\\Google_Service_YouTubeAnalytics_BatchReportDefinitionList");
    }
}
/**
 * The "batchReportDefinitions" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_YouTubeAnalytics_BatchReportDefinitions_Resource', 'VendorDuplicator\\Google_Service_YouTubeAnalytics_BatchReportDefinitions_Resource', \false);
/**
...
class Google_Service_YouTubeAnalytics_BatchReports_Resource extends Google_Service_Resource
{
    ...
    public function listBatchReports($batchReportDefinitionId, $onBehalfOfContentOwner, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('list', array($params), "VendorDuplicator\\Google_Service_YouTubeAnalytics_BatchReportList");
    }
}
/**
 * The "batchReports" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_YouTubeAnalytics_BatchReports_Resource', 'VendorDuplicator\\Google_Service_YouTubeAnalytics_BatchReports_Resource', \false);
/**
...
class Google_Service_YouTubeAnalytics_GroupItems_Resource extends Google_Service_Resource
{
    ...
    public function insert(Google_Service_YouTubeAnalytics_GroupItem $postBody, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('insert', array($params), "VendorDuplicator\\Google_Service_YouTubeAnalytics_GroupItem");
    }
    /**
    ...
    public function listGroupItems($groupId, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('list', array($params), "VendorDuplicator\\Google_Service_YouTubeAnalytics_GroupItemListResponse");
    }
}
/**
 * The "groupItems" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_YouTubeAnalytics_GroupItems_Resource', 'VendorDuplicator\\Google_Service_YouTubeAnalytics_GroupItems_Resource', \false);
/**
...
class Google_Service_YouTubeAnalytics_Groups_Resource extends Google_Service_Resource
{
    ...
    public function insert(Google_Service_YouTubeAnalytics_Group $postBody, $optParams = array())
    {
        $params = array('postBody' => $postBody);
        $params = \array_merge($params, $optParams);
        return $this->call('insert', array($params), "VendorDuplicator\\Google_Service_YouTubeAnalytics_Group");
    }
    /**
    ...
    public function listGroups($optParams = array())
    {
        $params = array();
        $params = \array_merge($params, $optParams);
        return $this->call('list', array($params), "VendorDuplicator\\Google_Service_YouTubeAnalytics_GroupListResponse");
    }
    /**
    ...
    public function update(Google_Service_YouTubeAnalytics_Group $postBody, $optParams = array())
    {
        $params = array('postBody' => $postBody);
        $params = \array_merge($params, $optParams);
        return $this->call('update', array($params), "VendorDuplicator\\Google_Service_YouTubeAnalytics_Group");
    }
}
/**
 * The "groups" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_YouTubeAnalytics_Groups_Resource', 'VendorDuplicator\\Google_Service_YouTubeAnalytics_Groups_Resource', \false);
/**
...
class Google_Service_YouTubeAnalytics_Reports_Resource extends Google_Service_Resource
{
    ...
    public function query($ids, $startDate, $endDate, $metrics, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('query', array($params), "VendorDuplicator\\Google_Service_YouTubeAnalytics_ResultTable");
    }
}
/**
 * The "reports" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_YouTubeAnalytics_Reports_Resource', 'VendorDuplicator\\Google_Service_YouTubeAnalytics_Reports_Resource', \false);
/** @internal */
class Google_Service_YouTubeAnalytics_BatchReport extends Google_Collection
{
    ...
    public $id;
    public $kind;
    protected $outputsType = 'VendorDuplicator\\Google_Service_YouTubeAnalytics_BatchReportOutputs';
    protected $outputsDataType = 'array';
    public $reportId;
    protected $timeSpanType = 'VendorDuplicator\\Google_Service_YouTubeAnalytics_BatchReportTimeSpan';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_YouTubeAnalytics_BatchReport', 'VendorDuplicator\\Google_Service_YouTubeAnalytics_BatchReport', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_YouTubeAnalytics_BatchReportDefinition', 'VendorDuplicator\\Google_Service_YouTubeAnalytics_BatchReportDefinition', \false);
/** @internal */
class Google_Service_YouTubeAnalytics_BatchReportDefinitionList extends Google_Collection
{
    protected $collection_key = 'items';
    protected $internal_gapi_mappings = array();
    protected $itemsType = 'VendorDuplicator\\Google_Service_YouTubeAnalytics_BatchReportDefinition';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_YouTubeAnalytics_BatchReportDefinitionList', 'VendorDuplicator\\Google_Service_YouTubeAnalytics_BatchReportDefinitionList', \false);
/** @internal */
class Google_Service_YouTubeAnalytics_BatchReportList extends Google_Collection
{
    protected $collection_key = 'items';
    protected $internal_gapi_mappings = array();
    protected $itemsType = 'VendorDuplicator\\Google_Service_YouTubeAnalytics_BatchReport';
    protected $itemsDataType = 'array';
    public $kind;
    public function setItems($items)
    {
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_YouTubeAnalytics_BatchReportList', 'VendorDuplicator\\Google_Service_YouTubeAnalytics_BatchReportList', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_YouTubeAnalytics_BatchReportOutputs', 'VendorDuplicator\\Google_Service_YouTubeAnalytics_BatchReportOutputs', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_YouTubeAnalytics_BatchReportTimeSpan', 'VendorDuplicator\\Google_Service_YouTubeAnalytics_BatchReportTimeSpan', \false);
/** @internal */
class Google_Service_YouTubeAnalytics_Group extends Google_Model
{
    protected $internal_gapi_mappings = array();
    protected $contentDetailsType = 'VendorDuplicator\\Google_Service_YouTubeAnalytics_GroupContentDetails';
    protected $contentDetailsDataType = '';
    public $etag;
    public $id;
    public $kind;
    protected $snippetType = 'VendorDuplicator\\Google_Service_YouTubeAnalytics_GroupSnippet';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_YouTubeAnalytics_Group', 'VendorDuplicator\\Google_Service_YouTubeAnalytics_Group', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_YouTubeAnalytics_GroupContentDetails', 'VendorDuplicator\\Google_Service_YouTubeAnalytics_GroupContentDetails', \false);
/** @internal */
class Google_Service_YouTubeAnalytics_GroupItem extends Google_Model
{
    ...
    public $id;
    public $kind;
    protected $resourceType = 'VendorDuplicator\\Google_Service_YouTubeAnalytics_GroupItemResource';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_YouTubeAnalytics_GroupItem', 'VendorDuplicator\\Google_Service_YouTubeAnalytics_GroupItem', \false);
/** @internal */
class Google_Service_YouTubeAnalytics_GroupItemListResponse extends Google_Collection
{
    ...
    protected $internal_gapi_mappings = array();
    public $etag;
    protected $itemsType = 'VendorDuplicator\\Google_Service_YouTubeAnalytics_GroupItem';
    protected $itemsDataType = 'array';
    public $kind;
    public function setEtag($etag)
    {
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_YouTubeAnalytics_GroupItemListResponse', 'VendorDuplicator\\Google_Service_YouTubeAnalytics_GroupItemListResponse', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_YouTubeAnalytics_GroupItemResource', 'VendorDuplicator\\Google_Service_YouTubeAnalytics_GroupItemResource', \false);
/** @internal */
class Google_Service_YouTubeAnalytics_GroupListResponse extends Google_Collection
{
    ...
    protected $internal_gapi_mappings = array();
    public $etag;
    protected $itemsType = 'VendorDuplicator\\Google_Service_YouTubeAnalytics_Group';
    protected $itemsDataType = 'array';
    public $kind;
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_YouTubeAnalytics_GroupListResponse', 'VendorDuplicator\\Google_Service_YouTubeAnalytics_GroupListResponse', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_YouTubeAnalytics_GroupSnippet', 'VendorDuplicator\\Google_Service_YouTubeAnalytics_GroupSnippet', \false);
/** @internal */
class Google_Service_YouTubeAnalytics_ResultTable extends Google_Collection
{
    protected $collection_key = 'rows';
    protected $internal_gapi_mappings = array();
    protected $columnHeadersType = 'VendorDuplicator\\Google_Service_YouTubeAnalytics_ResultTableColumnHeaders';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_YouTubeAnalytics_ResultTable', 'VendorDuplicator\\Google_Service_YouTubeAnalytics_ResultTable', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_YouTubeAnalytics_ResultTableColumnHeaders', 'VendorDuplicator\\Google_Service_YouTubeAnalytics_ResultTableColumnHeaders', \false);
