...
class Google_Service_Fusiontables extends Google_Service
{
    ...
    public function __construct(Google_Client $client)
    {
        ...
        $this->column = new Google_Service_Fusiontables_Column_Resource($this, $this->serviceName, 'column', array('methods' => array('delete' => array('path' => 'tables/{tableId}/columns/{columnId}', 'httpMethod' => 'DELETE', 'parameters' => array('tableId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'columnId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'get' => array('path' => 'tables/{tableId}/columns/{columnId}', 'httpMethod' => 'GET', 'parameters' => array('tableId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'columnId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'insert' => array('path' => 'tables/{tableId}/columns', 'httpMethod' => 'POST', 'parameters' => array('tableId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'list' => array('path' => 'tables/{tableId}/columns', 'httpMethod' => 'GET', 'parameters' => array('tableId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'maxResults' => array('location' => 'query', 'type' => 'integer'), 'pageToken' => array('location' => 'query', 'type' => 'string'))), 'patch' => array('path' => 'tables/{tableId}/columns/{columnId}', 'httpMethod' => 'PATCH', 'parameters' => array('tableId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'columnId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'update' => array('path' => 'tables/{tableId}/columns/{columnId}', 'httpMethod' => 'PUT', 'parameters' => array('tableId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'columnId' => array('location' => 'path', 'type' => 'string', 'required' => \true))))));
        $this->query = new Google_Service_Fusiontables_Query_Resource($this, $this->serviceName, 'query', array('methods' => array('sql' => array('path' => 'query', 'httpMethod' => 'POST', 'parameters' => array('sql' => array('location' => 'query', 'type' => 'string', 'required' => \true), 'hdrs' => array('location' => 'query', 'type' => 'boolean'), 'typed' => array('location' => 'query', 'type' => 'boolean'))), 'sqlGet' => array('path' => 'query', 'httpMethod' => 'GET', 'parameters' => array('sql' => array('location' => 'query', 'type' => 'string', 'required' => \true), 'hdrs' => array('location' => 'query', 'type' => 'boolean'), 'typed' => array('location' => 'query', 'type' => 'boolean'))))));
        $this->style = new Google_Service_Fusiontables_Style_Resource($this, $this->serviceName, 'style', array('methods' => array('delete' => array('path' => 'tables/{tableId}/styles/{styleId}', 'httpMethod' => 'DELETE', 'parameters' => array('tableId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'styleId' => array('location' => 'path', 'type' => 'integer', 'required' => \true))), 'get' => array('path' => 'tables/{tableId}/styles/{styleId}', 'httpMethod' => 'GET', 'parameters' => array('tableId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'styleId' => array('location' => 'path', 'type' => 'integer', 'required' => \true))), 'insert' => array('path' => 'tables/{tableId}/styles', 'httpMethod' => 'POST', 'parameters' => array('tableId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'list' => array('path' => 'tables/{tableId}/styles', 'httpMethod' => 'GET', 'parameters' => array('tableId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'maxResults' => array('location' => 'query', 'type' => 'integer'), 'pageToken' => array('location' => 'query', 'type' => 'string'))), 'patch' => array('path' => 'tables/{tableId}/styles/{styleId}', 'httpMethod' => 'PATCH', 'parameters' => array('tableId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'styleId' => array('location' => 'path', 'type' => 'integer', 'required' => \true))), 'update' => array('path' => 'tables/{tableId}/styles/{styleId}', 'httpMethod' => 'PUT', 'parameters' => array('tableId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'styleId' => array('location' => 'path', 'type' => 'integer', 'required' => \true))))));
        $this->table = new Google_Service_Fusiontables_Table_Resource($this, $this->serviceName, 'table', array('methods' => array('copy' => array('path' => 'tables/{tableId}/copy', 'httpMethod' => 'POST', 'parameters' => array('tableId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'copyPresentation' => array('location' => 'query', 'type' => 'boolean'))), 'delete' => array('path' => 'tables/{tableId}', 'httpMethod' => 'DELETE', 'parameters' => array('tableId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'get' => array('path' => 'tables/{tableId}', 'httpMethod' => 'GET', 'parameters' => array('tableId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'importRows' => array('path' => 'tables/{tableId}/import', 'httpMethod' => 'POST', 'parameters' => array('tableId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'delimiter' => array('location' => 'query', 'type' => 'string'), 'encoding' => array('location' => 'query', 'type' => 'string'), 'endLine' => array('location' => 'query', 'type' => 'integer'), 'isStrict' => array('location' => 'query', 'type' => 'boolean'), 'startLine' => array('location' => 'query', 'type' => 'integer'))), 'importTable' => array('path' => 'tables/import', 'httpMethod' => 'POST', 'parameters' => array('name' => array('location' => 'query', 'type' => 'string', 'required' => \true), 'delimiter' => array('location' => 'query', 'type' => 'string'), 'encoding' => array('location' => 'query', 'type' => 'string'))), 'insert' => array('path' => 'tables', 'httpMethod' => 'POST', 'parameters' => array()), 'list' => array('path' => 'tables', 'httpMethod' => 'GET', 'parameters' => array('maxResults' => array('location' => 'query', 'type' => 'integer'), 'pageToken' => array('location' => 'query', 'type' => 'string'))), 'patch' => array('path' => 'tables/{tableId}', 'httpMethod' => 'PATCH', 'parameters' => array('tableId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'replaceViewDefinition' => array('location' => 'query', 'type' => 'boolean'))), 'replaceRows' => array('path' => 'tables/{tableId}/replace', 'httpMethod' => 'POST', 'parameters' => array('tableId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'delimiter' => array('location' => 'query', 'type' => 'string'), 'encoding' => array('location' => 'query', 'type' => 'string'), 'endLine' => array('location' => 'query', 'type' => 'integer'), 'isStrict' => array('location' => 'query', 'type' => 'boolean'), 'startLine' => array('location' => 'query', 'type' => 'integer'))), 'update' => array('path' => 'tables/{tableId}', 'httpMethod' => 'PUT', 'parameters' => array('tableId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'replaceViewDefinition' => array('location' => 'query', 'type' => 'boolean'))))));
        $this->task = new Google_Service_Fusiontables_Task_Resource($this, $this->serviceName, 'task', array('methods' => array('delete' => array('path' => 'tables/{tableId}/tasks/{taskId}', 'httpMethod' => 'DELETE', 'parameters' => array('tableId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'taskId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'get' => array('path' => 'tables/{tableId}/tasks/{taskId}', 'httpMethod' => 'GET', 'parameters' => array('tableId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'taskId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'list' => array('path' => 'tables/{tableId}/tasks', 'httpMethod' => 'GET', 'parameters' => array('tableId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'maxResults' => array('location' => 'query', 'type' => 'integer'), 'pageToken' => array('location' => 'query', 'type' => 'string'), 'startIndex' => array('location' => 'query', 'type' => 'integer'))))));
        $this->template = new Google_Service_Fusiontables_Template_Resource($this, $this->serviceName, 'template', array('methods' => array('delete' => array('path' => 'tables/{tableId}/templates/{templateId}', 'httpMethod' => 'DELETE', 'parameters' => array('tableId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'templateId' => array('location' => 'path', 'type' => 'integer', 'required' => \true))), 'get' => array('path' => 'tables/{tableId}/templates/{templateId}', 'httpMethod' => 'GET', 'parameters' => array('tableId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'templateId' => array('location' => 'path', 'type' => 'integer', 'required' => \true))), 'insert' => array('path' => 'tables/{tableId}/templates', 'httpMethod' => 'POST', 'parameters' => array('tableId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'list' => array('path' => 'tables/{tableId}/templates', 'httpMethod' => 'GET', 'parameters' => array('tableId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'maxResults' => array('location' => 'query', 'type' => 'integer'), 'pageToken' => array('location' => 'query', 'type' => 'string'))), 'patch' => array('path' => 'tables/{tableId}/templates/{templateId}', 'httpMethod' => 'PATCH', 'parameters' => array('tableId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'templateId' => array('location' => 'path', 'type' => 'integer', 'required' => \true))), 'update' => array('path' => 'tables/{tableId}/templates/{templateId}', 'httpMethod' => 'PUT', 'parameters' => array('tableId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'templateId' => array('location' => 'path', 'type' => 'integer', 'required' => \true))))));
    }
}
/*
 * Licensed under the Apache License, Version 2.0 (the "License"); you may not
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Fusiontables', 'VendorDuplicator\\Google_Service_Fusiontables', \false);
/**
...
class Google_Service_Fusiontables_Column_Resource extends Google_Service_Resource
{
    ...
    public function get($tableId, $columnId, $optParams = array())
    {
        $params = array('tableId' => $tableId, 'columnId' => $columnId);
        $params = \array_merge($params, $optParams);
        return $this->call('get', array($params), "VendorDuplicator\\Google_Service_Fusiontables_Column");
    }
    /**
    ...
    public function insert($tableId, Google_Service_Fusiontables_Column $postBody, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('insert', array($params), "VendorDuplicator\\Google_Service_Fusiontables_Column");
    }
    /**
    ...
    public function listColumn($tableId, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('list', array($params), "VendorDuplicator\\Google_Service_Fusiontables_ColumnList");
    }
    /**
    ...
    public function patch($tableId, $columnId, Google_Service_Fusiontables_Column $postBody, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('patch', array($params), "VendorDuplicator\\Google_Service_Fusiontables_Column");
    }
    /**
    ...
    public function update($tableId, $columnId, Google_Service_Fusiontables_Column $postBody, $optParams = array())
    {
        $params = array('tableId' => $tableId, 'columnId' => $columnId, 'postBody' => $postBody);
        $params = \array_merge($params, $optParams);
        return $this->call('update', array($params), "VendorDuplicator\\Google_Service_Fusiontables_Column");
    }
}
/**
 * The "column" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Fusiontables_Column_Resource', 'VendorDuplicator\\Google_Service_Fusiontables_Column_Resource', \false);
/**
...
class Google_Service_Fusiontables_Query_Resource extends Google_Service_Resource
{
    ...
    public function sql($sql, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('sql', array($params), "VendorDuplicator\\Google_Service_Fusiontables_Sqlresponse");
    }
    /**
    ...
    public function sqlGet($sql, $optParams = array())
    {
        $params = array('sql' => $sql);
        $params = \array_merge($params, $optParams);
        return $this->call('sqlGet', array($params), "VendorDuplicator\\Google_Service_Fusiontables_Sqlresponse");
    }
}
/**
 * The "query" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Fusiontables_Query_Resource', 'VendorDuplicator\\Google_Service_Fusiontables_Query_Resource', \false);
/**
...
class Google_Service_Fusiontables_Style_Resource extends Google_Service_Resource
{
    ...
    public function get($tableId, $styleId, $optParams = array())
    {
        $params = array('tableId' => $tableId, 'styleId' => $styleId);
        $params = \array_merge($params, $optParams);
        return $this->call('get', array($params), "VendorDuplicator\\Google_Service_Fusiontables_StyleSetting");
    }
    /**
    ...
    public function insert($tableId, Google_Service_Fusiontables_StyleSetting $postBody, $optParams = array())
    {
        $params = array('tableId' => $tableId, 'postBody' => $postBody);
        $params = \array_merge($params, $optParams);
        return $this->call('insert', array($params), "VendorDuplicator\\Google_Service_Fusiontables_StyleSetting");
    }
    /**
    ...
    public function listStyle($tableId, $optParams = array())
    {
        $params = array('tableId' => $tableId);
        $params = \array_merge($params, $optParams);
        return $this->call('list', array($params), "VendorDuplicator\\Google_Service_Fusiontables_StyleSettingList");
    }
    /**
    ...
    public function patch($tableId, $styleId, Google_Service_Fusiontables_StyleSetting $postBody, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('patch', array($params), "VendorDuplicator\\Google_Service_Fusiontables_StyleSetting");
    }
    /**
    ...
    public function update($tableId, $styleId, Google_Service_Fusiontables_StyleSetting $postBody, $optParams = array())
    {
        $params = array('tableId' => $tableId, 'styleId' => $styleId, 'postBody' => $postBody);
        $params = \array_merge($params, $optParams);
        return $this->call('update', array($params), "VendorDuplicator\\Google_Service_Fusiontables_StyleSetting");
    }
}
/**
 * The "style" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Fusiontables_Style_Resource', 'VendorDuplicator\\Google_Service_Fusiontables_Style_Resource', \false);
/**
...
class Google_Service_Fusiontables_Table_Resource extends Google_Service_Resource
{
    ...
    public function copy($tableId, $optParams = array())
    {
        $params = array('tableId' => $tableId);
        $params = \array_merge($params, $optParams);
        return $this->call('copy', array($params), "VendorDuplicator\\Google_Service_Fusiontables_Table");
    }
    /**
    ...
    public function get($tableId, $optParams = array())
    {
        $params = array('tableId' => $tableId);
        $params = \array_merge($params, $optParams);
        return $this->call('get', array($params), "VendorDuplicator\\Google_Service_Fusiontables_Table");
    }
    /**
    ...
    public function importRows($tableId, $optParams = array())
    {
        $params = array('tableId' => $tableId);
        $params = \array_merge($params, $optParams);
        return $this->call('importRows', array($params), "VendorDuplicator\\Google_Service_Fusiontables_Import");
    }
    /**
    ...
    public function importTable($name, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('importTable', array($params), "VendorDuplicator\\Google_Service_Fusiontables_Table");
    }
    /**
    ...
    public function insert(Google_Service_Fusiontables_Table $postBody, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('insert', array($params), "VendorDuplicator\\Google_Service_Fusiontables_Table");
    }
    /**
    ...
    public function listTable($optParams = array())
    {
        $params = array();
        $params = \array_merge($params, $optParams);
        return $this->call('list', array($params), "VendorDuplicator\\Google_Service_Fusiontables_TableList");
    }
    /**
    ...
    public function patch($tableId, Google_Service_Fusiontables_Table $postBody, $optParams = array())
    {
        $params = array('tableId' => $tableId, 'postBody' => $postBody);
        $params = \array_merge($params, $optParams);
        return $this->call('patch', array($params), "VendorDuplicator\\Google_Service_Fusiontables_Table");
    }
    /**
    ...
    public function replaceRows($tableId, $optParams = array())
    {
        $params = array('tableId' => $tableId);
        $params = \array_merge($params, $optParams);
        return $this->call('replaceRows', array($params), "VendorDuplicator\\Google_Service_Fusiontables_Task");
    }
    /**
     * Updates an existing table. Unless explicitly requested, only the name,
    ...
    public function update($tableId, Google_Service_Fusiontables_Table $postBody, $optParams = array())
    {
        $params = array('tableId' => $tableId, 'postBody' => $postBody);
        $params = \array_merge($params, $optParams);
        return $this->call('update', array($params), "VendorDuplicator\\Google_Service_Fusiontables_Table");
    }
}
/**
 * The "table" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Fusiontables_Table_Resource', 'VendorDuplicator\\Google_Service_Fusiontables_Table_Resource', \false);
/**
...
class Google_Service_Fusiontables_Task_Resource extends Google_Service_Resource
{
    ...
    public function get($tableId, $taskId, $optParams = array())
    {
        $params = array('tableId' => $tableId, 'taskId' => $taskId);
        $params = \array_merge($params, $optParams);
        return $this->call('get', array($params), "VendorDuplicator\\Google_Service_Fusiontables_Task");
    }
    /**
    ...
    public function listTask($tableId, $optParams = array())
    {
        $params = array('tableId' => $tableId);
        $params = \array_merge($params, $optParams);
        return $this->call('list', array($params), "VendorDuplicator\\Google_Service_Fusiontables_TaskList");
    }
}
/**
 * The "task" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Fusiontables_Task_Resource', 'VendorDuplicator\\Google_Service_Fusiontables_Task_Resource', \false);
/**
...
class Google_Service_Fusiontables_Template_Resource extends Google_Service_Resource
{
    ...
    public function get($tableId, $templateId, $optParams = array())
    {
        $params = array('tableId' => $tableId, 'templateId' => $templateId);
        $params = \array_merge($params, $optParams);
        return $this->call('get', array($params), "VendorDuplicator\\Google_Service_Fusiontables_Template");
    }
    /**
    ...
    public function insert($tableId, Google_Service_Fusiontables_Template $postBody, $optParams = array())
    {
        $params = array('tableId' => $tableId, 'postBody' => $postBody);
        $params = \array_merge($params, $optParams);
        return $this->call('insert', array($params), "VendorDuplicator\\Google_Service_Fusiontables_Template");
    }
    /**
    ...
    public function listTemplate($tableId, $optParams = array())
    {
        $params = array('tableId' => $tableId);
        $params = \array_merge($params, $optParams);
        return $this->call('list', array($params), "VendorDuplicator\\Google_Service_Fusiontables_TemplateList");
    }
    /**
    ...
    public function patch($tableId, $templateId, Google_Service_Fusiontables_Template $postBody, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('patch', array($params), "VendorDuplicator\\Google_Service_Fusiontables_Template");
    }
    /**
    ...
    public function update($tableId, $templateId, Google_Service_Fusiontables_Template $postBody, $optParams = array())
    {
        $params = array('tableId' => $tableId, 'templateId' => $templateId, 'postBody' => $postBody);
        $params = \array_merge($params, $optParams);
        return $this->call('update', array($params), "VendorDuplicator\\Google_Service_Fusiontables_Template");
    }
}
/**
 * The "template" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Fusiontables_Template_Resource', 'VendorDuplicator\\Google_Service_Fusiontables_Template_Resource', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Fusiontables_Bucket', 'VendorDuplicator\\Google_Service_Fusiontables_Bucket', \false);
/** @internal */
class Google_Service_Fusiontables_Column extends Google_Collection
{
    protected $collection_key = 'validValues';
    protected $internal_gapi_mappings = array();
    protected $baseColumnType = 'VendorDuplicator\\Google_Service_Fusiontables_ColumnBaseColumn';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Fusiontables_Column', 'VendorDuplicator\\Google_Service_Fusiontables_Column', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Fusiontables_ColumnBaseColumn', 'VendorDuplicator\\Google_Service_Fusiontables_ColumnBaseColumn', \false);
/** @internal */
class Google_Service_Fusiontables_ColumnList extends Google_Collection
{
    protected $collection_key = 'items';
    protected $internal_gapi_mappings = array();
    protected $itemsType = 'VendorDuplicator\\Google_Service_Fusiontables_Column';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Fusiontables_ColumnList', 'VendorDuplicator\\Google_Service_Fusiontables_ColumnList', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Fusiontables_Geometry', 'VendorDuplicator\\Google_Service_Fusiontables_Geometry', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Fusiontables_Import', 'VendorDuplicator\\Google_Service_Fusiontables_Import', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Fusiontables_Line', 'VendorDuplicator\\Google_Service_Fusiontables_Line', \false);
/** @internal */
class Google_Service_Fusiontables_LineStyle extends Google_Model
{
    protected $internal_gapi_mappings = array();
    public $strokeColor;
    protected $strokeColorStylerType = 'VendorDuplicator\\Google_Service_Fusiontables_StyleFunction';
    protected $strokeColorStylerDataType = '';
    public $strokeOpacity;
    public $strokeWeight;
    protected $strokeWeightStylerType = 'VendorDuplicator\\Google_Service_Fusiontables_StyleFunction';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Fusiontables_LineStyle', 'VendorDuplicator\\Google_Service_Fusiontables_LineStyle', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Fusiontables_Point', 'VendorDuplicator\\Google_Service_Fusiontables_Point', \false);
/** @internal */
class Google_Service_Fusiontables_PointStyle extends Google_Model
{
    protected $internal_gapi_mappings = array();
    public $iconName;
    protected $iconStylerType = 'VendorDuplicator\\Google_Service_Fusiontables_StyleFunction';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Fusiontables_PointStyle', 'VendorDuplicator\\Google_Service_Fusiontables_PointStyle', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Fusiontables_Polygon', 'VendorDuplicator\\Google_Service_Fusiontables_Polygon', \false);
/** @internal */
class Google_Service_Fusiontables_PolygonStyle extends Google_Model
{
    protected $internal_gapi_mappings = array();
    public $fillColor;
    protected $fillColorStylerType = 'VendorDuplicator\\Google_Service_Fusiontables_StyleFunction';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Fusiontables_PolygonStyle', 'VendorDuplicator\\Google_Service_Fusiontables_PolygonStyle', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Fusiontables_Sqlresponse', 'VendorDuplicator\\Google_Service_Fusiontables_Sqlresponse', \false);
/** @internal */
class Google_Service_Fusiontables_StyleFunction extends Google_Collection
{
    protected $collection_key = 'buckets';
    protected $internal_gapi_mappings = array();
    protected $bucketsType = 'VendorDuplicator\\Google_Service_Fusiontables_Bucket';
    protected $bucketsDataType = 'array';
    public $columnName;
    protected $gradientType = 'VendorDuplicator\\Google_Service_Fusiontables_StyleFunctionGradient';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Fusiontables_StyleFunction', 'VendorDuplicator\\Google_Service_Fusiontables_StyleFunction', \false);
/** @internal */
class Google_Service_Fusiontables_StyleFunctionGradient extends Google_Collection
{
    protected $collection_key = 'colors';
    protected $internal_gapi_mappings = array();
    protected $colorsType = 'VendorDuplicator\\Google_Service_Fusiontables_StyleFunctionGradientColors';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Fusiontables_StyleFunctionGradient', 'VendorDuplicator\\Google_Service_Fusiontables_StyleFunctionGradient', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Fusiontables_StyleFunctionGradientColors', 'VendorDuplicator\\Google_Service_Fusiontables_StyleFunctionGradientColors', \false);
/** @internal */
class Google_Service_Fusiontables_StyleSetting extends Google_Model
{
    protected $internal_gapi_mappings = array();
    public $kind;
    protected $markerOptionsType = 'VendorDuplicator\\Google_Service_Fusiontables_PointStyle';
    protected $markerOptionsDataType = '';
    public $name;
    protected $polygonOptionsType = 'VendorDuplicator\\Google_Service_Fusiontables_PolygonStyle';
    protected $polygonOptionsDataType = '';
    protected $polylineOptionsType = 'VendorDuplicator\\Google_Service_Fusiontables_LineStyle';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Fusiontables_StyleSetting', 'VendorDuplicator\\Google_Service_Fusiontables_StyleSetting', \false);
/** @internal */
class Google_Service_Fusiontables_StyleSettingList extends Google_Collection
{
    protected $collection_key = 'items';
    protected $internal_gapi_mappings = array();
    protected $itemsType = 'VendorDuplicator\\Google_Service_Fusiontables_StyleSetting';
    protected $itemsDataType = 'array';
    public $kind;
    public $nextPageToken;
    public $totalItems;
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Fusiontables_StyleSettingList', 'VendorDuplicator\\Google_Service_Fusiontables_StyleSettingList', \false);
/** @internal */
class Google_Service_Fusiontables_Table extends Google_Collection
{
    ...
    protected $columnsType = 'VendorDuplicator\\Google_Service_Fusiontables_Column';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Fusiontables_Table', 'VendorDuplicator\\Google_Service_Fusiontables_Table', \false);
/** @internal */
class Google_Service_Fusiontables_TableList extends Google_Collection
{
    protected $collection_key = 'items';
    protected $internal_gapi_mappings = array();
    protected $itemsType = 'VendorDuplicator\\Google_Service_Fusiontables_Table';
    protected $itemsDataType = 'array';
    public $kind;
    public $nextPageToken;
    public function setItems($items)
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Fusiontables_TableList', 'VendorDuplicator\\Google_Service_Fusiontables_TableList', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Fusiontables_Task', 'VendorDuplicator\\Google_Service_Fusiontables_Task', \false);
/** @internal */
class Google_Service_Fusiontables_TaskList extends Google_Collection
{
    protected $collection_key = 'items';
    protected $internal_gapi_mappings = array();
    protected $itemsType = 'VendorDuplicator\\Google_Service_Fusiontables_Task';
    protected $itemsDataType = 'array';
    public $kind;
    public $nextPageToken;
    public $totalItems;
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Fusiontables_TaskList', 'VendorDuplicator\\Google_Service_Fusiontables_TaskList', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Fusiontables_Template', 'VendorDuplicator\\Google_Service_Fusiontables_Template', \false);
/** @internal */
class Google_Service_Fusiontables_TemplateList extends Google_Collection
{
    protected $collection_key = 'items';
    protected $internal_gapi_mappings = array();
    protected $itemsType = 'VendorDuplicator\\Google_Service_Fusiontables_Template';
    protected $itemsDataType = 'array';
    public $kind;
    public $nextPageToken;
    public $totalItems;
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Fusiontables_TemplateList', 'VendorDuplicator\\Google_Service_Fusiontables_TemplateList', \false);
