...
class Google_Service_AdExchangeBuyer extends Google_Service
{
    ...
    public function __construct(Google_Client $client)
    {
        ...
        $this->accounts = new Google_Service_AdExchangeBuyer_Accounts_Resource($this, $this->serviceName, 'accounts', array('methods' => array('get' => array('path' => 'accounts/{id}', 'httpMethod' => 'GET', 'parameters' => array('id' => array('location' => 'path', 'type' => 'integer', 'required' => \true))), 'list' => array('path' => 'accounts', 'httpMethod' => 'GET', 'parameters' => array()), 'patch' => array('path' => 'accounts/{id}', 'httpMethod' => 'PATCH', 'parameters' => array('id' => array('location' => 'path', 'type' => 'integer', 'required' => \true))), 'update' => array('path' => 'accounts/{id}', 'httpMethod' => 'PUT', 'parameters' => array('id' => array('location' => 'path', 'type' => 'integer', 'required' => \true))))));
        $this->billingInfo = new Google_Service_AdExchangeBuyer_BillingInfo_Resource($this, $this->serviceName, 'billingInfo', array('methods' => array('get' => array('path' => 'billinginfo/{accountId}', 'httpMethod' => 'GET', 'parameters' => array('accountId' => array('location' => 'path', 'type' => 'integer', 'required' => \true))), 'list' => array('path' => 'billinginfo', 'httpMethod' => 'GET', 'parameters' => array()))));
        $this->budget = new Google_Service_AdExchangeBuyer_Budget_Resource($this, $this->serviceName, 'budget', array('methods' => array('get' => array('path' => 'billinginfo/{accountId}/{billingId}', 'httpMethod' => 'GET', 'parameters' => array('accountId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'billingId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'patch' => array('path' => 'billinginfo/{accountId}/{billingId}', 'httpMethod' => 'PATCH', 'parameters' => array('accountId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'billingId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'update' => array('path' => 'billinginfo/{accountId}/{billingId}', 'httpMethod' => 'PUT', 'parameters' => array('accountId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'billingId' => array('location' => 'path', 'type' => 'string', 'required' => \true))))));
        $this->creatives = new Google_Service_AdExchangeBuyer_Creatives_Resource($this, $this->serviceName, 'creatives', array('methods' => array('addDeal' => array('path' => 'creatives/{accountId}/{buyerCreativeId}/addDeal/{dealId}', 'httpMethod' => 'POST', 'parameters' => array('accountId' => array('location' => 'path', 'type' => 'integer', 'required' => \true), 'buyerCreativeId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'dealId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'get' => array('path' => 'creatives/{accountId}/{buyerCreativeId}', 'httpMethod' => 'GET', 'parameters' => array('accountId' => array('location' => 'path', 'type' => 'integer', 'required' => \true), 'buyerCreativeId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'insert' => array('path' => 'creatives', 'httpMethod' => 'POST', 'parameters' => array()), 'list' => array('path' => 'creatives', 'httpMethod' => 'GET', 'parameters' => array('accountId' => array('location' => 'query', 'type' => 'integer', 'repeated' => \true), 'buyerCreativeId' => array('location' => 'query', 'type' => 'string', 'repeated' => \true), 'dealsStatusFilter' => array('location' => 'query', 'type' => 'string'), 'maxResults' => array('location' => 'query', 'type' => 'integer'), 'openAuctionStatusFilter' => array('location' => 'query', 'type' => 'string'), 'pageToken' => array('location' => 'query', 'type' => 'string'))), 'removeDeal' => array('path' => 'creatives/{accountId}/{buyerCreativeId}/removeDeal/{dealId}', 'httpMethod' => 'POST', 'parameters' => array('accountId' => array('location' => 'path', 'type' => 'integer', 'required' => \true), 'buyerCreativeId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'dealId' => array('location' => 'path', 'type' => 'string', 'required' => \true))))));
        $this->marketplacedeals = new Google_Service_AdExchangeBuyer_Marketplacedeals_Resource($this, $this->serviceName, 'marketplacedeals', array('methods' => array('delete' => array('path' => 'proposals/{proposalId}/deals/delete', 'httpMethod' => 'POST', 'parameters' => array('proposalId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'insert' => array('path' => 'proposals/{proposalId}/deals/insert', 'httpMethod' => 'POST', 'parameters' => array('proposalId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'list' => array('path' => 'proposals/{proposalId}/deals', 'httpMethod' => 'GET', 'parameters' => array('proposalId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'update' => array('path' => 'proposals/{proposalId}/deals/update', 'httpMethod' => 'POST', 'parameters' => array('proposalId' => array('location' => 'path', 'type' => 'string', 'required' => \true))))));
        $this->marketplacenotes = new Google_Service_AdExchangeBuyer_Marketplacenotes_Resource($this, $this->serviceName, 'marketplacenotes', array('methods' => array('insert' => array('path' => 'proposals/{proposalId}/notes/insert', 'httpMethod' => 'POST', 'parameters' => array('proposalId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'list' => array('path' => 'proposals/{proposalId}/notes', 'httpMethod' => 'GET', 'parameters' => array('proposalId' => array('location' => 'path', 'type' => 'string', 'required' => \true))))));
        $this->performanceReport = new Google_Service_AdExchangeBuyer_PerformanceReport_Resource($this, $this->serviceName, 'performanceReport', array('methods' => array('list' => array('path' => 'performancereport', 'httpMethod' => 'GET', 'parameters' => array('accountId' => array('location' => 'query', 'type' => 'string', 'required' => \true), 'endDateTime' => array('location' => 'query', 'type' => 'string', 'required' => \true), 'startDateTime' => array('location' => 'query', 'type' => 'string', 'required' => \true), 'maxResults' => array('location' => 'query', 'type' => 'integer'), 'pageToken' => array('location' => 'query', 'type' => 'string'))))));
        $this->pretargetingConfig = new Google_Service_AdExchangeBuyer_PretargetingConfig_Resource($this, $this->serviceName, 'pretargetingConfig', array('methods' => array('delete' => array('path' => 'pretargetingconfigs/{accountId}/{configId}', 'httpMethod' => 'DELETE', 'parameters' => array('accountId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'configId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'get' => array('path' => 'pretargetingconfigs/{accountId}/{configId}', 'httpMethod' => 'GET', 'parameters' => array('accountId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'configId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'insert' => array('path' => 'pretargetingconfigs/{accountId}', 'httpMethod' => 'POST', 'parameters' => array('accountId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'list' => array('path' => 'pretargetingconfigs/{accountId}', 'httpMethod' => 'GET', 'parameters' => array('accountId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'patch' => array('path' => 'pretargetingconfigs/{accountId}/{configId}', 'httpMethod' => 'PATCH', 'parameters' => array('accountId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'configId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'update' => array('path' => 'pretargetingconfigs/{accountId}/{configId}', 'httpMethod' => 'PUT', 'parameters' => array('accountId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'configId' => array('location' => 'path', 'type' => 'string', 'required' => \true))))));
        $this->products = new Google_Service_AdExchangeBuyer_Products_Resource($this, $this->serviceName, 'products', array('methods' => array('get' => array('path' => 'products/{productId}', 'httpMethod' => 'GET', 'parameters' => array('productId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'search' => array('path' => 'products/search', 'httpMethod' => 'GET', 'parameters' => array('pqlQuery' => array('location' => 'query', 'type' => 'string'))))));
        $this->proposals = new Google_Service_AdExchangeBuyer_Proposals_Resource($this, $this->serviceName, 'proposals', array('methods' => array('get' => array('path' => 'proposals/{proposalId}', 'httpMethod' => 'GET', 'parameters' => array('proposalId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'insert' => array('path' => 'proposals/insert', 'httpMethod' => 'POST', 'parameters' => array()), 'patch' => array('path' => 'proposals/{proposalId}/{revisionNumber}/{updateAction}', 'httpMethod' => 'PATCH', 'parameters' => array('proposalId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'revisionNumber' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'updateAction' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'search' => array('path' => 'proposals/search', 'httpMethod' => 'GET', 'parameters' => array('pqlQuery' => array('location' => 'query', 'type' => 'string'))), 'update' => array('path' => 'proposals/{proposalId}/{revisionNumber}/{updateAction}', 'httpMethod' => 'PUT', 'parameters' => array('proposalId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'revisionNumber' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'updateAction' => array('location' => 'path', 'type' => 'string', 'required' => \true))))));
    }
}
/*
 * Licensed under the Apache License, Version 2.0 (the "License"); you may not
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_AdExchangeBuyer', 'VendorDuplicator\\Google_Service_AdExchangeBuyer', \false);
/**
...
class Google_Service_AdExchangeBuyer_Accounts_Resource extends Google_Service_Resource
{
    ...
    public function get($id, $optParams = array())
    {
        ...
        return $this->call('get', array($params), "VendorDuplicator\\Google_Service_AdExchangeBuyer_Account");
    }
    /**
    ...
    public function listAccounts($optParams = array())
    {
        $params = array();
        $params = \array_merge($params, $optParams);
        return $this->call('list', array($params), "VendorDuplicator\\Google_Service_AdExchangeBuyer_AccountsList");
    }
    /**
    ...
    public function patch($id, Google_Service_AdExchangeBuyer_Account $postBody, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('patch', array($params), "VendorDuplicator\\Google_Service_AdExchangeBuyer_Account");
    }
    /**
    ...
    public function update($id, Google_Service_AdExchangeBuyer_Account $postBody, $optParams = array())
    {
        $params = array('id' => $id, 'postBody' => $postBody);
        $params = \array_merge($params, $optParams);
        return $this->call('update', array($params), "VendorDuplicator\\Google_Service_AdExchangeBuyer_Account");
    }
}
/**
 * The "accounts" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_AdExchangeBuyer_Accounts_Resource', 'VendorDuplicator\\Google_Service_AdExchangeBuyer_Accounts_Resource', \false);
/**
...
class Google_Service_AdExchangeBuyer_BillingInfo_Resource extends Google_Service_Resource
{
    ...
    public function get($accountId, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('get', array($params), "VendorDuplicator\\Google_Service_AdExchangeBuyer_BillingInfo");
    }
    /**
    ...
    public function listBillingInfo($optParams = array())
    {
        $params = array();
        $params = \array_merge($params, $optParams);
        return $this->call('list', array($params), "VendorDuplicator\\Google_Service_AdExchangeBuyer_BillingInfoList");
    }
}
/**
 * The "billingInfo" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_AdExchangeBuyer_BillingInfo_Resource', 'VendorDuplicator\\Google_Service_AdExchangeBuyer_BillingInfo_Resource', \false);
/**
...
class Google_Service_AdExchangeBuyer_Budget_Resource extends Google_Service_Resource
{
    ...
    public function get($accountId, $billingId, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('get', array($params), "VendorDuplicator\\Google_Service_AdExchangeBuyer_Budget");
    }
    /**
    ...
    public function patch($accountId, $billingId, Google_Service_AdExchangeBuyer_Budget $postBody, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('patch', array($params), "VendorDuplicator\\Google_Service_AdExchangeBuyer_Budget");
    }
    /**
     * Updates the budget amount for the budget of the adgroup specified by the
    ...
    public function update($accountId, $billingId, Google_Service_AdExchangeBuyer_Budget $postBody, $optParams = array())
    {
        $params = array('accountId' => $accountId, 'billingId' => $billingId, 'postBody' => $postBody);
        $params = \array_merge($params, $optParams);
        return $this->call('update', array($params), "VendorDuplicator\\Google_Service_AdExchangeBuyer_Budget");
    }
}
/**
 * The "budget" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_AdExchangeBuyer_Budget_Resource', 'VendorDuplicator\\Google_Service_AdExchangeBuyer_Budget_Resource', \false);
/**
...
class Google_Service_AdExchangeBuyer_Creatives_Resource extends Google_Service_Resource
{
    ...
    public function get($accountId, $buyerCreativeId, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('get', array($params), "VendorDuplicator\\Google_Service_AdExchangeBuyer_Creative");
    }
    /**
    ...
    public function insert(Google_Service_AdExchangeBuyer_Creative $postBody, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('insert', array($params), "VendorDuplicator\\Google_Service_AdExchangeBuyer_Creative");
    }
    /**
    ...
    public function listCreatives($optParams = array())
    {
        $params = array();
        $params = \array_merge($params, $optParams);
        return $this->call('list', array($params), "VendorDuplicator\\Google_Service_AdExchangeBuyer_CreativesList");
    }
    /**
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_AdExchangeBuyer_Creatives_Resource', 'VendorDuplicator\\Google_Service_AdExchangeBuyer_Creatives_Resource', \false);
/**
...
class Google_Service_AdExchangeBuyer_Marketplacedeals_Resource extends Google_Service_Resource
{
    ...
    public function delete($proposalId, Google_Service_AdExchangeBuyer_DeleteOrderDealsRequest $postBody, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('delete', array($params), "VendorDuplicator\\Google_Service_AdExchangeBuyer_DeleteOrderDealsResponse");
    }
    /**
    ...
    public function insert($proposalId, Google_Service_AdExchangeBuyer_AddOrderDealsRequest $postBody, $optParams = array())
    {
        $params = array('proposalId' => $proposalId, 'postBody' => $postBody);
        $params = \array_merge($params, $optParams);
        return $this->call('insert', array($params), "VendorDuplicator\\Google_Service_AdExchangeBuyer_AddOrderDealsResponse");
    }
    /**
    ...
    public function listMarketplacedeals($proposalId, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('list', array($params), "VendorDuplicator\\Google_Service_AdExchangeBuyer_GetOrderDealsResponse");
    }
    /**
    ...
    public function update($proposalId, Google_Service_AdExchangeBuyer_EditAllOrderDealsRequest $postBody, $optParams = array())
    {
        $params = array('proposalId' => $proposalId, 'postBody' => $postBody);
        $params = \array_merge($params, $optParams);
        return $this->call('update', array($params), "VendorDuplicator\\Google_Service_AdExchangeBuyer_EditAllOrderDealsResponse");
    }
}
/**
 * The "marketplacedeals" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_AdExchangeBuyer_Marketplacedeals_Resource', 'VendorDuplicator\\Google_Service_AdExchangeBuyer_Marketplacedeals_Resource', \false);
/**
...
class Google_Service_AdExchangeBuyer_Marketplacenotes_Resource extends Google_Service_Resource
{
    ...
    public function insert($proposalId, Google_Service_AdExchangeBuyer_AddOrderNotesRequest $postBody, $optParams = array())
    {
        $params = array('proposalId' => $proposalId, 'postBody' => $postBody);
        $params = \array_merge($params, $optParams);
        return $this->call('insert', array($params), "VendorDuplicator\\Google_Service_AdExchangeBuyer_AddOrderNotesResponse");
    }
    /**
    ...
    public function listMarketplacenotes($proposalId, $optParams = array())
    {
        $params = array('proposalId' => $proposalId);
        $params = \array_merge($params, $optParams);
        return $this->call('list', array($params), "VendorDuplicator\\Google_Service_AdExchangeBuyer_GetOrderNotesResponse");
    }
}
/**
 * The "marketplacenotes" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_AdExchangeBuyer_Marketplacenotes_Resource', 'VendorDuplicator\\Google_Service_AdExchangeBuyer_Marketplacenotes_Resource', \false);
/**
...
class Google_Service_AdExchangeBuyer_PerformanceReport_Resource extends Google_Service_Resource
{
    ...
    public function listPerformanceReport($accountId, $endDateTime, $startDateTime, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('list', array($params), "VendorDuplicator\\Google_Service_AdExchangeBuyer_PerformanceReportList");
    }
}
/**
 * The "performanceReport" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_AdExchangeBuyer_PerformanceReport_Resource', 'VendorDuplicator\\Google_Service_AdExchangeBuyer_PerformanceReport_Resource', \false);
/**
...
class Google_Service_AdExchangeBuyer_PretargetingConfig_Resource extends Google_Service_Resource
{
    ...
    public function get($accountId, $configId, $optParams = array())
    {
        $params = array('accountId' => $accountId, 'configId' => $configId);
        $params = \array_merge($params, $optParams);
        return $this->call('get', array($params), "VendorDuplicator\\Google_Service_AdExchangeBuyer_PretargetingConfig");
    }
    /**
    ...
    public function insert($accountId, Google_Service_AdExchangeBuyer_PretargetingConfig $postBody, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('insert', array($params), "VendorDuplicator\\Google_Service_AdExchangeBuyer_PretargetingConfig");
    }
    /**
    ...
    public function listPretargetingConfig($accountId, $optParams = array())
    {
        $params = array('accountId' => $accountId);
        $params = \array_merge($params, $optParams);
        return $this->call('list', array($params), "VendorDuplicator\\Google_Service_AdExchangeBuyer_PretargetingConfigList");
    }
    /**
    ...
    public function patch($accountId, $configId, Google_Service_AdExchangeBuyer_PretargetingConfig $postBody, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('patch', array($params), "VendorDuplicator\\Google_Service_AdExchangeBuyer_PretargetingConfig");
    }
    /**
    ...
    public function update($accountId, $configId, Google_Service_AdExchangeBuyer_PretargetingConfig $postBody, $optParams = array())
    {
        $params = array('accountId' => $accountId, 'configId' => $configId, 'postBody' => $postBody);
        $params = \array_merge($params, $optParams);
        return $this->call('update', array($params), "VendorDuplicator\\Google_Service_AdExchangeBuyer_PretargetingConfig");
    }
}
/**
 * The "pretargetingConfig" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_AdExchangeBuyer_PretargetingConfig_Resource', 'VendorDuplicator\\Google_Service_AdExchangeBuyer_PretargetingConfig_Resource', \false);
/**
...
class Google_Service_AdExchangeBuyer_Products_Resource extends Google_Service_Resource
{
    ...
    public function get($productId, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('get', array($params), "VendorDuplicator\\Google_Service_AdExchangeBuyer_Product");
    }
    /**
    ...
    public function search($optParams = array())
    {
        $params = array();
        $params = \array_merge($params, $optParams);
        return $this->call('search', array($params), "VendorDuplicator\\Google_Service_AdExchangeBuyer_GetOffersResponse");
    }
}
/**
 * The "products" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_AdExchangeBuyer_Products_Resource', 'VendorDuplicator\\Google_Service_AdExchangeBuyer_Products_Resource', \false);
/**
...
class Google_Service_AdExchangeBuyer_Proposals_Resource extends Google_Service_Resource
{
    ...
    public function get($proposalId, $optParams = array())
    {
        $params = array('proposalId' => $proposalId);
        $params = \array_merge($params, $optParams);
        return $this->call('get', array($params), "VendorDuplicator\\Google_Service_AdExchangeBuyer_Proposal");
    }
    /**
    ...
    public function insert(Google_Service_AdExchangeBuyer_CreateOrdersRequest $postBody, $optParams = array())
    {
        $params = array('postBody' => $postBody);
        $params = \array_merge($params, $optParams);
        return $this->call('insert', array($params), "VendorDuplicator\\Google_Service_AdExchangeBuyer_CreateOrdersResponse");
    }
    /**
    ...
    public function patch($proposalId, $revisionNumber, $updateAction, Google_Service_AdExchangeBuyer_Proposal $postBody, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('patch', array($params), "VendorDuplicator\\Google_Service_AdExchangeBuyer_Proposal");
    }
    /**
    ...
    public function search($optParams = array())
    {
        $params = array();
        $params = \array_merge($params, $optParams);
        return $this->call('search', array($params), "VendorDuplicator\\Google_Service_AdExchangeBuyer_GetOrdersResponse");
    }
    /**
    ...
    public function update($proposalId, $revisionNumber, $updateAction, Google_Service_AdExchangeBuyer_Proposal $postBody, $optParams = array())
    {
        $params = array('proposalId' => $proposalId, 'revisionNumber' => $revisionNumber, 'updateAction' => $updateAction, 'postBody' => $postBody);
        $params = \array_merge($params, $optParams);
        return $this->call('update', array($params), "VendorDuplicator\\Google_Service_AdExchangeBuyer_Proposal");
    }
}
/**
 * The "proposals" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_AdExchangeBuyer_Proposals_Resource', 'VendorDuplicator\\Google_Service_AdExchangeBuyer_Proposals_Resource', \false);
/** @internal */
class Google_Service_AdExchangeBuyer_Account extends Google_Collection
{
    protected $collection_key = 'bidderLocation';
    protected $internal_gapi_mappings = array();
    protected $bidderLocationType = 'VendorDuplicator\\Google_Service_AdExchangeBuyer_AccountBidderLocation';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_AdExchangeBuyer_Account', 'VendorDuplicator\\Google_Service_AdExchangeBuyer_Account', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_AdExchangeBuyer_AccountBidderLocation', 'VendorDuplicator\\Google_Service_AdExchangeBuyer_AccountBidderLocation', \false);
/** @internal */
class Google_Service_AdExchangeBuyer_AccountsList extends Google_Collection
{
    protected $collection_key = 'items';
    protected $internal_gapi_mappings = array();
    protected $itemsType = 'VendorDuplicator\\Google_Service_AdExchangeBuyer_Account';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_AdExchangeBuyer_AccountsList', 'VendorDuplicator\\Google_Service_AdExchangeBuyer_AccountsList', \false);
/** @internal */
class Google_Service_AdExchangeBuyer_AddOrderDealsRequest extends Google_Collection
{
    protected $collection_key = 'deals';
    protected $internal_gapi_mappings = array();
    protected $dealsType = 'VendorDuplicator\\Google_Service_AdExchangeBuyer_MarketplaceDeal';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_AdExchangeBuyer_AddOrderDealsRequest', 'VendorDuplicator\\Google_Service_AdExchangeBuyer_AddOrderDealsRequest', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_AdExchangeBuyer_AddOrderDealsResponse', 'VendorDuplicator\\Google_Service_AdExchangeBuyer_AddOrderDealsResponse', \false);
/** @internal */
class Google_Service_AdExchangeBuyer_AddOrderNotesRequest extends Google_Collection
{
    protected $collection_key = 'notes';
    protected $internal_gapi_mappings = array();
    protected $notesType = 'VendorDuplicator\\Google_Service_AdExchangeBuyer_MarketplaceNote';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_AdExchangeBuyer_AddOrderNotesRequest', 'VendorDuplicator\\Google_Service_AdExchangeBuyer_AddOrderNotesRequest', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_AdExchangeBuyer_AddOrderNotesResponse', 'VendorDuplicator\\Google_Service_AdExchangeBuyer_AddOrderNotesResponse', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_AdExchangeBuyer_BillingInfo', 'VendorDuplicator\\Google_Service_AdExchangeBuyer_BillingInfo', \false);
/** @internal */
class Google_Service_AdExchangeBuyer_BillingInfoList extends Google_Collection
{
    protected $collection_key = 'items';
    protected $internal_gapi_mappings = array();
    protected $itemsType = 'VendorDuplicator\\Google_Service_AdExchangeBuyer_BillingInfo';
    protected $itemsDataType = 'array';
    public $kind;
    public function setItems($items)
    {
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_AdExchangeBuyer_BillingInfoList', 'VendorDuplicator\\Google_Service_AdExchangeBuyer_BillingInfoList', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_AdExchangeBuyer_Budget', 'VendorDuplicator\\Google_Service_AdExchangeBuyer_Budget', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_AdExchangeBuyer_Buyer', 'VendorDuplicator\\Google_Service_AdExchangeBuyer_Buyer', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_AdExchangeBuyer_ContactInformation', 'VendorDuplicator\\Google_Service_AdExchangeBuyer_ContactInformation', \false);
/** @internal */
class Google_Service_AdExchangeBuyer_CreateOrdersRequest extends Google_Collection
{
    protected $collection_key = 'proposals';
    protected $internal_gapi_mappings = array();
    protected $proposalsType = 'VendorDuplicator\\Google_Service_AdExchangeBuyer_Proposal';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_AdExchangeBuyer_CreateOrdersRequest', 'VendorDuplicator\\Google_Service_AdExchangeBuyer_CreateOrdersRequest', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_AdExchangeBuyer_CreateOrdersResponse', 'VendorDuplicator\\Google_Service_AdExchangeBuyer_CreateOrdersResponse', \false);
/** @internal */
class Google_Service_AdExchangeBuyer_Creative extends Google_Collection
{
    ...
    protected $correctionsType = 'VendorDuplicator\\Google_Service_AdExchangeBuyer_CreativeCorrections';
    protected $correctionsDataType = 'array';
    public $dealsStatus;
    protected $filteringReasonsType = 'VendorDuplicator\\Google_Service_AdExchangeBuyer_CreativeFilteringReasons';
    protected $filteringReasonsDataType = '';
    public $height;
    public $impressionTrackingUrl;
    public $kind;
    protected $nativeAdType = 'VendorDuplicator\\Google_Service_AdExchangeBuyer_CreativeNativeAd';
    protected $nativeAdDataType = '';
    public $openAuctionStatus;
    public $productCategories;
    public $restrictedCategories;
    public $sensitiveCategories;
    protected $servingRestrictionsType = 'VendorDuplicator\\Google_Service_AdExchangeBuyer_CreativeServingRestrictions';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_AdExchangeBuyer_Creative', 'VendorDuplicator\\Google_Service_AdExchangeBuyer_Creative', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_AdExchangeBuyer_CreativeCorrections', 'VendorDuplicator\\Google_Service_AdExchangeBuyer_CreativeCorrections', \false);
/** @internal */
class Google_Service_AdExchangeBuyer_CreativeFilteringReasons extends Google_Collection
{
    ...
    protected $internal_gapi_mappings = array();
    public $date;
    protected $reasonsType = 'VendorDuplicator\\Google_Service_AdExchangeBuyer_CreativeFilteringReasonsReasons';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_AdExchangeBuyer_CreativeFilteringReasons', 'VendorDuplicator\\Google_Service_AdExchangeBuyer_CreativeFilteringReasons', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_AdExchangeBuyer_CreativeFilteringReasonsReasons', 'VendorDuplicator\\Google_Service_AdExchangeBuyer_CreativeFilteringReasonsReasons', \false);
/** @internal */
class Google_Service_AdExchangeBuyer_CreativeNativeAd extends Google_Collection
{
    ...
    protected $internal_gapi_mappings = array();
    public $advertiser;
    protected $appIconType = 'VendorDuplicator\\Google_Service_AdExchangeBuyer_CreativeNativeAdAppIcon';
    protected $appIconDataType = '';
    public $body;
    public $callToAction;
    public $clickTrackingUrl;
    public $headline;
    protected $imageType = 'VendorDuplicator\\Google_Service_AdExchangeBuyer_CreativeNativeAdImage';
    protected $imageDataType = '';
    public $impressionTrackingUrl;
    protected $logoType = 'VendorDuplicator\\Google_Service_AdExchangeBuyer_CreativeNativeAdLogo';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_AdExchangeBuyer_CreativeNativeAd', 'VendorDuplicator\\Google_Service_AdExchangeBuyer_CreativeNativeAd', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_AdExchangeBuyer_CreativeNativeAdAppIcon', 'VendorDuplicator\\Google_Service_AdExchangeBuyer_CreativeNativeAdAppIcon', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_AdExchangeBuyer_CreativeNativeAdImage', 'VendorDuplicator\\Google_Service_AdExchangeBuyer_CreativeNativeAdImage', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_AdExchangeBuyer_CreativeNativeAdLogo', 'VendorDuplicator\\Google_Service_AdExchangeBuyer_CreativeNativeAdLogo', \false);
/** @internal */
class Google_Service_AdExchangeBuyer_CreativeServingRestrictions extends Google_Collection
{
    ...
    protected $internal_gapi_mappings = array();
    protected $contextsType = 'VendorDuplicator\\Google_Service_AdExchangeBuyer_CreativeServingRestrictionsContexts';
    protected $contextsDataType = 'array';
    protected $disapprovalReasonsType = 'VendorDuplicator\\Google_Service_AdExchangeBuyer_CreativeServingRestrictionsDisapprovalReasons';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_AdExchangeBuyer_CreativeServingRestrictions', 'VendorDuplicator\\Google_Service_AdExchangeBuyer_CreativeServingRestrictions', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_AdExchangeBuyer_CreativeServingRestrictionsContexts', 'VendorDuplicator\\Google_Service_AdExchangeBuyer_CreativeServingRestrictionsContexts', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_AdExchangeBuyer_CreativeServingRestrictionsDisapprovalReasons', 'VendorDuplicator\\Google_Service_AdExchangeBuyer_CreativeServingRestrictionsDisapprovalReasons', \false);
/** @internal */
class Google_Service_AdExchangeBuyer_CreativesList extends Google_Collection
{
    protected $collection_key = 'items';
    protected $internal_gapi_mappings = array();
    protected $itemsType = 'VendorDuplicator\\Google_Service_AdExchangeBuyer_Creative';
    protected $itemsDataType = 'array';
    public $kind;
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_AdExchangeBuyer_CreativesList', 'VendorDuplicator\\Google_Service_AdExchangeBuyer_CreativesList', \false);
/** @internal */
class Google_Service_AdExchangeBuyer_DealTerms extends Google_Model
{
    ...
    public $brandingType;
    public $description;
    protected $estimatedGrossSpendType = 'VendorDuplicator\\Google_Service_AdExchangeBuyer_Price';
    protected $estimatedGrossSpendDataType = '';
    public $estimatedImpressionsPerDay;
    protected $guaranteedFixedPriceTermsType = 'VendorDuplicator\\Google_Service_AdExchangeBuyer_DealTermsGuaranteedFixedPriceTerms';
    protected $guaranteedFixedPriceTermsDataType = '';
    protected $nonGuaranteedAuctionTermsType = 'VendorDuplicator\\Google_Service_AdExchangeBuyer_DealTermsNonGuaranteedAuctionTerms';
    protected $nonGuaranteedAuctionTermsDataType = '';
    protected $nonGuaranteedFixedPriceTermsType = 'VendorDuplicator\\Google_Service_AdExchangeBuyer_DealTermsNonGuaranteedFixedPriceTerms';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_AdExchangeBuyer_DealTerms', 'VendorDuplicator\\Google_Service_AdExchangeBuyer_DealTerms', \false);
/** @internal */
class Google_Service_AdExchangeBuyer_DealTermsGuaranteedFixedPriceTerms extends Google_Collection
{
    ...
    protected $internal_gapi_mappings = array();
    protected $fixedPricesType = 'VendorDuplicator\\Google_Service_AdExchangeBuyer_PricePerBuyer';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_AdExchangeBuyer_DealTermsGuaranteedFixedPriceTerms', 'VendorDuplicator\\Google_Service_AdExchangeBuyer_DealTermsGuaranteedFixedPriceTerms', \false);
/** @internal */
class Google_Service_AdExchangeBuyer_DealTermsNonGuaranteedAuctionTerms extends Google_Collection
{
    ...
    protected $reservePricePerBuyersType = 'VendorDuplicator\\Google_Service_AdExchangeBuyer_PricePerBuyer';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_AdExchangeBuyer_DealTermsNonGuaranteedAuctionTerms', 'VendorDuplicator\\Google_Service_AdExchangeBuyer_DealTermsNonGuaranteedAuctionTerms', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_AdExchangeBuyer_DealTermsNonGuaranteedFixedPriceTerms', 'VendorDuplicator\\Google_Service_AdExchangeBuyer_DealTermsNonGuaranteedFixedPriceTerms', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_AdExchangeBuyer_DeleteOrderDealsRequest', 'VendorDuplicator\\Google_Service_AdExchangeBuyer_DeleteOrderDealsRequest', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_AdExchangeBuyer_DeleteOrderDealsResponse', 'VendorDuplicator\\Google_Service_AdExchangeBuyer_DeleteOrderDealsResponse', \false);
/** @internal */
class Google_Service_AdExchangeBuyer_DeliveryControl extends Google_Collection
{
    ...
    protected $frequencyCapsType = 'VendorDuplicator\\Google_Service_AdExchangeBuyer_DeliveryControlFrequencyCap';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_AdExchangeBuyer_DeliveryControl', 'VendorDuplicator\\Google_Service_AdExchangeBuyer_DeliveryControl', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_AdExchangeBuyer_DeliveryControlFrequencyCap', 'VendorDuplicator\\Google_Service_AdExchangeBuyer_DeliveryControlFrequencyCap', \false);
/** @internal */
class Google_Service_AdExchangeBuyer_EditAllOrderDealsRequest extends Google_Collection
{
    ...
    protected $dealsType = 'VendorDuplicator\\Google_Service_AdExchangeBuyer_MarketplaceDeal';
    protected $dealsDataType = 'array';
    protected $proposalType = 'VendorDuplicator\\Google_Service_AdExchangeBuyer_Proposal';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_AdExchangeBuyer_EditAllOrderDealsRequest', 'VendorDuplicator\\Google_Service_AdExchangeBuyer_EditAllOrderDealsRequest', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_AdExchangeBuyer_EditAllOrderDealsResponse', 'VendorDuplicator\\Google_Service_AdExchangeBuyer_EditAllOrderDealsResponse', \false);
/** @internal */
class Google_Service_AdExchangeBuyer_GetOffersResponse extends Google_Collection
{
    protected $collection_key = 'products';
    protected $internal_gapi_mappings = array();
    protected $productsType = 'VendorDuplicator\\Google_Service_AdExchangeBuyer_Product';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_AdExchangeBuyer_GetOffersResponse', 'VendorDuplicator\\Google_Service_AdExchangeBuyer_GetOffersResponse', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_AdExchangeBuyer_GetOrderDealsResponse', 'VendorDuplicator\\Google_Service_AdExchangeBuyer_GetOrderDealsResponse', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_AdExchangeBuyer_GetOrderNotesResponse', 'VendorDuplicator\\Google_Service_AdExchangeBuyer_GetOrderNotesResponse', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_AdExchangeBuyer_GetOrdersResponse', 'VendorDuplicator\\Google_Service_AdExchangeBuyer_GetOrdersResponse', \false);
/** @internal */
class Google_Service_AdExchangeBuyer_MarketplaceDeal extends Google_Collection
{
    protected $collection_key = 'sharedTargetings';
    protected $internal_gapi_mappings = array();
    protected $buyerPrivateDataType = 'VendorDuplicator\\Google_Service_AdExchangeBuyer_PrivateData';
    protected $buyerPrivateDataDataType = '';
    public $creationTimeMs;
    public $creativePreApprovalPolicy;
    public $dealId;
    protected $deliveryControlType = 'VendorDuplicator\\Google_Service_AdExchangeBuyer_DeliveryControl';
    ...
    public $proposalId;
    protected $sellerContactsType = 'VendorDuplicator\\Google_Service_AdExchangeBuyer_ContactInformation';
    protected $sellerContactsDataType = 'array';
    protected $sharedTargetingsType = 'VendorDuplicator\\Google_Service_AdExchangeBuyer_SharedTargeting';
    protected $sharedTargetingsDataType = 'array';
    public $syndicationProduct;
    protected $termsType = 'VendorDuplicator\\Google_Service_AdExchangeBuyer_DealTerms';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_AdExchangeBuyer_MarketplaceDeal', 'VendorDuplicator\\Google_Service_AdExchangeBuyer_MarketplaceDeal', \false);
/** @internal */
class Google_Service_AdExchangeBuyer_MarketplaceDealParty extends Google_Model
{
    protected $internal_gapi_mappings = array();
    protected $buyerType = 'VendorDuplicator\\Google_Service_AdExchangeBuyer_Buyer';
    protected $buyerDataType = '';
    protected $sellerType = 'VendorDuplicator\\Google_Service_AdExchangeBuyer_Seller';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_AdExchangeBuyer_MarketplaceDealParty', 'VendorDuplicator\\Google_Service_AdExchangeBuyer_MarketplaceDealParty', \false);
/** @internal */
class Google_Service_AdExchangeBuyer_MarketplaceLabel extends Google_Model
{
    ...
    public $accountId;
    public $createTimeMs;
    protected $deprecatedMarketplaceDealPartyType = 'VendorDuplicator\\Google_Service_AdExchangeBuyer_MarketplaceDealParty';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_AdExchangeBuyer_MarketplaceLabel', 'VendorDuplicator\\Google_Service_AdExchangeBuyer_MarketplaceLabel', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_AdExchangeBuyer_MarketplaceNote', 'VendorDuplicator\\Google_Service_AdExchangeBuyer_MarketplaceNote', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_AdExchangeBuyer_PerformanceReport', 'VendorDuplicator\\Google_Service_AdExchangeBuyer_PerformanceReport', \false);
/** @internal */
class Google_Service_AdExchangeBuyer_PerformanceReportList extends Google_Collection
{
    ...
    protected $internal_gapi_mappings = array();
    public $kind;
    protected $performanceReportType = 'VendorDuplicator\\Google_Service_AdExchangeBuyer_PerformanceReport';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_AdExchangeBuyer_PerformanceReportList', 'VendorDuplicator\\Google_Service_AdExchangeBuyer_PerformanceReportList', \false);
/** @internal */
class Google_Service_AdExchangeBuyer_PretargetingConfig extends Google_Collection
{
    ...
    public $configName;
    public $creativeType;
    protected $dimensionsType = 'VendorDuplicator\\Google_Service_AdExchangeBuyer_PretargetingConfigDimensions';
    protected $dimensionsDataType = 'array';
    public $excludedContentLabels;
    public $excludedGeoCriteriaIds;
    protected $excludedPlacementsType = 'VendorDuplicator\\Google_Service_AdExchangeBuyer_PretargetingConfigExcludedPlacements';
    ...
    protected $placementsType = 'VendorDuplicator\\Google_Service_AdExchangeBuyer_PretargetingConfigPlacements';
    ...
    public $vendorTypes;
    public $verticals;
    protected $videoPlayerSizesType = 'VendorDuplicator\\Google_Service_AdExchangeBuyer_PretargetingConfigVideoPlayerSizes';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_AdExchangeBuyer_PretargetingConfig', 'VendorDuplicator\\Google_Service_AdExchangeBuyer_PretargetingConfig', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_AdExchangeBuyer_PretargetingConfigDimensions', 'VendorDuplicator\\Google_Service_AdExchangeBuyer_PretargetingConfigDimensions', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_AdExchangeBuyer_PretargetingConfigExcludedPlacements', 'VendorDuplicator\\Google_Service_AdExchangeBuyer_PretargetingConfigExcludedPlacements', \false);
/** @internal */
class Google_Service_AdExchangeBuyer_PretargetingConfigList extends Google_Collection
{
    protected $collection_key = 'items';
    protected $internal_gapi_mappings = array();
    protected $itemsType = 'VendorDuplicator\\Google_Service_AdExchangeBuyer_PretargetingConfig';
    protected $itemsDataType = 'array';
    public $kind;
    public function setItems($items)
    {
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_AdExchangeBuyer_PretargetingConfigList', 'VendorDuplicator\\Google_Service_AdExchangeBuyer_PretargetingConfigList', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_AdExchangeBuyer_PretargetingConfigPlacements', 'VendorDuplicator\\Google_Service_AdExchangeBuyer_PretargetingConfigPlacements', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_AdExchangeBuyer_PretargetingConfigVideoPlayerSizes', 'VendorDuplicator\\Google_Service_AdExchangeBuyer_PretargetingConfigVideoPlayerSizes', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_AdExchangeBuyer_Price', 'VendorDuplicator\\Google_Service_AdExchangeBuyer_Price', \false);
/** @internal */
class Google_Service_AdExchangeBuyer_PricePerBuyer extends Google_Model
{
    ...
    protected $buyerType = 'VendorDuplicator\\Google_Service_AdExchangeBuyer_Buyer';
    protected $buyerDataType = '';
    protected $priceType = 'VendorDuplicator\\Google_Service_AdExchangeBuyer_Price';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_AdExchangeBuyer_PricePerBuyer', 'VendorDuplicator\\Google_Service_AdExchangeBuyer_PricePerBuyer', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_AdExchangeBuyer_PrivateData', 'VendorDuplicator\\Google_Service_AdExchangeBuyer_PrivateData', \false);
/** @internal */
class Google_Service_AdExchangeBuyer_Product extends Google_Collection
{
    ...
    protected $internal_gapi_mappings = array();
    public $creationTimeMs;
    protected $creatorContactsType = 'VendorDuplicator\\Google_Service_AdExchangeBuyer_ContactInformation';
    ...
    public $kind;
    protected $labelsType = 'VendorDuplicator\\Google_Service_AdExchangeBuyer_MarketplaceLabel';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_AdExchangeBuyer_Product', 'VendorDuplicator\\Google_Service_AdExchangeBuyer_Product', \false);
/** @internal */
class Google_Service_AdExchangeBuyer_Proposal extends Google_Collection
{
    protected $collection_key = 'sellerContacts';
    protected $internal_gapi_mappings = array();
    protected $billedBuyerType = 'VendorDuplicator\\Google_Service_AdExchangeBuyer_Buyer';
    protected $billedBuyerDataType = '';
    protected $buyerType = 'VendorDuplicator\\Google_Service_AdExchangeBuyer_Buyer';
    protected $buyerDataType = '';
    protected $buyerContactsType = 'VendorDuplicator\\Google_Service_AdExchangeBuyer_ContactInformation';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_AdExchangeBuyer_Proposal', 'VendorDuplicator\\Google_Service_AdExchangeBuyer_Proposal', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_AdExchangeBuyer_Seller', 'VendorDuplicator\\Google_Service_AdExchangeBuyer_Seller', \false);
/** @internal */
class Google_Service_AdExchangeBuyer_SharedTargeting extends Google_Collection
{
    protected $collection_key = 'inclusions';
    protected $internal_gapi_mappings = array();
    protected $exclusionsType = 'VendorDuplicator\\Google_Service_AdExchangeBuyer_TargetingValue';
    protected $exclusionsDataType = 'array';
    protected $inclusionsType = 'VendorDuplicator\\Google_Service_AdExchangeBuyer_TargetingValue';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_AdExchangeBuyer_SharedTargeting', 'VendorDuplicator\\Google_Service_AdExchangeBuyer_SharedTargeting', \false);
/** @internal */
class Google_Service_AdExchangeBuyer_TargetingValue extends Google_Model
{
    protected $internal_gapi_mappings = array();
    protected $creativeSizeValueType = 'VendorDuplicator\\Google_Service_AdExchangeBuyer_TargetingValueCreativeSize';
    protected $creativeSizeValueDataType = '';
    protected $dayPartTargetingValueType = 'VendorDuplicator\\Google_Service_AdExchangeBuyer_TargetingValueDayPartTargeting';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_AdExchangeBuyer_TargetingValue', 'VendorDuplicator\\Google_Service_AdExchangeBuyer_TargetingValue', \false);
/** @internal */
class Google_Service_AdExchangeBuyer_TargetingValueCreativeSize extends Google_Collection
{
    ...
    protected $internal_gapi_mappings = array();
    protected $companionSizesType = 'VendorDuplicator\\Google_Service_AdExchangeBuyer_TargetingValueSize';
    protected $companionSizesDataType = 'array';
    public $creativeSizeType;
    protected $sizeType = 'VendorDuplicator\\Google_Service_AdExchangeBuyer_TargetingValueSize';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_AdExchangeBuyer_TargetingValueCreativeSize', 'VendorDuplicator\\Google_Service_AdExchangeBuyer_TargetingValueCreativeSize', \false);
/** @internal */
class Google_Service_AdExchangeBuyer_TargetingValueDayPartTargeting extends Google_Collection
{
    ...
    protected $internal_gapi_mappings = array();
    protected $dayPartsType = 'VendorDuplicator\\Google_Service_AdExchangeBuyer_TargetingValueDayPartTargetingDayPart';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_AdExchangeBuyer_TargetingValueDayPartTargeting', 'VendorDuplicator\\Google_Service_AdExchangeBuyer_TargetingValueDayPartTargeting', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_AdExchangeBuyer_TargetingValueDayPartTargetingDayPart', 'VendorDuplicator\\Google_Service_AdExchangeBuyer_TargetingValueDayPartTargetingDayPart', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_AdExchangeBuyer_TargetingValueSize', 'VendorDuplicator\\Google_Service_AdExchangeBuyer_TargetingValueSize', \false);
