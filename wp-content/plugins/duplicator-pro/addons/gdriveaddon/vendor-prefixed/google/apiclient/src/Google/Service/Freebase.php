...
class Google_Service_Freebase extends Google_Service
{
    ...
    public function __construct(Google_Client $client)
    {
        ...
        $this->base_methods = new Google_Service_Resource($this, $this->serviceName, '', array('methods' => array('reconcile' => array('path' => 'reconcile', 'httpMethod' => 'GET', 'parameters' => array('confidence' => array('location' => 'query', 'type' => 'number'), 'kind' => array('location' => 'query', 'type' => 'string', 'repeated' => \true), 'lang' => array('location' => 'query', 'type' => 'string', 'repeated' => \true), 'limit' => array('location' => 'query', 'type' => 'integer'), 'name' => array('location' => 'query', 'type' => 'string'), 'prop' => array('location' => 'query', 'type' => 'string', 'repeated' => \true))), 'search' => array('path' => 'search', 'httpMethod' => 'GET', 'parameters' => array('as_of_time' => array('location' => 'query', 'type' => 'string'), 'callback' => array('location' => 'query', 'type' => 'string'), 'cursor' => array('location' => 'query', 'type' => 'integer'), 'domain' => array('location' => 'query', 'type' => 'string', 'repeated' => \true), 'encode' => array('location' => 'query', 'type' => 'string'), 'exact' => array('location' => 'query', 'type' => 'boolean'), 'filter' => array('location' => 'query', 'type' => 'string', 'repeated' => \true), 'format' => array('location' => 'query', 'type' => 'string'), 'help' => array('location' => 'query', 'type' => 'string'), 'indent' => array('location' => 'query', 'type' => 'boolean'), 'lang' => array('location' => 'query', 'type' => 'string', 'repeated' => \true), 'limit' => array('location' => 'query', 'type' => 'integer'), 'mid' => array('location' => 'query', 'type' => 'string', 'repeated' => \true), 'mql_output' => array('location' => 'query', 'type' => 'string'), 'output' => array('location' => 'query', 'type' => 'string'), 'prefixed' => array('location' => 'query', 'type' => 'boolean'), 'query' => array('location' => 'query', 'type' => 'string'), 'scoring' => array('location' => 'query', 'type' => 'string'), 'spell' => array('location' => 'query', 'type' => 'string'), 'stemmed' => array('location' => 'query', 'type' => 'boolean'), 'type' => array('location' => 'query', 'type' => 'string', 'repeated' => \true), 'with' => array('location' => 'query', 'type' => 'string', 'repeated' => \true), 'without' => array('location' => 'query', 'type' => 'string', 'repeated' => \true))))));
    }
    /**
    ...
    public function reconcile($optParams = array())
    {
        ...
        return $this->base_methods->call('reconcile', array($params), "VendorDuplicator\\Google_Service_Freebase_ReconcileGet");
    }
    /**
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Freebase', 'VendorDuplicator\\Google_Service_Freebase', \false);
/** @internal */
class Google_Service_Freebase_ReconcileCandidate extends Google_Model
{
    ...
    public $mid;
    public $name;
    protected $notableType = 'VendorDuplicator\\Google_Service_Freebase_ReconcileCandidateNotable';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Freebase_ReconcileCandidate', 'VendorDuplicator\\Google_Service_Freebase_ReconcileCandidate', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Freebase_ReconcileCandidateNotable', 'VendorDuplicator\\Google_Service_Freebase_ReconcileCandidateNotable', \false);
/** @internal */
class Google_Service_Freebase_ReconcileGet extends Google_Collection
{
    protected $collection_key = 'warning';
    protected $internal_gapi_mappings = array();
    protected $candidateType = 'VendorDuplicator\\Google_Service_Freebase_ReconcileCandidate';
    protected $candidateDataType = 'array';
    protected $costsType = 'VendorDuplicator\\Google_Service_Freebase_ReconcileGetCosts';
    protected $costsDataType = '';
    protected $matchType = 'VendorDuplicator\\Google_Service_Freebase_ReconcileCandidate';
    protected $matchDataType = '';
    protected $warningType = 'VendorDuplicator\\Google_Service_Freebase_ReconcileGetWarning';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Freebase_ReconcileGet', 'VendorDuplicator\\Google_Service_Freebase_ReconcileGet', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Freebase_ReconcileGetCosts', 'VendorDuplicator\\Google_Service_Freebase_ReconcileGetCosts', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Freebase_ReconcileGetWarning', 'VendorDuplicator\\Google_Service_Freebase_ReconcileGetWarning', \false);
