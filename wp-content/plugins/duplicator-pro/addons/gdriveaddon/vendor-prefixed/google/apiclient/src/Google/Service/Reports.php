...
class Google_Service_Reports extends Google_Service
{
    ...
    public function __construct(Google_Client $client)
    {
        ...
        $this->activities = new Google_Service_Reports_Activities_Resource($this, $this->serviceName, 'activities', array('methods' => array('list' => array('path' => 'activity/users/{userKey}/applications/{applicationName}', 'httpMethod' => 'GET', 'parameters' => array('userKey' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'applicationName' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'actorIpAddress' => array('location' => 'query', 'type' => 'string'), 'customerId' => array('location' => 'query', 'type' => 'string'), 'endTime' => array('location' => 'query', 'type' => 'string'), 'eventName' => array('location' => 'query', 'type' => 'string'), 'filters' => array('location' => 'query', 'type' => 'string'), 'maxResults' => array('location' => 'query', 'type' => 'integer'), 'pageToken' => array('location' => 'query', 'type' => 'string'), 'startTime' => array('location' => 'query', 'type' => 'string'))), 'watch' => array('path' => 'activity/users/{userKey}/applications/{applicationName}/watch', 'httpMethod' => 'POST', 'parameters' => array('userKey' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'applicationName' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'actorIpAddress' => array('location' => 'query', 'type' => 'string'), 'customerId' => array('location' => 'query', 'type' => 'string'), 'endTime' => array('location' => 'query', 'type' => 'string'), 'eventName' => array('location' => 'query', 'type' => 'string'), 'filters' => array('location' => 'query', 'type' => 'string'), 'maxResults' => array('location' => 'query', 'type' => 'integer'), 'pageToken' => array('location' => 'query', 'type' => 'string'), 'startTime' => array('location' => 'query', 'type' => 'string'))))));
        $this->channels = new Google_Service_Reports_Channels_Resource($this, $this->serviceName, 'channels', array('methods' => array('stop' => array('path' => '/admin/reports_v1/channels/stop', 'httpMethod' => 'POST', 'parameters' => array()))));
        $this->customerUsageReports = new Google_Service_Reports_CustomerUsageReports_Resource($this, $this->serviceName, 'customerUsageReports', array('methods' => array('get' => array('path' => 'usage/dates/{date}', 'httpMethod' => 'GET', 'parameters' => array('date' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'customerId' => array('location' => 'query', 'type' => 'string'), 'pageToken' => array('location' => 'query', 'type' => 'string'), 'parameters' => array('location' => 'query', 'type' => 'string'))))));
        $this->userUsageReport = new Google_Service_Reports_UserUsageReport_Resource($this, $this->serviceName, 'userUsageReport', array('methods' => array('get' => array('path' => 'usage/users/{userKey}/dates/{date}', 'httpMethod' => 'GET', 'parameters' => array('userKey' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'date' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'customerId' => array('location' => 'query', 'type' => 'string'), 'filters' => array('location' => 'query', 'type' => 'string'), 'maxResults' => array('location' => 'query', 'type' => 'integer'), 'pageToken' => array('location' => 'query', 'type' => 'string'), 'parameters' => array('location' => 'query', 'type' => 'string'))))));
    }
}
/*
 * Licensed under the Apache License, Version 2.0 (the "License"); you may not
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Reports', 'VendorDuplicator\\Google_Service_Reports', \false);
/**
...
class Google_Service_Reports_Activities_Resource extends Google_Service_Resource
{
    ...
    public function listActivities($userKey, $applicationName, $optParams = array())
    {
        ...
        return $this->call('list', array($params), "VendorDuplicator\\Google_Service_Reports_Activities");
    }
    /**
    ...
    public function watch($userKey, $applicationName, Google_Service_Reports_Channel $postBody, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('watch', array($params), "VendorDuplicator\\Google_Service_Reports_Channel");
    }
}
/**
 * The "activities" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Reports_Activities_Resource', 'VendorDuplicator\\Google_Service_Reports_Activities_Resource', \false);
/**
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Reports_Channels_Resource', 'VendorDuplicator\\Google_Service_Reports_Channels_Resource', \false);
/**
...
class Google_Service_Reports_CustomerUsageReports_Resource extends Google_Service_Resource
{
    ...
    public function get($date, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('get', array($params), "VendorDuplicator\\Google_Service_Reports_UsageReports");
    }
}
/**
 * The "customerUsageReports" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Reports_CustomerUsageReports_Resource', 'VendorDuplicator\\Google_Service_Reports_CustomerUsageReports_Resource', \false);
/**
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Reports_UserUsageReport_Resource', 'VendorDuplicator\\Google_Service_Reports_UserUsageReport_Resource', \false);
/** @internal */
class Google_Service_Reports_Activities extends Google_Collection
{
    ...
    public $etag;
    protected $itemsType = 'VendorDuplicator\\Google_Service_Reports_Activity';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Reports_Activities', 'VendorDuplicator\\Google_Service_Reports_Activities', \false);
/** @internal */
class Google_Service_Reports_Activity extends Google_Collection
{
    protected $collection_key = 'events';
    protected $internal_gapi_mappings = array();
    protected $actorType = 'VendorDuplicator\\Google_Service_Reports_ActivityActor';
    protected $actorDataType = '';
    public $etag;
    protected $eventsType = 'VendorDuplicator\\Google_Service_Reports_ActivityEvents';
    protected $eventsDataType = 'array';
    protected $idType = 'VendorDuplicator\\Google_Service_Reports_ActivityId';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Reports_Activity', 'VendorDuplicator\\Google_Service_Reports_Activity', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Reports_ActivityActor', 'VendorDuplicator\\Google_Service_Reports_ActivityActor', \false);
/** @internal */
class Google_Service_Reports_ActivityEvents extends Google_Collection
{
    ...
    protected $internal_gapi_mappings = array();
    public $name;
    protected $parametersType = 'VendorDuplicator\\Google_Service_Reports_ActivityEventsParameters';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Reports_ActivityEvents', 'VendorDuplicator\\Google_Service_Reports_ActivityEvents', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Reports_ActivityEventsParameters', 'VendorDuplicator\\Google_Service_Reports_ActivityEventsParameters', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Reports_ActivityId', 'VendorDuplicator\\Google_Service_Reports_ActivityId', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Reports_Channel', 'VendorDuplicator\\Google_Service_Reports_Channel', \false);
/** @internal */
class Google_Service_Reports_UsageReport extends Google_Collection
{
    ...
    protected $internal_gapi_mappings = array();
    public $date;
    protected $entityType = 'VendorDuplicator\\Google_Service_Reports_UsageReportEntity';
    protected $entityDataType = '';
    public $etag;
    public $kind;
    protected $parametersType = 'VendorDuplicator\\Google_Service_Reports_UsageReportParameters';
    protected $parametersDataType = 'array';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Reports_UsageReport', 'VendorDuplicator\\Google_Service_Reports_UsageReport', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Reports_UsageReportEntity', 'VendorDuplicator\\Google_Service_Reports_UsageReportEntity', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Reports_UsageReportParameters', 'VendorDuplicator\\Google_Service_Reports_UsageReportParameters', \false);
/** @internal */
class Google_Service_Reports_UsageReports extends Google_Collection
{
    ...
    public $kind;
    public $nextPageToken;
    protected $usageReportsType = 'VendorDuplicator\\Google_Service_Reports_UsageReport';
    protected $usageReportsDataType = 'array';
    protected $warningsType = 'VendorDuplicator\\Google_Service_Reports_UsageReportsWarnings';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Reports_UsageReports', 'VendorDuplicator\\Google_Service_Reports_UsageReports', \false);
/** @internal */
class Google_Service_Reports_UsageReportsWarnings extends Google_Collection
{
    ...
    protected $internal_gapi_mappings = array();
    public $code;
    protected $dataType = 'VendorDuplicator\\Google_Service_Reports_UsageReportsWarningsData';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Reports_UsageReportsWarnings', 'VendorDuplicator\\Google_Service_Reports_UsageReportsWarnings', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Reports_UsageReportsWarningsData', 'VendorDuplicator\\Google_Service_Reports_UsageReportsWarningsData', \false);
