...
class Google_Service_CivicInfo extends Google_Service
{
    ...
    public function __construct(Google_Client $client)
    {
        ...
        $this->divisions = new Google_Service_CivicInfo_Divisions_Resource($this, $this->serviceName, 'divisions', array('methods' => array('search' => array('path' => 'divisions', 'httpMethod' => 'GET', 'parameters' => array('query' => array('location' => 'query', 'type' => 'string'))))));
        $this->elections = new Google_Service_CivicInfo_Elections_Resource($this, $this->serviceName, 'elections', array('methods' => array('electionQuery' => array('path' => 'elections', 'httpMethod' => 'GET', 'parameters' => array()), 'voterInfoQuery' => array('path' => 'voterinfo', 'httpMethod' => 'GET', 'parameters' => array('address' => array('location' => 'query', 'type' => 'string', 'required' => \true), 'electionId' => array('location' => 'query', 'type' => 'string'), 'officialOnly' => array('location' => 'query', 'type' => 'boolean'))))));
        $this->representatives = new Google_Service_CivicInfo_Representatives_Resource($this, $this->serviceName, 'representatives', array('methods' => array('representativeInfoByAddress' => array('path' => 'representatives', 'httpMethod' => 'GET', 'parameters' => array('address' => array('location' => 'query', 'type' => 'string'), 'includeOffices' => array('location' => 'query', 'type' => 'boolean'), 'levels' => array('location' => 'query', 'type' => 'string', 'repeated' => \true), 'roles' => array('location' => 'query', 'type' => 'string', 'repeated' => \true))), 'representativeInfoByDivision' => array('path' => 'representatives/{ocdId}', 'httpMethod' => 'GET', 'parameters' => array('ocdId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'levels' => array('location' => 'query', 'type' => 'string', 'repeated' => \true), 'recursive' => array('location' => 'query', 'type' => 'boolean'), 'roles' => array('location' => 'query', 'type' => 'string', 'repeated' => \true))))));
    }
}
/*
 * Licensed under the Apache License, Version 2.0 (the "License"); you may not
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_CivicInfo', 'VendorDuplicator\\Google_Service_CivicInfo', \false);
/**
...
class Google_Service_CivicInfo_Divisions_Resource extends Google_Service_Resource
{
    ...
    public function search($optParams = array())
    {
        ...
        return $this->call('search', array($params), "VendorDuplicator\\Google_Service_CivicInfo_DivisionSearchResponse");
    }
}
/**
 * The "divisions" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_CivicInfo_Divisions_Resource', 'VendorDuplicator\\Google_Service_CivicInfo_Divisions_Resource', \false);
/**
...
class Google_Service_CivicInfo_Elections_Resource extends Google_Service_Resource
{
    ...
    public function electionQuery($optParams = array())
    {
        $params = array();
        $params = \array_merge($params, $optParams);
        return $this->call('electionQuery', array($params), "VendorDuplicator\\Google_Service_CivicInfo_ElectionsQueryResponse");
    }
    /**
    ...
    public function voterInfoQuery($address, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('voterInfoQuery', array($params), "VendorDuplicator\\Google_Service_CivicInfo_VoterInfoResponse");
    }
}
/**
 * The "elections" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_CivicInfo_Elections_Resource', 'VendorDuplicator\\Google_Service_CivicInfo_Elections_Resource', \false);
/**
...
class Google_Service_CivicInfo_Representatives_Resource extends Google_Service_Resource
{
    ...
    public function representativeInfoByAddress($optParams = array())
    {
        $params = array();
        $params = \array_merge($params, $optParams);
        return $this->call('representativeInfoByAddress', array($params), "VendorDuplicator\\Google_Service_CivicInfo_RepresentativeInfoResponse");
    }
    /**
    ...
    public function representativeInfoByDivision($ocdId, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('representativeInfoByDivision', array($params), "VendorDuplicator\\Google_Service_CivicInfo_RepresentativeInfoData");
    }
}
/**
 * The "representatives" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_CivicInfo_Representatives_Resource', 'VendorDuplicator\\Google_Service_CivicInfo_Representatives_Resource', \false);
/** @internal */
class Google_Service_CivicInfo_AdministrationRegion extends Google_Collection
{
    ...
    protected $electionAdministrationBodyType = 'VendorDuplicator\\Google_Service_CivicInfo_AdministrativeBody';
    protected $electionAdministrationBodyDataType = '';
    public $id;
    protected $localJurisdictionType = 'VendorDuplicator\\Google_Service_CivicInfo_AdministrationRegion';
    protected $localJurisdictionDataType = '';
    public $name;
    protected $sourcesType = 'VendorDuplicator\\Google_Service_CivicInfo_Source';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_CivicInfo_AdministrationRegion', 'VendorDuplicator\\Google_Service_CivicInfo_AdministrationRegion', \false);
/** @internal */
class Google_Service_CivicInfo_AdministrativeBody extends Google_Collection
{
    ...
    protected $correspondenceAddressType = 'VendorDuplicator\\Google_Service_CivicInfo_SimpleAddressType';
    protected $correspondenceAddressDataType = '';
    public $electionInfoUrl;
    protected $electionOfficialsType = 'VendorDuplicator\\Google_Service_CivicInfo_ElectionOfficial';
    ...
    public $name;
    protected $physicalAddressType = 'VendorDuplicator\\Google_Service_CivicInfo_SimpleAddressType';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_CivicInfo_AdministrativeBody', 'VendorDuplicator\\Google_Service_CivicInfo_AdministrativeBody', \false);
/** @internal */
class Google_Service_CivicInfo_Candidate extends Google_Collection
{
    ...
    public $candidateUrl;
    protected $channelsType = 'VendorDuplicator\\Google_Service_CivicInfo_Channel';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_CivicInfo_Candidate', 'VendorDuplicator\\Google_Service_CivicInfo_Candidate', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_CivicInfo_Channel', 'VendorDuplicator\\Google_Service_CivicInfo_Channel', \false);
/** @internal */
class Google_Service_CivicInfo_Contest extends Google_Collection
{
    ...
    protected $candidatesType = 'VendorDuplicator\\Google_Service_CivicInfo_Candidate';
    protected $candidatesDataType = 'array';
    protected $districtType = 'VendorDuplicator\\Google_Service_CivicInfo_ElectoralDistrict';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_CivicInfo_Contest', 'VendorDuplicator\\Google_Service_CivicInfo_Contest', \false);
/** @internal */
class Google_Service_CivicInfo_DivisionSearchResponse extends Google_Collection
{
    ...
    protected $internal_gapi_mappings = array();
    public $kind;
    protected $resultsType = 'VendorDuplicator\\Google_Service_CivicInfo_DivisionSearchResult';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_CivicInfo_DivisionSearchResponse', 'VendorDuplicator\\Google_Service_CivicInfo_DivisionSearchResponse', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_CivicInfo_DivisionSearchResult', 'VendorDuplicator\\Google_Service_CivicInfo_DivisionSearchResult', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_CivicInfo_Election', 'VendorDuplicator\\Google_Service_CivicInfo_Election', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_CivicInfo_ElectionOfficial', 'VendorDuplicator\\Google_Service_CivicInfo_ElectionOfficial', \false);
/** @internal */
class Google_Service_CivicInfo_ElectionsQueryResponse extends Google_Collection
{
    protected $collection_key = 'elections';
    protected $internal_gapi_mappings = array();
    protected $electionsType = 'VendorDuplicator\\Google_Service_CivicInfo_Election';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_CivicInfo_ElectionsQueryResponse', 'VendorDuplicator\\Google_Service_CivicInfo_ElectionsQueryResponse', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_CivicInfo_ElectoralDistrict', 'VendorDuplicator\\Google_Service_CivicInfo_ElectoralDistrict', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_CivicInfo_GeographicDivision', 'VendorDuplicator\\Google_Service_CivicInfo_GeographicDivision', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_CivicInfo_Office', 'VendorDuplicator\\Google_Service_CivicInfo_Office', \false);
/** @internal */
class Google_Service_CivicInfo_Official extends Google_Collection
{
    protected $collection_key = 'urls';
    protected $internal_gapi_mappings = array();
    protected $addressType = 'VendorDuplicator\\Google_Service_CivicInfo_SimpleAddressType';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_CivicInfo_Official', 'VendorDuplicator\\Google_Service_CivicInfo_Official', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_CivicInfo_PollingLocation', 'VendorDuplicator\\Google_Service_CivicInfo_PollingLocation', \false);
/** @internal */
class Google_Service_CivicInfo_RepresentativeInfoData extends Google_Collection
{
    protected $collection_key = 'officials';
    protected $internal_gapi_mappings = array();
    protected $divisionsType = 'VendorDuplicator\\Google_Service_CivicInfo_GeographicDivision';
    protected $divisionsDataType = 'map';
    protected $officesType = 'VendorDuplicator\\Google_Service_CivicInfo_Office';
    protected $officesDataType = 'array';
    protected $officialsType = 'VendorDuplicator\\Google_Service_CivicInfo_Official';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_CivicInfo_RepresentativeInfoData', 'VendorDuplicator\\Google_Service_CivicInfo_RepresentativeInfoData', \false);
/** @internal */
class Google_Service_CivicInfo_RepresentativeInfoResponse extends Google_Collection
{
    ...
    protected $divisionsDataType = 'map';
    public $kind;
    protected $normalizedInputType = 'VendorDuplicator\\Google_Service_CivicInfo_SimpleAddressType';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_CivicInfo_RepresentativeInfoResponse', 'VendorDuplicator\\Google_Service_CivicInfo_RepresentativeInfoResponse', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_CivicInfo_SimpleAddressType', 'VendorDuplicator\\Google_Service_CivicInfo_SimpleAddressType', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_CivicInfo_Source', 'VendorDuplicator\\Google_Service_CivicInfo_Source', \false);
/** @internal */
class Google_Service_CivicInfo_VoterInfoResponse extends Google_Collection
{
    protected $collection_key = 'state';
    protected $internal_gapi_mappings = array();
    protected $contestsType = 'VendorDuplicator\\Google_Service_CivicInfo_Contest';
    protected $contestsDataType = 'array';
    protected $dropOffLocationsType = 'VendorDuplicator\\Google_Service_CivicInfo_PollingLocation';
    protected $dropOffLocationsDataType = 'array';
    protected $earlyVoteSitesType = 'VendorDuplicator\\Google_Service_CivicInfo_PollingLocation';
    protected $earlyVoteSitesDataType = 'array';
    protected $electionType = 'VendorDuplicator\\Google_Service_CivicInfo_Election';
    protected $electionDataType = '';
    public $kind;
    public $mailOnly;
    protected $normalizedInputType = 'VendorDuplicator\\Google_Service_CivicInfo_SimpleAddressType';
    protected $normalizedInputDataType = '';
    protected $otherElectionsType = 'VendorDuplicator\\Google_Service_CivicInfo_Election';
    protected $otherElectionsDataType = 'array';
    protected $pollingLocationsType = 'VendorDuplicator\\Google_Service_CivicInfo_PollingLocation';
    protected $pollingLocationsDataType = 'array';
    public $precinctId;
    protected $stateType = 'VendorDuplicator\\Google_Service_CivicInfo_AdministrationRegion';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_CivicInfo_VoterInfoResponse', 'VendorDuplicator\\Google_Service_CivicInfo_VoterInfoResponse', \false);
