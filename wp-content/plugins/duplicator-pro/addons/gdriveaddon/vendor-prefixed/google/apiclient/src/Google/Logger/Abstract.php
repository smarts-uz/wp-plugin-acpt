...
abstract class Google_Logger_Abstract
{
    ...
    {
        $this->setLevel($client->getClassConfig('VendorDuplicator\\Google_Logger_Abstract', 'level'));
        $format = $client->getClassConfig('VendorDuplicator\\Google_Logger_Abstract', 'log_format');
        $this->logFormat = $format ? $format : self::DEFAULT_LOG_FORMAT;
        $format = $client->getClassConfig('VendorDuplicator\\Google_Logger_Abstract', 'date_format');
        $this->dateFormat = $format ? $format : self::DEFAULT_DATE_FORMAT;
        $this->allowNewLines = (bool) $client->getClassConfig('VendorDuplicator\\Google_Logger_Abstract', 'allow_newlines');
    }
    /**
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Logger_Abstract', 'VendorDuplicator\\Google_Logger_Abstract', \false);
