...
class Google_Service_Blogger extends Google_Service
{
    ...
    public function __construct(Google_Client $client)
    {
        ...
        $this->blogUserInfos = new Google_Service_Blogger_BlogUserInfos_Resource($this, $this->serviceName, 'blogUserInfos', array('methods' => array('get' => array('path' => 'users/{userId}/blogs/{blogId}', 'httpMethod' => 'GET', 'parameters' => array('userId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'blogId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'maxPosts' => array('location' => 'query', 'type' => 'integer'))))));
        $this->blogs = new Google_Service_Blogger_Blogs_Resource($this, $this->serviceName, 'blogs', array('methods' => array('get' => array('path' => 'blogs/{blogId}', 'httpMethod' => 'GET', 'parameters' => array('blogId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'maxPosts' => array('location' => 'query', 'type' => 'integer'), 'view' => array('location' => 'query', 'type' => 'string'))), 'getByUrl' => array('path' => 'blogs/byurl', 'httpMethod' => 'GET', 'parameters' => array('url' => array('location' => 'query', 'type' => 'string', 'required' => \true), 'view' => array('location' => 'query', 'type' => 'string'))), 'listByUser' => array('path' => 'users/{userId}/blogs', 'httpMethod' => 'GET', 'parameters' => array('userId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'fetchUserInfo' => array('location' => 'query', 'type' => 'boolean'), 'role' => array('location' => 'query', 'type' => 'string', 'repeated' => \true), 'status' => array('location' => 'query', 'type' => 'string', 'repeated' => \true), 'view' => array('location' => 'query', 'type' => 'string'))))));
        $this->comments = new Google_Service_Blogger_Comments_Resource($this, $this->serviceName, 'comments', array('methods' => array('approve' => array('path' => 'blogs/{blogId}/posts/{postId}/comments/{commentId}/approve', 'httpMethod' => 'POST', 'parameters' => array('blogId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'postId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'commentId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'delete' => array('path' => 'blogs/{blogId}/posts/{postId}/comments/{commentId}', 'httpMethod' => 'DELETE', 'parameters' => array('blogId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'postId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'commentId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'get' => array('path' => 'blogs/{blogId}/posts/{postId}/comments/{commentId}', 'httpMethod' => 'GET', 'parameters' => array('blogId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'postId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'commentId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'view' => array('location' => 'query', 'type' => 'string'))), 'list' => array('path' => 'blogs/{blogId}/posts/{postId}/comments', 'httpMethod' => 'GET', 'parameters' => array('blogId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'postId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'endDate' => array('location' => 'query', 'type' => 'string'), 'fetchBodies' => array('location' => 'query', 'type' => 'boolean'), 'maxResults' => array('location' => 'query', 'type' => 'integer'), 'pageToken' => array('location' => 'query', 'type' => 'string'), 'startDate' => array('location' => 'query', 'type' => 'string'), 'status' => array('location' => 'query', 'type' => 'string', 'repeated' => \true), 'view' => array('location' => 'query', 'type' => 'string'))), 'listByBlog' => array('path' => 'blogs/{blogId}/comments', 'httpMethod' => 'GET', 'parameters' => array('blogId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'endDate' => array('location' => 'query', 'type' => 'string'), 'fetchBodies' => array('location' => 'query', 'type' => 'boolean'), 'maxResults' => array('location' => 'query', 'type' => 'integer'), 'pageToken' => array('location' => 'query', 'type' => 'string'), 'startDate' => array('location' => 'query', 'type' => 'string'), 'status' => array('location' => 'query', 'type' => 'string', 'repeated' => \true))), 'markAsSpam' => array('path' => 'blogs/{blogId}/posts/{postId}/comments/{commentId}/spam', 'httpMethod' => 'POST', 'parameters' => array('blogId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'postId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'commentId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'removeContent' => array('path' => 'blogs/{blogId}/posts/{postId}/comments/{commentId}/removecontent', 'httpMethod' => 'POST', 'parameters' => array('blogId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'postId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'commentId' => array('location' => 'path', 'type' => 'string', 'required' => \true))))));
        $this->pageViews = new Google_Service_Blogger_PageViews_Resource($this, $this->serviceName, 'pageViews', array('methods' => array('get' => array('path' => 'blogs/{blogId}/pageviews', 'httpMethod' => 'GET', 'parameters' => array('blogId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'range' => array('location' => 'query', 'type' => 'string', 'repeated' => \true))))));
        $this->pages = new Google_Service_Blogger_Pages_Resource($this, $this->serviceName, 'pages', array('methods' => array('delete' => array('path' => 'blogs/{blogId}/pages/{pageId}', 'httpMethod' => 'DELETE', 'parameters' => array('blogId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'pageId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'get' => array('path' => 'blogs/{blogId}/pages/{pageId}', 'httpMethod' => 'GET', 'parameters' => array('blogId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'pageId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'view' => array('location' => 'query', 'type' => 'string'))), 'insert' => array('path' => 'blogs/{blogId}/pages', 'httpMethod' => 'POST', 'parameters' => array('blogId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'isDraft' => array('location' => 'query', 'type' => 'boolean'))), 'list' => array('path' => 'blogs/{blogId}/pages', 'httpMethod' => 'GET', 'parameters' => array('blogId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'fetchBodies' => array('location' => 'query', 'type' => 'boolean'), 'maxResults' => array('location' => 'query', 'type' => 'integer'), 'pageToken' => array('location' => 'query', 'type' => 'string'), 'status' => array('location' => 'query', 'type' => 'string', 'repeated' => \true), 'view' => array('location' => 'query', 'type' => 'string'))), 'patch' => array('path' => 'blogs/{blogId}/pages/{pageId}', 'httpMethod' => 'PATCH', 'parameters' => array('blogId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'pageId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'publish' => array('location' => 'query', 'type' => 'boolean'), 'revert' => array('location' => 'query', 'type' => 'boolean'))), 'publish' => array('path' => 'blogs/{blogId}/pages/{pageId}/publish', 'httpMethod' => 'POST', 'parameters' => array('blogId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'pageId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'revert' => array('path' => 'blogs/{blogId}/pages/{pageId}/revert', 'httpMethod' => 'POST', 'parameters' => array('blogId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'pageId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'update' => array('path' => 'blogs/{blogId}/pages/{pageId}', 'httpMethod' => 'PUT', 'parameters' => array('blogId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'pageId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'publish' => array('location' => 'query', 'type' => 'boolean'), 'revert' => array('location' => 'query', 'type' => 'boolean'))))));
        $this->postUserInfos = new Google_Service_Blogger_PostUserInfos_Resource($this, $this->serviceName, 'postUserInfos', array('methods' => array('get' => array('path' => 'users/{userId}/blogs/{blogId}/posts/{postId}', 'httpMethod' => 'GET', 'parameters' => array('userId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'blogId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'postId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'maxComments' => array('location' => 'query', 'type' => 'integer'))), 'list' => array('path' => 'users/{userId}/blogs/{blogId}/posts', 'httpMethod' => 'GET', 'parameters' => array('userId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'blogId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'endDate' => array('location' => 'query', 'type' => 'string'), 'fetchBodies' => array('location' => 'query', 'type' => 'boolean'), 'labels' => array('location' => 'query', 'type' => 'string'), 'maxResults' => array('location' => 'query', 'type' => 'integer'), 'orderBy' => array('location' => 'query', 'type' => 'string'), 'pageToken' => array('location' => 'query', 'type' => 'string'), 'startDate' => array('location' => 'query', 'type' => 'string'), 'status' => array('location' => 'query', 'type' => 'string', 'repeated' => \true), 'view' => array('location' => 'query', 'type' => 'string'))))));
        $this->posts = new Google_Service_Blogger_Posts_Resource($this, $this->serviceName, 'posts', array('methods' => array('delete' => array('path' => 'blogs/{blogId}/posts/{postId}', 'httpMethod' => 'DELETE', 'parameters' => array('blogId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'postId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'get' => array('path' => 'blogs/{blogId}/posts/{postId}', 'httpMethod' => 'GET', 'parameters' => array('blogId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'postId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'fetchBody' => array('location' => 'query', 'type' => 'boolean'), 'fetchImages' => array('location' => 'query', 'type' => 'boolean'), 'maxComments' => array('location' => 'query', 'type' => 'integer'), 'view' => array('location' => 'query', 'type' => 'string'))), 'getByPath' => array('path' => 'blogs/{blogId}/posts/bypath', 'httpMethod' => 'GET', 'parameters' => array('blogId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'path' => array('location' => 'query', 'type' => 'string', 'required' => \true), 'maxComments' => array('location' => 'query', 'type' => 'integer'), 'view' => array('location' => 'query', 'type' => 'string'))), 'insert' => array('path' => 'blogs/{blogId}/posts', 'httpMethod' => 'POST', 'parameters' => array('blogId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'fetchBody' => array('location' => 'query', 'type' => 'boolean'), 'fetchImages' => array('location' => 'query', 'type' => 'boolean'), 'isDraft' => array('location' => 'query', 'type' => 'boolean'))), 'list' => array('path' => 'blogs/{blogId}/posts', 'httpMethod' => 'GET', 'parameters' => array('blogId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'endDate' => array('location' => 'query', 'type' => 'string'), 'fetchBodies' => array('location' => 'query', 'type' => 'boolean'), 'fetchImages' => array('location' => 'query', 'type' => 'boolean'), 'labels' => array('location' => 'query', 'type' => 'string'), 'maxResults' => array('location' => 'query', 'type' => 'integer'), 'orderBy' => array('location' => 'query', 'type' => 'string'), 'pageToken' => array('location' => 'query', 'type' => 'string'), 'startDate' => array('location' => 'query', 'type' => 'string'), 'status' => array('location' => 'query', 'type' => 'string', 'repeated' => \true), 'view' => array('location' => 'query', 'type' => 'string'))), 'patch' => array('path' => 'blogs/{blogId}/posts/{postId}', 'httpMethod' => 'PATCH', 'parameters' => array('blogId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'postId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'fetchBody' => array('location' => 'query', 'type' => 'boolean'), 'fetchImages' => array('location' => 'query', 'type' => 'boolean'), 'maxComments' => array('location' => 'query', 'type' => 'integer'), 'publish' => array('location' => 'query', 'type' => 'boolean'), 'revert' => array('location' => 'query', 'type' => 'boolean'))), 'publish' => array('path' => 'blogs/{blogId}/posts/{postId}/publish', 'httpMethod' => 'POST', 'parameters' => array('blogId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'postId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'publishDate' => array('location' => 'query', 'type' => 'string'))), 'revert' => array('path' => 'blogs/{blogId}/posts/{postId}/revert', 'httpMethod' => 'POST', 'parameters' => array('blogId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'postId' => array('location' => 'path', 'type' => 'string', 'required' => \true))), 'search' => array('path' => 'blogs/{blogId}/posts/search', 'httpMethod' => 'GET', 'parameters' => array('blogId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'q' => array('location' => 'query', 'type' => 'string', 'required' => \true), 'fetchBodies' => array('location' => 'query', 'type' => 'boolean'), 'orderBy' => array('location' => 'query', 'type' => 'string'))), 'update' => array('path' => 'blogs/{blogId}/posts/{postId}', 'httpMethod' => 'PUT', 'parameters' => array('blogId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'postId' => array('location' => 'path', 'type' => 'string', 'required' => \true), 'fetchBody' => array('location' => 'query', 'type' => 'boolean'), 'fetchImages' => array('location' => 'query', 'type' => 'boolean'), 'maxComments' => array('location' => 'query', 'type' => 'integer'), 'publish' => array('location' => 'query', 'type' => 'boolean'), 'revert' => array('location' => 'query', 'type' => 'boolean'))))));
        $this->users = new Google_Service_Blogger_Users_Resource($this, $this->serviceName, 'users', array('methods' => array('get' => array('path' => 'users/{userId}', 'httpMethod' => 'GET', 'parameters' => array('userId' => array('location' => 'path', 'type' => 'string', 'required' => \true))))));
    }
}
/*
 * Licensed under the Apache License, Version 2.0 (the "License"); you may not
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Blogger', 'VendorDuplicator\\Google_Service_Blogger', \false);
/**
...
class Google_Service_Blogger_BlogUserInfos_Resource extends Google_Service_Resource
{
    ...
    public function get($userId, $blogId, $optParams = array())
    {
        ...
        return $this->call('get', array($params), "VendorDuplicator\\Google_Service_Blogger_BlogUserInfo");
    }
}
/**
 * The "blogUserInfos" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Blogger_BlogUserInfos_Resource', 'VendorDuplicator\\Google_Service_Blogger_BlogUserInfos_Resource', \false);
/**
...
class Google_Service_Blogger_Blogs_Resource extends Google_Service_Resource
{
    ...
    public function get($blogId, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('get', array($params), "VendorDuplicator\\Google_Service_Blogger_Blog");
    }
    /**
    ...
    public function getByUrl($url, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('getByUrl', array($params), "VendorDuplicator\\Google_Service_Blogger_Blog");
    }
    /**
    ...
    public function listByUser($userId, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('listByUser', array($params), "VendorDuplicator\\Google_Service_Blogger_BlogList");
    }
}
/**
 * The "blogs" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Blogger_Blogs_Resource', 'VendorDuplicator\\Google_Service_Blogger_Blogs_Resource', \false);
/**
...
class Google_Service_Blogger_Comments_Resource extends Google_Service_Resource
{
    ...
    public function approve($blogId, $postId, $commentId, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('approve', array($params), "VendorDuplicator\\Google_Service_Blogger_Comment");
    }
    /**
    ...
    public function get($blogId, $postId, $commentId, $optParams = array())
    {
        $params = array('blogId' => $blogId, 'postId' => $postId, 'commentId' => $commentId);
        $params = \array_merge($params, $optParams);
        return $this->call('get', array($params), "VendorDuplicator\\Google_Service_Blogger_Comment");
    }
    /**
    ...
    public function listComments($blogId, $postId, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('list', array($params), "VendorDuplicator\\Google_Service_Blogger_CommentList");
    }
    /**
    ...
    public function listByBlog($blogId, $optParams = array())
    {
        $params = array('blogId' => $blogId);
        $params = \array_merge($params, $optParams);
        return $this->call('listByBlog', array($params), "VendorDuplicator\\Google_Service_Blogger_CommentList");
    }
    /**
    ...
    public function markAsSpam($blogId, $postId, $commentId, $optParams = array())
    {
        $params = array('blogId' => $blogId, 'postId' => $postId, 'commentId' => $commentId);
        $params = \array_merge($params, $optParams);
        return $this->call('markAsSpam', array($params), "VendorDuplicator\\Google_Service_Blogger_Comment");
    }
    /**
    ...
    public function removeContent($blogId, $postId, $commentId, $optParams = array())
    {
        $params = array('blogId' => $blogId, 'postId' => $postId, 'commentId' => $commentId);
        $params = \array_merge($params, $optParams);
        return $this->call('removeContent', array($params), "VendorDuplicator\\Google_Service_Blogger_Comment");
    }
}
/**
 * The "comments" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Blogger_Comments_Resource', 'VendorDuplicator\\Google_Service_Blogger_Comments_Resource', \false);
/**
...
class Google_Service_Blogger_PageViews_Resource extends Google_Service_Resource
{
    ...
    public function get($blogId, $optParams = array())
    {
        $params = array('blogId' => $blogId);
        $params = \array_merge($params, $optParams);
        return $this->call('get', array($params), "VendorDuplicator\\Google_Service_Blogger_Pageviews");
    }
}
/**
 * The "pageViews" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Blogger_PageViews_Resource', 'VendorDuplicator\\Google_Service_Blogger_PageViews_Resource', \false);
/**
...
class Google_Service_Blogger_Pages_Resource extends Google_Service_Resource
{
    ...
    public function get($blogId, $pageId, $optParams = array())
    {
        $params = array('blogId' => $blogId, 'pageId' => $pageId);
        $params = \array_merge($params, $optParams);
        return $this->call('get', array($params), "VendorDuplicator\\Google_Service_Blogger_Page");
    }
    /**
    ...
    public function insert($blogId, Google_Service_Blogger_Page $postBody, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('insert', array($params), "VendorDuplicator\\Google_Service_Blogger_Page");
    }
    /**
    ...
    public function listPages($blogId, $optParams = array())
    {
        $params = array('blogId' => $blogId);
        $params = \array_merge($params, $optParams);
        return $this->call('list', array($params), "VendorDuplicator\\Google_Service_Blogger_PageList");
    }
    /**
    ...
    public function patch($blogId, $pageId, Google_Service_Blogger_Page $postBody, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('patch', array($params), "VendorDuplicator\\Google_Service_Blogger_Page");
    }
    /**
    ...
    public function publish($blogId, $pageId, $optParams = array())
    {
        $params = array('blogId' => $blogId, 'pageId' => $pageId);
        $params = \array_merge($params, $optParams);
        return $this->call('publish', array($params), "VendorDuplicator\\Google_Service_Blogger_Page");
    }
    /**
    ...
    public function revert($blogId, $pageId, $optParams = array())
    {
        $params = array('blogId' => $blogId, 'pageId' => $pageId);
        $params = \array_merge($params, $optParams);
        return $this->call('revert', array($params), "VendorDuplicator\\Google_Service_Blogger_Page");
    }
    /**
    ...
    public function update($blogId, $pageId, Google_Service_Blogger_Page $postBody, $optParams = array())
    {
        $params = array('blogId' => $blogId, 'pageId' => $pageId, 'postBody' => $postBody);
        $params = \array_merge($params, $optParams);
        return $this->call('update', array($params), "VendorDuplicator\\Google_Service_Blogger_Page");
    }
}
/**
 * The "pages" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Blogger_Pages_Resource', 'VendorDuplicator\\Google_Service_Blogger_Pages_Resource', \false);
/**
...
class Google_Service_Blogger_PostUserInfos_Resource extends Google_Service_Resource
{
    ...
    public function get($userId, $blogId, $postId, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('get', array($params), "VendorDuplicator\\Google_Service_Blogger_PostUserInfo");
    }
    /**
    ...
    public function listPostUserInfos($userId, $blogId, $optParams = array())
    {
        $params = array('userId' => $userId, 'blogId' => $blogId);
        $params = \array_merge($params, $optParams);
        return $this->call('list', array($params), "VendorDuplicator\\Google_Service_Blogger_PostUserInfosList");
    }
}
/**
 * The "postUserInfos" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Blogger_PostUserInfos_Resource', 'VendorDuplicator\\Google_Service_Blogger_PostUserInfos_Resource', \false);
/**
...
class Google_Service_Blogger_Posts_Resource extends Google_Service_Resource
{
    ...
    public function get($blogId, $postId, $optParams = array())
    {
        $params = array('blogId' => $blogId, 'postId' => $postId);
        $params = \array_merge($params, $optParams);
        return $this->call('get', array($params), "VendorDuplicator\\Google_Service_Blogger_Post");
    }
    /**
    ...
    public function getByPath($blogId, $path, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('getByPath', array($params), "VendorDuplicator\\Google_Service_Blogger_Post");
    }
    /**
    ...
    public function insert($blogId, Google_Service_Blogger_Post $postBody, $optParams = array())
    {
        $params = array('blogId' => $blogId, 'postBody' => $postBody);
        $params = \array_merge($params, $optParams);
        return $this->call('insert', array($params), "VendorDuplicator\\Google_Service_Blogger_Post");
    }
    /**
    ...
    public function listPosts($blogId, $optParams = array())
    {
        $params = array('blogId' => $blogId);
        $params = \array_merge($params, $optParams);
        return $this->call('list', array($params), "VendorDuplicator\\Google_Service_Blogger_PostList");
    }
    /**
    ...
    public function patch($blogId, $postId, Google_Service_Blogger_Post $postBody, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('patch', array($params), "VendorDuplicator\\Google_Service_Blogger_Post");
    }
    /**
    ...
    public function publish($blogId, $postId, $optParams = array())
    {
        $params = array('blogId' => $blogId, 'postId' => $postId);
        $params = \array_merge($params, $optParams);
        return $this->call('publish', array($params), "VendorDuplicator\\Google_Service_Blogger_Post");
    }
    /**
    ...
    public function revert($blogId, $postId, $optParams = array())
    {
        $params = array('blogId' => $blogId, 'postId' => $postId);
        $params = \array_merge($params, $optParams);
        return $this->call('revert', array($params), "VendorDuplicator\\Google_Service_Blogger_Post");
    }
    /**
    ...
    public function search($blogId, $q, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('search', array($params), "VendorDuplicator\\Google_Service_Blogger_PostList");
    }
    /**
    ...
    public function update($blogId, $postId, Google_Service_Blogger_Post $postBody, $optParams = array())
    {
        $params = array('blogId' => $blogId, 'postId' => $postId, 'postBody' => $postBody);
        $params = \array_merge($params, $optParams);
        return $this->call('update', array($params), "VendorDuplicator\\Google_Service_Blogger_Post");
    }
}
/**
 * The "posts" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Blogger_Posts_Resource', 'VendorDuplicator\\Google_Service_Blogger_Posts_Resource', \false);
/**
...
class Google_Service_Blogger_Users_Resource extends Google_Service_Resource
{
    ...
    public function get($userId, $optParams = array())
    {
        $params = array('userId' => $userId);
        $params = \array_merge($params, $optParams);
        return $this->call('get', array($params), "VendorDuplicator\\Google_Service_Blogger_User");
    }
}
/**
 * The "users" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Blogger_Users_Resource', 'VendorDuplicator\\Google_Service_Blogger_Users_Resource', \false);
/** @internal */
class Google_Service_Blogger_Blog extends Google_Model
{
    ...
    public $id;
    public $kind;
    protected $localeType = 'VendorDuplicator\\Google_Service_Blogger_BlogLocale';
    protected $localeDataType = '';
    public $name;
    protected $pagesType = 'VendorDuplicator\\Google_Service_Blogger_BlogPages';
    protected $pagesDataType = '';
    protected $postsType = 'VendorDuplicator\\Google_Service_Blogger_BlogPosts';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Blogger_Blog', 'VendorDuplicator\\Google_Service_Blogger_Blog', \false);
/** @internal */
class Google_Service_Blogger_BlogList extends Google_Collection
{
    protected $collection_key = 'items';
    protected $internal_gapi_mappings = array();
    protected $blogUserInfosType = 'VendorDuplicator\\Google_Service_Blogger_BlogUserInfo';
    protected $blogUserInfosDataType = 'array';
    protected $itemsType = 'VendorDuplicator\\Google_Service_Blogger_Blog';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Blogger_BlogList', 'VendorDuplicator\\Google_Service_Blogger_BlogList', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Blogger_BlogLocale', 'VendorDuplicator\\Google_Service_Blogger_BlogLocale', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Blogger_BlogPages', 'VendorDuplicator\\Google_Service_Blogger_BlogPages', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Blogger_BlogPerUserInfo', 'VendorDuplicator\\Google_Service_Blogger_BlogPerUserInfo', \false);
/** @internal */
class Google_Service_Blogger_BlogPosts extends Google_Collection
{
    protected $collection_key = 'items';
    protected $internal_gapi_mappings = array();
    protected $itemsType = 'VendorDuplicator\\Google_Service_Blogger_Post';
    protected $itemsDataType = 'array';
    public $selfLink;
    public $totalItems;
    public function setItems($items)
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Blogger_BlogPosts', 'VendorDuplicator\\Google_Service_Blogger_BlogPosts', \false);
/** @internal */
class Google_Service_Blogger_BlogUserInfo extends Google_Model
{
    ...
    protected $blogType = 'VendorDuplicator\\Google_Service_Blogger_Blog';
    protected $blogDataType = '';
    protected $blogUserInfoType = 'VendorDuplicator\\Google_Service_Blogger_BlogPerUserInfo';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Blogger_BlogUserInfo', 'VendorDuplicator\\Google_Service_Blogger_BlogUserInfo', \false);
/** @internal */
class Google_Service_Blogger_Comment extends Google_Model
{
    protected $internal_gapi_mappings = array();
    protected $authorType = 'VendorDuplicator\\Google_Service_Blogger_CommentAuthor';
    protected $authorDataType = '';
    protected $blogType = 'VendorDuplicator\\Google_Service_Blogger_CommentBlog';
    protected $blogDataType = '';
    public $content;
    public $id;
    protected $inReplyToType = 'VendorDuplicator\\Google_Service_Blogger_CommentInReplyTo';
    protected $inReplyToDataType = '';
    public $kind;
    protected $postType = 'VendorDuplicator\\Google_Service_Blogger_CommentPost';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Blogger_Comment', 'VendorDuplicator\\Google_Service_Blogger_Comment', \false);
/** @internal */
class Google_Service_Blogger_CommentAuthor extends Google_Model
{
    ...
    public $displayName;
    public $id;
    protected $imageType = 'VendorDuplicator\\Google_Service_Blogger_CommentAuthorImage';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Blogger_CommentAuthor', 'VendorDuplicator\\Google_Service_Blogger_CommentAuthor', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Blogger_CommentAuthorImage', 'VendorDuplicator\\Google_Service_Blogger_CommentAuthorImage', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Blogger_CommentBlog', 'VendorDuplicator\\Google_Service_Blogger_CommentBlog', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Blogger_CommentInReplyTo', 'VendorDuplicator\\Google_Service_Blogger_CommentInReplyTo', \false);
/** @internal */
class Google_Service_Blogger_CommentList extends Google_Collection
{
    ...
    protected $internal_gapi_mappings = array();
    public $etag;
    protected $itemsType = 'VendorDuplicator\\Google_Service_Blogger_Comment';
    protected $itemsDataType = 'array';
    public $kind;
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Blogger_CommentList', 'VendorDuplicator\\Google_Service_Blogger_CommentList', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Blogger_CommentPost', 'VendorDuplicator\\Google_Service_Blogger_CommentPost', \false);
/** @internal */
class Google_Service_Blogger_Page extends Google_Model
{
    protected $internal_gapi_mappings = array();
    protected $authorType = 'VendorDuplicator\\Google_Service_Blogger_PageAuthor';
    protected $authorDataType = '';
    protected $blogType = 'VendorDuplicator\\Google_Service_Blogger_PageBlog';
    protected $blogDataType = '';
    public $content;
    public $etag;
    public $id;
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Blogger_Page', 'VendorDuplicator\\Google_Service_Blogger_Page', \false);
/** @internal */
class Google_Service_Blogger_PageAuthor extends Google_Model
{
    ...
    public $displayName;
    public $id;
    protected $imageType = 'VendorDuplicator\\Google_Service_Blogger_PageAuthorImage';
    protected $imageDataType = '';
    public $url;
    public function setDisplayName($displayName)
    {
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Blogger_PageAuthor', 'VendorDuplicator\\Google_Service_Blogger_PageAuthor', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Blogger_PageAuthorImage', 'VendorDuplicator\\Google_Service_Blogger_PageAuthorImage', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Blogger_PageBlog', 'VendorDuplicator\\Google_Service_Blogger_PageBlog', \false);
/** @internal */
class Google_Service_Blogger_PageList extends Google_Collection
{
    ...
    protected $internal_gapi_mappings = array();
    public $etag;
    protected $itemsType = 'VendorDuplicator\\Google_Service_Blogger_Page';
    protected $itemsDataType = 'array';
    public $kind;
    public $nextPageToken;
    public function setEtag($etag)
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Blogger_PageList', 'VendorDuplicator\\Google_Service_Blogger_PageList', \false);
/** @internal */
class Google_Service_Blogger_Pageviews extends Google_Collection
{
    ...
    protected $internal_gapi_mappings = array();
    public $blogId;
    protected $countsType = 'VendorDuplicator\\Google_Service_Blogger_PageviewsCounts';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Blogger_Pageviews', 'VendorDuplicator\\Google_Service_Blogger_Pageviews', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Blogger_PageviewsCounts', 'VendorDuplicator\\Google_Service_Blogger_PageviewsCounts', \false);
/** @internal */
class Google_Service_Blogger_Post extends Google_Collection
{
    protected $collection_key = 'labels';
    protected $internal_gapi_mappings = array();
    protected $authorType = 'VendorDuplicator\\Google_Service_Blogger_PostAuthor';
    protected $authorDataType = '';
    protected $blogType = 'VendorDuplicator\\Google_Service_Blogger_PostBlog';
    protected $blogDataType = '';
    public $content;
    public $customMetaData;
    public $etag;
    public $id;
    protected $imagesType = 'VendorDuplicator\\Google_Service_Blogger_PostImages';
    protected $imagesDataType = 'array';
    public $kind;
    public $labels;
    protected $locationType = 'VendorDuplicator\\Google_Service_Blogger_PostLocation';
    protected $locationDataType = '';
    public $published;
    public $readerComments;
    protected $repliesType = 'VendorDuplicator\\Google_Service_Blogger_PostReplies';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Blogger_Post', 'VendorDuplicator\\Google_Service_Blogger_Post', \false);
/** @internal */
class Google_Service_Blogger_PostAuthor extends Google_Model
{
    ...
    public $displayName;
    public $id;
    protected $imageType = 'VendorDuplicator\\Google_Service_Blogger_PostAuthorImage';
    protected $imageDataType = '';
    public $url;
    public function setDisplayName($displayName)
    {
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Blogger_PostAuthor', 'VendorDuplicator\\Google_Service_Blogger_PostAuthor', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Blogger_PostAuthorImage', 'VendorDuplicator\\Google_Service_Blogger_PostAuthorImage', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Blogger_PostBlog', 'VendorDuplicator\\Google_Service_Blogger_PostBlog', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Blogger_PostImages', 'VendorDuplicator\\Google_Service_Blogger_PostImages', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Blogger_PostList', 'VendorDuplicator\\Google_Service_Blogger_PostList', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Blogger_PostLocation', 'VendorDuplicator\\Google_Service_Blogger_PostLocation', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Blogger_PostPerUserInfo', 'VendorDuplicator\\Google_Service_Blogger_PostPerUserInfo', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Blogger_PostReplies', 'VendorDuplicator\\Google_Service_Blogger_PostReplies', \false);
/** @internal */
class Google_Service_Blogger_PostUserInfo extends Google_Model
{
    ...
    public $kind;
    protected $postType = 'VendorDuplicator\\Google_Service_Blogger_Post';
    protected $postDataType = '';
    protected $postUserInfoType = 'VendorDuplicator\\Google_Service_Blogger_PostPerUserInfo';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Blogger_PostUserInfo', 'VendorDuplicator\\Google_Service_Blogger_PostUserInfo', \false);
/** @internal */
class Google_Service_Blogger_PostUserInfosList extends Google_Collection
{
    protected $collection_key = 'items';
    protected $internal_gapi_mappings = array();
    protected $itemsType = 'VendorDuplicator\\Google_Service_Blogger_PostUserInfo';
    protected $itemsDataType = 'array';
    public $kind;
    public $nextPageToken;
    public function setItems($items)
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Blogger_PostUserInfosList', 'VendorDuplicator\\Google_Service_Blogger_PostUserInfosList', \false);
/** @internal */
class Google_Service_Blogger_User extends Google_Model
{
    protected $internal_gapi_mappings = array();
    public $about;
    protected $blogsType = 'VendorDuplicator\\Google_Service_Blogger_UserBlogs';
    protected $blogsDataType = '';
    public $created;
    public $displayName;
    public $id;
    public $kind;
    protected $localeType = 'VendorDuplicator\\Google_Service_Blogger_UserLocale';
    protected $localeDataType = '';
    public $selfLink;
    public $url;
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Blogger_User', 'VendorDuplicator\\Google_Service_Blogger_User', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Blogger_UserBlogs', 'VendorDuplicator\\Google_Service_Blogger_UserBlogs', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Blogger_UserLocale', 'VendorDuplicator\\Google_Service_Blogger_UserLocale', \false);
