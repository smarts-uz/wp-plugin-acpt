...
class Google_Service_Kgsearch extends Google_Service
{
    ...
    public function __construct(Google_Client $client)
    {
        ...
        $this->entities = new Google_Service_Kgsearch_Entities_Resource($this, $this->serviceName, 'entities', array('methods' => array('search' => array('path' => 'v1/entities:search', 'httpMethod' => 'GET', 'parameters' => array('query' => array('location' => 'query', 'type' => 'string'), 'ids' => array('location' => 'query', 'type' => 'string', 'repeated' => \true), 'languages' => array('location' => 'query', 'type' => 'string', 'repeated' => \true), 'types' => array('location' => 'query', 'type' => 'string', 'repeated' => \true), 'indent' => array('location' => 'query', 'type' => 'boolean'), 'prefix' => array('location' => 'query', 'type' => 'boolean'), 'limit' => array('location' => 'query', 'type' => 'integer'))))));
    }
}
/*
 * Licensed under the Apache License, Version 2.0 (the "License"); you may not
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Kgsearch', 'VendorDuplicator\\Google_Service_Kgsearch', \false);
/**
...
class Google_Service_Kgsearch_Entities_Resource extends Google_Service_Resource
{
    ...
    public function search($optParams = array())
    {
        ...
        return $this->call('search', array($params), "VendorDuplicator\\Google_Service_Kgsearch_SearchResponse");
    }
}
/**
 * The "entities" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_Kgsearch_Entities_Resource', 'VendorDuplicator\\Google_Service_Kgsearch_Entities_Resource', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_Kgsearch_SearchResponse', 'VendorDuplicator\\Google_Service_Kgsearch_SearchResponse', \false);
