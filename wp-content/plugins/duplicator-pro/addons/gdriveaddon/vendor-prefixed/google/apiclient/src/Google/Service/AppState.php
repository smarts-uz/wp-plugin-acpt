...
class Google_Service_AppState extends Google_Service
{
    ...
    public function __construct(Google_Client $client)
    {
        ...
        $this->states = new Google_Service_AppState_States_Resource($this, $this->serviceName, 'states', array('methods' => array('clear' => array('path' => 'states/{stateKey}/clear', 'httpMethod' => 'POST', 'parameters' => array('stateKey' => array('location' => 'path', 'type' => 'integer', 'required' => \true), 'currentDataVersion' => array('location' => 'query', 'type' => 'string'))), 'delete' => array('path' => 'states/{stateKey}', 'httpMethod' => 'DELETE', 'parameters' => array('stateKey' => array('location' => 'path', 'type' => 'integer', 'required' => \true))), 'get' => array('path' => 'states/{stateKey}', 'httpMethod' => 'GET', 'parameters' => array('stateKey' => array('location' => 'path', 'type' => 'integer', 'required' => \true))), 'list' => array('path' => 'states', 'httpMethod' => 'GET', 'parameters' => array('includeData' => array('location' => 'query', 'type' => 'boolean'))), 'update' => array('path' => 'states/{stateKey}', 'httpMethod' => 'PUT', 'parameters' => array('stateKey' => array('location' => 'path', 'type' => 'integer', 'required' => \true), 'currentStateVersion' => array('location' => 'query', 'type' => 'string'))))));
    }
}
/*
 * Licensed under the Apache License, Version 2.0 (the "License"); you may not
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_AppState', 'VendorDuplicator\\Google_Service_AppState', \false);
/**
...
class Google_Service_AppState_States_Resource extends Google_Service_Resource
{
    ...
    public function clear($stateKey, $optParams = array())
    {
        ...
        return $this->call('clear', array($params), "VendorDuplicator\\Google_Service_AppState_WriteResult");
    }
    /**
    ...
    public function get($stateKey, $optParams = array())
    {
        $params = array('stateKey' => $stateKey);
        $params = \array_merge($params, $optParams);
        return $this->call('get', array($params), "VendorDuplicator\\Google_Service_AppState_GetResponse");
    }
    /**
    ...
    public function listStates($optParams = array())
    {
        $params = array();
        $params = \array_merge($params, $optParams);
        return $this->call('list', array($params), "VendorDuplicator\\Google_Service_AppState_ListResponse");
    }
    /**
    ...
    public function update($stateKey, Google_Service_AppState_UpdateRequest $postBody, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('update', array($params), "VendorDuplicator\\Google_Service_AppState_WriteResult");
    }
}
/**
 * The "states" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_AppState_States_Resource', 'VendorDuplicator\\Google_Service_AppState_States_Resource', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_AppState_GetResponse', 'VendorDuplicator\\Google_Service_AppState_GetResponse', \false);
/** @internal */
class Google_Service_AppState_ListResponse extends Google_Collection
{
    protected $collection_key = 'items';
    protected $internal_gapi_mappings = array();
    protected $itemsType = 'VendorDuplicator\\Google_Service_AppState_GetResponse';
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_AppState_ListResponse', 'VendorDuplicator\\Google_Service_AppState_ListResponse', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_AppState_UpdateRequest', 'VendorDuplicator\\Google_Service_AppState_UpdateRequest', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_AppState_WriteResult', 'VendorDuplicator\\Google_Service_AppState_WriteResult', \false);
