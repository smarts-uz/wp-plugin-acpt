...
class Google_Service_GroupsMigration extends Google_Service
{
    ...
    public function __construct(Google_Client $client)
    {
        ...
        $this->archive = new Google_Service_GroupsMigration_Archive_Resource($this, $this->serviceName, 'archive', array('methods' => array('insert' => array('path' => '{groupId}/archive', 'httpMethod' => 'POST', 'parameters' => array('groupId' => array('location' => 'path', 'type' => 'string', 'required' => \true))))));
    }
}
/*
 * Licensed under the Apache License, Version 2.0 (the "License"); you may not
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_GroupsMigration', 'VendorDuplicator\\Google_Service_GroupsMigration', \false);
/**
...
class Google_Service_GroupsMigration_Archive_Resource extends Google_Service_Resource
{
    ...
    public function insert($groupId, $optParams = array())
    {
        ...
        return $this->call('insert', array($params), "VendorDuplicator\\Google_Service_GroupsMigration_Groups");
    }
}
/**
 * The "archive" collection of methods.
 ...
 * @internal
 */
\class_alias('VendorDuplicator\\Google_Service_GroupsMigration_Archive_Resource', 'VendorDuplicator\\Google_Service_GroupsMigration_Archive_Resource', \false);
/** @internal */
...
/** @internal */
\class_alias('VendorDuplicator\\Google_Service_GroupsMigration_Groups', 'VendorDuplicator\\Google_Service_GroupsMigration_Groups', \false);
