                ...
                <tr>
                    ...
                    <td>
                        ...
                        <div class="sub-filter-data sub-filter-data-directories">
                            ...
                            echo "<a href='javascript:void(0)' onclick=\"jQuery(this).parent().children('.filter-info').eq(0).toggle(200)\" title='"
                                . esc_attr($title) . "'>" . "<i class='fa fa-filter fa-fw fa-xs'></i>" . esc_html__('User Defined', 'duplicator-pro')
                                . "</a>  <sup>(" . (int) $count . ")</sup><br/>";

                            echo ($count == 0)
                                ? "<div class='filter-info'>" . esc_html__('- filter type not found -', 'duplicator-pro') . "</div>"
                            ...
                            echo "<a href='javascript:void(0)' onclick=\"jQuery(this).parent().children('.filter-info').eq(1).toggle(200)\" title='"
                            . esc_attr($title) . "'>" . "<i class='fa fa-filter fa-fw fa-xs'></i>" . esc_html__('Unreadable', 'duplicator-pro')
                            . "</a> <sup>(" . (int) $count . ")</sup><br/>";
                        ...
                        <div class="sub-filter-data sub-filter-data-tables">
                            ...
                            <div id="dup-filter-tables" class="filter-info">
                                ...
                                echo (strlen($package->Database->FilterTables)
                                    ...
                                    : esc_html__('- no filters -', 'duplicator-pro'));
                                ?>
                            </div>
