...
class ImportPageController extends AbstractMenuPageController
{
    ...
    protected function __construct()
    {
        ...
        add_action('duplicator_before_render_page_' . $this->pageSlug, array($this, 'beforeRender'), 10, 2);
    }
     ...
     * @return void
     */
    public function beforeRender($currentLevelSlugs, $innerPage)
    {
        $installInfo = UpgradePlugin::getInstallInfo();
        if ($installInfo['time'] > License::lastLicenseUpdateTime()) {
            License::getLicenseStatus(true);
            LicenseNotices::licenseAlertCheck();
        }
    }
}
