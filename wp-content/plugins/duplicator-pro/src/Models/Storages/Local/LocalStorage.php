...
class LocalStorage extends AbstractStorageEntity
{
     ...
     *
     * @param StorageAdapterInterface $adapter Storage adapter
     *
     * @return bool True if success, false otherwise
     */
    protected static function setupStorageHtaccess(StorageAdapterInterface $adapter)
    {
        try {
            $fileName = '.htaccess';
...
FILECONTENT;
     ...
     * @return bool True if success, false otherwise
     */
    protected static function setupStorageIndex(StorageAdapterInterface $adapter)
    {
        $fileName    = 'index.php';
...
INDEXPHP;
    ...
    * @return bool True if success, false otherwise
    */
    protected static function setupStorageDirRobotsFile(StorageAdapterInterface $adapter)
    {
        try {
            $fileName = 'robots.txt';
...
FILECONTENT;
    ...
    * @return bool True if success, false otherwise
    */
    public static function performHardenProcesses(StorageAdapterInterface $adapter)
    {
        try {
    ...
    *
    * @param string|StorageAdapterInterface $path The folder path
    *
            ...
            <tr valign="top">
                ...
                <td>
                    <input 
                        ...
                        value="<?php echo $values['local_upload_chunksize_in_MB']; ?>" 
                    >&nbsp;<b>MB</b>
